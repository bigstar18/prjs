...
public class CapitalProcessor
{
  ...
  public CapitalProcessor()
  {
    try
    {
      ...
      if (!ISLOADED) {
        ...
        else log("初始化处理器失败：加载配置的科目与摘要信息错误"); 
      }
    }
    catch (Exception e)
    {
  ...
  {
    if (ADAPTERLIST == null) ADAPTERLIST = new Hashtable();
    ADAPTERLIST.put(bankID, adapterClassname);
  }

  private void addBankIdAndAdapterClassname(String adapterClassname, String bankID)
  {
    if (this.BankIdAndAdapterClassnameList == null) this.BankIdAndAdapterClassnameList = new Hashtable();
  ...
  private double getTotalTransMoney(String bankID, String firmID, int type, Connection conn)
    throws SQLException
  {
    System.out.println("{{{{{{{{{{{{{{{{{{{{{{{{{{{{{{{{{{{{{{{{{{");
  ...
  private double getDayTransMoney(String bankID, String firmID, int type, Timestamp time, Connection conn)
    throws SQLException
  {
    System.out.println("{{{{{{{{{{{{{{{{{{{{{{{{{{{{{{{{{{{{{{{{{{{{{{");
  ...
  private int getDayTransCount(String bankID, String firmID, int type, Timestamp time, Connection conn)
    throws SQLException
  {
    System.out.println("{{{{{{{{{{{{{{{{{{{{{{{{{{{{{{{{{{{{{{{{{{{{{");
  ...
  private long checkTrans(String bankID, String firmID, double money, Timestamp time, int type, Connection conn)
  {
    ...
    try
    {
      ...
      if (fVal.maxPerTransMoney > 0.0D) maxPerTransMoney = fVal.maxPerTransMoney;
      if (fVal.maxPerTransCount > 0) maxPerTransCount = fVal.maxPerTransCount;
      if (fVal.maxPerSglTransMoney > 0.0D) maxPerSglTransMoney = fVal.maxPerSglTransMoney;
  ...
  public long inMoney(String bankID, String contact, String account, Timestamp bankTime, double money, String funID, long actionID, int funFlag, String remark)
  {
    ...
    System.out.println("bankID[" + bankID + "]contact[" + contact + "]account[" + account + "]bankTime[" + bankTime + "]money[" + money + "]funID[" + funID + "]actionID[" + actionID + "]funFlag[" + funFlag + "]remark[" + remark + "]");
    System.out.println("}}}}}}}}}}}}}}}}}}}}}}}}时间：" + Tool.fmtTime(new java.util.Date()) + "}}}}}}}}}}}}}}}}}}}}}}");
    ...
    Vector vec = null;
    try {
      vec = DAO.getCapitalInfoList(" where actionid=" + actionID + " or (funid='" + funID + "' and trunc(createtime)=to_date('" + Tool.fmtDate(bankTime) + "','yyyy-MM-dd'))");
    } catch (Exception e) {
  ...
  public long inMoneyMarket(String bankID, String firmID, String account, String accountPwd, double money, String remark, String inOutStart, String PersonName, String AmoutDate, String BankName, String OutAccount)
  {
    System.out.println("{{{{{{{{{{{{{{{{{{{{入金，由市场端调用{{{{{{{{{{{{{{{{{{{{{{{{{{");
    System.out.println("bankID[" + bankID + "]firmID[" + firmID + "]account[" + account + "]accountPwd[" + accountPwd + "]money[" + money + "]remark[" + remark + "]");
    System.out.println("}}}}}}}}}}}}}}}}}}}}时间：" + Tool.fmtTime(new java.util.Date()) + "}}}}}}}}}}}}}}}}}}}}}}}}}}");
          ...
          if (result == 0L)
          {
            try
            {
              ...
              if (capital.type == 1) {
                ...
                dataProcess.updateFundsFull(capital.firmID, dataProcess.getOUTSUMMARY(), (String)dataProcess.getBANKSUB().get(capital.bankID), capital.money, actionID, conn);
                ...
                dataProcess.updateFundsFull(capital.firmID, dataProcess.getINSUMMARY(), (String)dataProcess.getBANKSUB().get(capital.bankID), capital.money, actionID, conn);
                dataProcess.updateFundsFull(capital.firmID, dataProcess.getFEESUMMARY(), null, rate.money, actionID, conn);
  ...
  public ReturnValue outMoney(String bankID, double money, String contact, String bankAccount, String funID, String operator, int express, int type)
  {
    ...
    System.out.println("bankID[" + bankID + "]money[" + money + "]contact[" + contact + "]bankAccount[" + bankAccount + "]funID[" + funID + "]operator[" + operator + "]express[" + express + "]type[" + type + "]");
    System.out.println("}}}}}}}}}}}}}}}}}}}}时间：" + Tool.fmtTime(new java.util.Date()) + "}}}}}}}}}}}}}}}}}}}}}}}}}}");
  ...
  public long rgstAccount(CorrespondValue correspondValue)
  {
    ...
    try
    {
      ...
      else if (DAO.getCorrespondList(" where bankID='" + correspondValue.bankID + "' and firmID='" + correspondValue.firmID + "' and account='" + correspondValue.account + "' and status=1 and isopen=1", conn).size() > 0)
      {
        DAO.modCorrespond(correspondValue, conn);
      }
      else if (DAO.getCorrespondList(" where bankID='" + correspondValue.bankID + "' and firmID='" + correspondValue.firmID + "' and account='" + correspondValue.account + "'", conn).size() <= 0)
      {
        log("添加交易商");
  ...
  public long delAccountMaket(CorrespondValue correspondValue)
  {
    ...
    {
      conn = DAO.getConnection();
      Vector vector = DAO.getCorrespondList(" where bankID='" + correspondValue.bankID + "' and firmID='" + correspondValue.firmID + "' and account='" + correspondValue.account + "'", conn);
      ...
      else
      {
        ...
        if (cv.isOpen == 1)
        {
          ...
          if (returnValue.result != 0L) {
            ...
            long l1 = returnValue.result; return l1;
          }
      ...
      if (result == 0)
      {
        try
        {
          ...
          for (int i = 0; i < list.size(); i++)
          {
            ...
            moneyInfoValue.firmID = getFirmID(moneyInfoValue.firmID, moneyInfoValue.bankID);

            Vector curList = DAO.getMoneyInfoList("where funID='" + moneyInfoValue.id + 
  ...
  public double queryFirmBalance(String firmID)
    throws SQLException
  {
    System.out.println("{{{{{{{{{{{{{{{{{{{{{{{{{{{{{{{{{{{{{{{{{{{{{{");
      ...
      try {
        ...
        if (rv.result == 0L) {
          ...
          if ((capList != null) && (capList.size() > 0)) {
                ...
                if (fbv != null) {
                  if ("true".equalsIgnoreCase(Tool.getConfig("fuYing"))) {
                    try {
                      ...
                      Vector floatingloss = DAO.getFlote(new String[] { capVal.firmID });
            ...
            dataProcess.updateFundsFull(cv.firmID, cv.oprcode, (String)dataProcess.getBANKSUB().get(cv.bankID), dataProcess.getOUTSUMMARY().equalsIgnoreCase(cv.oprcode) ? -cv.money : cv.money, cv.actionID, conn);
            conn.commit();
          } else {
            rv.result = -50007L;
  ...
  public FirmBalanceValue getMarketBalance(String firmid, Connection conn)
  {
    ...
    if ("true".equalsIgnoreCase(getConfig("fuYing"))) {
      try {
        Vector floatingloss = DAO.getFlote(new String[] { firmid }, conn);
        if ((floatingloss != null) && (floatingloss.size() > 0))
          for (FirmBalanceValue fb : floatingloss)
            if ((fb != null) && (firmid.equals(fb.firmId))) {
              fbv.floatingloss = fb.floatingloss;
      ...
      if (mv != null) {
        try
        {
          for (int a = 0; a < mv.size(); a++)
          {
            ...
            Vector curList = DAO.getMoneyInfoList("where funID='" + miv.id + 
  ...
  public long checkArgs(Connection conn, double realFunds, double outRate, String bankID, double money, String firmID, String bankAccount, int express, int type)
    throws SQLException
  {
    System.out.println("{{{{{{{{{{{{{{{{{{{{{{{{{{{{{{{{{{{{{{{{{{{{{{");
  ...
  public HashMap<Integer, Long> handleOUtMoney(long result, Connection conn, long checkTrans, double outRate, String bankID, double money, String firmID, String funID, int express, int type)
    throws SQLException
  {
    System.out.println("{{{{{{{{{{{{{{{{{{{{{{{{{{{{{{{{{{{{{{{{{{{{{{");
    ...
    try
    {
      ...
      if ((funID != null) && (funID.trim().length() > 0)) {
        Vector cv = DAO.getCapitalInfoList(" where bankID='" + bankID + "' and trunc(createtime)=trunc(sysdate) and funID='" + funID + "'", conn);
  ...
  public long chenckCorrespondValue(CorrespondValue cv)
  {
    ...
    else
    {
      try
      {
        List cvresult = DAO.getCorrespondList(" where bankId='" + bankid + "' and firmId='" + firmid + "' and (account like '%" + account.trim() + "%' or account='" + Tool.getConfig("DefaultAccount") + "')");
  ...
  public long chenckCorrespondValue(CorrespondValue cv, Connection conn)
  {
    ...
    else
    {
      try
      {
        List cvresult = DAO.getCorrespondList(" where bankId='" + bankid + "' and firmId='" + firmid + "' and (account like '%" + account.trim() + "%' or account='" + Tool.getConfig("DefaultAccount") + "')", conn);
        if ((bankid.equals("20")) || (bankid.equals("005")) || (bankid.equals("66"))) {
  ...
  public ReturnValue synchroAccountMarket(CorrespondValue cv)
  {
    ...
    if (checkResult == 0L)
    {
      ...
      try {
        cv.isOpen = 1;
        List cvresult = DAO.getCorrespondList(" where bankId='" + cv.bankID.trim() + "' and firmId='" + cv.firmID.trim() + "' and account like '%" + cv.account.trim() + "%'");
        if ((cvresult == null) || (cvresult.size() <= 0))
        {
          rv.result = -40001L;
        } else {
  ...
  public long tradeDate(String bankID)
  {
    ...
    try {
      ...
      switch (n) { case 0:
        result = 0L; break;
      case 1:
        result = -920003L; break;
      case 2:
        result = -920004L; break;
      case 3:
        result = -920005L; break;
      default:
        result = -920006L; }
    }
    catch (Exception e) {
            ...
            if (capital.type == 1) {
              ...
              if (result >= 0L) {
                if (Tool.getConfig("inMoneyNoAdapterAddMoney").equals("true")) {
                  dataProcess.updateFundsFull(capital.firmID, dataProcess.getINSUMMARY(), (String)dataProcess.getBANKSUB().get(capital.bankID), capital.money, result, conn);
  ...
  private HashMap<Integer, Long> handleOUtMoney(long result, Connection conn, long checkTrans, String maketbankID, double money, String firmID, int express, int type, String bankName, String account)
    throws SQLException
  {
    System.out.println("{{{{{{{{{{{{{{{{{{{{{{{{{{{{{{{{{{{{{{{{{{{{{{");
      ...
      while (flag)
      {
        ...
        if (usdate == null) {
          ...
          if ((lastQSDate != null) && (usdate.after(lastQSDate))) {
            ...
            Vector bfr = DAO.getFirmBalanceError(str, bankID, usdate);
            Vector bcd = DAO.getBatCustDz(str, bankID, usdate);
  ...
  public ReturnValue sentFirmBalance(String bankID, java.util.Date date)
  {
    ...
    try {
      ...
      if (bankadapter == null) {
        ...
        log("准备查询数据");
        Vector vector = DAO.getFirmBalance(bankID, null, date);
  ...
  public ReturnValue pfdbQS(String bankID, java.util.Date date)
  {
    ...
    try {
      ...
      if ((v1 != null) && (v1.size() > 0)) {
        try {
          conn.setAutoCommit(false);
          Vector v11 = DAO.getChangeFirmRights(" and trunc(Trade_Date)=to_date('" + Tool.fmtDate(date) + "','yyyy-MM-dd') and flag<>'Y' for update ", conn);
      ...
      if ((v2 != null) && (v2.size() > 0))
        try {
          conn.setAutoCommit(false);
          Vector v21 = DAO.getChangeFirmFrozen(" and trunc(Trade_Date)=to_date('" + Tool.fmtDate(date) + "','yyyy-MM-dd') and flag<>'Y' for update", conn);
  ...
  public ReturnValue getBankFirmRightValue(String bankID, java.util.Date date)
  {
    ...
    if (bankadapter == null) {
      ...
      try {
        List firmRightValues = bankadapter.getBankFirmRightValue(bankID, date);
        try {
  ...
  public Map<String, FirmRights> getRightsMap(String bankId, String firmId, java.util.Date qdate) {
    ...
    List frvs = getTradeDataMsg(bankId, firmId, qdate);
  ...
  public List<TradingDetailsValue> getChangeBalance(String bankId, String firmId, java.util.Date qdate) {
    ...
    List selectDate = getRightsList(bankId, firmId, qdate);
    try {
      conn = DAO.getConnection();
  ...
  public List<OpenOrDelFirmValue> getOpenOrDropMaket(String bankId, java.util.Date qdate) {
    ...
    Vector openFirmVector = null;

    Vector delFirmVector = null;
    try
    {
    ...
    if (bankAdapter == null) {
      ...
      try
      {
        try {
          ...
          Vector vt = DAO.getBankQSDate(" where trunc(tradedate)=to_date('" + Tool.fmtDate(tradeDate) + "','yyyy-MM-dd')" + " and bankID='" + bankID + "'");
        ...
        if (usdate == null) {
          ...
          for (int i = 0; i < firmsTody.size(); i++) {
            ...
            if (lastDay.get(firmID) != null) {
              ...
              if (firmLast != null) {
                firmTody.tradeFee = (Double.parseDouble(firmTody.tradeFee == null ? "0" : firmTody.tradeFee) + Double.parseDouble(firmLast.tradeFee == null ? "0" : firmLast.tradeFee));
                firmTody.settleFee = (Double.parseDouble(firmTody.settleFee == null ? "0" : firmTody.settleFee) + Double.parseDouble(firmLast.settleFee == null ? "0" : firmLast.settleFee));
  ...
  public ReturnValue addMarketMoney(XYMarketMoney xymm)
  {
    ...
    try {
      if (xymm == null) {
        ...
        Vector vec = DAO.getMarketMoney(" and bankID='" + xymm.bankID + "' and bankNumber='" + xymm.bankNumber + "' and bankNumber is not null");
        if ((vec != null) && (vec.size() > 0)) {
          result.result = -1L;
  ...
  public ReturnValue sendCMBCQSValue(String bankID, java.util.Date date)
  {
    ...
    try {
      ...
      if ("20".equals(bankID))
      {
        QYHZ += DAO.sumAmount("where 1= 1 and bankid ='20' and isopen = 1 and trunc(opentime)=to_date('" + Tool.fmtDate(date) + "','yyyy-MM-dd') ", conn);
      }
      if (QYHZ != 0.0D) {
        Spay spay = new Spay();
        spay.setMoney(QYHZ);
  ...
  public ReturnValue marketTransfer(BankTransferValue bankTransferValue, Connection conn)
  ...
  public CEB_RSP CEB(CEB_param param, String id)
  {
    ...
    catch (Exception e)
    {
      ...
      DAO.closeStatement(null, null, conn); } DAO.closeStatement(null, null, conn);
    try
    {
            ...
            if (firmMsg.get(capVal.firmID) != null)
            {
              ...
              if (fbv != null)
              {
                if ("true".equalsIgnoreCase(Tool.getConfig("fuYing")))
                {
                  ...
                  {
                    BankDAO DAO = BankDAOFactory.getDAO();
                    Vector floatingloss = DAO.getFlote(
                      new String[] { capVal.firmID });
                    if ((floatingloss != null) && (floatingloss.size() > 0))
                    {
                      for (FirmBalanceValue tp : floatingloss)
                      {
  ...
  public ReturnValue modAccount(CorrespondValue cv1, CorrespondValue cv2, String bankID)
  {
    ...
    if (checkResult == 0L)
    {
      ...
      try
      {
        ...
        if (rv.result != 0L) break label290;
        rv.result = DAO.modCorrespond(cv2);
      }
      catch (RemoteException e) {
        rv.result = -920000L;
        ...
        if ((cv.status == 2) || (cv.status == 5)) {
          ...
          try {
            ...
            if ((result.result == 0L) || (result.result == -1L)) {
              ...
              long m = inMoney(cpv.bankID, cpv.firmID, cpv.account, cpv.bankTime, cpv.money, result.funID, actionID, funFlag, result.remark);
              if (m >= 0L) {
                rv.result = 0L;
  ...
  public ReturnValue inMoneyMarketByEBank(String bankID, String firmID, String account, String accountPwd, double money, String remark)
  {
    ...
    try
    {
      ...
      if (returnValue.result > 0L)
      {
        ...
        BankValue bv = DAO.getBank(bankID);
        InMoneyVO inMoneyInfo = new InMoneyVO(bankID, bv.bankName, money, firmID, payInfo, accountPwd, receiveInfo, remark, returnValue.result);
        ...
        if ((cv.isOpen == 1) || (cv.isOpen == 2))
        {
          ...
          if ((returnValue != null) && (returnValue.result == 0L))
          {
            ...
            if (num != 0) {
              log("删除数据库中对应关系异常");
              result.result = num;
              result.remark = "删除数据库中对应关系异常"; break label731;
            }
          }
          else {
            log(returnValue.remark);

            log("银行帐号注销，银行解约失败，错误码=" + result.result); break label731;
          }
        } else {
  ...
  public HashMap<Integer, Long> handleOUtMoneyAbc(long result, Connection conn, long checkTrans, double outRate, String bankID, double money, String firmID, String funID, int express, int type)
    throws SQLException
  {
    System.out.println("{{{{{{{{{{{{{{{{{{{{{{{{{{{{{{{{{{{{{{{{{{{{{{");
    System.out.println("检查交易商是否符合出金条件,符合条件进行出金处理,记录流水");
    ...
    try
    {
      conn.setAutoCommit(false);
      if (result > 0L) {
        Vector cv = DAO.getCapitalInfoList(" where bankID='" + bankID + "' and trunc(createtime)=trunc(sysdate) and actionID='" + result + "'", conn);
        if ((cv != null) && (cv.size() > 0)) {
          result = -20042L;
        ...
        if (row != null)
        {
          ...
          try {
            ...
            for (int a = 0; a < list.size(); a++) {
              ...
              Vector vcv = DAO.getCorrespondList(" where (firmID='" + cv.firmID + "' or firmID='D_'||'" + cv.firmID + "') and (bankID='" + bankID.trim() + "'or bankID='D_'||'" + bankID.trim() + "')", conn);
          ...
          if (moneyInfoValue.compareDate == null) moneyInfoValue.compareDate = new java.sql.Date(date.getTime());
  ...
  public Vector<FirmBalance> firmBalance(String bankID, java.util.Date date)
  {
    ...
    try
    {
      ...
      Vector vector1 = DAO.getFirmBalance(bankID, trDate);
      ...
      {
        Vector vector2 = DAO.getFirmBalance(bankID, trDate);
  ...
  public double getCanOutBalance(String firmID, String bankID, Connection conn)
  {
    ...
    try
    {
      ...
      Vector vecHis = DAO.getFirmBankFundsHis(" and f.firmID='" + firmID + "' and f.bankcode='" + bankID + "' and f.b_date=(select max(B_date) from f_h_firmbankfunds where B_date< to_date('" + Tool.fmtDate(new java.util.Date()) + "','yyyy-MM-dd'))");
      double money2 = 0.0D;
      if ((vecHis == null) || (vecHis.size() <= 0))
  ...
  public ReturnValue synchFirmAccount(CorrespondValue corr)
  {
    ...
    try {
      ...
      if ((vecFBF == null) || (vecFBF.size() <= 0)) {
        ...
        Vector vecCorrIsOpen;
        Vector vecFBF;
        FirmBankFunds firmBankFunds;
        FirmID2SysFirmID f2f;
        Vector vecCorr;
        result.result = 1L;
      }
  ...
  public ReturnValue openAccountBank(CorrespondValue corr)
  {
    ...
    try {
      ...
      else
      {
        ...
        Vector vecFBF2;
        Vector vecFBF;
        Vector vecOpen = DAO.getCorrespondList(" where firmid='" + corr.firmID + "' and bankid='" + ((FirmBankFunds)vecFBF2.get(0)).bankID + "'", conn);
        ...
        if (((CorrespondValue)vecOpen.get(0)).isOpen == 1) {
          ...
          Tool.log("平台号[" + corr.firmID + "]之前签约的主银行[" + ((FirmBankFunds)vecFBF2.get(0)).bankID + "]没有最终签约成功，将本次签约的银行[" + corr.bankID + "]设置为主银行，原有主银行修改为次银行");
  ...
  public boolean canDelCorr(CorrespondValue corr)
  {
    ...
    if ((fbfOld != null) && (fbfOld.size() > 0) && ((((FirmBankFunds)fbfOld.get(0)).RIGHTS != 0.0D) || (((FirmBankFunds)fbfOld.get(0)).balance != 0.0D) || (((FirmBankFunds)fbfOld.get(0)).RIGHTSFROZENFUNDS != 0.0D))) {
      log("平台号[" + corr.firmID + "]上一日[" + Tool.fmtDate(((FirmBankFunds)fbfOld.get(0)).b_date) + "]结算后权益[" + ((FirmBankFunds)fbfOld.get(0)).RIGHTS + "]可用[" + ((FirmBankFunds)fbfOld.get(0)).balance + "]冻结[" + ((FirmBankFunds)fbfOld.get(0)).RIGHTSFROZENFUNDS + "]有余额不为零，不允许解约");
      result = false;
      return result;
    }
    ...
    Vector vecCV = null;
    try {
      vecCV = DAO.getCapitalInfoList(" where bankID='" + corr.bankID + "' and firmID='" + corr.firmID + "' and trunc(banktime) =to_date('" + Tool.fmtDate(new java.util.Date()) + "', 'yyyy-MM-dd')");
    } catch (Exception e) {
      log("查询平台出入金流水记录异常");
      return false;
    }
  ...
  public ReturnValue outMoneyBank(InOutMoney outMoney)
  {
    ...
    try {
      ...
      if ((outMoney.firmID == null) || (outMoney.systemID == null) || (outMoney.sysFirmID == null) || (outMoney.account == null) || 
        ("".equals(outMoney.firmID)) || ("".equals(outMoney.systemID)) || ("".equals(outMoney.sysFirmID)) || ("".equals(outMoney.account))) {
        log("银行端出金参数非法");
        result.result = -1L;
      ...
      Vector vecf2f = null;
      vecf2f = DAO.getFirmID2SysFirmID(" where firmID='" + outMoney.firmID + "' and sysFirmID='" + outMoney.sysFirmID + "' and systemID='" + outMoney.systemID + "'");
      if ((vecf2f == null) || (vecf2f.size() <= 0)) {
        log("没有找到平台交易商[" + outMoney.firmID + "]和子系统[" + outMoney.systemID + "]的交易商[" + outMoney.sysFirmID + "]关于银行[" + outMoney.bankID + "]的绑定关系");
        result.result = -1L;
      ...
      Vector vecf2f;
      Vector vecCV = null;
      vecCV = DAO.getCorrespondList(" where firmID='" + outMoney.firmID + "' and bankID='" + outMoney.bankID + "' and account='" + outMoney.account + "'");
      ...
      try
      {
        ...
        if (result.result == 0L) {
          ...
          dataProcess.updateFundsFull(outMoney.firmID, dataProcess.getOUTSUMMARY(), (String)dataProcess.getBANKSUB().get(outMoney.bankID), outMoney.money, outMoney.actionID, conn);
        }
        else if (result.result == 5L)
        {
          log("业务流水处理中。");
  ...
  public ReturnValue inMoneyBank(InOutMoney inMoney)
  {
    ...
    try {
      ...
      if ((inMoney.firmID == null) || (inMoney.systemID == null) || (inMoney.sysFirmID == null) || (inMoney.account == null) || 
        ("".equals(inMoney.firmID)) || ("".equals(inMoney.systemID)) || ("".equals(inMoney.sysFirmID)) || ("".equals(inMoney.account))) {
        log("银行端入金参数非法");
        result.result = -1L;
      ...
      Vector vecf2f = null;
      vecf2f = DAO.getFirmID2SysFirmID(" where firmID='" + inMoney.firmID + "' and sysFirmID='" + inMoney.sysFirmID + "' and systemID='" + inMoney.systemID + "' and bankID='" + inMoney.bankID + "'");
      if ((vecf2f == null) || (vecf2f.size() <= 0)) {
        log("没有找到平台交易商[" + inMoney.firmID + "]和子系统[" + inMoney.systemID + "]的交易商[" + inMoney.sysFirmID + "]关于银行[" + inMoney.bankID + "]的绑定关系");
        result.result = -1L;
        result.remark = "交易商同平台的绑定关系不存在";
        localReturnValue1 = result; return localReturnValue1;
      }
      ...
      if ((vecSystem == null) || (vecSystem.size() < 0)) {
        ...
        if (!isTradeDate(inMoney.systemID)) {
          log("平台号[" + inMoney.firmID + "]交易系统[" + inMoney.systemID + "]交易商[" + inMoney.sysFirmID + "]银行[" + inMoney.bankID + "]对应的默认入金系统[" + ((FirmID2SysFirmID)vecf2f.get(0)).defaultSystem + "]不在转账时间内");
          notice = false;
        }
      ...
      try
      {
        ...
        dataProcess.updateFundsFull(inMoney.firmID, dataProcess.getINSUMMARY(), (String)dataProcess.getBANKSUB().get(inMoney.bankID), inMoney.money, inMoney.actionID, conn);
    ...
    try {
      ...
      if (result.result == 0L) {
        ...
        if (checkOutMoney <= outMoney.money) {
          Tool.log("平台号[" + outMoney.firmID + "]出金[" + outMoney.money + "]到银行[" + outMoney.bankID + "]，超过了审核额度[" + checkOutMoney + "]，进入审核队列");
          result.result = 5L;
  ...
  public Vector<CapitalValue> getCRJMX(String systemID)
  {
    ...
    try {
      result = DAO.getCapitalInfoListPT(" where systemID='" + systemID + "' and type<>2 and status=0 and bankTime>=to_date('" + Tool.fmtTime(Tool.time2Today(sm.startTime)) + "','yyyy-MM-dd HH:mm:ss') and bankTime<=to_date('" + Tool.fmtTime(Tool.time2Today(sm.endTime)) + "','yyyy-MM-dd HH:mm:ss')");
    } catch (Exception e) {
  ...
  public ReturnValue saveQSData(Vector<SystemQSValue> vec)
  {
    ...
    try {
      ...
      for (int i = 0; i < vec.size(); i++) {
        String filter = " where firmid='" + ((SystemQSValue)vec.get(i)).firmID + 
          "' and sysfirmid='" + ((SystemQSValue)vec.get(i)).sysFirmID + 
          "' and systemid='" + ((SystemQSValue)vec.get(i)).systemID + 
          "' and bankcode='" + ((SystemQSValue)vec.get(i)).bankCode + 
  ...
  public ReturnValue getSystemDetailsFile(String systemID)
  {
    ...
    try {
      String filter = " where systemID='" + systemID + "' and status=0 " + 
        " and type<>2 and createtime>=to_date('" + Tool.fmtTime(Tool.time2Today(sysMsg.startTime)) + "','yyyy-MM-dd hh24:mi:ss') " + 
        " and createtime<=to_date('" + Tool.fmtTime(Tool.time2Today(sysMsg.endTime)) + "','yyyy-MM-dd hh24:mi:ss')";
    ...
    if (checkResult == 0L)
    {
      ...
      try {
        ...
        if (cv.bankID.equals("005"))
          ...
          cvresult = DAO.getCorrespondList(" where bankId='" + cv.bankID.trim() + "' and firmId='" + cv.firmID.trim() + "' and account like '%" + cv.account.trim() + "%'", conn);
        }
        if ((cvresult == null) || (cvresult.size() <= 0))
        {
          rv.result = -40001L;
  ...
  public ReturnValue fundsTransfer(InOutMoney outMoney, String systemID)
  {
    ...
    try
    {
      conn = DAO.getConnection();
      ReturnValue localReturnValue1;
      if ((outMoney.firmID == null) || (outMoney.systemID == null) || (outMoney.sysFirmID == null) || 
      ...
      Vector vecf2f = DAO.getFirmID2SysFirmID(" where firmID='" + outMoney.firmID + "' and sysFirmID='" + outMoney.sysFirmID + "' and systemID='" + outMoney.systemID + "'");
      if ((vecf2f == null) || (vecf2f.size() <= 0)) {
        log("没有找到平台交易商[" + outMoney.firmID + "]和子系统[" + outMoney.systemID + "]的交易商[" + outMoney.sysFirmID + "]关于银行[" + outMoney.bankID + "]的绑定关系");
        result.result = -1L;
        result.remark = "交易商同平台的绑定关系不存在";
  ...
  public ReturnValue associatedFirmInfo(String firmID, String tradeFirmID, String oldFirmID, String systemID)
    throws RemoteException
  {
    ...
    try
    {
      ...
      Vector vec = DAO.getFirmID2SysFirmID(" where sysfirmid='" + tradeFirmID + "' and firmid='" + oldFirmID + "' and systemid='" + systemID + "'");
      ReturnValue localReturnValue1;
      if ((vec == null) || (vec.size() == 0)) {
        rv.remark = "账号不存在";
        conn.rollback();
      ...
      Vector vec3;
      Vector vec;
      Vector corr = DAO.getCorrespondList(" where bankid in (select bankid from f_b_firmidandaccount where isopen=1 and firmid='" + firmID + "') and isopen=1 and firmid='" + oldFirmID + "'");
      ...
      Vector vec3;
      Vector vec;
      Vector corr1 = DAO.getCorrespondList(" where bankid in (select bankid from f_b_firmidandaccount where isopen=1 and firmid='" + oldFirmID + "') and isopen=1 and firmid='" + firmID + "'");
