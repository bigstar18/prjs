...
public class CapitalProcessorRMIImpl extends UnicastRemoteObject
  implements CapitalProcessorRMI
{
  ...
  public Vector<CompareResult> checkMoney(String bankID, Date date) throws RemoteException {
    return this.cp.checkMoney(bankID, date);
  }

  public Vector<CapitalCompare> sumResultInfo(String bankID, String[] firmIDs, Date date) throws RemoteException {
  ...
  public ReturnValue delAccountMaketForYJF(CorrespondValue correspondValue) throws RemoteException {
    return this.cp.delAccountMaketForYJF(correspondValue);
  }
  ...
  public long inMoneyMarket(String bankID, String firmID, String account, String accountPwd, double money, String remark, String inOutStart, String personName, String amoutDate, String bankName, String outAccount)
    throws RemoteException
  {
    return this.cp.inMoneyMarket(bankID, firmID, account, accountPwd, money, remark, inOutStart, personName, amoutDate, bankName, outAccount);
  }
  ...
  public long setMoneyInfoAutoOrNo(String bankID, Date date, int moduleid) throws RemoteException
  {
  ...
  public FirmBalanceValue getMarketBalance(String firmid, String bankID) throws RemoteException {
  ...
  public long moneyInAudit(long actionID, boolean funFlag) throws RemoteException {
    return this.cp.moneyInAudit(actionID, funFlag);
  }
  public long tradeDate(String bankID) throws RemoteException {
    return this.cp.tradeDate(bankID);
  }
  public ReturnValue isPassword(String firmID, String password) throws RemoteException {
    return this.cp.isPassword(firmID, password);
  }
  public ReturnValue modPwd(String firmID, String password, String chpassword) throws RemoteException {
  ...
  public long inMoneyNoAdapter(String maketbankID, String firmID, String account, String bankName, double money, String remark) throws RemoteException {
    return this.cp.inMoneyNoAdapter(maketbankID, firmID, account, bankName, money, remark);
  }
  ...
  public long outMoneyNoAdapter(String maketbankID, double money, String firmID, String bankName, String account, String operator, int express, int type) throws RemoteException {
    return this.cp.outMoneyNoAdapter(maketbankID, money, firmID, bankName, account, operator, express, type);
  }
  ...
  public ReturnValue isTradeDate(Date tradeDate) throws RemoteException {
  ...
  public ReturnValue saveFirmKXH(Date date, String bankID) throws RemoteException {
    return this.cp.saveFirmKXH(date, bankID);
  }
  public ReturnValue getBatCustDz(Date date, String bankID) throws RemoteException {
    return this.cp.getBatCustDz(date, bankID);
  }
  public ReturnValue getBatCustDz(Vector<BatCustDzFailChild> bcd, Date date, String bankID) throws RemoteException {
    return this.cp.getBatCustDz(bcd, date, bankID);
  }
  public ReturnValue getfirmBalanceFile(Date date, String bankID) throws RemoteException {
    return this.cp.getfirmBalanceFile(date, bankID);
  }

  public ReturnValue getfirmBalanceFile(Vector<BatCustDzBChild> fbf, Date date, String bankID) throws RemoteException {
    return this.cp.getfirmBalanceFile(fbf, date, bankID);
  }
  public ReturnValue getFirmBalanceError(Date date, String bankID) throws RemoteException {
    return this.cp.getFirmBalanceError(date, bankID);
  }
  public ReturnValue getFirmBalanceError(Vector<BatFailResultChild> fbe, Date date, String bankID) throws RemoteException {
    return this.cp.getFirmBalanceError(fbe, date, bankID);
  }
  public ReturnValue getBankFileStatus(Date tradeDate, int type, String bankID) throws RemoteException {
    return this.cp.getBankFileStatus(tradeDate, type, bankID);
  }
  public ReturnValue sentMaketQS(Date date, String bankID) throws RemoteException {
  ...
  public ReturnValue sentFirmBalance(String bankID, Date date) throws RemoteException {
  ...
  public ReturnValue hxSentQS(String bankID, Date date) throws RemoteException {
    return this.cp.hxSentQS(bankID, date);
  }
  public ReturnValue hxSentDZ(String bankID, Date date) throws RemoteException {
    return this.cp.hxSentDZ(bankID, date);
  }
  public Vector<HXSentQSMsgValue> hxGetQS(String bankID, Date date) throws RemoteException {
    return this.cp.hxGetQS(bankID, date);
  }
  public Vector<HXSentQSMsgValue> hxGetDZ(String bankID, Date date) throws RemoteException {
    return this.cp.hxGetQS(bankID, date);
  }
  public ReturnValue hxGetQSError(String bankID, Date tradeDate) throws RemoteException {
    return this.cp.hxGetQSError(bankID, tradeDate);
  }
  public ReturnValue hxGetDZError(String bankID, Date tradeDate) throws RemoteException {
  ...
  public ReturnValue pfdbQS(String bankID, Date date) throws RemoteException {
    return this.cp.pfdbQS(bankID, date);
  }
  public ReturnValue getTradesDateDetailsList(String bankID, Date date, int sendCount, int timeOutCount, int faileCount) throws RemoteException {
    return this.cp.getTradesDateDetailsList(bankID, date, sendCount, timeOutCount, faileCount);
  }
  public Vector<TradeList> getTradesDateDetailsList(String bankID, Date date, String[] flag) throws RemoteException {
    return this.cp.getTradesDateDetailsList(bankID, date, flag);
  }
  public ReturnValue getDongjieDetailList(String bankID, Date date, int sendCount, int timeOutCount, int faileCount) throws RemoteException {
    return this.cp.getDongjieDetailList(bankID, date, sendCount, timeOutCount, faileCount);
  }
  public Vector<Margins> getDongjieDetailList(String bankID, Date date, String[] flag) throws RemoteException {
    return this.cp.getDongjieDetailList(bankID, date, flag);
  }
  public Hashtable<String, FundsMarg> getFundsMarg(String bankID, Date date) throws RemoteException {
    return this.cp.getFundsMarg(bankID, date);
  }

  public ReturnValue sendGHQS(String bankId, String firmId, Date qdate) throws RemoteException
  {
    return this.cp.sendGHQS(bankId, firmId, qdate);
  }
  public List<FirmRights> getRightsList(String bankId, String firmId, Date qdate) throws RemoteException {
    return this.cp.getRightsList(bankId, firmId, qdate);
  }
  public List<TradingDetailsValue> getChangeBalance(String bankId, String firmId, Date qdate) throws RemoteException {
    return this.cp.getChangeBalance(bankId, firmId, qdate);
  }
  public List<OpenOrDelFirmValue> getOpenOrDropMaket(String bankId, Date qdate) throws RemoteException {
  ...
  public ReturnValue getBankFirmRightValue(String bankID, Date date) throws RemoteException {
    return this.cp.getBankFirmRightValue(bankID, date);
  }

  public ReturnValue getProperBalanceValue(String bankID, Date date) throws RemoteException {
  ...
  public ReturnValue sendXYQSValue(String bankID, String[] firmIDs, Date tradeDate) throws RemoteException {
    return this.cp.sendXYQSValue(bankID, firmIDs, tradeDate);
  }

  public ReturnValue sendHRBQSValue(String bankID, String[] firmIDs, Date tradeDate) throws RemoteException {
    return this.cp.sendHRBQSValue(bankID, firmIDs, tradeDate);
  }
  public RZQSValue getXYQSValue(String bankID, String[] firmIDs, Date tradeDate) throws RemoteException {
    return this.cp.getXYQSValue(bankID, firmIDs, tradeDate);
  }
  public RZDZValue getXYDZValue(String bankID, String[] firmIDs, Date tradeDate) throws RemoteException {
    return this.cp.getXYDZValue(bankID, firmIDs, tradeDate);
  }
  public ReturnValue getZFPH(String bankID, Date date) throws RemoteException {
    return this.cp.getZFPH(bankID, date);
  }
  public ReturnValue getFFHD(String bankID, Date date) throws RemoteException {
  ...
  public long inMoneyMarket(String bankID, String firmID, String account, String accountPwd, double money, String remark) throws RemoteException
  {
    return this.cp.inMoneyMarket(bankID, firmID, account, accountPwd, money, remark);
  }
  ...
  public long inMoneyMarketGS(String bankID, String firmID, String account, String accountPwd, double money, String remark) throws RemoteException
  {
  ...
  public ReturnValue sendZHQS(String bankID, String[] firmIDs, Date tradeDate) throws RemoteException
  {
  ...
  public ReturnValue modAccount(CorrespondValue cv1, CorrespondValue cv2, String bankID) throws RemoteException
  {
  ...
  public ReturnValue inMoneyMarketForYJF(String bankID, String firmID, String account, String accountPwd, double money, String remark)
    throws RemoteException
  {
    return this.cp.inMoneyMarketForYJF(bankID, firmID, account, accountPwd, money, remark);
  }

  public ReturnValue modBankQS(BankQSVO bq) throws RemoteException
  {
  ...
  public ReturnValue inMoneyMarketByEBank(String bankID, String firmID, String account, String accountPwd, double money, String remark)
    throws RemoteException
  {
    return this.cp.inMoneyMarketByEBank(bankID, firmID, account, accountPwd, money, remark);
  }

  public ReturnValue inMoneyQuery(long actionID) throws RemoteException
  {
    return this.cp.inMoneyQuery(actionID);
  }

  public ReturnValue outMoneyQuery(long actionID) throws RemoteException {
  ...
  public ReturnValue insertAbcInfo(AbcInfoValue value) throws RemoteException {
  ...
  public long inMoneyMarketAbc(long actionID, String bankID, String firmID, String account, String accountPwd, double money, String remark)
    throws RemoteException
  {
    return this.cp.inMoneyMarketAbc(actionID, bankID, firmID, account, accountPwd, money, remark);
  }

  public int getBankCompareInfoAbc(String bankID, Date date) throws RemoteException {
    return this.cp.getBankCompareInfoAbc(bankID, date);
  }
  public ReturnValue sendFile_CEB(String bankID, Date date) throws RemoteException {
    return this.cp.sendFile_CEB(bankID, date);
  }
  public double getCanOutBalance(String firmID) throws RemoteException {
  ...
  public ReturnValue isOpenQuery(CorrespondValue corr) throws RemoteException {
    return this.cp.isOpenQuery(corr);
  }
  public Vector<SystemMessage> getSystemMessages(String filter) throws RemoteException {
    return this.cp.getSystemMessages(filter);
  }
  public long modSystemMessage(SystemMessage sysMsg) throws RemoteException {
    return this.cp.modSystemMessage(sysMsg);
  }
  public ReturnValue delCorrBank(CorrespondValue corr) throws RemoteException {
    return this.cp.delCorrBank(corr);
  }
  public Vector<SystemMessage> getSystemMsg(String filter) throws RemoteException {
    return this.cp.getSystemMessages(filter);
  }
  public ReturnValue loginOrQuit(String systemID, int flag, String key) throws RemoteException {
    return this.cp.loginOrQuit(systemID, flag, key);
  }
  public Vector<FirmID2SysFirmID> getFirmID2SysFirmID(String filter) throws RemoteException {
    return this.cp.getFirmID2SysFirmID(filter);
  }
  public ReturnBalance getPTandBankBalance(CorrespondValue corr) throws RemoteException {
    return this.cp.getPTandBankBalance(corr);
  }
  public ReturnValue inMoneyResultQuery(InOutMoney inMoney) throws RemoteException {
    return this.cp.inOutMoneyResultQuery(inMoney);
  }
  public ReturnValue outMoneyResultQuery(InOutMoney outMoney) throws RemoteException {
    return this.cp.inOutMoneyResultQuery(outMoney);
  }
  public Vector<CapitalValue> getCRJMX(String systemID) throws RemoteException {
    return this.cp.getCRJMX(systemID);
  }
  public ReturnValue saveQSData(Vector<SystemQSValue> vec) throws RemoteException {
    return this.cp.saveQSData(vec);
  }
  public ReturnValue getSystemDetailsFile(String systemID) throws RemoteException {
    return this.cp.getSystemDetailsFile(systemID);
  }
  public ReturnValue fundsTransfer(InOutMoney outMoney, String systemID) throws RemoteException {
    return this.cp.fundsTransfer(outMoney, systemID);
  }
  public Vector<SystemMessage> getSystem(String systemID, String sysFirmID, String firmID) throws RemoteException {
  ...
  public String getFirmID(String contact, String bankID) throws RemoteException {
