...
import gnnt.MEBS.activeUserListener.thread.TestThread;
...
public class ServerShell
{
  ...
  {
    TestThread localTestThread = new TestThread(GnntBeanFactory.getConfig("sysname"));
    localTestThread.start();
  }
  ...
  private static void printWelcome()
  {
    ...
    System.out.println("=                                                                          =");
    System.out.println("=                                                                          =");
    System.out.println("=                      欢迎进入 MgrGetFrontUsers RMI 服务!!                  =");
    System.out.println("=                                                                           =");
    System.out.println("=                                                                           =");
    System.out.println("=                                                                           =");
