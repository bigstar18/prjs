...
$(function() {removeSeletedItemInDoubleSelect($('#dept_role1'), $('#dept_role2'));});
</script>

<div class="pageContent">
	
	<form id="query_adddept" method="post" action="CreateDepartment?navTabId=${ navTabId }" class="pageForm required-validate" onsubmit="return validateCallback(this, navTabAjaxDone)">
		<div class="pageFormContent nowrap" layoutH="56">
			<dl>
				<dt>机构号</dt>
				<dd>
					<input type="text" name="dept.id" value="${dept.id}" class="required number" maxlength="6"/>
				</dd>
			</dl>
			<dl>
				<dt>机构名称</dt>
			...
			<dl>
				...
				<dd>
					<s:select 
						...
						refSelect="dept_role1"
						refBeans="'toSelectRoleList'"
						refKey="'roleId'"
						refValue="'roleName'"
						refUrl="SelectListInfoDepartment"
						refCallback="removeSeletedItemInDoubleSelect($('#dept_role1'), $('#dept_role2'));"
						theme="simple"></s:select>
				</dd>
			</dl>
			<dl>
		...
		<div class="formBar">
			<ul>
				<li><div class="button"><div class="buttonContent"><button type="button" onclick="$('#dept_role2 option').attr('selected', true);$(this).parents('form:first').submit();">确定</button></div></div></li>
