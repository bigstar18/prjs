...
<div class="pageContent">
	...
	<form id="query_modifyfunc" method="post" action="ModifyFunction?navTabId=${ navTabId }" class="pageForm required-validate" onsubmit="return validateCallback(this, navTabAjaxDone)">
		<div class="pageFormContent nowrap" layoutH="56">
			...
			<dl>
				<dt>所属应用</dt>
				<dd>
					<s:select id="modify_select_app" name="func.appid" value="func.appid" list="appidList" listKey="id" listValue="value" 
						cssClass="required textInput commontypeSelect"
						refSelect="modify_select_subapp"
						refCt="'subappidList'"
			...
			<dl>
				<dt>所属子应用</dt>
				<dd><s:select id="modify_select_subapp" name="func.subappid" value="func.subappid" list="subappidList" listKey="id" listValue="value" cssClass="textInput"></s:select></dd>
			</dl>
			<dl>
				<dt>功能地址</dt>
		...
		<input type="hidden" name="func.funcId" value="${func.funcId}">
	</form>
