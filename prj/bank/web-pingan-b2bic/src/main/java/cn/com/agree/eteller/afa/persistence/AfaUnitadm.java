...
public class AfaUnitadm
  implements Serializable
{
  private static final long serialVersionUID = 1L;
  private AfaUnitadmPK comp_id;
  ...
  static
  {
    ...
    hm.put("Unitname", "商户名称");
    hm.put("Unitsname", "商户简称");
    hm.put("Status", "商户分支单位状态");
    hm.put("Bankmode", "银行模式");
  ...
  public String toString2()
  {
    ...
    sb.append("Sysid=" + getComp_id().getSysid() + "|")
      ...
      .append("Unitsname=" + getUnitsname() + "|")
      .append("Bankmode=" + getBankmode() + "|")
      .append("Status=" + getStatus() + "|")
      .append("Workdate=" + getWorkdate() + "|")
      .append("Preworkdate=" + getPreworkdate() + "|")
      ...
      .append("Accmode=" + getAccmode() + "|")
      .append("Bankunitno=" + getBankunitno() + "|")
      .append("Accno1=" + getAccno1() + "|")
      .append("Accno2=" + getAccno2() + "|")
      .append("Accno3=" + getAccno3() + "|")
      .append("Accno4=" + getAccno4() + "|")
      .append("Accno5=" + getAccno5() + "|")
      .append("Accno6=" + getAccno6() + "|")
      .append("Name=" + getName() + "|")
      .append("Telphone=" + getTelphone() + "|")
      .append("Address=" + getAddress() + "|")
      .append("Agenteigen=" + getAgenteigen() + "|")
      .append("Loginstatus=" + getLoginstatus() + "|")
      .append("Dayendstatus=" + getDayendstatus() + "|")
      .append("Dayendtime=" + getDayendtime() + "|")
      .append("Trxchkstatus=" + getTrxchkstatus() + "|")
      .append("Trxchktime=" + getTrxchktime() + "|")
  ...
  public AfaUnitadm(AfaUnitadmPK comp_id, String unitname, String unitsname, String status, String bankmode, String busimode, String accmode, String bankunitno, String zoneno, String brno, String workdate, String preworkdate, String starttime, String stoptime, String feeflag, String bankcode, String accno1, String accno2, String accno3, String accno4, String accno5, String accno6, String name, String telphone, String address, String agenteigen, String loginstatus, String dayendstatus, String dayendtime, String trxchkstatus, String trxchktime, String note1, String note2)
  {
  ...
  public AfaUnitadm(AfaUnitadmPK comp_id, String status, String bankmode, String busimode, String accmode, String bankunitno)
  {
    this.comp_id = comp_id;
    this.status = status;
    this.bankmode = bankmode;
  ...
  public AfaUnitadmPK getComp_id()
  {
    return this.comp_id;
  }
  
  public void setComp_id(AfaUnitadmPK comp_id)
  {
    this.comp_id = comp_id;
  }
  ...
  public String toString()
  {
    ...
    return 
      ...
      new ToStringBuilder(this).append("comp_id", getComp_id()).append("unitname", getUnitname()).append("unitsname", getUnitsname()).append("status", getStatus()).append("bankmode", getBankmode()).append("busimode", getBusimode()).append("accmode", getAccmode()).append("bankunitno", getBankunitno()).append("zoneno", getZoneno()).append("brno", getBrno()).append("workdate", getWorkdate()).append("preworkdate", getPreworkdate()).append("starttime", getStarttime()).append("stoptime", getStoptime()).append("feeflag", getFeeflag()).append("bankcode", getBankcode()).append("accno1", getAccno1()).append("accno2", getAccno2()).append("accno3", getAccno3()).append("accno4", getAccno4()).append("accno5", getAccno5()).append("accno6", getAccno6()).append("name", getName()).append("telphone", getTelphone()).append("address", getAddress()).append("agenteigen", getAgenteigen()).toString();
  }
  ...
  public boolean equals(Object other)
  {
    ...
    if (!(other instanceof AfaUnitadm)) {
      return false;
    }
    AfaUnitadm castOther = (AfaUnitadm)other;
