...
import gnnt.trade.bank.CMBCapitalProcessor;
import gnnt.trade.bank.processorrmi.CMBCapitalProcessorRMI;
...
public class CMBCapitalProcessorRMIImpl
  extends UnicastRemoteObject
  implements CMBCapitalProcessorRMI
{
  private static final long serialVersionUID = 2L;
  CMBCapitalProcessor cp = new CMBCapitalProcessor();
  
  public CMBCapitalProcessorRMIImpl()
    ...
    throws RemoteException
  {
    ...
    ReturnValue result = this.cp.checkSigning(cv);
    this.cp.log("=========================================checkSigning  校验签约是否通过");
    return result;
  }
  ...
  public long tradeDate(String bankID, int type)
    throws RemoteException
  {
    this.cp.log("-----------------------------------------tradeDate(String bankID,int type) 判断是否可以发生转账交易");
    long result = this.cp.tradeDate(bankID, type);
    this.cp.log("=========================================tradeDate(String bankID,int type)  判断是否可以发生转账交易");
    return result;
  }
