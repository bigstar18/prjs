...
import gnnt.trade.bank.processorrmi.impl.BCMCapitalProcessorRMIImpl;
...
import gnnt.trade.bank.processorrmi.impl.CGBCapitalProcessorRMIImpl;
...
import gnnt.trade.bank.processorrmi.impl.PACapitalProcessorRMIImpl;
import gnnt.trade.bank.processorrmi.impl.UPCapitalProcessorRMIImpl;
...
public class CapitalProcessorRMIServer
{
  ...
  private static PACapitalProcessorRMIImpl PAcpRmi = null;
  private static UPCapitalProcessorRMIImpl UPcpRmi = null;
  private static BCMCapitalProcessorRMIImpl BCMcpRmi = null;
  private static CGBCapitalProcessorRMIImpl CGBcpRmi = null;
  ...
  public void startRMI(String IpAddress, int PortNumber, String ServiceNameS)
  {
    ...
    try
    {
      ...
      if (Tool.isContainRMIServer(ServiceNameS, props.getProperty("PARmiServiceName")))
      {
        PAcpRmi = new PACapitalProcessorRMIImpl();
        log("PAcpRmi://" + IpAddress + ":" + PortNumber + "/" + props.getProperty("PARmiServiceName"));
        Naming.bind("rmi://" + IpAddress + ":" + PortNumber + "/" + props.getProperty("PARmiServiceName"), PAcpRmi);
        
        log("PAcpRmi服务启动成功!");
      }
      if (Tool.isContainRMIServer(ServiceNameS, props.getProperty("UPRmiServiceName")))
      {
        UPcpRmi = new UPCapitalProcessorRMIImpl();
        log("UPcpRmi://" + IpAddress + ":" + PortNumber + "/" + props.getProperty("UPRmiServiceName"));
        Naming.bind("rmi://" + IpAddress + ":" + PortNumber + "/" + props.getProperty("UPRmiServiceName"), UPcpRmi);
        
        log("UPcpRmi服务启动成功!");
      }
      if (Tool.isContainRMIServer(ServiceNameS, props.getProperty("BCMRmiServiceName")))
      {
        BCMcpRmi = new BCMCapitalProcessorRMIImpl();
        log("BCMcpRmi://" + IpAddress + ":" + PortNumber + "/" + props.getProperty("BCMRmiServiceName"));
        Naming.bind("rmi://" + IpAddress + ":" + PortNumber + "/" + props.getProperty("BCMRmiServiceName"), BCMcpRmi);
        
        log("BCMcpRmi服务启动成功!");
      }
      if (Tool.isContainRMIServer(ServiceNameS, props.getProperty("CGBRmiServiceName")))
      {
        CGBcpRmi = new CGBCapitalProcessorRMIImpl();
        log("CGBcpRmi://" + IpAddress + ":" + PortNumber + "/" + props.getProperty("CGBRmiServiceName"));
        Naming.bind("rmi://" + IpAddress + ":" + PortNumber + "/" + props.getProperty("CGBRmiServiceName"), CGBcpRmi);
