...
import gnnt.trade.bank.ICBCECapitalProcessor;
import gnnt.trade.bank.processorrmi.ICBCECapitalProcessorRMI;
...
public class ICBCECapitalProcessorRMIImpl
  extends UnicastRemoteObject
  implements ICBCECapitalProcessorRMI
{
  private static final long serialVersionUID = 1L;
  ICBCECapitalProcessor cp = new ICBCECapitalProcessor();
  
  public ICBCECapitalProcessorRMIImpl()
    ...
    throws RemoteException
  {
    ...
    this.cp.log("----------交易商出金-----------");
    result = this.cp.outMoneyMarket(omm);
  ...
  public ReturnValue modCapitailInOutMoney(long actionID, String funID, boolean funFlag, String note)
    throws RemoteException
  {
    this.cp.log("-----------------------------------------modCapitailInOutMoney  修改出入金状态记录");
    ReturnValue result = this.cp.modCaptailInfoInOutMoney(actionID, funID, funFlag, note);
    this.cp.log("-----------------------------------------modCapitailInOutMoney  修改出入金状态记录");
    return result;
  }
}
