...
import gnnt.trade.bank.BCMCapitalProcessor;
import gnnt.trade.bank.processorrmi.BCMCapitalProcessorRMI;
...
public class BCMCapitalProcessorRMIImpl
  extends UnicastRemoteObject
  implements BCMCapitalProcessorRMI
{
  private static final long serialVersionUID = 1L;
  BCMCapitalProcessor cp = new BCMCapitalProcessor();
  
  public BCMCapitalProcessorRMIImpl()
