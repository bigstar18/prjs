...
import gnnt.trade.bank.UPCapitalProcessor;
import gnnt.trade.bank.processorrmi.UPCapitalProcessorRMI;
...
public class UPCapitalProcessorRMIImpl
  extends UnicastRemoteObject
  implements UPCapitalProcessorRMI
{
  private static final long serialVersionUID = 1L;
  UPCapitalProcessor cp = new UPCapitalProcessor();
  
  public UPCapitalProcessorRMIImpl()
  ...
  public ReturnValue inMoneyMarket(InMoneyMarket imm, String account, String bankCode, String bankName, String bankProvince, String bankCity, String accountType)
    throws RemoteException
  {
    this.cp.log("-----------------------------------------inMoneyMarket  银联入金");
    ReturnValue result = this.cp.inMoneyMarket(imm, account, bankCode, bankName, bankProvince, bankCity, accountType);
    this.cp.log("-----------------------------------------inMoneyMarket  银联入金");
    return result;
  }
  ...
  public ReturnValue outMoneyMarket(OutMoneyMarket omm, String account, String bankCode, String bankName, String bankProvince, String bankCity, String accountType)
    throws RemoteException
  {
    this.cp.log("-----------------------------------------outMoneyMarket  银联出金");
    ReturnValue result = this.cp.outMoneyMarket(omm, account, bankCode, bankName, bankProvince, bankCity, accountType);
    this.cp.log("-----------------------------------------outMoneyMarket  银联出金");
    return result;
  }
}
