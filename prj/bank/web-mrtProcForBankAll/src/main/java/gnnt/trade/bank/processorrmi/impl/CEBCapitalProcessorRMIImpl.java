...
import gnnt.trade.bank.CEBCapitalProcessor;
import gnnt.trade.bank.data.ceb.CEBExDataImpl;
import gnnt.trade.bank.processorrmi.CEBCapitalProcessorRMI;
...
public class CEBCapitalProcessorRMIImpl
  extends UnicastRemoteObject
  implements CEBCapitalProcessorRMI
{
  private static final long serialVersionUID = 2L;
  CEBCapitalProcessor cp = new CEBCapitalProcessor();
  
  public CEBCapitalProcessorRMIImpl()
  ...
  public ReturnValue chargeAgainstMaket_ceb(ChargeAgainstValue cav)
    throws RemoteException
  {
    return this.cp.chargeAgainstMaket_ceb(cav);
  }
  
  public Map<String, FirmRights> getRightsMap(String bankId, String firmId, Date qdate)
    throws RemoteException
  {
    return this.cp.getRightsMap(bankId, firmId, qdate);
  }
  
  public List<FirmRightsValue> getTradeDataMsg(String bankId, String firmId, Date qdate)
    throws RemoteException
  {
    return this.cp.getTradeDataMsg(bankId, firmId, qdate);
  }
  
  public String insertFcs10(Vector<FCS_10_Result> fcs10V)
    throws RemoteException
  {
    return this.cp.insertFcs10(fcs10V);
  }
  
  public String insertFcs11(Vector<FCS_11_Result> fcs11V)
    throws RemoteException
  {
    return this.cp.insertFcs11(fcs11V);
  }
  
  public String insertFcs13(Vector<FCS_13_Result> fcs13V)
    throws RemoteException
  {
    return this.cp.insertFcs13(fcs13V);
  }
  
  public String insertFcs99(Vector<FCS_99> fcs99V)
    throws RemoteException
  {
    return this.cp.insertFcs99(fcs99V);
  }
  ...
  public ReturnValue modAccount(CorrespondValue cv1, CorrespondValue cv2, String bankID)
    throws RemoteException
  {
    this.cp.log("-----------------------------------------modAccount  市场端发起的改约");
    ReturnValue result = this.cp.modAccount(cv1, cv2, bankID);
    this.cp.log("=========================================modAccount  市场端发起的改约");
    return result;
  }
