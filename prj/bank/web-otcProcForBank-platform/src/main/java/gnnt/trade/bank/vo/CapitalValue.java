  ...
  implements Serializable
{
  ...
  public String toString()
  {
    return 
      ...
      "CapitalValue [account=" + this.account + ", actionID=" + this.actionID + ", bankID=" + this.bankID + ", bankName=" + this.bankName + ", bankTime=" + this.bankTime + ", contact=" + this.contact + ", createtime=" + this.createtime + ", creditID=" + this.creditID + ", debitID=" + this.debitID + ", express=" + this.express + ", feeMoney=" + this.feeMoney + ", firmID=" + this.firmID + ", firmName=" + this.firmName + ", funID=" + this.funID + ", iD=" + this.iD + ", money=" + this.money + ", note=" + this.note + ", oprcode=" + this.oprcode + ", status=" + this.status + ", sysFirmID=" + this.sysFirmID + ", systemID=" + this.systemID + ", tradeSource=" + this.tradeSource + ", type=" + this.type + "]";
  }
}
