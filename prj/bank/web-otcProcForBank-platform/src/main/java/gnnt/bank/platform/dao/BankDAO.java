...
public abstract class BankDAO
{
  ...
  public abstract Vector<CapitalValue> getCapitalInfoListPT(String paramString, Connection paramConnection)
    throws SQLException, ClassNotFoundException;
  
  public abstract Vector<CapitalValue> getCapitalInfoListPT(int paramInt1, int paramInt2, String paramString1, String paramString2)
    throws SQLException, ClassNotFoundException;
  ...
  public abstract int addFirmMapping(FirmID2SysFirmID paramFirmID2SysFirmID, Connection paramConnection)
    throws SQLException;
  ...
  public abstract Vector<FirmBalance> getRZDateByBank(String paramString, Date paramDate)
    throws SQLException, ClassNotFoundException;
  
  public abstract long addCCBQS(Vector<FirmBalance> paramVector, Connection paramConnection)
    throws SQLException;
