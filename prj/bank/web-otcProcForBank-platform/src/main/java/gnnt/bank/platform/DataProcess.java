...
public class DataProcess {
	...
	public double updateFrozenFunds(String firmID, String bankID, double money, Connection conn) throws SQLException {
		double result = 0.0D;
		CallableStatement proc = null;
		try {
			proc = conn.prepareCall("{ ?=call FN_F_UpdateBankFrozenFunds(?,?,?) }");
