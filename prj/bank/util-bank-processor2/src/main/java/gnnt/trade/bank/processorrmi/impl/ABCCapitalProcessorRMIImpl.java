...
import gnnt.trade.bank.ABCCapitalProcessor;
import gnnt.trade.bank.processorrmi.ABCCapitalProcessorRMI;
...
public class ABCCapitalProcessorRMIImpl
  extends UnicastRemoteObject
  implements ABCCapitalProcessorRMI
{
  private static final long serialVersionUID = 2L;
  ABCCapitalProcessor cp = new ABCCapitalProcessor();
  
  public ABCCapitalProcessorRMIImpl()
  ...
  {
    this.cp.log("-----------------------------------------outMoneyMarket  出金 (市场方调用)");
    ReturnValue result = this.cp.outMoneyMarket(omm, actionid);
    this.cp.log("=========================================outMoneyMarket  出金 (市场方调用)");
    return result;
  }
  ...
  {
    this.cp.log("-----------------------------------------inMoneyMarket  入金(市场方调用)");
    ReturnValue result = this.cp.inMoneyMarket(imm, actionid);
    this.cp.log("=========================================inMoneyMarket  入金(市场方调用)");
    return result;
  }
  ...
  public int getBankCompareInfoAbc(String bankID, Date date)
    throws RemoteException
  {
    this.cp.log("-----------------------------------------getBankCompareInfoAbc  农行对账");
    int result = this.cp.getBankCompareInfoAbc(bankID, date);
    this.cp.log("=========================================getBankCompareInfoAbc  农行对账");
    return result;
  }
