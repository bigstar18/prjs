...
public class CGBBankDAOImpl extends CGBBankDAO {
	private BankDAO DAO;

	public CGBBankDAOImpl() throws Exception {
		try {
	...
	public double getfirmQY(String bankID, String firmID, Connection conn) throws SQLException, ClassNotFoundException {
		double money = 0.0D;
		PreparedStatement state = null;
		ResultSet rs = null;
		String sql = null;
