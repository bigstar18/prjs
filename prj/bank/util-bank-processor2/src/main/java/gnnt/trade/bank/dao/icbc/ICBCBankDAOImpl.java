...
public class ICBCBankDAOImpl extends ICBCBankDAO {
	public ICBCBankDAOImpl() throws Exception {
	}
	...
	public Vector<BankTransferValue> getBankTransferList(String filter) throws SQLException, ClassNotFoundException {
		System.out.println("===>>>获得待审核银行间资金划转流水列表   getBankTransferList " + new Date());
		Connection conn = null;
		PreparedStatement state = null;
		ResultSet rs = null;
		String sql = null;
