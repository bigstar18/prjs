...
import gnnt.trade.bank.CMBCCapitalProcessor;
import gnnt.trade.bank.data.boc.BOCExDataImpl;
import gnnt.trade.bank.processorrmi.CMBCCapitalProcessorRMI;
...
public class CMBCCapitalProcessorRMIImpl
  extends UnicastRemoteObject
  implements CMBCCapitalProcessorRMI
{
  private static final long serialVersionUID = 1L;
  private CMBCCapitalProcessor cp = new CMBCCapitalProcessor();
  
  public CMBCCapitalProcessorRMIImpl()
  ...
  public Vector<FirmBalance> sendCMBCQS(String bankID, Date tradeDate)
    throws RemoteException
  {
    this.cp.log("-----------------------------------------sendCMBCQS  获取清算数据");
    Vector<FirmBalance> result = this.cp.sendCMBCQS(bankID, tradeDate);
    this.cp.log("-----------------------------------------sendCMBCQS  获取清算数据");
    return result;
  }
