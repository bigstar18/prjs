...
import gnnt.trade.bank.processorrmi.ICBCCapitalProcessorRMI;
...
public class ICBCCapitalProcessorRMIImpl
  extends UnicastRemoteObject
  implements ICBCCapitalProcessorRMI
{
  private static final long serialVersionUID = 1L;
  ICBCCapitalProcessor cp = new ICBCCapitalProcessor();
  
  public ICBCCapitalProcessorRMIImpl()
  ...
  public List<TradingDetailsValue> getChangeBalance(Vector<FirmBalance> list)
    throws RemoteException
  {
    return this.cp.getChangeBalance(list);
  }
  
  public List<FirmRights> getRightsList(Vector<FirmBalance> list)
    throws RemoteException
  {
    return this.cp.getRightsList(list);
  }
  ...
  public ReturnValue bankTransfer(BankTransferValue bankTransferValue)
    throws RemoteException
  {
    return this.cp.bankTransfer(bankTransferValue);
  }
  ...
  public ReturnValue checkSigning(CorrespondValue fv)
    throws RemoteException
  {
    this.cp.log("-----------------------------------------checkSigning  校验签约是否通过");
    ReturnValue result = this.cp.checkSigning(fv);
    this.cp.log("=========================================checkSigning  校验签约是否通过");
    return result;
  }
  ...
  {
    this.cp.log("-----------------------------------------checkSigning  校验签约是否通过");
    String firmId = this.cp.getfirmid(contact);
    this.cp.log("=========================================checkSigning  校验签约是否通过");
    return firmId;
  }
    ...
    throws RemoteException
  {
    ...
    ReturnValue result = new ICBCExDataImpl().send(date);
    this.cp.log("========================================sendOldQS   发送指定日期的清算");
    return result;
  }
  ...
  public void send(Date tradeDate)
    throws RemoteException
  {
    new ICBCExDataImpl().send(tradeDate);
  }
  ...
  public ReturnValue auditBankTransfer(String actionId, String bankId, Boolean flag)
    throws RemoteException
  {
    this.cp.log("----------------------------------------auditBankTransfer   审核");
    ReturnValue result = this.cp.auditBankTransfer(actionId, bankId, flag);
    this.cp.log("========================================auditBankTransfer   审核");
    return result;
  }
