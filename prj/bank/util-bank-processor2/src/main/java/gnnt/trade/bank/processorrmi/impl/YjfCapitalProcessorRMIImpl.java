...
import gnnt.trade.bank.YjfCapitalProcessor;
import gnnt.trade.bank.data.yjf.YjfExDataImpl;
import gnnt.trade.bank.processorrmi.YjfCapitalProcessorRMI;
...
public class YjfCapitalProcessorRMIImpl
  extends UnicastRemoteObject
  implements YjfCapitalProcessorRMI
{
  private static final long serialVersionUID = 2L;
  YjfCapitalProcessor cp = new YjfCapitalProcessor();
  
  public YjfCapitalProcessorRMIImpl()
  ...
  public ReturnValue inMoneyResultQuery(String exSerial, String bankID)
    throws RemoteException
  {
    return this.cp.inMoneyResultQuery(exSerial, bankID);
  }
  
  public ReturnValue outMoneyResultQuery(String exSerial, String bankID)
    throws RemoteException
  {
    return this.cp.outMoneyResultQuery(exSerial, bankID);
  }
    ...
    throws RemoteException
  {
    ...
    ReturnValue result = new YjfExDataImpl().send(date);
    this.cp.log("========================================sendOldQS   发送指定日期的清算");
    return result;
  }
}
