...
import gnnt.trade.bank.JSBCapitalProcessor;
import gnnt.trade.bank.processorrmi.JSBCapitalProcessorRMI;
...
public class JSBCapitalProcessorRMIImpl
  extends UnicastRemoteObject
  implements JSBCapitalProcessorRMI
{
  private static final long serialVersionUID = 1L;
  JSBCapitalProcessor cp = new JSBCapitalProcessor();
  
  public JSBCapitalProcessorRMIImpl()
  ...
  public String getfirmid(String contact)
    throws RemoteException
  {
    this.cp.log("-----------------------------------------getfirmid  通过contact获取firmid");
  ...
  public ReturnValue synchroAccountMarket(CorrespondValue cv)
    throws RemoteException
  {
    this.cp.log("-----------------------------------------synchroAccountMarket  JSB市场端预签约");
    ReturnValue result = this.cp.synchroAccountMarket(cv);
    this.cp.log("-----------------------------------------synchroAccountMarket  JSB市场端预签约");
    return result;
  }
  ...
  public ReturnValue transferPositions(TransferInfo trans)
    throws RemoteException
  {
    this.cp.log("-----------------------------------------transferPositions  江苏银行头寸、收益划转");
    ReturnValue result = this.cp.transferPositions(trans);
    this.cp.log("-----------------------------------------transferPositions  江苏银行头寸、收益划转");
    return result;
  }
  ...
  public ReturnValue send(Date tradeDate)
    throws RemoteException
  {
    this.cp.log("-----------------------------------------send  适配器调用发清算");
    ReturnValue result = this.cp.send(tradeDate);
    this.cp.log("-----------------------------------------send  适配器调用发清算");
    return result;
  }
  ...
  public ReturnValue modTransferStatus(long actionID, String funID, boolean funFlag)
    throws RemoteException
  {
    this.cp.log("-----------------------------------------modTransferStatus  江苏银行头寸、收益划转确认通知");
    ReturnValue result = this.cp.modTransferStatus(actionID, funID, funFlag);
    this.cp.log("-----------------------------------------modTransferStatus  江苏银行头寸、收益划转确认通知");
    return result;
  }
  ...
  public ReturnValue getQSDate(Date date, String type)
    throws RemoteException
  {
    this.cp.log("-----------------------------------------getQSDate  查看江苏银行清算结果文件");
    ReturnValue result = this.cp.getQSDate(date, type);
    this.cp.log("-----------------------------------------getQSDate  查看江苏银行清算结果文件");
    return result;
  }
  ...
  public ReturnValue auditPositions(String actionId, String bankId, Boolean flag)
    throws RemoteException
  {
    this.cp.log("-----------------------------------------auditPositions  江苏银行头寸、收益划转审核");
    ReturnValue result = this.cp.auditPositions(actionId, bankId, flag);
    this.cp.log("-----------------------------------------auditPositions  江苏银行头寸、收益划转审核");
    return result;
  }
