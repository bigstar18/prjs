...
function start(){
	...
	//}else{
		if(${pageInfo.pageNumber}==0){
			...
			this.addDiv(from,from+pagelength);
		}
	//}
}
start();
...
$(document).ready(function() {
	...
	if(orderby.length>0){
		...
		if(array[3]=="asc"){
			...
			document.getElementById(array[2]).innerHTML = document.getElementById(array[2]).innerHTML+"<img src='${skinPath }/image/display/flag_up.png' width='7' height='13'>";
		}else{
			//$("#"+array[2]).append("↓");
			document.getElementById(array[2]).innerHTML = document.getElementById(array[2]).innerHTML+"<img src='${skinPath }/image/display/flag_down.png' width='7' height='13'>";
		}
