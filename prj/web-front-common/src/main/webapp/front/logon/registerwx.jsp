...
<link rel="stylesheet" href="../../front/logon/bootstrap.min.css"/>
...
jQuery(document).ready(function() {
	...
	jQuery("fieldset input").addClass("form-control").addClass("inputwidth");
	jQuery("fieldset select").addClass("inputwidth");
	//提交前事件
	...
	<div class="bodyStep2">
		...
		<fieldset>
			...
			<div>
				...
				<label width="35%">
					<input id="userID" name="entity.userID" class="validate[required,size[9],custom[onlyNumberSp],funcCall[checkUserId],ajax[checknoUserID]] datepicker" data-prompt-position="topLeft:0,8"/>
				</label>
			</div>
			<div>
				<label width="25%">密码：</label>
				<label width="35%">
					<input id="password" name="entity.password" type="password" class="validate[required,minSize[6],maxSize[32]]" onKeyUp="pwStrength(this.value);" onblur="pwStrength(this.value)" onpaste="return false" oncontextmenu="return false" oncopy="return false" oncut="return false"/>
				</label>
			</div>
			<div>
				<label class="fontSize">密码强度：</label>
				<label width="35%">
					<table width="180px" border="0" cellspacing="0" cellpadding="0" bordercolor="#eeeeee" height="15">  
			...
			<div>
				...
				<label  width="35%">
					<input id="password1" type="password" class="validate[required,equals[password]]" onpaste="return false" oncontextmenu="return false" oncopy="return false" oncut="return false" data-prompt-position="topLeft:0,8"/>
				</label>
			</div>
			<div>
			...
			<div>
				...
				<label width="50%">
					<input id="name" name="entity.name" class="validate[required,maxSize[16]]"/>
				</label>&nbsp;&nbsp;<span id="jysmc"></span>
			</div>
			<div>
				<label width="25%">交易商全称：</label>
				<label width="35%">
					<input id="fullName" name="entity.fullName" class="validate[required,maxSize[64]]"/>
			...
			<div id="content" style="display: block;">
			    ...
			    <div id="farenziduan" style="display: none">
					...
					<label width="35%">
						<input id="organizationCode" type="text" class="validate[required,custom[onlyLetterNumber],maxSize[9]]" name="entity.organizationCode" value="${entity.organizationCode}"/>
					</label>	
					</div>
						<div>
			...
			<div>
				...
				<label width="35%">
					<input id="certificateNO" name="entity.certificateNO" class="validate[required,custom[onlyLetterNumber],maxSize[32]]" data-prompt-position="topLeft:0,8"/>
				</label>请输入相应证件的编号
			</div> --%>
			<div>
				<label width="25%"><span id="sfzh">身份证号：</span></label>
				<label width="35%">
					<input id="certificateNO" name="entity.certificateNO" onblur="isCardNo(this.value)" class="validate[required,custom[onlyLetterNumber],maxSize[32]]" data-prompt-position="topLeft:0,8"/>
		...
		<fieldset>
			<div>
				...
				<label style="width: 143px;">
					<input id="picture1" name="upPicture" type="file" accept="image/*" onChange="judgePicture(1)"/>
			...
			<div>
				...
				<label style="width: 143px;">
					<input id="picture2" name="upPicture" type="file" accept="image/*" onChange="judgePicture(2)"/>
				</label>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span id="zjfmts"></span>
			</div>
			<div>
				<label widht="25%">银行卡正面：</label>
				<label style="width: 143px;">
					<input id="picture3" name="upPicture" type="file" accept="image/*" onChange="judgePicture(3)"/>
				</label>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;必须为工行或农行的储蓄卡
			</div>
			</div>
			...
			<div>
				...
				<label style="width: 143px;">
					<input id="picture4" name="upPicture" type="file" accept="image/*" onChange="judgePicture(4)"/>
				</label>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;必须为复印件加盖公章
			</div>
			<div>
				<label widht="25%">税务登记证副本：</label>
				<label style="width: 143px;">
					<input id="picture5" name="upPicture" type="file" accept="image/*" onChange="judgePicture(5)"/>
				</label>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;必须为复印件加盖公章
			</div>
			<div>
				<label widht="25%">组织机构代码证副本：</label>
				<label style="width: 143px;">
					<input id="picture6" name="upPicture" type="file" accept="image/*" onChange="judgePicture(6)"/>
				</label>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;必须为复印件加盖公章
			</div>
			<div>
				<label widht="25%">开户许可证：</label>
				<label style="width: 143px;">
					<input id="picture7" name="upPicture" type="file" accept="image/*" onChange="judgePicture(7)"/>
				</label>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;必须为复印件加盖公章
			</div>
			</div>
		</fieldset>
		...
		<fieldset>
			<div>
				...
				<label width="35%">
					<input id="contactMan" class="validate[required,maxSize[16]]" name="entity.contactMan"/>
				</label>
			</div>
			<div>
				<label width="25%">联系地址：</label>
				<label width="35%">
					<input id="address" name="entity.address" class="validate[required,maxSize[64]]" data-prompt-position="topLeft:0,8"/>
				</label>
			</div>
			<div>
				<label width="25%">手机号码：</label>
				<label width="35%">
					<input id="mobile" class="validate[required,maxSize[12],custom[mobile]]" name="entity.mobile"/>
				</label>&nbsp;&nbsp;<span id="sjhm"></span>
			</div>
			<div>
				<label width="25%">电子邮箱：</label>
				<label width="35%">
					<input id="email" class="validate[required,custom[email],maxSize[64]]" name="entity.email" data-prompt-position="bottomLeft:0,-3"/>
				</label>
			</div>
			<div>
			...
			<div>
				...
				<label style="width: 143px;">
				    <input id="imgcode" name="imgcode" type="text" class="validate[required] imgcode"/>
				</label>
