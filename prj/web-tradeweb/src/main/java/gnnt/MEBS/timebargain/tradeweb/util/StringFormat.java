...
public class StringFormat {
	...
	public static Date toDate(String paramString1, String paramString2) throws ParseException {
		Date localDate = null;
	...
	public static Number toNumber(String paramString1, String paramString2) throws ParseException {
	...
	public static String LTrim(String paramString) {
		...
		int i;
		for (i = 0; (i < paramString.length()) && (paramString.charAt(i) == ' '); i++) {
		}
