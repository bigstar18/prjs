...
<html>
	...
	<body onload="window_onload();">
		<form id="frm" method="post" enctype="multipart/form-data" action="${basePath}/timebargain/authorize/loginConsigner.action" target="HiddFrame">
			<div class="div_cx">
							...
							<table border="0" width="100%" align="center">
								...
								<div>
									<table border="0" cellspacing="0" cellpadding="4" width="100%" align="center">
										<tr>
											<td align="center">
												<rightButton:rightButton name="强制转让" onclick="" className="btn_sec" action="/timebargain/authorize/chkLogin.action" id="order"></rightButton:rightButton>
												&nbsp;&nbsp;
