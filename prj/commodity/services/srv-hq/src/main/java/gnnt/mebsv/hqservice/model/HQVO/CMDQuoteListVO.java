...
public class CMDQuoteListVO extends CMDVO
{
    ...
    throws IOException
  {
    ...
    for (int i = 0; i < arrayOfProductDataVO.length; i++)
    {
      ...
      arrayOfProductDataVO[i].marketID = paramDataInputStream.readUTF();
      ...
      arrayOfProductDataVO[i].consignRate = paramDataInputStream.readFloat();
      ...
      arrayOfProductDataVO[i].expStr = paramDataInputStream.readUTF();
    }
