  ...
  public int doEndTag()
  {
    try
    {
      ...
      if (i != 0)
      {
        ...
        localJspWriter.println("<a " + ((this.id == null) || (this.id.trim().length() <= 0) ? "" : new StringBuilder().append("id=\"").append(this.id.trim()).append("\" ").toString()) + ((this.name == null) || (this.name.trim().length() <= 0) ? "" : new StringBuilder().append("name=\"").append(this.name.trim()).append("\" ").toString()) + ((this.title == null) || (this.title.trim().length() <= 0) ? "" : new StringBuilder().append("title=\"").append(this.title.trim()).append("\" ").toString()) + ((this.className == null) || (this.className.trim().length() <= 0) ? "" : new StringBuilder().append("class=\"").append(this.className.trim()).append("\" ").toString()) + ((this.style == null) || (this.style.trim().length() <= 0) ? "" : new StringBuilder().append("style=\"").append(this.style.trim()).append("\" ").toString()) + ((this.target == null) || (this.target.trim().length() <= 0) ? "" : new StringBuilder().append("target=\"").append(this.target.trim()).append("\" ").toString()) + ((this.onclick == null) || (this.onclick.trim().length() <= 0) ? "" : new StringBuilder().append("onclick=\"").append(this.onclick.trim()).append("\" ").toString()) + ((this.action == null) || (this.action.trim().length() <= 0) ? "" : new StringBuilder().append("action=\"").append(this.action.trim()).append("\" ").toString()) + ((this.href == null) || (this.href.trim().length() <= 0) ? "href=\"#\"" : new StringBuilder().append("href=\"").append(this.href.trim()).append("\" ").toString()) + ">" + this.text + "</a>");
      }
