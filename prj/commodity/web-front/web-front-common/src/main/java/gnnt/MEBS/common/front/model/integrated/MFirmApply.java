...
public class MFirmApply extends StandardModel {
	...
	@ClassDiscription(name = "银行卡二进制形式", description = "")
	private byte[] picture;
	@ClassDiscription(name = "正面二进制形式", description = "")
	private byte[] picturecs;
	@ClassDiscription(name = "反面二进制形式", description = "")
	...
	public PrimaryInfo fetchPKey() {
		return new PrimaryInfo("applyID", this.applyID);
	}
