...
<form name="frm" id="frm" method="post"
	action="${basePath }/user/updateUser.action" targetType="hidden">
	<div class="div_tj">
				...
				<td>
					...
					<table border="0" cellspacing="0" cellpadding="0" width="100%"
						...
						<c:if
							...
							<tr height="35">
								<td align="right" class="td_size" width="20%">
									<span class="required">*</span>管理员类型 ：
								</td>
						...
						<tr height="35">
							<td align="right" class="td_size">
								<span class="required">*</span>是否禁用 ：
							</td>
							<td align="left" class="td_size">
								<select name="entity.isForbid" id="isForbid"
			...
			<tr height="35">
				...
				<td align="right" id="tdId">
					<rightButton:rightButton name="修改" onclick="" className="btn_sec"
						action="/user/updateUser.action" id="update"></rightButton:rightButton>
					&nbsp;&nbsp;
