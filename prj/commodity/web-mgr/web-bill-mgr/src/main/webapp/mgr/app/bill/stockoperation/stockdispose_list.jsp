			...
			<table class="table1_style" border="0" cellspacing="0"
				...
				<tr>
					<td>
						<div class="div_cx">
							<form name="frm"
								action="${basePath}/stockoperation/${operation}/list.action?sortColumns=order+by+id"
								method="post">
								...
								<tr>
									...
									<ec:table items="pageInfo.result" var="stockOperation"
											...
											<ec:row>
												...
												<ec:column property="stock.breed.breedName" width="8%" title="Stock.breed"
													style="text-align:left; " ellipsis="true">
												</ec:column>
												<ec:column property="stock.warehouseId" width="8%" title="Stock.warehouseId"
													style="text-align:left; " ellipsis="true">
												</ec:column>
												<ec:column property="stock.quantity" width="16%" title="Stock.quantity"
												...
												<ec:column property="stock.ownerFirm" width="8%" title="Stock.ownerFirm"
													style="text-align:left; "  ellipsis="true">
												</ec:column>
												...
												<ec:column property="operate" title="数据处理" width="8%" 
													...
													<rightHyperlink:rightHyperlink href="#" className="blank_a" action="/stockoperation/apart/updateStockDispose.action" id="updateStockDispose" text="<font color='#880000'>拆仓单处理</font>" onclick="return updateStockDispose('${stockOperation.stock.stockId}');"/>
													</a>
													</c:if>
												</ec:column>
											</ec:row>
