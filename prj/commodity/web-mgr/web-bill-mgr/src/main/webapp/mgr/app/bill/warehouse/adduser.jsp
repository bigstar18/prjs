...
<script>
	jQuery(document).ready(function() {
		...
		jQuery("#frm").validationEngine( {
			...
			ajaxFormValidationURL : "../../ajaxcheck/checkWuserForm.action",
...
<body style="overflow-y: hidden">
	<form id="frm" name="frm" method="post" targetType="hidden"
		action="${basePath }/stock/warehouseUser/add.action">
		<div class="div_tj">
				...
				<tr>
					<td>
						...
						<table border="0" cellspacing="0" cellpadding="0" width="100%"
							...
							<tr height="35">
								...
								<td align="left" width="45%">
									<input id="userId" style="width: 160px;" name="entity.userId"
										type="text"
										class="validate[required,custom[onlyLetterNumber],maxSize[<fmt:message key='userID' bundle='${PropsFieldLength}'/>],ajax[checkWuserByUserId]] input_text" />
								</td>
								<td align="left">
									<div class="onfocus">
										不能为空！
							...
							<input type="hidden" id="type" name="entity.type"/>
							<tr style="display:none;">
								<td align="right" class="td_size">
									仓库编号：
								</td>
								<td>
									<input type="text" id="warehouseID" name="entity.warehouseID" value="${warehouseId}" size="16" class="input_text" />
								</td>
							</tr>
							<tr height="35">
								<td align="right" class="td_size" width="20%">
				...
				<tr height="35">
					<td align="right">
						<rightButton:rightButton name="添加" onclick=" " className="btn_sec"
							action="/stock/warehouseUser/add.action" id="add"></rightButton:rightButton>
						&nbsp;&nbsp;
