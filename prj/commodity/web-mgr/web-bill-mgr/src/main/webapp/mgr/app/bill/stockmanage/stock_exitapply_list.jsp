										...
										<ec:row>
											<ec:column width="7%" property="_0" title="序号" style="text-align:center;"
												...
												<ec:column property="operate" width="14%" title="操作"
													...
													<rightHyperlink:rightHyperlink href="#" className="blank_a" action="/stock/exitlist/stockOutCancel.action" id="cancel${stock.stockId}" text="<font color='#880000'>撤销申请</font>" onclick="stockOutCancel(${stock.stockId})"/>
												</ec:column>
											</ec:row>
										</ec:table>
									</td>
...
<SCRIPT type="text/javascript">
	...
	function details(stockid){
		...
		var url="${basePath}"+a+"?isQueryDB=true&num=1&entity.stockId="+stockid;
	...
	function stockOutCancel(stockid){
		...
		if(result){
			var a=document.getElementById("cancel"+stockid).action;
