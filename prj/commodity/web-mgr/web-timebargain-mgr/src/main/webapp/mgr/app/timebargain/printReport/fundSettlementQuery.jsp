...
function query(exportTo)
{
     ...
     if(exportTo=="excel"){
		//获取配置权限的 URL
		var url = "${mgrPath}/app/timebargain/printReport/fundSettlementReportExcel.jsp?startFirmID="+zStart +"&endFirmID="+ zEnd +"&cleardate="+zDate+"&title=资金结算表&brokerId="+brokerId+"&cateGoryId="+cateGoryId;		
		document.location.href = url;
	 }else{
		//获取配置权限的 URL
		var url = "${mgrPath}/app/timebargain/printReport/fundSettlementReport.jsp?startFirmID="+zStart +"&endFirmID="+ zEnd +"&cleardate="+zDate+"&title=资金结算表&brokerId="+brokerId+"&cateGoryId="+cateGoryId;		
