...
<head>
<%
    String reportTiltle = "转让和交收盈亏统计表";
%>
<%
...
function query(exportTo)
{
    ...
    if(cateGoryId == ""){
	 ...
	 if(exportTo=="excel"){
			//获取配置权限的 URL
			var url = "${mgrPath}/app/timebargain/printReport/tAPLStatisticReportExcel.jsp?startFirmID="+zStart +"&endFirmID="+ zEnd +"&startClearDate="+zDate+"&endClearDate="+ zEndDate+"&startCommodityID=" + zStartCommodity + "&endCommodityID=" + zEndCommodity + "&title=转让和交收盈亏统计表&breedId="+breedId+"&brokerId="+brokerId+"&cateGoryId="+cateGoryId;
			document.location.href = url;
		 }else{
			//获取配置权限的 URL
			var url = "${mgrPath}/app/timebargain/printReport/tAPLStatisticReport.jsp?startFirmID="+zStart +"&endFirmID="+ zEnd +"&startClearDate="+zDate+"&endClearDate="+zEndDate+ "&startCommodityID=" + zStartCommodity + "&endCommodityID=" + zEndCommodity + "&title=转让和交收盈亏统计表&breedId="+breedId+"&brokerId="+brokerId+"&cateGoryId="+cateGoryId;
