	...
	<form id="frm" name="frm" method="post" enctype="multipart/form-data" action="" targetType="hidden" >
		    ...
		    <td>
			  <div class="warning">
			    <div class="content">
			               温馨提示 :修改特殊交易保证金
			      <br/>
			        <span class="required">交易过程中设置特殊交易保证金后，需要到订单交易--系统维护--异常处理：点击“在线设置特殊保证金”，再点击“在线更新交易数据”按钮更新交易数据后方可成功，否则将导致保证金为0，增大市场风险</span>
				</div>
			  </div>
			</td>
		  </tr>
			  ...
			  <table border="0" width="100%" align="center">
			    <tr>
				  <td>
				    ...
				    <div>
					  <table border="0" cellspacing="0" cellpadding="5" align="center" class="table2_style">
					    <tr>
	  ...
	  <div class="tab_pad">
	    <table border="0" cellspacing="0" cellpadding="0" width="100%" align="center">
		  <tr>
		    <td align="center">
			  <rightButton:rightButton name="修改" onclick="" className="btn_sec" action="/timebargain/firmSet/commoditySpecial/updateTradeMargin.action" id="update"></rightButton:rightButton>
			  &nbsp;&nbsp;
