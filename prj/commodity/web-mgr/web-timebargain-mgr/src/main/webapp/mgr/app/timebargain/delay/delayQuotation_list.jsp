									...
									<div class="div2_top">
										<table class="table3_style" border="0" cellspacing="0" cellpadding="0" style="margin-top: 5px">
											<tr>
												...
												<td>
													<input type="text" id="commodityID" name="${GNNT_}primary.commodityID[like]" title="可输入模式匹配符查询" style="width:111;ime-mode:disabled" maxlength="24"
							...
							<td>
								<ec:table items="pageInfo.result" var="quotation"
									...
									<ec:row>
										...
										<ec:column property="buySettleQty" title="买入交收申报量" cell="currency" width="10%" style="text-align:right;"/>
										<ec:column property="sellSettleQty" title="卖出交收申报量" cell="currency" width="10%" style="text-align:right;"/>
										<ec:column property="buyNeutralQty" title="买入中立仓申报量" cell="number" calc="total" calcTitle= "合计" width="10%" style="text-align:right;"/>
							
										<ec:column property="sellNeutralQty" title="卖出中立仓申报量" cell="number" calc="total" calcTitle= "合计" width="10%" style="text-align:right;"/>
										<ec:column property="delayCleanHoldQty" title="延期净订货量" cell="number" calc="total" calcTitle= "合计" width="10%" style="text-align:right;"/>
