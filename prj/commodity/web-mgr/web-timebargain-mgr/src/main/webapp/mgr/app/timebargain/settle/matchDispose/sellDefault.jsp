    ...
    <script type="text/javascript">
	  ...
	  function event(v){
		  ...
		  switch(v)
			{	
		  	case 1:
			  	url = "${basePath}/timebargain/settle/matchDispose/viewMatch.action?flag=31&entity.matchID=${entity.matchID}";
				break;
			case 2:
				url = "${basePath}/timebargain/settle/matchDispose/viewMatch.action?flag=32&entity.matchID=${entity.matchID}";
				break;
			case 3:
				url = "${basePath}/timebargain/settle/matchDispose/viewMatch.action?flag=33&entity.matchID=${entity.matchID}";
				break;
			case 4:
				url = "${basePath}/timebargain/settle/matchDispose/viewMatch.action?flag=34&entity.matchID=${entity.matchID}";
				break;
			case 20:
				  ...
				  <div>
				    <table border="0" cellspacing="0" cellpadding="8" width="100%" align="center" class="table2_style">
					  ...
					  <tr>
						...
						<td>
						  <fmt:formatNumber value="${entity.payPenalty_B }" pattern="#,##0.00"/>&nbsp;
						</td>
					  </tr>
					   <tr>
				...
				<td>
				  ...
				  <div>
				    <table border="0" cellspacing="0" cellpadding="8" width="100%" align="center" class="table2_style">
					  ...
					  <tr>
			            <td align="right">收卖方违约金：</td>
						<td>
						  <fmt:formatNumber value="${entity.takePenalty_S }" pattern="#,##0.00"/>&nbsp;
						</td>
					  </tr>
					   <tr>
	...
	<div>
	  <table border="0" cellspacing="0" cellpadding="4" width="100%" align="center">
	    ...
	    <c:if test="${entity.status <= 1 }">
	       <td>
			<button class="btn_sec1" onClick="event(1)">收卖方违约金</button>
		  </td>
		  <td>
			<button class="btn_sec1" onClick="event(2)">付买方违约金</button>
		  </td>
