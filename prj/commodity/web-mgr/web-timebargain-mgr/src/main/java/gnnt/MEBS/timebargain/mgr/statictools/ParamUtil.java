...
public class ParamUtil {
	public static void bindData(HttpServletRequest request, Object bean) {
		...
		List names = getParamNames(bean, em);
	...
	public static void bindSubObject(Object bean, String objName, String value) throws SecurityException, Exception {
		...
		} else if ((cl == Integer.class) || (cl == Float.class) || (cl == Long.class) || (cl == Double.class) || (cl == Byte.class)
				|| (cl == Boolean.class) || (cl == Character.class) || (cl == Short.class)) {
	...
	private static List<String> getParamNames(Object bean, Enumeration<String> em) {
		...
		while (em.hasMoreElements()) {
			...
			methodname = (new StringBuilder("set")).append(getFunName(name)).toString();
