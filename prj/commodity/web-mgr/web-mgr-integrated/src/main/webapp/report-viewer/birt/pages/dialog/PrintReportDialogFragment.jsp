		...
		<TD>
			<DIV ID="printFormatSetting">
				...
				<SELECT	ID="printFitSetting" CLASS="birtviewer_printreport_dialog_select" DISABLED="true">
					<option value="0" ><%=BirtResources.getMessage( "birt.viewer.dialog.export.pdf.fittoauto" )%></option>
					<option value="1"><%=BirtResources.getMessage( "birt.viewer.dialog.export.pdf.fittoactual" )%></option>
					<option value="2" selected><%=BirtResources.getMessage( "birt.viewer.dialog.export.pdf.fittowhole" )%></option>
				</SELECT>
				</DIV>
			</DIV>
		</TD>
