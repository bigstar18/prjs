						...
						<ec:table items="pageInfo.result" var="apply"
							...
							<ec:row>
								...
								<ec:column property="applyType" title="审核类型" width="22%"
									...
									<rightHyperlink:rightHyperlink href="#" className="blank_a" action="/audit/baseAudit/withdrawedDetails.action" id="detail" text="<font color='#880000'>${auditOperateMap[applyTypeKey].name}</font>" onclick="applyDetail('${apply.id}');"/>
								</ec:column>
								...
								<ec:column property="modTime" title="撤销时间"
									width="20%" style="text-align:center;" >
									<fmt:formatDate value="${apply.modTime}" pattern="yyyy-MM-dd HH:mm:ss"/>
								</ec:column>
							</ec:row>
						</ec:table>
					</td>
