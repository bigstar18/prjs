					...
					<td>
						<ec:table items="pageInfo.result" var="audit"
							...
							<ec:row>
								...
								<ec:column property="apply.discribe" title="描述" ellipsis="true"
									width="25%" style="text-align:center;"
									value="${audit.apply.discribe}"/>
								<ec:column property="apply.applyUser" title="申请人" width="14%"
									style="text-align:center;" value="${audit.apply.applyUser}" />
								<ec:column property="auditUser" title="驳回人" width="14%"
								...
								<ec:column property="modTime" title="驳回时间"
									width="14%" style="text-align:center;" >
