...
<html>
	...
	<iframe id="hiddenframe" name="hiddenframe" width=0 height=0 style="display:none" src="" application="yes"></iframe>
		<form id="frm" method="post"
			action="${basePath}/mfirmAttribute/mainTenance/updateFirmCategory.action" target="hiddenframe">
			<div class="div_cx"  style="overflow:auto;height:320px;" >
			...
			<div>
				<table border="0" cellspacing="0" cellpadding="4" width="100%"
					...
					<tr>
						...
						<td  width="30%">
							<input type="text" id="sortNo"  class="validate[required,custom[onlyNumberSp],maxSize[2],ajax[checkFirmCategoryBySortNo]] input_text" name="entity.sortNo" value="${entity.sortNo}"/>
						</td>
						<td colspan="2">
							<div class="onfocus">
								不能为空！
					...
					<tr>
						...
						<td colspan="3">
							<textarea rows="4" cols="50"  id="note" name="entity.note" class="validate[maxSize[<fmt:message key='note_q' bundle='${PropsFieldLength}' />]">${entity.note}</textarea>
						</td>
					</tr>
				</table>
			</div>
					...
					<tr>
						<td align="right">
							<rightButton:rightButton name="修改" onclick="" className="btn_sec"
								action="/mfirmAttribute/mainTenance/updateFirmCategory.action" id="update"></rightButton:rightButton>
