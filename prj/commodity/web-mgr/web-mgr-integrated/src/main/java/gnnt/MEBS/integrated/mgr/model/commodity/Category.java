  ...
  extends StandardModel
{
  ...
  public String findTreeJsons()
  {
    ...
    if (getParentCategory() == null) {
      str1 = "{id:\"" + getCategoryId() + "\"" + ",icon:" + "\"../../mgr/skinstyle/default/image/app/integrated_mgr/image/category_1.png\"" + ",name:" + "\"" + getCategoryName() + "\"" + ",type:" + "\"" + getType() + "\"" + ",treeType:" + "\"cate\"" + ",pId:" + "\"0\"" + ",children:[";
    } else if (getType().equals("leaf")) {
      str1 = "{id:\"" + getCategoryId() + "\"" + ",icon:" + "\"../../mgr/skinstyle/default/image/app/integrated_mgr/image/category_3.png\"" + ",name:" + "\"" + getCategoryName() + "\"" + ",type:" + "\"" + getType() + "\"" + ",treeType:" + "\"cate\"" + ",pId:" + "\"" + getParentCategory().getCategoryId() + "\"" + ",children:[";
    } else {
      str1 = "{id:\"" + getCategoryId() + "\"" + ",icon:" + "\"../../mgr/skinstyle/default/image/app/integrated_mgr/image/category_2.png\"" + ",name:" + "\"" + getCategoryName() + "\"" + ",type:" + "\"" + getType() + "\"" + ",treeType:" + "\"cate\"" + ",pId:" + "\"" + getParentCategory().getCategoryId() + "\"" + ",children:[";
    }
  ...
  public String findBreedTreeJsons()
  {
    String str1 = "";
    if (getParentCategory() == null) {
      str1 = "{id:\"" + getCategoryId() + "\"" + ",icon:" + "\"../../mgr/skinstyle/default/image/app/integrated_mgr/image/category_1.png\"" + ",name:" + "\"" + getCategoryName() + "\"" + ",open:" + "true" + ",type:" + "\"" + getType() + "\"" + ",pId:" + "\"0\"" + ",children:[";
    } else if (getType().equals("leaf")) {
      str1 = "{id:\"" + getCategoryId() + "\"" + ",icon:" + "\"../../mgr/skinstyle/default/image/app/integrated_mgr/image/category_3.png\"" + ",name:" + "\"" + getCategoryName() + "\"" + ",open:" + "false" + ",type:" + "\"" + getType() + "\"" + ",pId:" + "\"" + getParentCategory().getCategoryId() + "\"" + ",children:[";
    } else {
      str1 = "{id:\"" + getCategoryId() + "\"" + ",icon:" + "\"../../mgr/skinstyle/default/image/app/integrated_mgr/image/category_2.png\"" + ",name:" + "\"" + getCategoryName() + "\"" + ",open:" + "true" + ",type:" + "\"" + getType() + "\"" + ",pId:" + "\"" + getParentCategory().getCategoryId() + "\"" + ",children:[";
    }
    if ((getChildCategorySet() != null) && (getChildCategorySet().size() > 0))
    {
      int i = 0;
        ...
        if (localCategory.getStatus().intValue() == 1)
        {
          ...
          if ((localCategory.getBreedSet() != null) && (localCategory.getBreedSet().size() > 0))
          {
            ...
            while (localIterator2.hasNext())
            {
              ...
              {
                j++;
                String str3 = "{id:\"" + localBreed.getBreedId() + "\"" + ",icon:" + "\"../../mgr/skinstyle/default/image/app/integrated_mgr/image/breed.png\"" + ",name:" + "\"" + "(" + localBreed.getBreedId() + ")" + localBreed.getBreedName() + "\"" + ",pId:" + "\"" + localCategory.getCategoryId() + "\"" + ",open:" + "false" + ",type:" + "\"" + "pro" + "\"" + ",children:[]" + "},";
                str1 = str1 + str3;
              }
            }
            if (j > 0)
