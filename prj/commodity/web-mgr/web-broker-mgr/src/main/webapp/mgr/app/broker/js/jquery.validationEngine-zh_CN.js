        ...
        newLang: function(){
            $.validationEngineLanguage.allRules = {
                ...
                "mouseCheckFirmByFirmId": {
                    "url": "../../ajaxcheck/broker/mouseCheckFirmByFirmId.action",
                    // error
                    "alertText": "* 此交易商不存在",
                    // if you provide an "alertTextOk", it will show as a green prompt when the field validates
                ...
                "mouseCheckBrokerBrokerId": {
                    "url": "../../ajaxcheck/broker/mouseCheckBrokerBrokerId.action",
                    // error
                    "alertText": "* 此加盟商已存在",
                    // if you provide an "alertTextOk", it will show as a green prompt when the field validates
                    "alertTextOk": "此加盟商可以使用",
                    // speaks by itself
                    "alertTextLoad": "* 正在确认加盟商是否有存在，请稍等。"
                }
            };
