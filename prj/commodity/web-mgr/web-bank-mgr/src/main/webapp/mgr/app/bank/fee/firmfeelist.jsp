...
<html>
	<head>
		...
		<script>
			...
			function query(){<%//执行查询功能%>
				...
				$("#frm").attr("action","${basePath}/bank/fee/setUpFirmFeeForward.action");
				$("#frm").submit();
			}
			function addtr(){<%//添加行%>
				var feebody = $("#feebody");
	...
	<body style="overflow-y: hidden">
		<form id="frm" method="post" action="">
			<input type="hidden" name="firmID" value="${firm.firmID}"/><%//隐藏域银行编号 %>
				...
				<table border="0" width="90%" align="center">
					<tr>
						<td>
							<div class="warning">
								<div class="content">
									温馨提示 :${firm.firm.name}&nbsp;手续费设置。<font color="#FF0000;"><strong>注：上限为 -1 时，表示无上限</strong></font>
								</div>
							</div>
						</td>
					</tr>
				...
				<table border="0" cellspacing="0" cellpadding="4" width="100%"
					...
					<tr>
						<td align="right">
							...
							&nbsp;&nbsp;<rightButton:rightButton name="设置" onclick="" className="btn_sec" action="/bank/fee/setUpFirmFee.action" id="update"></rightButton:rightButton>
