								...
								<td>
									<ec:table items="pageInfo.result" var="capital"
										...
										<ec:row>
											...
											<ec:column property="type" title="类型" width="10%" style="text-align:center;" value="${capitalInfoType[capital.type]}"/>
											...
											<ec:column property="status" title="状态" width="10%" style="text-align:center;" value="${capitalInfoStatus[capital.status]}"/>
											<ec:column property="property" title="备注" width="10%" style="text-align:center;" sortable="false"><c:if 
												...
												test="${fn:indexOf(capital.note,'market_out')>=0}">市场出金</c:if>
												<c:if 
