...
<html>
	<head>
		...
		<script type="text/javascript">
			...
			function auditUnilateral(btn){<%//执行出金审核%>
	...
	<body>
		<table class="table1_style" border="0" cellspacing="0" cellpadding="0">
			<tr>
				<td>
					<div class="div_cx">
						<form name="frm" id="frm" action="${basePath}/bank/capital/capitalUnilateralList.action?sortColumns=order+by+id+desc" method="post">
					...
					<div class="div_gn">
						<rightButton:rightButton name="审核通过" onclick="auditUnilateral(this);" className="anniu_btn" action="/bank/capital/capitalUnilateralPass.action" id="auditpass"></rightButton:rightButton>&nbsp;&nbsp;
						<rightButton:rightButton name="审核拒绝" onclick="auditUnilateral(this);" className="anniu_btn" action="/bank/capital/capitalUnilateralRefuse.action" id="auditrefuse"></rightButton:rightButton>
					</div>
					<div class="div_list">
							...
							<tr>
								<td>
									<ec:table items="pageInfo.result" var="capital"
										action="${basePath}/bank/capital/capitalUnilateralList.action"											
