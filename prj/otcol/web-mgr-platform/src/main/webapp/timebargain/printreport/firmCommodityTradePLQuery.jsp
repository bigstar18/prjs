...
function query(exportTo)
{
	...
	if(exportTo=="excel")
		window.open("reportContainerExcel.jsp?sign=firmCommodityTradePL&startFirmID=" + zStart + "&endFirmID=" + zEnd + "&startCommodity=" + startCommodity + "&endCommodity=" + endCommodity + "&beginDate=" + zDate + "&endDate=" + zEndDate + "&brokerID=" + brokerID + "&type=" + type + "&title=交易商分商品盈亏表&breedId="+breedId);
		else 
	window.showModalDialog("reportContainer.jsp?sign=firmCommodityTradePL&startFirmID=" + zStart + "&endFirmID=" + zEnd + "&startCommodity=" + startCommodity + "&endCommodity=" + endCommodity + "&beginDate=" + zDate + "&endDate=" + zEndDate + "&brokerID=" + brokerID + "&type=" + type + "&title=交易商分商品盈亏表","", "dialogWidth=1000px; dialogHeight=600px; status=no;scroll=yes;help=no;resizable=yes");
