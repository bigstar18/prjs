...
<%
	...
	String sql = "select * from ( " +
		  "select (select brokerid from m_b_firmandbroker where firmid = x1.firmid) brokerid, " +
	        "x1.firmid firmid, " +
...
"where 1=1 " + broker;
	...
	<tr>
		...
		<td  class="reportRight">加盟商:<%=brokerID %></td>
		<%} %>
		<c:if test="${type == 'h'}">
	...
	<tr>
	  ...
	  <td class="td_reportMd1">&nbsp;<fmt:formatNumber value="<%=turnToNum(innerMap.get("sumBuyAgreeQuantity")) %>" pattern="#,###"/></td>
	  <td class="td_reportMd1">&nbsp;<fmt:formatNumber value="<%=turnToNum(innerMap.get("sumBuyAgreeAvg")) %>" pattern="#,##0.00"/></td>
	  <td class="td_reportMd1">&nbsp;<fmt:formatNumber value="<%=turnToNum(innerMap.get("sumBuyTransferQuantity")) %>" pattern="#,###"/></td>
	  <td class="td_reportMd1">&nbsp;<fmt:formatNumber value="<%=turnToNum(innerMap.get("sumBuyTransferAvg")) %>" pattern="#,##0.00"/></td>
	  <td class="td_reportMd1">&nbsp;<fmt:formatNumber value="<%=turnToNum(innerMap.get("sumBuyTradeFee")) %>" pattern="#,##0.00"/></td>
	  <td class="td_reportMd1">&nbsp;<fmt:formatNumber value="<%=turnToNum(innerMap.get("sumSellAgreeQuantity")) %>" pattern="#,###"/></td>
	  <td class="td_reportMd1">&nbsp;<fmt:formatNumber value="<%=turnToNum(innerMap.get("sumSellAgreeAvg")) %>" pattern="#,##0.00"/></td>
	  <td class="td_reportMd1">&nbsp;<fmt:formatNumber value="<%=turnToNum(innerMap.get("sumSellTransferQuantity")) %>" pattern="#,###"/></td>
	  <td class="td_reportMd1">&nbsp;<fmt:formatNumber value="<%=turnToNum(innerMap.get("sumSellTransferAvg")) %>" pattern="#,##0.00"/></td>
	  <td class="td_reportMd1">&nbsp;<fmt:formatNumber value="<%=turnToNum(innerMap.get("sumSellTradeFee")) %>" pattern="#,##0.00"/></td>
	  <td class="td_reportMd1">&nbsp;<fmt:formatNumber value="<%=turnToNum(innerMap.get("sumQuantity")) %>" pattern="#,###"/></td>
