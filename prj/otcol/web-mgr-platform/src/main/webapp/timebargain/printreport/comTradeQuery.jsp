...
<fieldset class="pickList" >
	...
	<tr>
        ...
        <td>
        <INPUT TYPE="text" NAME="breed" style="ime-mode:disabled"  id="breedId" value="" size=8 maxlength=8 onchange="dealcontentStrartBreed(this)" onkeypress="notSpace()">
...
function dealcontentStrartBreed(sel)
{
...
function query(exportTo)
{
	...
	if(exportTo=="excel")
		window.open("reportContainerExcel.jsp?sign=comTrade" + "&startClearDate=" + zDate + "&endClearDate=" + zEndDate + "&startCommodityID=" + zStartCommodity + "&endCommodityID=" + zEndCommodity + "&title=分商品成交量统计表&breedId="+breedId);
		else 
	window.showModalDialog("reportContainer.jsp?sign=comTrade" + "&startClearDate=" + zDate + "&endClearDate=" + zEndDate + "&startCommodityID=" + zStartCommodity + "&endCommodityID=" + zEndCommodity + "&title=分商品成交量统计表&breedId="+breedId,"", "dialogWidth=900px; dialogHeight=650px; status=no;scroll=yes;help=no;resizable=yes");
