...
function query(exportTo)
{
    ...
    if(exportTo=="excel")
		window.open("reportContainerExcel.jsp?sign=orders&startFirmID=" + zStart + "&endFirmID=" + zEnd + "&cleardate=" + zDate + "&title=委托情况表&brokerId="+brokerId);
		else
	window.showModalDialog("reportContainer.jsp?sign=orders&startFirmID=" + zStart + "&endFirmID=" + zEnd + "&cleardate=" + zDate + "&title=委托情况表&brokerId="+brokerId,"", "dialogWidth=900px; dialogHeight=700px; status=no;scroll=yes;help=no;resizable=yes");
}
