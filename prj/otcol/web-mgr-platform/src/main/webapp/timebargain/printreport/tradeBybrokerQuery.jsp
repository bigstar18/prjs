...
function query(exportTo)
{
	...
	if(exportTo=="excel")
		window.open("reportContainerExcel.jsp?sign=tradeBybroker&startFirmID=" + zStart + "&endFirmID=" + zEnd + "&startClearDate=" + zDate + "&endClearDate=" + zEndDate + "&title=分加盟商成交统计表");
	else
		window.showModalDialog("reportContainer2.jsp?sign=tradeBybroker&startFirmID=" + zStart + "&endFirmID=" + zEnd + "&startClearDate=" + zDate + "&endClearDate=" + zEndDate + "&title=分加盟商成交统计表","", "dialogWidth=1000px; dialogHeight=700px; status=no;scroll=yes;help=no;resizable=yes");
