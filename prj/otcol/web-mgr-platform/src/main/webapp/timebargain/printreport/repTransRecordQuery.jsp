...
function query(exportTo)
{
	...
	if(exportTo=="excel")
		window.open("reportContainerExcel.jsp?sign=repTransRecord&startClearDate=" + zDate + "&endClearDate=" + zEndDate + "&title=代为转让记录表");
		else
	window.showModalDialog("reportContainer.jsp?sign=repTransRecord&startClearDate=" + zDate + "&endClearDate=" + zEndDate + "&title=代为转让记录表","", "dialogWidth=900px; dialogHeight=650px; status=no;scroll=yes;help=no;resizable=yes");
