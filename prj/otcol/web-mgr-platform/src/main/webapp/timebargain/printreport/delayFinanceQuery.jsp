...
function query(exportTo)
{
	...
	if(exportTo=="excel")
		window.open("reportContainerExcel.jsp?sign=delayFinance&startFirmID=" + zStart + "&endFirmID=" + zEnd + "&cleardate=" + zDate + "&title=资金日报表&brokerId="+brokerId+"&cateGoryId="+cateGoryId);
		else 
		window.showModalDialog("reportContainer.jsp?sign=delayFinance&startFirmID=" + zStart + "&endFirmID=" + zEnd + "&cleardate=" + zDate + "&title=资金日报表&brokerId="+brokerId+"&cateGoryId="+cateGoryId,"", "dialogWidth=900px; dialogHeight=700px; status=no;scroll=yes;help=no;resizable=yes");
