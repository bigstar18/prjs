...
function query(exportTo)
{
	...
	if(exportTo=="excel")
		window.open("reportContainerExcel.jsp?sign=brokerallReport&startFirmID=" + zStart + "&endFirmID=" + zEnd + "&startClearDate=" + zDate + "&endClearDate=" + zEndDate + "&title=分加盟商综合统计表");
		else 
	window.showModalDialog("reportContainer2.jsp?sign=brokerallReport&startFirmID=" + zStart + "&endFirmID=" + zEnd + "&startClearDate=" + zDate + "&endClearDate=" + zEndDate + "&title=分加盟商综合统计表","", "dialogWidth=1000px; dialogHeight=700px; status=no;scroll=yes;help=no;resizable=yes");
