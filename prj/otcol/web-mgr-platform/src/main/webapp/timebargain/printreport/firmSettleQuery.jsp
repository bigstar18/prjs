...
function query(exportTo)
{
	...
	if(exportTo=="excel")
		window.open("reportContainerExcel.jsp?sign=firmSettle&startFirmID=" + zStart + "&endFirmID=" + zEnd +"&startClearDate=" + zDate + "&endClearDate=" + zEndDate+ "&title=交易商交收情况表&brokerId="+brokerId);
		else 
	window.showModalDialog("reportContainer.jsp?sign=firmSettle&startFirmID=" + zStart + "&endFirmID=" + zEnd + "&startClearDate=" + zDate + "&endClearDate=" + zEndDate + "&title=交易商交收情况表&brokerId="+brokerId,"", "dialogWidth=900px; dialogHeight=700px; status=no;scroll=yes;help=no;resizable=yes");
