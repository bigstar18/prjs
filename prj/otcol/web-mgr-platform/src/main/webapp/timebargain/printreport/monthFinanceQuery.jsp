...
function query(exportTo)
{
    ...
    if(exportTo=="excel")
		window.open("reportContainerExcel.jsp?sign=monthFinance&startFirmID=" + zStart + "&endFirmID=" + zEnd + "&startClearDate=" + zDate + "&endClearDate=" + zEndDate + "&title=资金月报表&brokerId="+brokerId+"&cateGoryId="+cateGoryId);
		else
	window.showModalDialog("reportContainer.jsp?sign=monthFinance&startFirmID=" + zStart + "&endFirmID=" + zEnd + "&startClearDate=" + zDate + "&endClearDate=" + zEndDate + "&title=资金月报表&brokerId="+brokerId+"&cateGoryId="+cateGoryId,"", "dialogWidth=1000px; dialogHeight=700px; status=no;scroll=yes;help=no;resizable=yes");
	//var pageUrl = "reportContainer.jsp?sign=monthFinance&startFirmID=" + zStart + "&endFirmID=" + zEnd + "&startClearDate=" + zDate + "&endClearDate=" + zEndDate + "&title=资金月报表";
	//window.open(pageUrl,"hidden","scrollbars=yes,toolbar=no,location=no,directories=no,status=no,menubar=no,resizable=yes,directories=no,width=800,height=600"); 
}
