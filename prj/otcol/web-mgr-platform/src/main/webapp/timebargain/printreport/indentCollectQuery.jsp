...
function query(exportTo)
{
	...
	if(exportTo=="excel")
		window.open("reportContainerExcel.jsp?sign=indentCollect&startFirmID=" + zStart + "&endFirmID=" + zEnd +"&cleardate=" + zDate + "&title=订货汇总表&brokerId="+brokerId);
		else 
	window.showModalDialog("reportContainer.jsp?sign=indentCollect&startFirmID=" + zStart + "&endFirmID=" + zEnd + "&cleardate=" + zDate + "&title=订货汇总表&brokerId="+brokerId + "&timestamp=" + new Date(),"", "dialogWidth=900px; dialogHeight=600px; status=no;scroll=yes;help=no;resizable=yes");
