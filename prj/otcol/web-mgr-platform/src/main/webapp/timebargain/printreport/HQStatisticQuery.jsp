...
function query(exportTo)
{
	...
	if(exportTo=="excel")
		window.open("reportContainerExcel.jsp?sign=HQStatistic&startClearDate=" + zDate + "&endClearDate=" + zEndDate + "&title=行情统计表");
		else 
	window.showModalDialog("reportContainer.jsp?sign=HQStatistic&startClearDate=" + zDate + "&endClearDate=" + zEndDate + "&title=行情统计表","", "dialogWidth=900px; dialogHeight=650px; status=no;scroll=yes;help=no;resizable=yes");
