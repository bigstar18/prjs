...
"where 1=1 " + broker;
	...
	<tr>
	  ...
	  <td class="td_reportMd1">&nbsp;<fmt:formatNumber value="<%=turnToNum(innerMap.get("sumBuyTransferClosePL")) %>" pattern="#,##0.00"/></td>
	  ...
	  <td class="td_reportMd1">&nbsp;<fmt:formatNumber value="<%=turnToNum(innerMap.get("sumSellTransferClosePL")) %>" pattern="#,##0.00"/></td>
