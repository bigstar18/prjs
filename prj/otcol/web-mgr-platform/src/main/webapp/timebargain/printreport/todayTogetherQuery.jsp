      ...
      <tr>
        ...
        <td>
         <div align="left">
            ...
            <SELECT  name="select7" onchange="dealcontent2(this)">
            <OPTION value="">请选择</OPTION>
...
function query(exportTo)
{
	...
	if (queryType == "") {
     ...
     if(exportTo=="excel")
		window.open("reportContainerExcel.jsp?sign=todayTogether&startFirmID=" + zStart + "&endFirmID=" + zEnd + "&cleardate=" + zDate + "&title=综合日报表&brokerId="+brokerId+"&queryType="+queryType);
		else
	window.showModalDialog("reportContainer2.jsp?sign=todayTogether&startFirmID=" + zStart + "&endFirmID=" + zEnd + "&cleardate=" + zDate + "&title=综合日报表&brokerId="+brokerId+"&queryType="+queryType,"", "dialogWidth=900px; dialogHeight=650px; status=no;scroll=yes;help=no;resizable=yes");
