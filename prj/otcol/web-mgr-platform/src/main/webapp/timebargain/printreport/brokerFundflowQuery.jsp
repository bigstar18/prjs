...
function query(exportTo)
{
	...
	if(exportTo=="excel")
		window.open("reportContainerExcel.jsp?sign=brokerFundflow&startBrokerID=" + zStart + "&endBrokerID=" + zEnd +"&beginDate=" + zDate + "&endDate=" + zEndDate+ "&title=加盟商资金报表");
		else 
	window.showModalDialog("reportContainer.jsp?sign=brokerFundflow&startBrokerID=" + zStart + "&endBrokerID=" + zEnd + "&beginDate=" + zDate + "&endDate=" + zEndDate + "&title=加盟商资金报表","", "dialogWidth=1000px; dialogHeight=700px; status=no;scroll=yes;help=no;resizable=yes");
