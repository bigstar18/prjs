...
function query(exportTo)
{
	...
	if(exportTo=="excel")
		window.open("reportContainerExcel.jsp?sign=contractCollect&startCommodity=" + startCommodity + "&endCommodity=" + endCommodity + "&beginDate=" + zDate + "&endDate=" + zEndDate + "&type=" + type + "&title=主力合约表&breedId="+breedId);
		else 
	window.showModalDialog("reportContainer.jsp?sign=contractCollect&startCommodity=" + startCommodity + "&endCommodity=" + endCommodity + "&beginDate=" + zDate + "&endDate=" + zEndDate + "&type=" + type + "&title=主力合约表&breedId="+breedId,"", "dialogWidth=900px; dialogHeight=700px; status=no;scroll=yes;help=no;resizable=yes");
