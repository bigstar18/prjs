...
function query(exportTo)
{
	...
	if(expif(exportTo=="excel")
		window.open("reportContainerExcel.jsp?sign=tradeDay&startFirmID=" + zStart + "&endFirmID=" + zEnd + "&cleardate=" + zDate + "&title=成交日报表&brokerId="+brokerId);
		else
	window.showModalDialog("reportContainer.jsp?sign=tradeDay&startFirmID=" + zStart + "&endFirmID=" + zEnd + "&cleardate=" + zDate + "&title=成交日报表&brokerId="+brokerId,"", "dialogWidth=900px; dialogHeight=700px; status=no;scroll=yes;help=no;resizable=yes");
