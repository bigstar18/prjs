...
function query(exportTo)
{
	...
	if(exportTo=="excel")
		window.open("reportContainerExcel.jsp?sign=transferProfitAndLoss&startFirmID=" + zStart + "&endFirmID=" + zEnd + "&cleardate=" + zDate + "&title=转让盈亏明细表&brokerId="+brokerId);
		else
	window.showModalDialog("reportContainer.jsp?sign=transferProfitAndLoss&startFirmID=" + zStart + "&endFirmID=" + zEnd + "&cleardate=" + zDate + "&title=转让盈亏明细表&brokerId="+brokerId,"", "dialogWidth=900px; dialogHeight=600px; status=no;scroll=yes;help=no;resizable=yes");
