...
function query(exportTo)
{
    ...
    if(exportTo=="excel")
		window.open("reportContainerExcel.jsp?sign=superAddBail&startFirmID=" + zStart + "&endFirmID=" + zEnd + "&cleardate=" + zDate + "&title=浮动亏损统计表&brokerId="+brokerId+"&cateGoryId="+cateGoryId);
		else
	window.showModalDialog("reportContainer.jsp?sign=superAddBail&startFirmID=" + zStart + "&endFirmID=" + zEnd + "&cleardate=" + zDate + "&title=浮动亏损统计表&brokerId="+brokerId+"&cateGoryId="+cateGoryId,"", "dialogWidth=900px; dialogHeight=700px; status=no;scroll=yes;help=no;resizable=yes");
