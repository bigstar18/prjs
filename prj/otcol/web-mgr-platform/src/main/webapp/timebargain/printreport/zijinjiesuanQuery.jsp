...
function query(exportTo)
{
    ...
    if(exportTo=="excel")
		window.open("reportContainerExcel.jsp?sign=zijinjiesuan&startFirmID=" + zStart + "&endFirmID=" + zEnd + "&cleardate=" + zDate + "&title=资金结算表&brokerId="+brokerId+"&cateGoryId="+cateGoryId);
		else
	window.showModalDialog("reportContainer.jsp?sign=zijinjiesuan&startFirmID=" + zStart + "&endFirmID=" + zEnd + "&cleardate=" + zDate + "&title=资金结算表&brokerId="+brokerId+"&cateGoryId="+cateGoryId,"", "dialogWidth=900px; dialogHeight=650px; status=no;scroll=yes;help=no;resizable=yes");
