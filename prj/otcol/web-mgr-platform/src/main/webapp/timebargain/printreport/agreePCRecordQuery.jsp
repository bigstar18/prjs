...
function query(exportTo)
{
	...
	if(exportTo=="excel")
		window.open("reportContainerExcel.jsp?sign=agreePCRecord&startClearDate=" + zDate + "&endClearDate=" + zEndDate + "&title=协议交收记录表");
		else 
	window.showModalDialog("reportContainer.jsp?sign=agreePCRecord&startClearDate=" + zDate + "&endClearDate=" + zEndDate + "&title=协议交收记录表","", "dialogWidth=900px; dialogHeight=650px; status=no;scroll=yes;help=no;resizable=yes");
