...
<table width="100%">
  <tr><td>
	...
	<ec:table items="listFund" var="listFund" 
			action="${pageContext.request.contextPath}/timebargain/statquery/statQuery.do?funcflg=listBrokerFund"	
			xlsFileName="listFund.xls" 
			csvFileName="listFund.csv"
			showPrint="true" 	
			rowsDisplayed="20"
			listWidth="1720"
			minHeight="500"
	...
	>
		...
		<ec:row>
			<ec:column property="brokerid" title="加盟商代码" width="80" style="text-align:center;"/>	
			...
			<ec:column property="quanyi" title="当前权益" cell="currency" calc="total" width="120" style="text-align:right;">
			<c:out value="${balance+ClearAssure+ClearMargin+ClearFL+PL+close_PL-TradeFee}"/>
			</ec:column>
...
<!--
<%
  if(request.getAttribute("listFund") != null)
  {
%>	if (parent.TopFrame) {
