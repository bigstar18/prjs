...
<table width="600">
  <tr><td>
	...
	>
		<ec:row>	
            <ec:column property="BrokerID" title="加盟商代码" width="90" style="text-align:center;" />
			...
			<ec:column property="lastholeqty" title="上日订货数量" cell="number" format="quantity" calc="total" calcTitle= "合计" width="120" style="text-align:right;"/>
			<ec:column property="holdce" title="订货差额" cell="number" format="quantity"  width="120" style="text-align:right;"/>
