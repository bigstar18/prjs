...
<body>
	<fieldset>
		...
		<table class="common" align="left" valign="center">
			<tr class="common">
			<td align="left">&nbsp;&nbsp;商品代码：<input type="text" name="commodityID" value="<%=CommodityID%>" onkeypress="notSpace()" style="ime-mode:disabled"  maxlength="16"></td>
			<td align="left">&nbsp;&nbsp;交易商代码：<input type="text" name="firmID" value="<%=firmID%>" onkeypress="notSpace()" style="ime-mode:disabled"  maxlength="16"></td>
	...
	<tr class="common"><td>
		  ...
		  >
			...
			<ec:row>
				...
				<ec:column property="null" title="审核" width="5%" style="text-align:center;">
					<c:choose>
				...
				<ec:column property="null" title="撤销" width="5%" style="text-align:center;">
					<c:choose>
						<c:when test="${!not empty settle.RegStockID &&  fn:contains(settle.MatchID,'ATS')}">
							<font color="red">需补录仓单</font>
						</c:when>
