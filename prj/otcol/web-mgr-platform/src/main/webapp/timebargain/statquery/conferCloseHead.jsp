...
function query()
{
  if(oper.value == "add")
  {
  	parent.ListFrame.location.href = "<c:url value="/timebargain/statquery/statQuery.do?funcflg=conferClose"/>";
  }
  else if(oper.value == "q")
  {
  	parent.ListFrame.location.href = "<c:url value="/timebargain/statquery/statQuery.do?funcflg=queryConferClose"/>";
  }
}
</script>
</head>
