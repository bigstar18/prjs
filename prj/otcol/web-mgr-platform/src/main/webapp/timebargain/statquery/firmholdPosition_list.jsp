...
<table width="100%">
  <tr><td>
	<ec:table items="holdPositionList" var="holdPosition" 
			action="${pageContext.request.contextPath}/timebargain/statquery/statQuery.do?funcflg=listfirmHoldPosition"	
	...
	>
		<ec:row>	
			...
			<ec:column property="HoldQtyGageQty" title="订货数量" cell="number" format="quantity" calc="total" calcTitle= "当前页合计" width="120" style="text-align:right;"/>			
			<ec:column property="GageQty" title="抵顶数量" cell="number" format="quantity" calc="total" calcTitle= "当前页合计" width="120" style="text-align:right;"/>
			<ec:column property="EvenPrice" title="订货均价"  width="100" style="text-align:right;">
			...
			<ec:column property="FloatingLoss" title="浮动盈亏" cell="currency" calc="total" width="120" style="text-align:right;"/>
		...
		<ec:extendrow>
			...
			<td style="text-align: center;">&nbsp;</td>
			<td style="text-align: center;">&nbsp;</td>
			<td style="text-align: center;"><fmt:formatNumber value="${sumHoldQtyGageQty}" pattern="#,##0"/></td>
			<td style="text-align: center;"><fmt:formatNumber value="${sumGageQty}" pattern="#,##0"/></td>
			<td style="text-align: center;">&nbsp;</td>
			<td style="text-align: center;"><fmt:formatNumber value="${sumHoldMargin}" pattern="#,##0.00"/></td>
			<td style="text-align: center;"><fmt:formatNumber value="${sumFloatingLoss}" pattern="#,##0.00"/></td>
			<td style="text-align: center;">&nbsp;</td>
			<td style="text-align: center;">&nbsp;</td>
		</ec:extendrow>
	</ec:table>
