...
function deduct_onchange(){
	...
	<body leftmargin="13" topmargin="0" onLoad="return window_onload()"
		...
		<table border="0" height="70%" width="100%" cellpadding="0" cellspacing="0" class="common" align="center">
			<tr>
				<td>
					<html:form action="/timebargain/deduct/deduct.do?funcflg=deductPositionListQuery"
						...
						<fieldset class="pickList" >
							...
							<table border="0" align="center" cellpadding="0" cellspacing="0"
								...
								<tr>
									...
									<td>
										<html:text property="deductDate" style="ime-mode:disabled"  ondblclick="if(!this.readOnly){setRq(this);}" title="双击选择日期" styleClass="text" maxlength="16" size="12" onkeypress="onlyDate()"></html:text>
									</td>
									<td align="left">
