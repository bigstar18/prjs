...
<SCRIPT language="javascript">
  ...
  <tr><td>
  		...
  		<ec:row>
  			...
  			<ec:column property="firmID_S" title="卖交易商代码" width="90" style="text-align:center;"/> 
  			...
  			<ec:column property="status" title="当前状态"  width="70" editTemplate="ecs_t_status" mappingItem="PRESENTSTATUS" style="text-align:center;"/>
