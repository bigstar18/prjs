...
<SCRIPT language="javascript">
  ...
  <tr><td>
  		<ec:table items="applyAlreadyList" var="app" 
			action="${pageContext.request.contextPath}/timebargain/apply/apply.do?funcflg=applyAlreadyList"	
  		...
  		>
  		<ec:row>
  			<ec:column property="billID" title="仓单号" width="130" style="text-align:center;"/>	
  			<ec:column property="firmID_S" title="卖交易商代码" width="100" style="text-align:center;"/> 
  			<ec:column property="commodityID" title="商品代码" width="100" style="text-align:center;"/> 
  			
  			
  			<ec:column property="quantity" title="仓单数量" width="100" format="quantity" calcTitle= "合计" calc="total" style="text-align:right;"/> 
