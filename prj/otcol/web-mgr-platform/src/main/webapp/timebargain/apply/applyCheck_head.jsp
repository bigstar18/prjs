...
function query()
{
  if(oper.value == "wait")
  {
  	parent.ListFrame.location.href = "<c:url value="/timebargain/apply/applyWaitCheck.jsp"/>";
  }
  else if(oper.value == "already")
  {
  	parent.ListFrame.location.href = "<c:url value="/timebargain/apply/applyAlreadyCheck.jsp"/>";
  }
