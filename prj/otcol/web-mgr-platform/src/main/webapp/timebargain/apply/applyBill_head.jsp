...
function query()
{
  if(oper.value == "wait")
  {
  	parent.ListFrame.location.href = "<c:url value="/timebargain/apply/applyWait.jsp"/>";
  }
  else if(oper.value == "already")
  {
  	parent.ListFrame.location.href = "<c:url value="/timebargain/apply/applyAlready.jsp"/>";
  }
  else if(oper.value == "aaa")
  {
  	parent.ListFrame.location.href = "<c:url value="/timebargain/apply/applyNew.jsp"/>";
  }
