...
<SCRIPT language="javascript">
  ...
  <tr><td>
  		...
  		>
  		<ec:row>
  			<ec:column property="APPLYID" title="申请单号" width="60" style="text-align:center;"/>	
  			<ec:column property="COMMODITYID" title="商品代码" width="70" style="text-align:center;"/> 
  			<ec:column property="FIRMID" title="交易商代码" width="70" style="text-align:center;"/> 
  			<ec:column property="CUSTOMERID" title="交易二级代码" width="80" style="text-align:center;"/>	
  			<ec:column property="QUANTITY" title="申请数量" width="60" style="text-align:center;"/> 
  			...
  			<ec:column property="CREATOR" title="创建人" width="60" style="text-align:center;"/> 
