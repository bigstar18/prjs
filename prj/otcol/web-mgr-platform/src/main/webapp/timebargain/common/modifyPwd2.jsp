...
//  }
  ...
  parent.HiddFrame.location.href = "<c:url value="/timebargain/baseinfo/market.do?funcflg=modifyPwd2&oldpwd="/>" + v_oldpwd + "&newpwd=" + v_newpwd + "&prikey=" + consignerID + "&type=" + type+"&type1="+type1;
  //new Ajax.Updater('chgpwdMessage', '<c:url value="/timebargain/baseinfo/market.do?funcflg=modifyPwd2&oldpwd="/>' + v_oldpwd + "&newpwd=" + v_newpwd + "&prikey=" + consignerID + "&type=" + type+"&type1="+type1, {asynchronous:true});
}
</script>	
</head>
	...
	<table class="common" align="center">
		...
		<tr>
			<td colspan="2" align="center">
			  ...
			  <html:reset  property="cancel" styleClass="button" onclick="javascript:window.close();">重置</html:reset>
			</td>		
	     </tr>	
		<tr>
			<td colspan="2" align="center">
