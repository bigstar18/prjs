    ...
    <tr>
      <td align="center">
        <table border="0" class="common">
          ...
          <tr>
            <td align="center">              
              <input type="button" name="query" value="查询"  class="button" style="behavior: url(<c:url value="/scripts/ButtonStyleFlat.htc"/>)" onclick="javascript:customerForm.submit();customerForm.query.disabled=true;">&nbsp;&nbsp;&nbsp;&nbsp;
              <input type="button" name="reset" value="重置"  class="button" style="behavior: url(<c:url value="/scripts/ButtonStyleFlat.htc"/>)" onclick="javascript:reset_onclick();">
            </td>
          </tr>
        </table>
      </td>
