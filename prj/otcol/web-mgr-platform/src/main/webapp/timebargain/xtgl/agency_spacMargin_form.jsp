...
<%
		...
		request.setAttribute("commoditySelect", lookupMgr
				.getSelectLabelValueByTableDistinctCommodityID("T_A_FirmMargin", "commodityID",
...
function commodity_onchange(){
  	if (document.forms(0).customerID.value == "") {
		alert("交易商代码不能为空！");
		document.forms(0).commodityID.value = "";
   ...
   createXML();
   var url = "<c:url value="/timebargain/xtgl/agency.do?funcflg=editSpacMargin&timeStamp="/>" + new Date().getTime();
   var queryStr = "commodityID=" + document.forms(0).commodityID.value + "&customerID=" + document.forms(0).customerID.value
  ...
  if (event.keyCode<45 || event.keyCode>57 || event.keyCode == 47)
  {
	...
	<body leftmargin="0" topmargin="0" onLoad="return window_onload()"
		...
		<table border="0" height="80%" width="55%" align="center">
			<tr>
				<td>
					<html:form action="/timebargain/xtgl/agency.do?funcflg=saveSpacMargin"
						...
						<fieldset class="pickList" >
							...
							<table border="0" align="center" cellpadding="5" cellspacing="5"
								...
								<tr>
									...
									<td>
										<html:text property="customerID" maxlength="10"  styleClass="text"/>
										<span class="req">*</span>
									</td>
									<td></td>
								</tr>
								<tr>
									...
									<td>
										<html:select property="commodityID"  style="width:145"  onchange="javascript:commodity_onchange()">
