...
{
   if(trim(agencyForm.recoverTime.value) == "")
   {
       alert("恢复时间不能为空！");
       agencyForm.recoverTime.focus();
 	   return false;
   }
   
	var str = trim(agencyForm.recoverTime.value);
   ...
   //window.returnValue = agencyForm.recoverTime.value;
   agencyForm.submit();	
   agencyForm.save.disabled = true;
...
function isTime(){
	...
	<body leftmargin="0" topmargin="0" onLoad="return window_onload()"
		...
		<table border="0" height="80%" width="80%" align="center">
			<tr>
				<td>
					<html:form action="/timebargain/xtgl/agency.do?funcflg=operate2"
