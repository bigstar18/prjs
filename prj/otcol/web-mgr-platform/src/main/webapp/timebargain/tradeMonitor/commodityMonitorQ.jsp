	...
	<!--
	   //设置数据源地址
		function winload() 
		{
			...
			setRequestUrl("<c:url value='/timebargain/tradeMonitor/tradeMonitor.do?funcflg=listCommodityMonitorQ'/>");
		}
  ...
  <form name="frm" METHOD=POST ACTION="">
     <table width="100%"  height="5%" align="center" cellpadding="0" cellspacing="0"   style="border-collapse:collapse;" id=tbHead onclick=dtquery()>
	   <tr>
	    ...
	    <td width="9%" class="hq_bt" align="center" abbr="Quantity" style="cursor:hand">成交量</td>
	  </tr>
	  </table>
