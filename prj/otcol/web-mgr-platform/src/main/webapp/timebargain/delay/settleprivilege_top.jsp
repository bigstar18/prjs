						...
						<fieldset class="pickList" >
							...
							<table border="0" align="center" cellpadding="0" cellspacing="0"
								...
								<tr>
									...
									<td>
										<input type="text" id="typeid" name="_typeid[=]" style="width:111;ime-mode:disabled" maxlength="16" title=""
									...
									<td>
										<input type="text" id="commodityID" name="_kindid[=]"  style="width:111;ime-mode:disabled" maxlength="18"
											styleClass="text" onkeypress="onlyNumberAndChakrInput()"/>
									</td>
									<td align="left">
										...
										<input type="reset" class="button" style="width:60"  value="重置"/>
									</td>																			
								</tr>
							</table>
						</fieldset>
