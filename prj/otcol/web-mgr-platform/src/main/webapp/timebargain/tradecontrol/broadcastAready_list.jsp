...
<table width="100%">
  <tr><td>
	...
	>
		...
		<ec:extend>
			<a href="#" onclick="javascript:batch_do('删除广播消息','<c:url value="/timebargain/tradecontrol/broadcast.do?funcflg=deleteAready"/>');"><img src="<c:url value="/timebargain/images/girddel.gif"/>"></a>
		</ec:extend>	
	</ec:table>
	</td></tr>
</table>	
