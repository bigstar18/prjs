...
function query()
{
  if(oper.value == "wait")
  {
  	parent.ListFrame.location.href = "<c:url value="/timebargain/applyGage/applyGageWait.jsp"/>";
  }
  else if(oper.value == "already")
  {
  	parent.ListFrame.location.href = "<c:url value="/timebargain/applyGage/applyGageAlready.jsp"/>";
  }
  else if(oper.value == "aaa")
  {
  	parent.ListFrame.location.href = "<c:url value="/timebargain/applyGage/applyGageNew.jsp"/>";
  }
