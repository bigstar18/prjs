...
<SCRIPT language="javascript">
  ...
  <tr><td>
  		...
  		<ec:row>
  			...
  			<ec:column property="STATUS" title="当前状态" width="100" style="text-align:center;">
				<c:choose>
  			...
  			<ec:column property="CREATETIME" title="创建时间" width="70" cell="date" format="date" style="text-align:center;"/> 
  			<ec:column property="CREATOR" title="创建人" width="70" style="text-align:center;"/> 
  			<ec:column property="MODIFYTIME" title="修改时间" width="70" cell="date" format="date" style="text-align:center;"/> 
