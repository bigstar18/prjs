...
{
   window.close();
   //top.mainFrame.location.href = "<c:url value="/timebargain/baseinfo/customer.do?funcflg=customerPrivilege&customerID="/>" + customerForm.typeID.value;
}
	...
	<body leftmargin="0" topmargin="0" onLoad="return window_onload()"
		...
		<table border="0" height="80%" width="50%" align="center">
			<tr>
				<td>
					<html:form action="/timebargain/baseinfo/customer.do?funcflg=saveCustomerPrivilege"
