  ...
  traderForm.submit();
	...
	<body leftmargin="10" topmargin="0" onLoad="return window_onload()"
		...
		<table border="0" height="100%" width="740" cellpadding="0" cellspacing="0" class="common" align="left">
			<tr>
				<td>
					<html:form action="/timebargain/baseinfo/trader.do?isQry=1"
						...
						<fieldset class="pickList" >
							...
							<table border="0"  cellpadding="1" cellspacing="0"
								...
								<tr>
									...
									<td>
										<input type="text" name="traderID" style="width:111" maxlength="16" title="<fmt:message key="title.dblclick.query"/>"
											styleClass="text" />
									</td>
									<td align="right">
										交易员名称：
									...
									<td>
										<input type="text" name="name" title="<fmt:message key="statQuery.like.inputmode"/>" style="width:111" maxlength="32" styleClass="text"/>
									</td>	
