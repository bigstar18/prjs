...
function window_onload()
{
    ...
    if (tradeRuleForm.crud.value == "create") {
    	if(tradeRuleForm.firmID.value!=""&&tradeRuleForm.firmID.value!=null){
  ...
  function changeManner102(id){
	...
	<body leftmargin="0" topmargin="0" onLoad="return window_onload()"
		...
		<table border="0" height="80%" width="70%" align="center">
			<tr>
				<td>
					<html:form action="/timebargain/baseinfo/tradeRule.do?funcflg=saveFirmMaxHoldQty&move=firm"
						...
						<fieldset class="pickList" >
							...
							<table width="80%" border="0" align="center" cellpadding="5" cellspacing="5"
								...
								<tr>
									...
									<td>
										<html:text size="10" property="firmID" maxlength="16" style="ime-mode:disabled" styleClass="text" />         
										<span class="req">*</span>
									</td>
								</tr>
								...
								<tr>
									<td colspan="3" align="center">
										...
										<html:reset  property="reset" onclick="javascript:tradeRuleForm.maxHoldQty.focus();" styleClass="button">重置</html:reset>
									</td>
								</tr>
							</table>
						</fieldset>
