...
<SCRIPT language="javascript">
  ...
  <body>
   <table width="100%">
  <tr><td>
  		<ec:table items="applyCheAlreadyList" var="che" 
			action="${pageContext.request.contextPath}/timebargain/baseinfo/virtualFund.do?funcflg=applyCheAlreadyList"	
...
<!--
<%
  if(request.getAttribute("applyCheAlreadyList") != null)
  {
%>
