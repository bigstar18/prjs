...
<table width="600">
  <tr><td>
	<ec:table items="customerList" var="customer" 
			action="${pageContext.request.contextPath}/timebargain/baseinfo/customer.do?funcflg=searchGroupFirm"	
	...
	>
		<ec:row>							
			...
			<ec:column property="status" title="状态" width="100" editTemplate="ecs_t_status" mappingItem="CUSTOMER_STATUS"/>							
			<ec:column property="groupName" title="组名称" width="130"/>
		</ec:row>
