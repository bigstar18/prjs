...
{
    document.location.href = "<c:url value="/timebargain/baseinfo/tradeRule.do?crud=create&funcflg=editFirmMaxHoldQty"/>";
}
// -->
</script>
</head>
...
<div id="content">
  ...
  <tr><td>
	<ec:table items="firmMaxHoldQtyList" var="tradeRule" 
			action="${pageContext.request.contextPath}/timebargain/baseinfo/tradeRule.do?funcflg=searchFirmMaxHoldQty"	
    ...
    <ec:row>
            ...
            <ec:column property="_1" title="修改" width="20%" style="text-align:center;">
              <a href="<c:out value="${ctx}"/>/timebargain/baseinfo/tradeRule.do?crud=update&funcflg=editFirmMaxHoldQty&firmID=<c:out value="${tradeRule.firmID}"/>&commodityID=<c:out value="${tradeRule.commodityID}"/>"><img title="进入修改信息" src="<c:url value="/timebargain/images/fly.gif"/>"/></a> 
            </ec:column>
	  ...
	  <ec:extend>
			...
			<a href="#" onclick="javascript:batch_do('删除特殊订货量','<c:url value="/timebargain/baseinfo/tradeRule.do?funcflg=deleteFirmMaxHoldQty"/>');"><img src="<c:url value="/timebargain/images/girddel.gif"/>"></a>
		</ec:extend>	
	</ec:table>
	</td></tr>
</table>	
