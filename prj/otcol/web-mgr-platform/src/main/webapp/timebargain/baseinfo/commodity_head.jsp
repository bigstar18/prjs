...
function query()
{
  if(oper.value == "cur")
  {
  	parent.ListFrame.location.href = "<c:url value="/timebargain/baseinfo/commodity.do?breedID="/>" + breedID.value + "&oper=cur";
  }
  else if(oper.value == "his")
  {
  	parent.ListFrame.location.href = "<c:url value="/timebargain/baseinfo/commodity.do?breedID="/>" + breedID.value + "&oper=his";
  } 
}
</script>
</head>
