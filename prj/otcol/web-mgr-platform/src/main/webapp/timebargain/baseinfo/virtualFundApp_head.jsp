...
function query()
{
  if(oper.value == "wait")
  {
  	parent.ListFrame.location.href = "<c:url value="/timebargain/baseinfo/virtualFundAppWait.jsp"/>";
  }
  else if(oper.value == "already")
  {
  	parent.ListFrame.location.href = "<c:url value="/timebargain/baseinfo/virtualFundAppAlready.jsp"/>";
  }
  else if(oper.value == "aaa")
  {
  	parent.ListFrame.location.href = "<c:url value="/timebargain/baseinfo/virtualFundAppNew_form.jsp"/>";
  }
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  <tr>
    ...
    <td width="180" background="<c:url value="/timebargain/images/bgimage.gif"/>" class="common" ><a href="#" id="wait" class="common" onclick="wait_onclick()">¥˝…Û∫À…Í«Î</a></td>
	...
	<td width="160" background="<c:url value="/timebargain/images/bgimage.gif"/>"><a href="#" id="already" class="common" onclick="already_onclick()">“—…Û∫À…Í«Î</a></td>
	...
	<td width="160" background="<c:url value="/timebargain/images/bgimage.gif"/>" ><a href="#" id="aaa" class="common" onclick="new_onclick()">ÃÓ–¥–¬…Í«Î</a></td>
    <td width="30" background="<c:url value="/timebargain/images/bgimage.gif"/>" class="common" ><img src="<c:url value="/timebargain/images/line.gif"/>" width="3" height="31"></td>
