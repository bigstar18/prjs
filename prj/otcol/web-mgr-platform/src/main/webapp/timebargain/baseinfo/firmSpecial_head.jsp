...
function query()
{
  ...
  {
  	parent.ListFrame.location.href = "<c:url value="/timebargain/menu/firmMargin.do"/>";
  }
  else if(oper.value == "qty")
  {
  	parent.ListFrame.location.href = "<c:url value="/timebargain/menu/firmMaxHoldQty.do"/>";
  } 
  else if(oper.value == "fee")
  {
  	parent.ListFrame.location.href = "<c:url value="/timebargain/menu/firmFee.do"/>";
  } 
}
</script>
</head>
