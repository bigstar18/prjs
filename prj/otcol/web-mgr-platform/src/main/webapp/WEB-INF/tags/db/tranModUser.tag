...
<%@ attribute name="frozencapital" required="true" %>
...
<c_db:set var="columns2" value="usercode,password,status,overdraft,feecut,balance,frozencapital,category1,category2,tradecount,totalsecurity"/>
<c_db:set var="values2" value="${code},'${password}',${status},${overdraft},${feecut},${balance},${frozencapital},${category1},${category2},${tradecount},${totalsecurity}"/>
<%//交易用户分市场资金%>
