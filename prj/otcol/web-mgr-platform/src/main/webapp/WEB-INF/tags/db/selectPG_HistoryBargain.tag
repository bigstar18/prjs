...
<sql_db:query dataSource="${tags_db_dataSource}" var="v_result">
    select id,name,userid,rown,tradepartition, code, contractid,price,amount,tradedate,section,tradeunit from (select id,name,userid,rownum rown,tradepartition, code, contractid,price,amount,tradedate,section,tradeunit from (select u1.firmid id,u1.name,u1.firmid,u2.userid,u2.tradepartition, u2.code,u2.contractid,u2.price,u2.amount,u2.tradedate,u2.section,u3.tradeunit from m_firm u1,v_hisbargain u2,v_commodity u3,v_commext u4
