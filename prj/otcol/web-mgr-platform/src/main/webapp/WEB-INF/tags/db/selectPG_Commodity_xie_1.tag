...
<sql_db:query dataSource="${tags_db_dataSource}" var="v_result">
    select id,code,firsttime,createtime,status,splitid,category,beginprice,stepprice,amount,tradeunit,alertprice,b_security,b_fee,s_security,s_fee,minamount,str1,str6,userid,trademode,rown from (select id,code,firsttime,createtime,status,splitid,category,beginprice,stepprice,amount,tradeunit,alertprice,b_security,b_fee,s_security,s_fee,minamount,str1,str6,userid,trademode,rownum rown from (select u1.id,u1.code,u1.firsttime,u1.createtime,u1.status,u1.splitid,u1.category,u1.beginprice,u1.stepprice,u1.amount,u1.tradeunit,u1.alertprice,u1.b_security,u1.b_fee,u1.s_security,u1.s_fee,u1.minamount,u2.str1,u2.str6,u1.userid,u1.trademode from commodity u1,commext u2
