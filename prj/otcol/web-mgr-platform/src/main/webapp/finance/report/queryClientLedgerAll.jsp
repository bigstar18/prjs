...
<html xmlns:MEBS>
  <head>
	...
	<script language="JavaScript">
		...
		function doQuery(){
			...
			frm_query.sign.value="sum";
			frm_query.submit();
		}
		function resetForm(){
			frm_query.beginDate.value = "";
			frm_query.endDate.value = "";
			frm_query.firmIdS.value = "";
			frm_query.firmIdE.value = "";
		}
		...
		function clickMenu(v){
			...
			frm_query.action="<%=basePath%>/reportController.spr?funcflg=queryClientLedger&sign=sum";
		    frm_query.submit();	
		}
	</script>
  </head>
 ...
 %>
		...
		<input type="hidden" id="sign" name="sign" value="sum">
		<fieldset width="95%">
			...
			<table border="0" cellspacing="0" cellpadding="0" width="100%" height="35">
				<tr height="35">
					...
					<td align="right">交易商开始：&nbsp;</td>
					<td align="left">
						<input id="firmIdS" name="_firmId[>=]" value="<c:out value='${oldParams["firmId[>=]"]}'/>" type=text class="text" style="width: 60px" onkeypress="onlyNumberAndCharInput()" maxlength="16">
					</td>
					<td align="right">交易商结束：&nbsp;</td>
					<td align="left">
						<input id="firmIdE" name="_firmId[<=]" value="<c:out value='${oldParams["firmId[<=]"]}'/>" type=text class="text" style="width: 60px" onkeypress="onlyNumberAndCharInput()" maxlength="16">
					</td>
					<td align="left">
