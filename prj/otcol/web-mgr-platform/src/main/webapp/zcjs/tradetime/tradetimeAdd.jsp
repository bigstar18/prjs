...
<body>
        <form id="formNew" name="frm" method="POST" action="<%=basePath%>tradeTimeController.zcjs?funcflg=tradeTimeAdd" >
		<fieldset width="100%">
		<legend>交易节信息添加</legend>
			<table border="0" cellspacing="0" cellpadding="0" width="100%">

			  <tr height="30">
                <td align="right" width="40%">开始时间：</td>
                <td align="left" width="60%">
                	<input class="text" name="startTime" value="" style="width: 150px;">&nbsp;
			   ...
			   <tr height="30">
                ...
                <td align="left" width="60%">
                 <input class="text" name="endTime" value="" style="width:150px;">&nbsp;
                 <font color="red">*(例：08:30)</font>&nbsp;
                </td>
			  </tr>
              <tr height="30">
