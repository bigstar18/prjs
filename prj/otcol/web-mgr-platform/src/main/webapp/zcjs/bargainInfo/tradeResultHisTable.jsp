...
<table id="tableList" border="0" cellspacing="0" cellpadding="0" width="200%" height="400">
  		<tHead>
  			<tr height="25">
  				...
  				<td class="panel_tHead_MB" align="center" colspan="2">操作</td>
		...
		<c:forEach items="${resultList}" var="result">
			  		<tr height="22" onclick="selectTr();">
						...
						<span onclick="fmod('<c:out value="${result.tradeNo}"/>')" style="cursor:hand;color:blue">
			  			商品参数</span>&nbsp;</td>
			  			<td class="underLine"><span onclick="showContractHis('${result.TradeNo}')" style="cursor:hand;color:blue">查看合同</span></td>
