...
<table id="tableList" border="0" cellspacing="0" cellpadding="0" width="140%" height="400">
  		<tHead>
  			<tr height="25">
		...
		<c:forEach items="${resultList}" var="result">
			  		<tr height="22" onclick="selectTr();">
						...
						<span onclick="fmod('<c:out value="${result.DiscussPriceId}"/>')" style="cursor:hand;color:blue">
			  			商品参数</span>&nbsp;</td>
