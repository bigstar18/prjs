...
<body>
        <form id="formNew" action="<%=basePath%>/firmController.mem?funcflg=firmCategoryAdd" method="POST" targetType="hidden" callback="closeDialog(1);">
		<fieldset width="100%">
		<legend>交易商类别添加信息</legend>
			<table border="0" cellspacing="0" cellpadding="0" width="100%">
				<tr height="35">
                	<td align="right"> 交易商类别编码 ：</td>
                	<td align="left">
                	<input class="normal" name="firmId" id="firmId" type="text" reqfv="required;交易商类别代码" style="width: 150px;"  maxlength="10"  "/> &nbsp;<font color="#ff0000">*</font>
                	</td>
            	</tr>
			  <tr height="35">
                <td align="right"> 交易商类别名称 ：</td>
                <td align="left">
                	<input class="normal" name="name" id="name" type="text" reqfv="required;交易商类别名称" style="width: 150px;"  maxlength="20"  "/> &nbsp;<font color="#ff0000">*</font>
                </td>
            	</tr>
              <tr height="35">
            	<td align="right"> 交易商类别描述 ：</td>
                <td align="left">
                	<textarea rows="4" cols="16" style="width: 150px;" onKeyDown="textdown(event)" onKeyUp="textup()" id = "note" name = "note"></textarea>
                </td>
                </tr>
              <tr height="35">
