...
<html xmlns:MEBS>
	...
	<body leftmargin="2" topmargin="0">
		...
		<table width="100%">
		    <tr>
				<td>
					<form name="frm_query" action="${pageContext.request.contextPath}/member/feeDetailController.mem?funcflg=hisDealDetailZcjsList"
			...
			<tr>
				<td>
					<ec:table items="resultList" var="result"
						action="${pageContext.request.contextPath}/member/feeDetailController.mem?funcflg=hisDealDetailZcjsList"
						xlsFileName="手续费明细(挂牌)${nowTime}.xls"
					    showPrint="false"
