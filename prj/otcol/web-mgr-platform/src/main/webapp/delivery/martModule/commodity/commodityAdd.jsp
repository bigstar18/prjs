...
<body>
        <form id="formNew" name="frm" method="POST" action="<%=basePath%>servlet/commodityController.${POSTFIX}?funcflg=commodityAdd" >
		<fieldset width="100%">
		<legend>品种信息</legend>
			<table border="0" cellspacing="0" cellpadding="0" width="100%">
			  ...
			  <tr height="30">
                ...
                <td align="left" width="60%">
                	<select id="id" name="id">
                		<option value="">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</option>
                		<c:forEach items="${entityBreedList}" var="result">
			  ...
			  <tr height="30">
                ...
                <td align="left">
                	<input name="countType" type="text" value="" class="text" style="width: 150px;" reqfv="required;计量单位" >&nbsp;<font color="red">*</font>&nbsp;（eg.吨）
                </td>
			  </tr>
			  </table>
			 <table border="0" cellspacing="0" cellpadding="0" width="100%">
