...
<form name="frm" method="post" action="<%=basePath%>servlet/settleMatchController.${POSTFIX}?funcflg=settleMatchList&_moduleid[%3D]=${moduleId }">
	...
	<fieldset>
		...
		<table border="0" cellspacing="0" cellpadding="0" width="100%">
			...
			<td>
				<input type="text" id="firmId" name="_firmId[=]" value="<c:out value='${oldParams["firmId[=]"]}'/>" class="text" style="width: 150px"onkeypress="onlyNumberAndCharInput()" maxlength="16">
	...
	<br>
	<%@ include file="settleMatchForwardTable.jsp" %>
	<%-- 
