...
<form name=frm action="" method="post">
    ...
    <c:set var="defaultSec" value=""/>
    <db:select var="row" table="v_syspartition" columns="partitionid" where="1=1 ${tempfilter}" orderBy="partitionid asc">
	...
	try
	{
		...
		{				
			...
			if(r == 2)
			{
                ...
                log.log(STARTSYS,loginID,remark);
				%>
		...
		else if(request.getParameter("resume") != null)//恢复交易
		{
			try
			{
				...
				//写日志
 	            String remark="恢复交易";
 	            OptLog log=new OptLog(JNDI);
                log.log(INSTATRADE,loginID,remark);
				%>
				<SCRIPT LANGUAGE="JavaScript">
				<!--
				alert("恢复交易成功！");
		...
		else if(request.getParameter("close") != null)//闭市
		{
			try
			{
				...
				//写日志
 	            String remark="闭市";
 	            OptLog log=new OptLog(JNDI);
                log.log(SHUTSYS,loginID,remark);
				%>
				<SCRIPT LANGUAGE="JavaScript">
				<!--
				alert("闭市成功！");
		...
		else if(request.getParameter("forcestart") != null)//强制开市
		{
			try
			{
				...
				//写日志
 	            String remark="强制开市";
 	            OptLog log=new OptLog(JNDI);
                log.log(COMPULSORYSHUTSYS,loginID,remark);
				%>
				<SCRIPT LANGUAGE="JavaScript">
				<!--
				alert("强制开市成功！");
