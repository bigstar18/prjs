...
<%
	...
	try{
		...
		if(ManaUtil.checkStr(contractIds)){
			...
			sql.append("select count(commodityid) as n from v_hisbargain where contractid in ("+contractIds+")");
			...
			ps.close();
			sql=new StringBuffer();
			sql.append("select contractcontent from v_hisbargain where contractid in ("+contractIds+")");
			Clob clob;
