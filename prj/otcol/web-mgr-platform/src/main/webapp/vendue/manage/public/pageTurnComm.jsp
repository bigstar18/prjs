...
<tFoot>
				...
				<tr height="22">
					<td class="panel_tBody_LB">&nbsp;</td>
					<td colspan="<%=colspan%>" align="right" class="pager">
					<!--分页信息-->
					商品总数量:
					<c:choose>
					  <c:when test="${not empty param.amountTotal}">
					  ${param.amountTotal}
					  </c:when>
					  <c:otherwise>
                      0
					...
					到<input class="text" type="text" style="width:25px;" name="pageJumpIdx" onkeydown="">页
