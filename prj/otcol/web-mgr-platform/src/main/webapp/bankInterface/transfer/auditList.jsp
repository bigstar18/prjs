...
<html xmlns:MEBS>
  ...
  <body>
	  ...
	  <table id="tableList" border="0" cellspacing="0" cellpadding="0" width="100%" height="400">
  		<tHead>
  			<tr height="25" align=center>
				...
				<td class="panel_tHead_MB" >流水号</td>
				<td class="panel_tHead_MB" >付款银行</td>			
				<td class="panel_tHead_MB" >收款银行</td>
				<td class="panel_tHead_MB" >收款交易商</td>
		...
		<tBody>
			...
			for(int i=0;i<obj.getCurNum();i++)
			{
				...
				<tr height="22" align=center>
					...
					<td class="underLine"><a href="audit.jsp?id=<%=bankTransferValue.id%>"><%=bankTransferValue.id%></a>&nbsp;</td>
	...
	<TR align=center>
		<TD>
		<!--<button type="button" class="smlbtn" onclick="goToAddFirm();">添加</button>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;-->
		<!--<button type="button" class="smlbtn" onclick="doDel();">删除</button>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;-->
		<!--<button type="button" class="smlbtn" onclick="exportData();">导出</button>&nbsp;-->
