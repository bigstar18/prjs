	...
	<tBody>
			...
			%>
				<tr height="22" align=center  onclick="selectTr();">   
					...
					<td class="underLine" align=center><%=Tool.fmtDouble2(firmvalue.sellerPayment)%>&nbsp;</td>
					<td class="underLine" align=center><%=Tool.fmtDouble2(firmvalue.BuyerPayment)%>&nbsp;</td>
					<td class="underLine" align=center><%=Tool.fmtDouble2(firmvalue.Profit)%>&nbsp;</td>
					<td class="underLine" align=center><%=Tool.fmtDouble2(firmvalue.Loss)%>&nbsp;</td>
