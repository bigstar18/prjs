	...
	if(request.getParameter("submitFlag") != null && request.getParameter("submitFlag").equals("do"))
	{
		...
		if(downLimit!=null)
		{
			for(int i = 0; i < downLimit.length; i++)
			{
				...
				lv.setLogcontent("修改交易商手续费，交易商代码："+firmID+"最低金额："+Tool.strToInt(downLimit[i])+"时间："+Tool.fmtTime(new java.util.Date()));
				DAO.log(lv);
			}
		}
	}
							  ...
							  <table id="tableList" border="0" cellspacing="0" cellpadding="0" width="100%" height="200" align="center">
								...
								<%
									...
									<tr onclick="selectTr();">
										...
										<td class="underLine"><input name="rate" type="text" class="text" style="width: 100px;" reqfv = "req_num;1;0;手续费" value="<%=feeInfoVO.rate%>"  onkeydown="if(event.keyCode==13)event.keyCode=9"></td>
										<td class="underLine"><input name="minRateValue" type="text" class="text" style="width: 100px;" reqfv = "req_num;1;0;最低手续费" value="<%=feeInfoVO.minRateValue%>"  onkeydown="if(event.keyCode==13)event.keyCode=9"></td>
										<td class="underLine"><input name="maxRateValue" type="text" class="text" style="width: 100px;" reqfv = "req_num;1;0;最高手续费" value="<%=feeInfoVO.maxRateValue%>"  onkeydown="if(event.keyCode==13)event.keyCode=9"></td>
										<td class="panel_tBody_RB">&nbsp;</td>
									</tr>
									<%}%>
								</tBody>
