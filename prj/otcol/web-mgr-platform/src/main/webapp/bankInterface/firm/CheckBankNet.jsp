	  ...
	  <table id="tableList" border="0" cellspacing="0" cellpadding="0" width="100%" height="400">
  		<tHead>
  			<tr height="25" align=center>
				...
				<td class="panel_tHead_MB" align=center>当日卖方货款</td>
				<td class="panel_tHead_MB" align=center>当日买方货款</td>
				<td class="panel_tHead_MB" align=center>当日盈利</td>
				<td class="panel_tHead_MB" align=center>当日亏损</td>
				<td class="panel_tHead_MB" align=center>当日交易盈亏变化量</td>
		...
		<tBody>
			...
			%>
				<tr height="22" align=center  onclick="selectTr();">
					...
					<td class="underLine" align=center><%=Tool.fmtDouble2(bqc.sellerPayment)%>&nbsp;</td>
					<td class="underLine" align=center><%=Tool.fmtDouble2(bqc.BuyerPayment)%>&nbsp;</td>
					<td class="underLine" align=center><%=Tool.fmtDouble2(bqc.Profit)%>&nbsp;</td>
					<td class="underLine" align=center><%=Tool.fmtDouble2(bqc.Loss)%>&nbsp;</td>
					<td class="underLine" align=center><%=Tool.fmtDouble2(bqc.QYchange)%>&nbsp;</td>
					
					<td class="underLine" align=center><a href="#" onclick="window.location='firmBalance.jsp?bankID=<%=bqc.bankId%>'" >查看</a>&nbsp;</td>	
