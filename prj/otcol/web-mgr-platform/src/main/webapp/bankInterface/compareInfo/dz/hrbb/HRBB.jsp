...
<%
	...
	if("cibQSDZ".equals(request.getParameter("submitFlag"))) {//发送对账信息
		...
		lv.setIp(computerIP);
		ReturnValue rv = cp.sendHRBQSValue(bankID,null,Tool.strToDate(s_time));
		result = rv.remark;
...
<html xmlns:MEBS>
  ...
  <body>
  	<form id="frm" action="" method="post">
		<fieldset width="100%">
			<legend>哈尔滨银行清算页面信息</legend>
			<table border="0" cellspacing="0" cellpadding="0" width="100%" height="35">
				<tr height="35">
					<td align="right" width>银行：&nbsp;</td>
					<td align="left">
				...
				<tr height="35">
					<td align="center" colspan=2>
						...
						&nbsp;&nbsp;&nbsp;
						<input type="button" name="compareBtn2" class="lgrbtn" <%if(getdisableBtn()){out.print("disabled='disabled'");} %> onclick="cibbuttonclick(5);" value="显示分分核对不平">
