...
<%
	...
	String filter = " where status=4 and type!=2 ";
...
<html xmlns:MEBS>
  ...
  <body>
  	<form id="frm" action="OutMoneySecondAudit2.jsp" method="post">
		<fieldset width="95%">
	...
	<TR align=center>
		...
		&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
		<button type="button" id="robakBtn" class="smlbtn" onclick="handleData(frm,tableList,'ck','no')">审核拒绝</button>
...
function handleData(v1,v2,v3,v4)
{
	...
	if(deleteRec(v1,v2,v3,v4)==false)
	{
		document.getElementById("audioBtn").disabled=false;	
		document.getElementById("robakBtn").disabled=false;	
	}
}
function hiddenBtn()
{
	document.getElementById("audioBtn").disabled=true;
	document.getElementById("robakBtn").disabled=true;
}
function pgTurn(i)
{
	if(i == 0)
