			...
			<table border="0" cellspacing="0" cellpadding="0" width="1600px" height="35">
				...
				<tr>
					...
					<td colspan="2" align="center">
						...
						<button type="button" class="smlbtn" onclick="checkCapital();">流水核对</button>&nbsp;
					</td>
				</tr>
			</table>
		</fieldset>
	  ...
	  <table id="tableList" border="0" cellspacing="0" cellpadding="0" width="1600px" height="400">
  		<tHead>
  			<tr height="25" align=center>
				...
				<td class="panel_tHead_MB" align="left">记录流水号</td>
				<td class="panel_tHead_MB" align="left">平台流水号</td>
				<td class="panel_tHead_MB" align="left">银行流水号</td>
				<td class="panel_tHead_MB" align="left">平台号</td>
				<td class="panel_tHead_MB" align="left">交易商代码</td>
				<td class="panel_tHead_MB" align="left">交易系统</td>
				<td class="panel_tHead_MB" align="left">交易发起方</td>
				<td class="panel_tHead_MB" align="left">银行代码</td>
				<td class="panel_tHead_MB" align="left">银行名称</td>
		...
		<tBody>
			...
			for(int i=0;i<obj.getCurNum();i++)
			{
				...
				<tr height="22" align=center onclick="selectTr();">
					...
					<td class="underLine" align="left"><%=(systemsMap.get(money.systemID) == null ? "未知交易系统" : systemsMap.get(money.systemID).systemName)%>&nbsp;</td>
	  	...
	  	<tFoot>
			...
			<tr height="22">
				<td class="panel_tBody_LB">&nbsp;</td>
				<td class="pager" colspan="5" align=center>资金合计：<%=Tool.formatToMoney(allMoney)%></td>
...
function checkCapital(){
	window.showModalDialog("checkCapitalPlatform.jsp","","dialogWidth=1100px; dialogHeight=500px; status=yes;scroll=yes;help=no;");
}
