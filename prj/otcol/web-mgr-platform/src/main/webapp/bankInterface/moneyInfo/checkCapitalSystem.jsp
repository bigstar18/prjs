...
<%
	...
	req.setBankID("");
	req.setMethodName("checkCapitalInfo");
	req.setParams(new Object[]{systemID, now});
	try {
		...
		<table id="tableList" border="0" cellspacing="0" cellpadding="0" width="1040px">
  		<tHead>
  			<tr height="25" align=center>
				...
				<td class="panel_tHead_MB">系统转账类型</td>
				<td class="panel_tHead_MB">平台转账类型</td>
				<td class="panel_tHead_MB">系统发生额</td>
				<td class="panel_tHead_MB">平台发生额</td>
