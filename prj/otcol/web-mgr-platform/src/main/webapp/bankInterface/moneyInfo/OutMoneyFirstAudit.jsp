...
<%
	...
	String filter = " where status=3 and type!=2 ";
...
<html xmlns:MEBS>
  ...
  <body>
  	<form id="frm" action="OutMoneyFirstAudit2.jsp" method="post">
		<fieldset width="95%">
	  ...
	  <table id="tableList" border="0" cellspacing="0" cellpadding="0" width="1600px" height="400">
  		<tHead>
  			<tr height="25" align=center>
				...
				<td class="panel_tHead_MB" align=center>平台流水号</td>
				<td class="panel_tHead_MB" align=left>平台号</td>
				<td class="panel_tHead_MB" align=left>银行</td>
