...
<form name="frm" id="frm" method ="post"  action="<%=commonUserControllerPath %>commonUserModStyle">
		...
		<tr height="35">
            ...
            <td align="left">
            	<input name="userId" type="text" class="text" style="width: 180px;" value="${user.userId }" readonly="readonly">
            </td>
        </tr>
        <tr height="35">
        	<td align="right"> 用户名称 ：</td>
            <td align="left">
            	<input name="name" type="text" class="text" style="width: 180px;" value="${user.name }" readonly="readonly">
            </td>
        </tr>
        <tr height="35">
