...
<body>
<form name="frm" id="frm" method ="post" action="<%=commonUserControllerPath%>commonUserModPassword&sign=new">
		<fieldset width="100%">
        ...
        <tr height="35">
            ...
            <td align="left">
                  <input name="password" type="password" class="text" style="width: 180px;" maxlength="14" onKeyUp="passwordStrength(this.value)" onblur="passwordYin(this.value)" onkeypress="notSpace()">
        ...
        <tr height="35">       
	          ...
	          <td align="left">
	          	<input name="password1" type="password" class="text" style="width: 180px;" maxlength="14" onkeypress="notSpace()">
	          </td>
        </tr>
  	</table>
		<BR>
