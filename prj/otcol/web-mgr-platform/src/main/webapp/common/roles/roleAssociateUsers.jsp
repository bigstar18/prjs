...
<SCRIPT LANGUAGE="JavaScript">
	...
	{
		var result=window.showModalDialog("<%=commonRoleControllerPath %>commonRoleAddAssociation&roleId="+(frm.roleId.value),"", "dialogWidth=550px; dialogHeight=500px; status=no;scroll=yes;help=no;"); 
		if(result)
		{
			queryInfo();
		}
		//frm.action="<%//=serverPath %>/commonRoleAddAssociation.cmn";
		//frm.submit();
	}
