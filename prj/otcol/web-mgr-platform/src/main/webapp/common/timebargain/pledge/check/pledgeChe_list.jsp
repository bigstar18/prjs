...
<script type="text/javascript">
	function check_pledge(id){
		pTop("<%=basePath%>/timebargain/pledge/check/pledgeChe_U.jsp?id=" + id,500,400);
	}
	
	function search(){
		document.location.href = "<%=basePath%>/timebargain/pledge/check/pledgeChe.jsp";
	}
</script>
...
<table width="100%">
  <tr><td>
	<ec:table items="pledgeList" var="pledge" 
			action="${basePath}/timebargain/pledgeCheList.spr"	
