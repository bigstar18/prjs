...
<%@ page import="gnnt.MEBS.common.action.Condition"%>
<%@ page import="gnnt.MEBS.common.util.SysData"%>
<%@ page import="gnnt.MEBS.common.util.query.PageInfo"%>
<%@ page import="gnnt.MEBS.common.util.query.OrderField"%>
...
<%
	...
	String comPath = request.getScheme()+"://"+request.getServerName()+":"+request.getServerPort()+projectPath;
