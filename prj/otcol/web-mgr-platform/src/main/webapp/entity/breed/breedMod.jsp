...
<html>
	...
	<body>
		<form id="formNew" name="frm" method="POST"
			action="<%=basePath%>breedController.entity?funcflg=breedMod">
			<fieldset width="100%">
				<legend>
					品种信息
				</legend>
				<table border="0" cellspacing="0" cellpadding="0" width="100%">
					<tr height="30">
						...
						<td align="left" width="60%">
							<input class="text" name="breedId" value="${breed.breedId }" style="width: 150px;color:gray"  readonly="readonly"
								reqfv="required;品种代码" onkeypress="onlyNumberAndCharInput()" maxlength="32">
							&nbsp;
					...
					<tr height="30">
						...
						<td align="left" width="60%">
							<input class="text" name="breedName" value="${breed.breedName }"
				...
				<c:set value="${breed.qualityList}" var="qualityList"/> 
				<c:set value="${breed.parametersList}" var="keyValueList"/> 
			<c:forEach items="${keyValueList}" var="keyValue">
				<c:set value="${keyValue.key}" var="property"/> 
					<table border="0" cellspacing="0" cellpadding="0" width="100%"
						id="${property.propertyKey}tb">
					
						<tr height="30">
							<td align="center" colspan="2">
								${property.propertyName }设置
							</td>
						</tr>
						<c:forEach items="${keyValue.value}" var="value">
						<tr>
							<td align="right" width="40%">
								名&nbsp;&nbsp;&nbsp;&nbsp;称：
							</td>
							<td align="left" width="60%">
								<input name="${property.propertyKey }" type="text" value="${value.name }" class="text"
						...
						<tr height="30">
							<td colspan="2">
								<div align="center">
									<button class="smlbtn" type="button" onclick="add('${property.propertyKey}');">
										添加项
									</button>
									&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
									<button class="smlbtn" type="button" onclick="del('${property.propertyKey }');">
										删除项
									</button>
									&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
								</div>
			...
			<table border="0" cellspacing="0" cellpadding="0" width="100%" id="qualitytb">
			  ...
			  <c:forEach items="${qualityList}" var="quality">
			  <tr>
			  	<td align="right" width="40%">名&nbsp;&nbsp;&nbsp;&nbsp;称：</td>
                <td align="left" width="60%">
                	<input name="quality" type="text" value="${quality.qualityName }" class="text" style="width: 150px;" reqfv="required;名称" onkeyup="value=value.replace(/^[0-9].*$/,'')" onkeypress="onlyNumberAndCharInput()" maxlength="32">&nbsp;<font color="red">*</font>
                </td>
			  </tr>
			  </c:forEach>
			  <tr height="30">
