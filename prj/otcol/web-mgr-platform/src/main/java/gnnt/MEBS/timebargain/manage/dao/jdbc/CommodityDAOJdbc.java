  ...
  implements CommodityDAO
{
  ...
  public Commodity getCommodityByIdCURorHIS(Commodity paramCommodity)
  {
    ...
    if ((localList1 != null) && (localList1.size() > 0))
    {
      ...
      localObject2 = ((Map)localObject1).get("holdDaysLimit").toString();
    ...
    Object localObject2 = { paramCommodity.getCommodityID() };
  ...
  public List getCommoditys(Commodity paramCommodity, String paramString)
  {
    ...
    localStringBuffer.append("select a.commodityID,a.name,a.status,a.marketdate,a.settledate,decode(a.MarginAlgr,1,a.marginrate_b*100||'%',2,a.marginrate_b) marginrate_b,decode(a.MarginAlgr,1,a.marginrate_s*100||'%',2,a.marginrate_s) marginrate_s,a.breedid,c.BreedName,d.SortName ").append("from T_COMMODITY a,T_A_BREED c,T_A_CMDTYSORT d where a.BreedID=c.BreedID(+) and a.SortID=d.SortID(+) ");
  ...
  {
    StringBuffer localStringBuffer = new StringBuffer();
    localStringBuffer.append("select a.commodityID,a.name,a.status,a.marketdate,a.settledate,decode(a.MarginAlgr,1,a.marginrate_b*100||'%',2,a.marginrate_b) marginrate_b,decode(a.MarginAlgr,1,a.marginrate_s*100||'%',2,a.marginrate_s) marginrate_s,a.breedid,c.BreedName,d.SortName ").append("from T_SETTLECOMMODITY a,T_A_BREED c,T_A_CMDTYSORT d where a.BreedID=c.BreedID(+) and a.SortID=d.SortID(+) ");
    Object[] arrayOfObject = null;
    ArrayList localArrayList = new ArrayList();
    if ((paramCommodity != null) && (paramCommodity.getBreedID() != null))
    {
  ...
  {
    StringBuffer localStringBuffer = new StringBuffer();
    localStringBuffer.append("insert into T_COMMODITY(CommodityID,Name,MaxHoldPositionDay,SortID,Status,ContractFactor,MinPriceMove,BreedID,SpreadAlgr,SpreadUpLmt,SpreadDownLmt,").append("FeeAlgr,FeeRate_B,FeeRate_S,MarginAlgr,MarketDate,SettleDate,SettleDate1,SettleDate2,SettleDate3,SettleDate4,").append("MarginItem1,MarginItem2,MarginItem3,MarginItem4,LastPrice,MarginItem1_S,MarginItem2_S,MarginItem3_S,MarginItem4_S,MarginItemAssure1,MarginItemAssure2,MarginItemAssure3,MarginItemAssure4,MarginItemAssure1_S,MarginItemAssure2_S,MarginItemAssure3_S,MarginItemAssure4_S,TodayCloseFeeRate_B,TodayCloseFeeRate_S,HistoryCloseFeeRate_B,HistoryCloseFeeRate_S,LimitCmdtyQty,SettleFeeAlgr,SettleFeeRate_B,SettleFeeRate_S,ForceCloseFeeAlgr,ForceCloseFeeRate_B,ForceCloseFeeRate_S,SettleMarginRate_B,SettleMarginRate_S,AddedTax,MarginPriceType,LowestSettleFee,FirmCleanQty,SettleMarginAlgr_B,SettleMarginAlgr_S,PayoutAlgr,PayoutRate,FirmMaxHoldQty,AddedTaxFactor,SettleDate5,MarginItem5,MarginItem5_S,MarginItemAssure5,MarginItemAssure5_S,OrderPrivilege_B,OrderPrivilege_S,SettlePriceType,BeforeDays,SpecSettlePrice,FirmMaxHoldQtyAlgr,StartPercentQty,MaxPercentLimit,OneMaxHoldQty,MinQuantityMove,MinSettleMoveQty,MinSettleQty,DelayRecoupRate,DelayRecoupRate_S,SettleWay,DelayFeeWay,MaxFeeRate,StoreRecoupRate,DelaySettlePriceType,SettleMarginType,BeforeDays_M,aheadSettlepriceType,HoldDaysLimit)").append(" values(?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)");
    int[] arrayOfInt = { 12, 12, -5, -5, 5, 8, 8, -5, 5, 8, 8, 5, 8, 8, 5, 91, 91, 91, 91, 91, 91, 8, 8, 8, 8, 8, 8, 8, 8, 8, 8, 8, 8, 8, 8, 8, 8, 8, 8, 8, 8, 8, -5, 5, 8, 8, 5, 8, 8, 8, 8, 8, 5, 8, -5, 5, 5, 5, 8, -5, 8, 91, 8, 8, 8, 8, 5, 5, 5, -5, 8, 5, -5, 8, -5, 5, 5, 5, 8, 8, 5, 5, 8, 8, 8, 4, 4, 4, 4 };
    Object[] arrayOfObject1 = { paramCommodity.getCommodityID(), paramCommodity.getName(), paramCommodity.getMaxHoldPositionDay(), paramCommodity.getSortID(), paramCommodity.getStatus() == null ? new Short((short)-1) : paramCommodity.getStatus(), paramCommodity.getContractFactor() == null ? new Double(0.0D) : paramCommodity.getContractFactor(), paramCommodity.getMinPriceMove() == null ? new Double(0.0D) : paramCommodity.getMinPriceMove(), paramCommodity.getBreedID(), paramCommodity.getSpreadAlgr(), paramCommodity.getSpreadUpLmt() == null ? new Double(0.0D) : paramCommodity.getSpreadUpLmt(), paramCommodity.getSpreadDownLmt() == null ? new Double(0.0D) : paramCommodity.getSpreadDownLmt(), paramCommodity.getFeeAlgr(), paramCommodity.getFeeRate_B() == null ? new Double(0.0D) : paramCommodity.getFeeRate_B(), paramCommodity.getFeeRate_S() == null ? new Double(0.0D) : paramCommodity.getFeeRate_S(), paramCommodity.getMarginAlgr(), paramCommodity.getMarketDate(), paramCommodity.getSettleDate(), paramCommodity.getSettleDate1(), paramCommodity.getSettleDate2(), paramCommodity.getSettleDate3(), paramCommodity.getSettleDate4(), paramCommodity.getMarginItem1() == null ? new Double(0.0D) : paramCommodity.getMarginItem1(), paramCommodity.getMarginItem2() == null ? new Double(0.0D) : paramCommodity.getMarginItem2(), paramCommodity.getMarginItem3() == null ? new Double(0.0D) : paramCommodity.getMarginItem3(), paramCommodity.getMarginItem4() == null ? new Double(0.0D) : paramCommodity.getMarginItem4(), paramCommodity.getLastPrice(), paramCommodity.getMarginItem1_S() == null ? new Double(0.0D) : paramCommodity.getMarginItem1_S(), paramCommodity.getMarginItem2_S() == null ? new Double(0.0D) : paramCommodity.getMarginItem2_S(), paramCommodity.getMarginItem3_S() == null ? new Double(0.0D) : paramCommodity.getMarginItem3_S(), paramCommodity.getMarginItem4_S() == null ? new Double(0.0D) : paramCommodity.getMarginItem4_S(), paramCommodity.getMarginItemAssure1() == null ? new Double(0.0D) : paramCommodity.getMarginItemAssure1(), paramCommodity.getMarginItemAssure2() == null ? new Double(0.0D) : paramCommodity.getMarginItemAssure2(), paramCommodity.getMarginItemAssure3() == null ? new Double(0.0D) : paramCommodity.getMarginItemAssure3(), paramCommodity.getMarginItemAssure4() == null ? new Double(0.0D) : paramCommodity.getMarginItemAssure4(), paramCommodity.getMarginItemAssure1_S() == null ? new Double(0.0D) : paramCommodity.getMarginItemAssure1_S(), paramCommodity.getMarginItemAssure2_S() == null ? new Double(0.0D) : paramCommodity.getMarginItemAssure2_S(), paramCommodity.getMarginItemAssure3_S() == null ? new Double(0.0D) : paramCommodity.getMarginItemAssure3_S(), paramCommodity.getMarginItemAssure4_S() == null ? new Double(0.0D) : paramCommodity.getMarginItemAssure4_S(), paramCommodity.getTodayCloseFeeRate_B() == null ? new Double(0.0D) : paramCommodity.getTodayCloseFeeRate_B(), paramCommodity.getTodayCloseFeeRate_S() == null ? new Double(0.0D) : paramCommodity.getTodayCloseFeeRate_S(), paramCommodity.getHistoryCloseFeeRate_B() == null ? new Double(0.0D) : paramCommodity.getHistoryCloseFeeRate_B(), paramCommodity.getHistoryCloseFeeRate_S() == null ? new Double(0.0D) : paramCommodity.getHistoryCloseFeeRate_S(), paramCommodity.getLimitCmdtyQty() == null ? new Long(0L) : paramCommodity.getLimitCmdtyQty(), paramCommodity.getSettleFeeAlgr(), paramCommodity.getSettleFeeRate_B() == null ? new Double(0.0D) : paramCommodity.getSettleFeeRate_B(), paramCommodity.getSettleFeeRate_S() == null ? new Double(0.0D) : paramCommodity.getSettleFeeRate_S(), paramCommodity.getForceCloseFeeAlgr(), paramCommodity.getForceCloseFeeRate_B() == null ? new Double(0.0D) : paramCommodity.getForceCloseFeeRate_B(), paramCommodity.getForceCloseFeeRate_S() == null ? new Double(0.0D) : paramCommodity.getForceCloseFeeRate_S(), paramCommodity.getSettleMarginRate_B() == null ? new Double(0.0D) : paramCommodity.getSettleMarginRate_B(), paramCommodity.getSettleMarginRate_S() == null ? new Double(0.0D) : paramCommodity.getSettleMarginRate_S(), paramCommodity.getAddedTax() == null ? new Double(0.0D) : paramCommodity.getAddedTax(), paramCommodity.getMarginPriceType(), paramCommodity.getLowestSettleFee() == null ? new Double(0.0D) : paramCommodity.getLowestSettleFee(), paramCommodity.getFirmCleanQty() == null ? new Long(0L) : paramCommodity.getFirmCleanQty(), paramCommodity.getSettleMarginAlgr_B(), paramCommodity.getSettleMarginAlgr_S(), paramCommodity.getPayoutAlgr(), paramCommodity.getPayoutRate() == null ? new Double(0.0D) : paramCommodity.getPayoutRate(), paramCommodity.getFirmMaxHoldQty() == null ? new Long(0L) : paramCommodity.getFirmMaxHoldQty(), paramCommodity.getAddedTaxFactor() == null ? new Double(0.0D) : paramCommodity.getAddedTaxFactor(), paramCommodity.getSettleDate5(), paramCommodity.getMarginItem5() == null ? new Double(0.0D) : paramCommodity.getMarginItem5(), paramCommodity.getMarginItem5_S() == null ? new Double(0.0D) : paramCommodity.getMarginItem5_S(), paramCommodity.getMarginItemAssure5() == null ? new Double(0.0D) : paramCommodity.getMarginItemAssure5(), paramCommodity.getMarginItemAssure5_S() == null ? new Double(0.0D) : paramCommodity.getMarginItemAssure5_S(), paramCommodity.getOrderPrivilege_B(), paramCommodity.getOrderPrivilege_S(), paramCommodity.getSettlePriceType(), paramCommodity.getBeforeDays() == null ? new Long(0L) : paramCommodity.getBeforeDays(), paramCommodity.getSpecSettlePrice() == null ? new Double(0.0D) : paramCommodity.getSpecSettlePrice(), paramCommodity.getFirmMaxHoldQtyAlgr(), paramCommodity.getStartPercentQty() == null ? new Long(0L) : paramCommodity.getStartPercentQty(), paramCommodity.getMaxPercentLimit() == null ? new Double(0.0D) : paramCommodity.getMaxPercentLimit(), paramCommodity.getOneMaxHoldQty() == null ? new Long(0L) : paramCommodity.getOneMaxHoldQty(), Integer.valueOf(paramCommodity.getMinQuantityMove()), Integer.valueOf(paramCommodity.getMinSettleMoveQty()), Integer.valueOf(paramCommodity.getMinSettleQty()), paramCommodity.getDelayRecoupRate() == null ? new Double(0.0D) : paramCommodity.getDelayRecoupRate(), paramCommodity.getDelayRecoupRate_S() == null ? new Double(0.0D) : paramCommodity.getDelayRecoupRate_S(), paramCommodity.getSettleWay(), paramCommodity.getDelayFeeWay(), paramCommodity.getMaxFeeRate() == null ? new Double(0.0D) : paramCommodity.getMaxFeeRate(), paramCommodity.getStoreRecoupRate() == null ? new Double(0.0D) : paramCommodity.getStoreRecoupRate(), Integer.valueOf(Integer.valueOf(paramCommodity.getDelaySettlePriceType()) == null ? new Integer(0).intValue() : paramCommodity.getDelaySettlePriceType()), Integer.valueOf(paramCommodity.getSettleMarginType()), Integer.valueOf(paramCommodity.getBeforeDays_M()), Integer.valueOf(paramCommodity.getAheadSettlePriceType()), Integer.valueOf(paramCommodity.getHoldDaysLimit()) };
    this.log.debug("sql: " + localStringBuffer.toString());
  ...
  {
    StringBuffer localStringBuffer = new StringBuffer();
    localStringBuffer.append("update T_COMMODITY set Name=?,MaxHoldPositionDay=?,SortID=?,Status=?,ContractFactor=?,MinPriceMove=?,BreedID=?,SpreadAlgr=?,SpreadUpLmt=?,SpreadDownLmt=?,").append("FeeAlgr=?,FeeRate_B=?,FeeRate_S=?,MarginAlgr=?,MarketDate=?,SettleDate=?,SettleDate1=?,SettleDate2=?,SettleDate3=?,SettleDate4=?,").append("MarginItem1=?,MarginItem2=?,MarginItem3=?,MarginItem4=?,LastPrice=?,MarginItem1_S=?,MarginItem2_S=?,MarginItem3_S=?,MarginItem4_S=?,MarginItemAssure1=?,MarginItemAssure2=?,MarginItemAssure3=?,MarginItemAssure4=?,MarginItemAssure1_S=?,MarginItemAssure2_S=?,MarginItemAssure3_S=?,MarginItemAssure4_S=?,TodayCloseFeeRate_B=?,TodayCloseFeeRate_S=?,HistoryCloseFeeRate_B=?,HistoryCloseFeeRate_S=?, LimitCmdtyQty=?, SettleFeeAlgr=?, SettleFeeRate_B=?, SettleFeeRate_S=?, ForceCloseFeeAlgr=?, ForceCloseFeeRate_B=?, ForceCloseFeeRate_S=?,SettleMarginRate_B=?,SettleMarginRate_S=?,AddedTax=?,MarginPriceType=?,LowestSettleFee=?,FirmCleanQty=?,SettleMarginAlgr_B=?,SettleMarginAlgr_S=?,PayoutAlgr=?,PayoutRate=?,FirmMaxHoldQty=?,AddedTaxFactor=?,SettleDate5=?,MarginItem5=?,MarginItem5_S=?,MarginItemAssure5=?,MarginItemAssure5_S=?,OrderPrivilege_B=?,OrderPrivilege_S=?,SettlePriceType=?,BeforeDays=?,SpecSettlePrice=?,FirmMaxHoldQtyAlgr=?,StartPercentQty=?,MaxPercentLimit=?,OneMaxHoldQty=?,MinQuantityMove=?,MinSettleMoveQty=?,MinSettleQty=?,DelayRecoupRate=?,DelayRecoupRate_S=?,SettleWay=?,DelayFeeWay=?,MaxFeeRate=?,StoreRecoupRate=?,DelaySettlePriceType=?,SettleMarginType=?,BeforeDays_M=?,aheadSettlepriceType=?,holdDaysLimit=?   where CommodityID=?");
    int[] arrayOfInt = { 12, -5, -5, 5, 8, 8, -5, 5, 8, 8, 5, 8, 8, 5, 91, 91, 91, 91, 91, 91, 8, 8, 8, 8, 8, 8, 8, 8, 8, 8, 8, 8, 8, 8, 8, 8, 8, 8, 8, 8, 8, -5, 5, 8, 8, 5, 8, 8, 8, 8, 8, 5, 8, -5, 5, 5, 5, 8, -5, 8, 91, 8, 8, 8, 8, 5, 5, 5, -5, 8, 5, -5, 8, -5, 5, 5, 5, 8, 8, 5, 5, 8, 8, 4, 4, 4, 4, 4, 12 };
    Object[] arrayOfObject1 = { paramCommodity.getName(), paramCommodity.getHoldDaysLimit() == 1 ? paramCommodity.getMaxHoldPositionDay() : null, paramCommodity.getSortID(), paramCommodity.getStatus() == null ? new Short((short)-1) : paramCommodity.getStatus(), paramCommodity.getContractFactor() == null ? new Double(0.0D) : paramCommodity.getContractFactor(), paramCommodity.getMinPriceMove() == null ? new Double(0.0D) : paramCommodity.getMinPriceMove(), paramCommodity.getBreedID(), paramCommodity.getSpreadAlgr(), paramCommodity.getSpreadUpLmt() == null ? new Double(0.0D) : paramCommodity.getSpreadUpLmt(), paramCommodity.getSpreadDownLmt() == null ? new Double(0.0D) : paramCommodity.getSpreadDownLmt(), paramCommodity.getFeeAlgr(), paramCommodity.getFeeRate_B() == null ? new Double(0.0D) : paramCommodity.getFeeRate_B(), paramCommodity.getFeeRate_S() == null ? new Double(0.0D) : paramCommodity.getFeeRate_S(), paramCommodity.getMarginAlgr(), paramCommodity.getMarketDate(), paramCommodity.getSettleDate(), paramCommodity.getSettleDate1(), paramCommodity.getSettleDate2(), paramCommodity.getSettleDate3(), paramCommodity.getSettleDate4(), paramCommodity.getMarginItem1() == null ? new Double(0.0D) : paramCommodity.getMarginItem1(), paramCommodity.getMarginItem2() == null ? new Double(0.0D) : paramCommodity.getMarginItem2(), paramCommodity.getMarginItem3() == null ? new Double(0.0D) : paramCommodity.getMarginItem3(), paramCommodity.getMarginItem4() == null ? new Double(0.0D) : paramCommodity.getMarginItem4(), paramCommodity.getLastPrice(), paramCommodity.getMarginItem1_S() == null ? new Double(0.0D) : paramCommodity.getMarginItem1_S(), paramCommodity.getMarginItem2_S() == null ? new Double(0.0D) : paramCommodity.getMarginItem2_S(), paramCommodity.getMarginItem3_S() == null ? new Double(0.0D) : paramCommodity.getMarginItem3_S(), paramCommodity.getMarginItem4_S() == null ? new Double(0.0D) : paramCommodity.getMarginItem4_S(), paramCommodity.getMarginItemAssure1() == null ? new Double(0.0D) : paramCommodity.getMarginItemAssure1(), paramCommodity.getMarginItemAssure2() == null ? new Double(0.0D) : paramCommodity.getMarginItemAssure2(), paramCommodity.getMarginItemAssure3() == null ? new Double(0.0D) : paramCommodity.getMarginItemAssure3(), paramCommodity.getMarginItemAssure4() == null ? new Double(0.0D) : paramCommodity.getMarginItemAssure4(), paramCommodity.getMarginItemAssure1_S() == null ? new Double(0.0D) : paramCommodity.getMarginItemAssure1_S(), paramCommodity.getMarginItemAssure2_S() == null ? new Double(0.0D) : paramCommodity.getMarginItemAssure2_S(), paramCommodity.getMarginItemAssure3_S() == null ? new Double(0.0D) : paramCommodity.getMarginItemAssure3_S(), paramCommodity.getMarginItemAssure4_S() == null ? new Double(0.0D) : paramCommodity.getMarginItemAssure4_S(), paramCommodity.getTodayCloseFeeRate_B() == null ? new Double(0.0D) : paramCommodity.getTodayCloseFeeRate_B(), paramCommodity.getTodayCloseFeeRate_S() == null ? new Double(0.0D) : paramCommodity.getTodayCloseFeeRate_S(), paramCommodity.getHistoryCloseFeeRate_B() == null ? new Double(0.0D) : paramCommodity.getHistoryCloseFeeRate_B(), paramCommodity.getHistoryCloseFeeRate_S() == null ? new Double(0.0D) : paramCommodity.getHistoryCloseFeeRate_S(), paramCommodity.getLimitCmdtyQty() == null ? new Long(0L) : paramCommodity.getLimitCmdtyQty(), paramCommodity.getSettleFeeAlgr(), paramCommodity.getSettleFeeRate_B() == null ? new Double(0.0D) : paramCommodity.getSettleFeeRate_B(), paramCommodity.getSettleFeeRate_S() == null ? new Double(0.0D) : paramCommodity.getSettleFeeRate_S(), paramCommodity.getForceCloseFeeAlgr(), paramCommodity.getForceCloseFeeRate_B() == null ? new Double(0.0D) : paramCommodity.getForceCloseFeeRate_B(), paramCommodity.getForceCloseFeeRate_S() == null ? new Double(0.0D) : paramCommodity.getForceCloseFeeRate_S(), paramCommodity.getSettleMarginRate_B() == null ? new Double(0.0D) : paramCommodity.getSettleMarginRate_B(), paramCommodity.getSettleMarginRate_S() == null ? new Double(0.0D) : paramCommodity.getSettleMarginRate_S(), paramCommodity.getAddedTax() == null ? new Double(0.0D) : paramCommodity.getAddedTax(), paramCommodity.getMarginPriceType(), paramCommodity.getLowestSettleFee() == null ? new Double(0.0D) : paramCommodity.getLowestSettleFee(), paramCommodity.getFirmCleanQty() == null ? new Long(0L) : paramCommodity.getFirmCleanQty(), paramCommodity.getSettleMarginAlgr_B(), paramCommodity.getSettleMarginAlgr_S(), paramCommodity.getPayoutAlgr(), paramCommodity.getPayoutRate() == null ? new Double(0.0D) : paramCommodity.getPayoutRate(), paramCommodity.getFirmMaxHoldQty() == null ? new Long(0L) : paramCommodity.getFirmMaxHoldQty(), paramCommodity.getAddedTaxFactor() == null ? new Double(0.0D) : paramCommodity.getAddedTaxFactor(), paramCommodity.getSettleDate5(), paramCommodity.getMarginItem5() == null ? new Double(0.0D) : paramCommodity.getMarginItem5(), paramCommodity.getMarginItem5_S() == null ? new Double(0.0D) : paramCommodity.getMarginItem5_S(), paramCommodity.getMarginItemAssure5() == null ? new Double(0.0D) : paramCommodity.getMarginItemAssure5(), paramCommodity.getMarginItemAssure5_S() == null ? new Double(0.0D) : paramCommodity.getMarginItemAssure5_S(), paramCommodity.getOrderPrivilege_B(), paramCommodity.getOrderPrivilege_S(), paramCommodity.getSettlePriceType(), paramCommodity.getBeforeDays() == null ? new Long(0L) : paramCommodity.getBeforeDays(), paramCommodity.getSpecSettlePrice() == null ? new Double(0.0D) : paramCommodity.getSpecSettlePrice(), paramCommodity.getFirmMaxHoldQtyAlgr(), paramCommodity.getStartPercentQty() == null ? new Long(0L) : paramCommodity.getStartPercentQty(), paramCommodity.getMaxPercentLimit() == null ? new Double(0.0D) : paramCommodity.getMaxPercentLimit(), paramCommodity.getOneMaxHoldQty() == null ? new Long(0L) : paramCommodity.getOneMaxHoldQty(), Integer.valueOf(paramCommodity.getMinQuantityMove()), Integer.valueOf(paramCommodity.getMinSettleMoveQty()), Integer.valueOf(paramCommodity.getMinSettleQty()), paramCommodity.getDelayRecoupRate() == null ? new Double(0.0D) : paramCommodity.getDelayRecoupRate(), paramCommodity.getDelayRecoupRate_S() == null ? new Double(0.0D) : paramCommodity.getDelayRecoupRate_S(), paramCommodity.getSettleWay(), paramCommodity.getDelayFeeWay(), paramCommodity.getMaxFeeRate(), paramCommodity.getStoreRecoupRate() == null ? new Double(0.0D) : paramCommodity.getStoreRecoupRate(), Integer.valueOf(Integer.valueOf(paramCommodity.getDelaySettlePriceType()) == null ? new Integer(0).intValue() : paramCommodity.getDelaySettlePriceType()), Integer.valueOf(paramCommodity.getSettleMarginType()), Integer.valueOf(paramCommodity.getBeforeDays_M()), Integer.valueOf(paramCommodity.getAheadSettlePriceType()), Integer.valueOf(paramCommodity.getHoldDaysLimit()), paramCommodity.getCommodityID() };
    this.log.debug("sql: " + localStringBuffer.toString());
    for (int i = 0; i < arrayOfObject1.length; i++) {
      this.log.debug("params[" + i + "]: " + arrayOfObject1[i]);
    }
  ...
  public void updateCommodityMargin(Commodity paramCommodity)
  {
    ...
    Object[] arrayOfObject = { paramCommodity.getMarginRate_B(), paramCommodity.getMarginRate_S(), paramCommodity.getMarginAssure_B(), paramCommodity.getMarginAssure_S(), paramCommodity.getCommodityID() };
    this.log.debug("sql: " + str);
    for (int i = 0; i < arrayOfObject.length; i++) {
      this.log.debug("params[" + i + "]: " + arrayOfObject[i]);
    }
  ...
  private class UpdateLastPriceProcedure
    ...
    implements RowMapper
  {
    ...
    private Commodity rsToCommodity(ResultSet paramResultSet)
      throws SQLException
    {
      Commodity localCommodity = new Commodity();
  ...
  private class CommodityStoredProcedure
    extends StoredProcedure
  {
