...
public class MarketDAOJdbc extends BaseDAOJdbc implements MarketDAO {
	...
	public void insertMarket(Market market) {
		...
		Object[] params = { market.getMarginFBFlag(), market.getShortName(), market.getFloatingLossComputeType(), market.getRunMode(),
				market.getSettleMode(), market.getTradePriceAlgr(), market.getFloatingProfitSubTax(), market.getGageMode(), market.getTradeTimeType(),
				market.getDelayQuoShowType(), market.getNeutralFeeWay(), market.getAsMarginType(), market.getDelayOrderIsPure(),
				market.getChargeDelayFeeType(), market.getIsCPriceCpFloatingLoss() };
	...
	public void updateMarket(Market market) {
		...
		Object[] params = {
				...
				market.getTradePriceAlgr(), market.getFloatingProfitSubTax(), market.getGageMode(), market.getTradeTimeType(),
				market.getDelayQuoShowType(), market.getNeutralFeeWay(), market.getAsMarginType(), market.getDelayOrderIsPure(),
				market.getChargeDelayFeeType(), market.getIsCPriceCpFloatingLoss(), market.getMarketCode() };
	...
	public void updateMarketEndTime(Market market) {
		...
		Object[] params = { market.getUpToTime(), market.getIssueDate(), market.getVerifyStr(), market.getTraderId(), market.getMarketCode() };
	...
	public void updateTradePassword(String oldPwd, String newPwd, String marketCode, String type) {
		...
		Object[] params = { StringUtil.encodeString(newPwd), marketCode };
	...
	class MarketRowMapper implements RowMapper {
		MarketRowMapper() {
		}
		...
		private Market rsToMarket(ResultSet rs) throws SQLException {
			Market m = new Market();
