...
public class BroadcastCacheService {
	...
	private void processModifiedBroadcast(List paramList1, List paramList2) {
		...
		for (int i = 0; i < paramList2.size() - 1; i++) {
	...
	private StringBuffer buildBroadcastXmlString(Broadcast paramBroadcast) {
		...
		localStringBuffer.append("<I>").append("<ID>").append(paramBroadcast.getId()).append("</ID>").append("<Title>")
				.append(paramBroadcast.getTitle()).append("</Title>").append("<Author>").append(paramBroadcast.getAuthor()).append("</Author>")
				.append("<Type>").append(paramBroadcast.getType()).append("</Type>").append("</I>");
	...
	private String buildReturnXml(BroadcastPack paramBroadcastPack, Timestamp paramTimestamp) {
		...
		for (int i = localList.size() - 1; i >= 0; i--) {
			Broadcast localObject = (Broadcast) localList.get(i);
