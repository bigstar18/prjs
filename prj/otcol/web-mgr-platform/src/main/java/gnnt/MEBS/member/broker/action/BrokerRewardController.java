...
public class BrokerRewardController
  extends BaseController
{
  private final transient Log logger = LogFactory.getLog(BrokerRewardController.class);
  
  public ModelAndView brokerRewardList(HttpServletRequest paramHttpServletRequest, HttpServletResponse paramHttpServletResponse)
    throws Exception
  {
    ...
    {
      localObject = localBrokerRewardService.getBrokerRewardList(localQueryConditions, localPageInfo);
    ...
    {
      localObject = localBrokerRewardService.getBrokerRewardList(localQueryConditions, null);
      localModelAndView = new ModelAndView("member/broker/brokerReward/brokerRewardExcel", "resultList", localObject);
    }
    ...
    throws Exception
  {
    ...
    ModelAndView localModelAndView = new ModelAndView("member/broker/brokerRewardProps/brokerRewardPropsUpdate", "brokerReward", localBrokerRewardProps);
    ...
    throws Exception
  {
    ...
    ModelAndView localModelAndView = new ModelAndView("member/broker/brokerRewardProps/brokerRewardPropsAdd", "brokerReward", localBrokerRewardProps);
    ...
    throws Exception
  {
    ...
    Object localObject = new ModelAndView("member/broker/brokerRewardProps/brokerRewardPropsList");
    ...
    throws Exception
  {
    ...
    List localList1 = localBrokerRewardPropsService.getTbBreeds();
    List localList2 = localBrokerRewardPropsService.getZcjsBreeds();
    ModelAndView localModelAndView = new ModelAndView("member/broker/brokerRewardProps/brokerRewardPropsUpdateOther", "brokerRewardProps", localBrokerRewardProps);
    localModelAndView.addObject("resultList1", localList1);
    localModelAndView.addObject("resultList2", localList2);
    return localModelAndView;
  }
  ...
  public ModelAndView brokerRewardPropsAllAddByModuleForward(HttpServletRequest paramHttpServletRequest, HttpServletResponse paramHttpServletResponse)
    throws Exception
  {
    ...
    ModelAndView localModelAndView = new ModelAndView("member/broker/brokerRewardProps/brokerRewardPropsAllAdd", "brokerReward", localBrokerRewardProps);
    ...
    throws Exception
  {
    ...
    try
    {
      ...
      if (str1.equals("4"))
      {
        ...
        {
          BrokerRewardProps localBrokerRewardProps2 = localBrokerRewardPropsService.getBrokerRewardProps(localBrokerRewardProps1.getBreedId(), localObject[i], str1);
      ...
      else
      {
        ...
        {
          localObject = paramHttpServletRequest.getParameter("breedId");
          localBrokerRewardProps1.setBreedId((String)localObject);
          arrayOfString = str2.split(",");
          for (j = 0; j < arrayOfString.length; j++)
          {
            BrokerRewardProps localBrokerRewardProps3 = localBrokerRewardPropsService.getBrokerRewardProps((String)localObject, arrayOfString[j], str1);
        ...
        else if (str3.equals("true"))
        {
          ...
          if (str1.equals("2"))
          {
            localObject = localBrokerRewardPropsService.getTbBreeds();
            arrayOfString = str2.split(",");
            for (j = 0; j < arrayOfString.length; j++)
            {
              localBrokerRewardProps1.setBrokerId(arrayOfString[j]);
          ...
          {
            localObject = localBrokerRewardPropsService.getZcjsBreeds();
            arrayOfString = str2.split(",");
            for (j = 0; j < arrayOfString.length; j++)
            {
              localBrokerRewardProps1.setBrokerId(arrayOfString[j]);
    ...
    throws Exception
  {
    ...
    ModelAndView localModelAndView = new ModelAndView("member/broker/brokerRewardProps/brokerRewardPropsBreedAdd", "brokerReward", localBrokerRewardProps);
    ...
    throws Exception
  {
    ...
    ModelAndView localModelAndView = new ModelAndView("member/broker/brokerRewardProps/brokerRewardPropsBreedUpdate", "brokerRewardProps", localList.get(0));
    return localModelAndView;
  }
