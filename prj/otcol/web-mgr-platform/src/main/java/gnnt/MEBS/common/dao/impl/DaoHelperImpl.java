  ...
  extends HibernateDaoSupport
{
  public List queryBySQL(String paramString, String[] paramArrayOfString, Object[] paramArrayOfObject, PageInfo paramPageInfo)
  {
    ...
    if (paramPageInfo != null)
    {
      ...
      k = paramPageInfo.getPageSize() > 0 ? 1 : 0;
  ...
  public List findAll(final int paramInt1, final int paramInt2, final String paramString, final String[] paramArrayOfString, final Object[] paramArrayOfObject)
  {
