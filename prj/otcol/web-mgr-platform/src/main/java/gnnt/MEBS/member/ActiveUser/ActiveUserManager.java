...
public class ActiveUserManager
{
  ...
  public long logon(String paramString1, String paramString2, Long paramLong)
  {
    ...
    if (!activeStore.containsKey(paramLong))
    {
      l = paramLong.longValue();
    }
    else
    {
      if (paramString1.equals(activeStore.get(paramLong))) {
  ...
  public String[] getAllUsersSys(String paramString)
  {
    SimpleDateFormat localSimpleDateFormat = new SimpleDateFormat("yyyy-MM-dd HH:mm:ss");
    Enumeration localEnumeration = activeStore.elements();
    Vector localVector = new Vector();
    ...
    {
      localAUValue = (AUValue)localEnumeration.nextElement();
      if ((paramString == null) || ("".equals(paramString)) || (localAUValue.getUserName().equals(paramString)))
      {
        localStringBuffer = new StringBuffer(localAUValue.getUserName());
        localStringBuffer.append(",");
        localStringBuffer.append(localSimpleDateFormat.format(localAUValue.getLogonTime()));
        ...
        localStringBuffer.append(localAUValue.getIP());
        localStringBuffer.append(",");
        localStringBuffer.append(localAUValue.getSessionId());
        localVector.addElement(localStringBuffer.toString());
      }
    }
    String[] arrayOfString = new String[localVector.size()];
