...
public class MoneyDoDao
  extends DaoHelperImpl
{
  public List getFundflowList(String paramString, long paramLong)
  {
    String str = "select fundflowid,firmid,oprcode,amount from (select * from  (select t.fundflowid,t.firmid,t.oprcode,t.amount from f_fundflow t where t.contractno='" + paramString + "') " + "union " + "(select t.fundflowid,t.firmid,t.oprcode,t.amount from f_h_fundflow t where t.contractno='" + paramString + "')) where fundflowid>" + paramLong + " " + "order by fundflowid";
  ...
  private class UpdateFundsFullProcedure
    extends StoredProcedure
  {
  ...
  private class UpdateSettleMarginProcedure
    extends StoredProcedure
  {
