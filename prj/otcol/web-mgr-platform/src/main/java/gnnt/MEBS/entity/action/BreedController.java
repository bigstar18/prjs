...
public class BreedController extends BaseController {
	...
	public ModelAndView getBreedList(HttpServletRequest paramHttpServletRequest, HttpServletResponse paramHttpServletResponse) throws Exception {
	...
	public ModelAndView breedAddForward(HttpServletRequest paramHttpServletRequest, HttpServletResponse paramHttpServletResponse) throws Exception {
	...
	public ModelAndView breedAdd(HttpServletRequest paramHttpServletRequest, HttpServletResponse paramHttpServletResponse) throws Exception {
		...
		if ((localList != null) && (localList.size() > 0)) {
			...
			for (int i = 0; i < localList.size(); i++) {
				KeyValue localObject1 = new KeyValue();
		...
		String[] localObject1 = paramHttpServletRequest.getParameterValues("quality");
	...
	public ModelAndView breedModForward(HttpServletRequest paramHttpServletRequest, HttpServletResponse paramHttpServletResponse) throws Exception {
	...
	public ModelAndView breedMod(HttpServletRequest paramHttpServletRequest, HttpServletResponse paramHttpServletResponse) throws Exception {
		this.logger.debug("enter breedAdd========");
		String str = "";
		Breed localBreed = new Breed();
		ParamUtil.bindData(paramHttpServletRequest, localBreed);
		...
		try {
			...
			if (k == -1) {
				...
				localModelAndView = new ModelAndView(
						"redirect:" + Condition.PATH + "breedController.entity?funcflg=breedModForward&breedId=" + localBreed.getBreedId());
			} else {
				str = "修改成功";
				localModelAndView = new ModelAndView("redirect:" + Condition.PATH + "breedController.entity?funcflg=getBreedList");
			}
	...
	public ModelAndView delete(HttpServletRequest paramHttpServletRequest, HttpServletResponse paramHttpServletResponse) throws Exception {
	...
	public ModelAndView synch(HttpServletRequest paramHttpServletRequest, HttpServletResponse paramHttpServletResponse) throws Exception {
