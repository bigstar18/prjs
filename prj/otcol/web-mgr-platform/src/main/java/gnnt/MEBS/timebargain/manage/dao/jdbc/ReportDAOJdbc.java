  ...
  implements ReportDAO
{
  ...
  {
    StringBuffer localStringBuffer = new StringBuffer("select a.CustomerID,a.Balance,b.CustomerName from T_H_firmFunds a,T_Customer b where a.CustomerID=b.CustomerID and a.ClearDate=trunc(sysdate) ");
  ...
  public List getHisOrders(QueryConditions paramQueryConditions)
  {
    ...
    localStringBuffer.append("select sysdate,a.A_OrderNo,a.FirmID,a.Price,a.Quantity,a.OrderTime,a.WithdrawTime,a.BS_Flag,a.OrderType,case when a.BS_Flag=1 then '买' when a.BS_Flag=2 then '卖' else '' end as sBS_Flag,").append("case when a.OrderType=1 then '订立' when a.OrderType=2 then '转让' when a.OrderType=3 then '强转' when a.OrderType=4 then '撤单' else '' end as sOrderType,").append("m.Name firmName,a.commodityid from T_H_Orders a, M_firm m ").append("where a.firmID = m.firmID ");
    Object[] arrayOfObject = null;
    if ((paramQueryConditions != null) && (paramQueryConditions.getFieldsSqlClause() != null))
    {
      arrayOfObject = paramQueryConditions.getValueArray();
  ...
  public Map getAccountUpdate(QueryConditions paramQueryConditions)
  {
    ...
    if ((localList != null) && (localList.size() > 0))
    {
      ...
      localHashMap.put("mjzyzj", new Double(Arith.add(((BigDecimal)localMap3.get("mjbzj")).doubleValue(), ((BigDecimal)localMap3.get("mjfk")).doubleValue())));
    }
    ...
    if ((localList != null) && (localList.size() > 0))
    {
      ...
      localHashMap.put("mczyzj", new Double(Arith.add(((BigDecimal)localMap4.get("mcbzj")).doubleValue(), ((BigDecimal)localMap4.get("mcfk")).doubleValue())));
    }
  ...
  public Map getAccountUpdate(QueryConditions paramQueryConditions, String paramString)
  {
    ...
    if ((localList1 != null) && (localList1.size() > 0))
    {
      localObject1 = (Map)localList1.get(0);
    ...
    if ((localList1 != null) && (localList1.size() > 0))
    {
      localObject2 = (Map)localList1.get(0);
  ...
  {
    StringBuffer localStringBuffer = new StringBuffer();
    localStringBuffer.append("select a.BuyQuantity,a.BuyEvenPrice,b.SellQuantity,b.SellEvenPrice,a.Commodityid  from ").append("(select ClearDate,Commodityid,nvl(sum(Quantity),0) BuyQuantity, nvl(sum(Price * Quantity) / sum(Quantity),0) BuyEvenPrice from T_H_Trade where BS_Flag = 1 and Quantity <> 0 group by ClearDate,Commodityid) a,").append("(select ClearDate,Commodityid,nvl(sum(Quantity),0) SellQuantity, nvl(sum(Price * Quantity) / sum(Quantity),0) SellEvenPrice from T_H_Trade where BS_Flag = 2 and Quantity <> 0 group by ClearDate,Commodityid) b,").append("(select distinct ClearDate,Commodityid from T_H_Trade  group by ClearDate,Commodityid) e ").append("where e.ClearDate=a.ClearDate(+) and e.ClearDate=b.ClearDate(+) and e.Commodityid=a.Commodityid(+) and e.Commodityid=b.Commodityid(+) ");
    Object[] arrayOfObject = null;
    if ((paramQueryConditions != null) && (paramQueryConditions.getFieldsSqlClause() != null))
    {
      arrayOfObject = paramQueryConditions.getValueArray();
  ...
  {
    StringBuffer localStringBuffer = new StringBuffer();
    localStringBuffer.append("select a.CustomerID,max(b.CustomerName) CustomerName,sum(a.TradeFee) TradeFee,sysdate ").append("from T_H_Trade a,T_Customer b where a.CustomerID = b.CustomerID ");
    Object[] arrayOfObject = null;
    if ((paramQueryConditions != null) && (paramQueryConditions.getFieldsSqlClause() != null))
    {
      arrayOfObject = paramQueryConditions.getValueArray();
  ...
  {
    StringBuffer localStringBuffer = new StringBuffer();
    localStringBuffer.append("select a.FirmID,max(c.Name) FirmName,sum(a.TradeFee) TradeFee,sysdate ").append("from T_H_Trade a,M_firm c where a.firmID = c.firmID ");
    Object[] arrayOfObject = null;
    if ((paramQueryConditions != null) && (paramQueryConditions.getFieldsSqlClause() != null))
    {
      arrayOfObject = paramQueryConditions.getValueArray();
  ...
  {
    StringBuffer localStringBuffer = new StringBuffer();
    localStringBuffer.append("select distinct(a.commodityId) commodityId,d.BuyQuantity,d.BuyEvenPrice,b.SellQuantity,b.SellEvenPrice from ").append("(select ClearDate,commodityId,nvl(sum(HoldQty),0) BuyQuantity, nvl(sum(EvenPrice * HoldQty) / sum(HoldQty),0) BuyEvenPrice from T_H_FirmHoldSum where BS_Flag = 1 and HoldQty <> 0 group by ClearDate,commodityId) d,").append("(select ClearDate,commodityId,nvl(sum(HoldQty),0) SellQuantity, nvl(sum(EvenPrice * HoldQty) / sum(HoldQty),0) SellEvenPrice from T_H_FirmHoldSum where BS_Flag = 2 and HoldQty <> 0 group by ClearDate,commodityId) b,").append("T_H_FirmHoldSum a ").append("where a.ClearDate=d.ClearDate(+) and a.ClearDate=b.ClearDate(+) ").append(" and a.commodityId=d.commodityId(+) and a.commodityId=b.commodityId(+) ");
  ...
  public List getReportByTypeView(QueryConditions paramQueryConditions, String paramString1, String paramString2)
  {
    ...
    localStringBuffer.append("select FirmID,max(FirmName) FirmName,sum(Balance),sum(InitFunds),sum(InFunds),sum(OutFunds),sum(Close_PL),sum(ClearFL+ClearMargin),sum(RuntimeMargin+RuntimeFL),sum(TradeFee) from t_bal_firmfundsview a ");
  ...
  public List getReportByTypeTrade(QueryConditions paramQueryConditions, String paramString1, String paramString2)
  {
    ...
    localObject = getJdbcTemplate().queryForList(localStringBuffer.toString(), arrayOfObject);
    return localObject;
  }
  ...
  public List getReportByTypeHold(QueryConditions paramQueryConditions, String paramString1, String paramString2)
  {
    ...
    String str5 = null;
    localStringBuffer = new StringBuffer();
    localStringBuffer.append("select  a.CommodityID,case when a.BS_Flag=1 then '买' when a.BS_Flag=2 then '卖' else '' end BS_Flag,a.EvenPrice,b.Price,a.HoldQty,").append("nvl((a.HoldMargin+(case when a.FloatingLoss>=0 then 0 else -a.FloatingLoss end)),0) ShouldFee,f.BreedName ").append("from T_H_FirmHoldSum a,T_H_Quotation b,T_Commodity d,T_A_breed f ").append("where  a.CommodityID = b.CommodityID and a.ClearDate = b.ClearDate and a.CommodityID=d.CommodityID and d.BreedID=f.BreedID ").append("and a.FirmID = ? ");
    if ((paramString1 == null) || (paramString1.equals("")))
    {
      arrayOfObject = new Object[] { paramString2 };
    }
    ...
    else if (paramString1.equals("week"))
    {
      str4 = DateUtil.getFirstWeekDay(localDate);
      str5 = DateUtil.getLastWeekDay(localDate);
      localStringBuffer.append("and to_char(a.ClearDate,'yyyyMMdd') in (select max(to_char(ClearDate,'yyyyMMdd')) from T_H_FirmHoldSum where ClearDate >= to_date(?, 'yyyy-MM-dd') and ClearDate <= to_date(?, 'yyyy-MM-dd')) ");
      arrayOfObject = new Object[] { paramString2, str4, str5 };
    }
    else if (paramString1.equals("month"))
    {
      str4 = DateUtil.formatDate(localDate, "yyyy-MM");
      localStringBuffer.append("and to_char(a.ClearDate,'yyyyMMdd') in (select max(to_char(ClearDate,'yyyyMMdd')) from T_H_FirmHoldSum where to_char(ClearDate,'yyyy-MM')=?)  ");
      arrayOfObject = new Object[] { paramString2, str4 };
    }
  ...
  public List getReportByTypeMoney(QueryConditions paramQueryConditions, String paramString1, String paramString2)
  {
    ...
    localStringBuffer2.append("select sum(InFunds) InFunds,sum(OutFunds) OutFunds,sum(Close_PL) Close_PL,sum(TradeFee) TradeFee from T_bal_firmfundsview a ");
    localStringBuffer2.append("where a.FirmID = ? ");
    StringBuffer localStringBuffer3 = new StringBuffer();
    localStringBuffer3.append("select Balance,RuntimeFL+RuntimeMargin a2,RuntimeAssure,SettleMargin,SettleFee,Settle_PL,Sales,ClearSettleMargin,RuntimeSettleMargin,FirmRights,OtherItem from T_bal_firmfundsview a ");
    ...
    else if (paramString1.equals("week"))
    {
      str4 = DateUtil.getFirstWeekDay(localDate);
      str5 = DateUtil.getLastWeekDay(localDate);
      localStringBuffer1.append("and to_char(a.ClearDate,'yyyyMMdd') in (select min(to_char(ClearDate,'yyyyMMdd')) from T_bal_firmfundsview where ClearDate >= to_date(?, 'yyyy-MM-dd') and ClearDate <= to_date(?, 'yyyy-MM-dd')) ");
      localStringBuffer2.append("and a.ClearDate >= to_date(?, 'yyyy-MM-dd') and a.ClearDate <= to_date(?, 'yyyy-MM-dd') ");
      localStringBuffer3.append("and to_char(a.ClearDate,'yyyyMMdd') in (select max(to_char(ClearDate,'yyyyMMdd')) from T_bal_firmfundsview where ClearDate >= to_date(?, 'yyyy-MM-dd') and ClearDate <= to_date(?, 'yyyy-MM-dd')) ");
      arrayOfObject = new Object[] { paramString2, str4, str5 };
    }
    else if (paramString1.equals("month"))
    {
      str4 = DateUtil.formatDate(localDate, "yyyy-MM");
      localStringBuffer1.append("and to_char(a.ClearDate,'yyyyMMdd') in (select min(to_char(ClearDate,'yyyyMMdd')) from T_bal_firmfundsview where to_char(ClearDate,'yyyy-MM')=?)  ");
      localStringBuffer2.append("and to_char(ClearDate,'yyyy-MM')=?  ");
      localStringBuffer3.append("and to_char(a.ClearDate,'yyyyMMdd') in (select max(to_char(ClearDate,'yyyyMMdd')) from T_bal_firmfundsview where to_char(ClearDate,'yyyy-MM')=?)  ");
      arrayOfObject = new Object[] { paramString2, str4 };
    }
    ...
    {
      localHashMap.put("InitFund", (BigDecimal)((Map)((List)localObject1).get(0)).get("InitFunds") != null ? (BigDecimal)((Map)((List)localObject1).get(0)).get("InitFunds") : new BigDecimal("0.00"));
      localHashMap.put("ClearFee", (BigDecimal)((Map)((List)localObject1).get(0)).get("a1") != null ? (BigDecimal)((Map)((List)localObject1).get(0)).get("a1") : new BigDecimal("0.00"));
      localHashMap.put("ClearAssure", (BigDecimal)((Map)((List)localObject1).get(0)).get("ClearAssure") != null ? (BigDecimal)((Map)((List)localObject1).get(0)).get("ClearAssure") : new BigDecimal("0.00"));
    }
    else
    {
    ...
    {
      localHashMap.put("InFund", (BigDecimal)((Map)((List)localObject2).get(0)).get("InFunds") != null ? (BigDecimal)((Map)((List)localObject2).get(0)).get("InFunds") : new BigDecimal("0.00"));
      localHashMap.put("OutFund", (BigDecimal)((Map)((List)localObject2).get(0)).get("OutFunds") != null ? (BigDecimal)((Map)((List)localObject2).get(0)).get("OutFunds") : new BigDecimal("0.00"));
      localHashMap.put("Close_PL", (BigDecimal)((Map)((List)localObject2).get(0)).get("Close_PL") != null ? (BigDecimal)((Map)((List)localObject2).get(0)).get("Close_PL") : new BigDecimal("0.00"));
      localHashMap.put("TradeFee", (BigDecimal)((Map)((List)localObject2).get(0)).get("TradeFee") != null ? (BigDecimal)((Map)((List)localObject2).get(0)).get("TradeFee") : new BigDecimal("0.00"));
    }
    else
    {
    ...
    {
      localHashMap.put("RuntimeFee", (BigDecimal)((Map)((List)localObject3).get(0)).get("a2") != null ? (BigDecimal)((Map)((List)localObject3).get(0)).get("a2") : new BigDecimal("0.00"));
      localHashMap.put("LastFund", (BigDecimal)((Map)((List)localObject3).get(0)).get("Balance") != null ? (BigDecimal)((Map)((List)localObject3).get(0)).get("Balance") : new BigDecimal("0.00"));
      localHashMap.put("RuntimeAssure", (BigDecimal)((Map)((List)localObject3).get(0)).get("RuntimeAssure") != null ? (BigDecimal)((Map)((List)localObject3).get(0)).get("RuntimeAssure") : new BigDecimal("0.00"));
      localHashMap.put("SettleMargin", (BigDecimal)((Map)((List)localObject3).get(0)).get("SettleMargin") != null ? (BigDecimal)((Map)((List)localObject3).get(0)).get("SettleMargin") : new BigDecimal("0.00"));
      localHashMap.put("SettleFee", (BigDecimal)((Map)((List)localObject3).get(0)).get("SettleFee") != null ? (BigDecimal)((Map)((List)localObject3).get(0)).get("SettleFee") : new BigDecimal("0.00"));
      localHashMap.put("Settle_PL", (BigDecimal)((Map)((List)localObject3).get(0)).get("Settle_PL") != null ? (BigDecimal)((Map)((List)localObject3).get(0)).get("Settle_PL") : new BigDecimal("0.00"));
      localHashMap.put("Sales", (BigDecimal)((Map)((List)localObject3).get(0)).get("Sales") != null ? (BigDecimal)((Map)((List)localObject3).get(0)).get("Sales") : new BigDecimal("0.00"));
      localHashMap.put("ClearSettleMargin", (BigDecimal)((Map)((List)localObject3).get(0)).get("ClearSettleMargin") != null ? (BigDecimal)((Map)((List)localObject3).get(0)).get("ClearSettleMargin") : new BigDecimal("0.00"));
      localHashMap.put("RuntimeSettleMargin", (BigDecimal)((Map)((List)localObject3).get(0)).get("RuntimeSettleMargin") != null ? (BigDecimal)((Map)((List)localObject3).get(0)).get("RuntimeSettleMargin") : new BigDecimal("0.00"));
      localHashMap.put("FirmRights", (BigDecimal)((Map)((List)localObject3).get(0)).get("FirmRights") != null ? (BigDecimal)((Map)((List)localObject3).get(0)).get("FirmRights") : new BigDecimal("0.00"));
      localHashMap.put("OtherItem", (BigDecimal)((Map)((List)localObject3).get(0)).get("OtherItem") != null ? (BigDecimal)((Map)((List)localObject3).get(0)).get("OtherItem") : new BigDecimal("0.00"));
    }
    else
    {
  ...
  {
    StringBuffer localStringBuffer = new StringBuffer();
    localStringBuffer.append("select sysdate,a.FirmID,a.BS_Flag,a.price,a.holdQty,").append("case when a.BS_Flag=1 then '买' when a.BS_Flag=2 then '卖' else '' end as sBS_Flag,").append("abs(a.FloatingLoss) as loss,a.CommodityId  ").append("from ").append("T_H_HoldPosition a ");
  ...
  {
    StringBuffer localStringBuffer = new StringBuffer("");
    localStringBuffer.append("select a.*, ").append("(case when a.BS_Flag=1 then '买进' when a.BS_Flag=2 then '卖出' else '' end) || ").append(" (case when a.OrderType=1 then '订立' when a.OrderType=2 then '转让' else '' end) BSOrderType ").append("from T_H_Trade a ").append(" ");
    Object[] arrayOfObject = null;
    if ((paramQueryConditions != null) && (paramQueryConditions.getFieldsSqlClause() != null))
    {
      arrayOfObject = paramQueryConditions.getValueArray();
  ...
  {
    StringBuffer localStringBuffer = new StringBuffer("");
    localStringBuffer.append("select a.*,b.OrderTime, ").append("(case when a.BS_Flag=1 then '买进' when a.BS_Flag=2 then '卖出' else '' end) || ").append(" (case when a.OrderType=1 then '订立' when a.OrderType=2 then '转让' else '' end) BSOrderType ").append("from T_H_Trade a,T_H_Orders b ").append("where a.ClearDate = b.ClearDate and a.A_OrderNo = b.A_OrderNo  ");
    Object[] arrayOfObject = null;
    if ((paramQueryConditions != null) && (paramQueryConditions.getFieldsSqlClause() != null))
    {
      arrayOfObject = paramQueryConditions.getValueArray();
  ...
  {
    StringBuffer localStringBuffer = new StringBuffer("");
    localStringBuffer.append("select a.*,b.TradeFee,b.Close_PL ,c.MinClearDeposit,").append("(case when (c.MinClearDeposit-c.Balance) > 0 then (c.MinClearDeposit-c.Balance) else 0 end) shouldAddFund ").append("from F_H_firmfunds a,T_FundTradePropsView c, ").append("(select ClearDate,CustomerID,sum(TradeFee) TradeFee,sum(Close_PL) Close_PL from T_h_trade group by ClearDate,CustomerID) b ").append("where a.ClearDate = b.ClearDate(+) and a.CustomerID=b.CustomerID(+) and a.CustomerID=c.CustomerID(+) ");
    Object[] arrayOfObject = null;
    if ((paramQueryConditions != null) && (paramQueryConditions.getFieldsSqlClause() != null))
    {
      arrayOfObject = paramQueryConditions.getValueArray();
  ...
  {
    StringBuffer localStringBuffer = new StringBuffer();
    localStringBuffer.append("select a.ClearDate,a.CustomerID,a.Balance,a.RuntimeMargin,nvl((case when b.floatProfit< 0 then 0 else b.floatProfit end),0) floatProfit,(a.Balance+a.RuntimeMargin-a.RuntimeAssure+nvl((case when b.floatProfit< 0 then 0 else b.floatProfit end),0)) allFunds,a.CustomerName  ").append("from T_Bal_CustomerFundsView a, ").append("(select a.cleardate,a.customerid,nvl(sum(a.FloatingLoss),0) floatProfit from T_H_CustomerHoldSum a group by a.cleardate, a.customerid) b  ").append("where a.ClearDate = b.ClearDate(+) and a.CustomerID=b.CustomerID(+)  ");
    Object[] arrayOfObject = null;
    if ((paramQueryConditions != null) && (paramQueryConditions.getFieldsSqlClause() != null))
    {
      arrayOfObject = paramQueryConditions.getValueArray();
    ...
    localStringBuffer.append(" order by (a.Balance+a.RuntimeMargin-a.RuntimeAssure+nvl((case when b.floatProfit< 0 then 0 else b.floatProfit end),0)) desc ");
    this.log.debug("sql: " + localStringBuffer.toString());
    if (arrayOfObject != null) {
      for (int i = 0; i < arrayOfObject.length; i++) {
        this.log.debug("params[" + i + "]: " + arrayOfObject[i]);
  ...
  public List getWeek1Detail(QueryConditions paramQueryConditions, String paramString)
  {
    ...
    StringBuffer localStringBuffer2 = new StringBuffer();
    StringBuffer localStringBuffer3 = new StringBuffer();
    localStringBuffer1.append("select FirmID,FirmName,InitFunds,ClearMargin+ClearFL a1,ClearAssure,SettleMargin,SettleFee,Settle_PL  from T_bal_firmfundsview a ");
    localStringBuffer2.append("select FirmID,sum(InFunds) InFunds,sum(OutFunds) OutFunds,sum(Close_PL) Close_PL,sum(TradeFee) TradeFee from T_bal_firmfundsview a ");
    ...
    if ((paramString != null) && (!paramString.equals(""))) {
      ...
      else if (paramString.equals("week"))
      {
        ...
        localStringBuffer1.append("where to_char(a.ClearDate,'yyyyMMdd') in (select min(to_char(ClearDate,'yyyyMMdd')) from T_bal_firmfundsview where ClearDate >= to_date('" + str1 + "', 'yyyy-MM-dd') and ClearDate <= to_date('" + str2 + "', 'yyyy-MM-dd')) ");
        localStringBuffer2.append("where a.ClearDate >= to_date('" + str1 + "', 'yyyy-MM-dd') and a.ClearDate <= to_date('" + str2 + "', 'yyyy-MM-dd') group by a.FirmID");
        localStringBuffer3.append("where to_char(a.ClearDate,'yyyyMMdd') in (select max(to_char(ClearDate,'yyyyMMdd')) from T_bal_firmfundsview where ClearDate >= to_date('" + str1 + "', 'yyyy-MM-dd') and ClearDate <= to_date('" + str2 + "', 'yyyy-MM-dd')) ");
      }
      else if (paramString.equals("month"))
      {
        str1 = DateUtil.formatDate(localDate, "yyyy-MM");
        localStringBuffer1.append("where to_char(a.ClearDate,'yyyyMMdd') in (select min(to_char(ClearDate,'yyyyMMdd')) from T_bal_firmfundsview where to_char(ClearDate,'yyyy-MM')='" + str1 + "') ");
        localStringBuffer2.append("where to_char(ClearDate,'yyyy-MM')='" + str1 + "' group by a.FirmID ");
        localStringBuffer3.append("where to_char(a.ClearDate,'yyyyMMdd') in (select max(to_char(ClearDate,'yyyyMMdd')) from T_bal_firmfundsview where to_char(ClearDate,'yyyy-MM')='" + str1 + "')  ");
      }
    }
    String str3 = "select b.FirmID,b.FirmName,nvl(b.SettleMargin,0) SettleMargin,nvl(b.SettleFee,0) SettleFee,nvl(b.Settle_PL,0) Settle_PL,nvl(b.InitFunds,0) InitFunds,nvl(b.a1,0) ClearFee,nvl(b.ClearAssure,0) ClearAssure,nvl(c.InFunds,0) InFunds,nvl(c.OutFunds,0) OutFunds,nvl(c.Close_PL,0) Close_PL,nvl(c.TradeFee,0) TradeFee,nvl(d.Balance,0) LastFund,nvl(d.a2,0) RuntimeFee,nvl(d.RuntimeAssure,0) RuntimeAssure from (" + localStringBuffer1.toString() + ") b,(" + localStringBuffer2.toString() + ") c," + "(" + localStringBuffer3.toString() + ") d where b.FirmID=c.FirmID and c.FirmID=d.FirmID  ";
   ...
   * @deprecated
   */
  private class ComputeFundStoredProcedure
