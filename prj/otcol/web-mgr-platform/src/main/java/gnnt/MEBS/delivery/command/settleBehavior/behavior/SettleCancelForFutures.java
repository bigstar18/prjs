...
public class SettleCancelForFutures
  implements Behaviour
{
  private final transient Log logger = LogFactory.getLog(SettleCancelForFutures.class);
  @Autowired
  ...
  public void deal(SettleObject paramSettleObject)
  {
    ...
    this.settleMatchService.cancelT_SettleMatch(str);
  }
}
