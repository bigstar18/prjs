  ...
  implements TraderDAO
{
  ...
  {
    StringBuffer localStringBuffer = new StringBuffer();
    localStringBuffer.append("select GatherBid,BidStartTime,BidEndTime,sectionID,Name,StartTime,EndTime,ModifyTime, status ,case when status in(0,1) then case when status=1 then '正常' when status=0 then '无效' else '' end else '' end as status from T_A_TradeTime");
    ArrayList localArrayList = new ArrayList();
  ...
  public void insertTrader(Trader paramTrader)
  {
    ...
    Object[] arrayOfObject = { paramTrader.getTraderID(), paramTrader.getName(), paramTrader.getPassword(), paramTrader.getStatus(), paramTrader.getFirmID(), paramTrader.getOperateCode() == null ? "" : paramTrader.getOperateCode(), paramTrader.getRegWord() == null ? "" : paramTrader.getRegWord(), paramTrader.getKeyCode(), paramTrader.getKeyStatus() };
    this.log.debug("sql: " + str);
    for (int i = 0; i < arrayOfObject.length; i++) {
      this.log.debug("params[" + i + "]: " + arrayOfObject[i]);
    }
  ...
  public void insertTradeTime(TradeTime paramTradeTime)
  {
    ...
    Object[] arrayOfObject = { paramTradeTime.getSectionID(), paramTradeTime.getName(), paramTradeTime.getStartTime(), paramTradeTime.getEndTime(), paramTradeTime.getStatus(), paramTradeTime.getGatherBid(), paramTradeTime.getBidStartTime() == null ? "" : paramTradeTime.getBidStartTime(), paramTradeTime.getBidEndTime() == null ? "" : paramTradeTime.getBidEndTime() };
    this.log.debug("sql: " + str);
    for (int i = 0; i < arrayOfObject.length; i++) {
      this.log.debug("params[" + i + "]: " + arrayOfObject[i]);
    }
  ...
  public void updateTradeTime(TradeTime paramTradeTime)
  {
    ...
    Object[] arrayOfObject = { paramTradeTime.getName(), paramTradeTime.getStartTime(), paramTradeTime.getEndTime(), paramTradeTime.getStatus(), paramTradeTime.getGatherBid(), paramTradeTime.getBidStartTime() == null ? "" : paramTradeTime.getBidStartTime(), paramTradeTime.getBidEndTime() == null ? "" : paramTradeTime.getBidEndTime(), paramTradeTime.getSectionID() };
    this.log.debug("sql: " + str);
    for (int i = 0; i < arrayOfObject.length; i++) {
      this.log.debug("params[" + i + "]: " + arrayOfObject[i]);
    }
  ...
  public void updateTrader(Trader paramTrader)
  {
    ...
    Object[] arrayOfObject = { paramTrader.getName(), paramTrader.getStatus(), paramTrader.getKeyCode(), paramTrader.getKeyStatus(), paramTrader.getTraderID() };
    this.log.debug("sql: " + str);
    for (int i = 0; i < arrayOfObject.length; i++) {
      this.log.debug("params[" + i + "]: " + arrayOfObject[i]);
    }
  ...
  public void updateConsignerPassword(String paramString1, String paramString2, String paramString3)
  {
    ...
    if ((paramString1 != null) && (!"".equals(paramString1)) && ((str2 == null) || (!str2.equals(StringUtil.encodePassword(paramString1, "MD5"))))) {
  ...
  public void insertConsigner(Consigner paramConsigner)
  {
    ...
    Object[] arrayOfObject = { paramConsigner.getConsignerID(), paramConsigner.getName(), str1, paramConsigner.getStatus(), "", paramConsigner.getType() };
  ...
  public void insertNotTradeDay(TradeTime paramTradeTime)
  {
    ...
    {
      str1 = "update T_A_DaySection set Status = 0";
  ...
  public void insertNewTraderPrivilege(Trader paramTrader)
  {
    ...
    Object[] arrayOfObject = { paramTrader.getTypeID(), paramTrader.getKindID(), paramTrader.getPrivilegeCode_B(), paramTrader.getPrivilegeCode_S() };
    this.log.debug("sql: " + str);
    for (int i = 0; i < arrayOfObject.length; i++) {
      this.log.debug("params[" + i + "]: " + arrayOfObject[i]);
    }
  ...
  class TraderPrivilegeMapRowMapper
    implements RowMapper
  {
    ...
    private Trader rsToFirmPrivilegeMap(ResultSet paramResultSet)
      throws SQLException
    {
    ...
    implements RowMapper
  {
    ...
    private TradeTime rsToTradeTime(ResultSet paramResultSet)
      throws SQLException
    {
    ...
    implements RowMapper
  {
    ...
    private Consigner rsToTradeTime(ResultSet paramResultSet)
      throws SQLException
    {
