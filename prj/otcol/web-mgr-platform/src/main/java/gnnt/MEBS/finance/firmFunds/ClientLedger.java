...
public class ClientLedger
{
  ...
  public static Map queryClientLedgerTotalCateGory(String paramString1, String paramString2, String paramString3, String paramString4, String paramString5, String paramString6, String paramString7)
  {
    Object localObject = new HashMap();
    QueryConditions localQueryConditions = new QueryConditions();
    if (paramString1 != null) {
    ...
    ViewService localViewService = (ViewService)SysData.getBean("f_viewService");
    localObject = localViewService.queryClientLedgerSumOutside2(localQueryConditions, null, str, paramString6, paramString7);
    return localObject;
  }
  
  public static Map queryClientLedgerTotal2(String paramString1, String paramString2, String paramString3, String paramString4, String paramString5)
  {
    Object localObject = new HashMap();
    QueryConditions localQueryConditions = new QueryConditions();
    if (paramString1 != null) {
  ...
  public static Map queryClientLedgerTotals(String paramString1, String paramString2, String paramString3, String paramString4, String paramString5, String paramString6, String paramString7)
  {
    Object localObject = new HashMap();
    QueryConditions localQueryConditions = new QueryConditions();
    if (paramString1 != null) {
    ...
    ViewService localViewService = (ViewService)SysData.getBean("f_viewService");
    localObject = localViewService.queryClientLedgerOutside2(localQueryConditions, null, str, paramString6, paramString7);
    return localObject;
  }
