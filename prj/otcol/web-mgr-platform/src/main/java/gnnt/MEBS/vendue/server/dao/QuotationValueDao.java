...
public class QuotationValueDao extends BaseDao {
	...
	public void changeCountStarttimeInDbForTest() throws Exception {
	...
	public void fetchQuotationValue(Long paramLong) throws Exception {
		Connection localConnection = getConnection();
		...
		try {
			...
			while (localResultSet.next()) {
				if ((localResultSet.getString("code") != null)
						&& ((this.newestSequenceId == null) || (localResultSet.getLong("id") > this.newestSequenceId.longValue()))) {
	...
	public Commodity fetchCommodityInTradePartitionQuotation(Long paramLong, String paramString) throws Exception {
	...
	public List fetchTradePartitionQuotation(Long paramLong) throws Exception {
		Connection localConnection = getConnection();
		PreparedStatement localPreparedStatement = null;
		ResultSet localResultSet = null;
		try {
			...
			while (localResultSet.next()) {
				QuotationValue localObject1 = new QuotationValue();
