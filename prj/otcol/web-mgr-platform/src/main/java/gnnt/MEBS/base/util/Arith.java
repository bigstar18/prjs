...
public class Arith
{
  ...
  public static Double mul(Double paramDouble1, Double paramDouble2)
  {
    BigDecimal localBigDecimal1 = new BigDecimal(Double.toString(paramDouble1.doubleValue())).setScale(10, 4);
    BigDecimal localBigDecimal2 = new BigDecimal(Double.toString(paramDouble2.doubleValue())).setScale(10, 4);
    return Double.valueOf(result(result(localBigDecimal1.multiply(localBigDecimal2))).doubleValue());
  }
