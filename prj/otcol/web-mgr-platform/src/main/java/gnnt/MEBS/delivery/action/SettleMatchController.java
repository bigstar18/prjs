...
public class SettleMatchController
  extends BaseController
{
  ...
  public ModelAndView settleMatchList(HttpServletRequest paramHttpServletRequest, HttpServletResponse paramHttpServletResponse)
    throws Exception
  {
    ...
    try
    {
      ...
      {
        localObject = (String)localQueryConditions.getConditionValue("firmId", "=");
        this.logger.debug("~~~~~~~~~~~~~~~~firmId:" + (String)localObject);
        if ((localObject != null) && (localObject != null) && (!"".equals(localObject)))
        {
          localQueryConditions.addCondition(" ", "or", "(s.FirmID_S='" + (String)localObject + "' or s.FirmID_B = '" + (String)localObject + "') ");
  ...
  public ModelAndView settleView(HttpServletRequest paramHttpServletRequest, HttpServletResponse paramHttpServletResponse)
    throws Exception
  {
    ...
    {
      localObject = localCommodityService.getT_CommodityList(localSettleMatch.getCommodityId());
    ...
    {
      localObject = localCommodityService.getT_BreedList(localSettleMatch.getBreedId());
      if (((List)localObject).size() > 0) {
        i = Integer.parseInt(((Map)((List)localObject).get(0)).get("settlePriceType").toString());
      }
    }
  ...
  public ModelAndView viewOperator(HttpServletRequest paramHttpServletRequest, HttpServletResponse paramHttpServletResponse)
    throws Exception
  {
  ...
  public ModelAndView viewStock(HttpServletRequest paramHttpServletRequest, HttpServletResponse paramHttpServletResponse)
    throws Exception
  {
  ...
  public ModelAndView settleMatchAdd(HttpServletRequest paramHttpServletRequest, HttpServletResponse paramHttpServletResponse)
    throws Exception
  {
    ...
    throws Exception
  {
    ...
    if (i != 0)
    {
      localObject = localRegStockService.getRegStockById(localSettleMatch.getRegStockId());
      localList.add(localObject);
    }
    Object localObject = new ModelAndView(Condition.SETTLEPATH + "warehouseSettle/settleRegStockMod");
  ...
  public ModelAndView settleBalance(HttpServletRequest paramHttpServletRequest, HttpServletResponse paramHttpServletResponse)
    throws Exception
  {
  ...
  public ModelAndView settlePayPayMent(HttpServletRequest paramHttpServletRequest, HttpServletResponse paramHttpServletResponse)
    throws Exception
  {
  ...
  public ModelAndView settlePayToSeller(HttpServletRequest paramHttpServletRequest, HttpServletResponse paramHttpServletResponse)
    throws Exception
  {
  ...
  public ModelAndView settlePayToBuyer(HttpServletRequest paramHttpServletRequest, HttpServletResponse paramHttpServletResponse)
    throws Exception
  {
  ...
  public ModelAndView settleHL_Amount(HttpServletRequest paramHttpServletRequest, HttpServletResponse paramHttpServletResponse)
    throws Exception
  {
  ...
  public ModelAndView settleSettlePL_B(HttpServletRequest paramHttpServletRequest, HttpServletResponse paramHttpServletResponse)
    throws Exception
  {
  ...
  public ModelAndView settleSettlePL_S(HttpServletRequest paramHttpServletRequest, HttpServletResponse paramHttpServletResponse)
    throws Exception
  {
  ...
  public ModelAndView settleCancel(HttpServletRequest paramHttpServletRequest, HttpServletResponse paramHttpServletResponse)
    throws Exception
  {
    ...
    return new ModelAndView("redirect:" + Condition.PATH + "servlet/settleMatchController." + Condition.POSTFIX + "?funcflg=settleView&matchId=" + str1 + "&moduleId=" + str3);
  }
  
  public ModelAndView settleInvoice(HttpServletRequest paramHttpServletRequest, HttpServletResponse paramHttpServletResponse)
    throws Exception
  {
  ...
  public ModelAndView settleRestore(HttpServletRequest paramHttpServletRequest, HttpServletResponse paramHttpServletResponse)
    throws Exception
  {
  ...
  public ModelAndView returnMoneyForBuy(HttpServletRequest paramHttpServletRequest, HttpServletResponse paramHttpServletResponse)
    throws Exception
  {
  ...
  public ModelAndView settleHandleOK(HttpServletRequest paramHttpServletRequest, HttpServletResponse paramHttpServletResponse)
    throws Exception
  {
    ...
    if (str4 != null)
    {
      ...
      localObject2 = new SettleObject();
      ((SettleObject)localObject2).setMatchId(str1);
      localObject3 = getCommandExecute().execute("SETTLEFINISH", localObject2, (LogValue)localObject1);
    ...
    if (localSettleMatch.getXml() != null)
    {
      localObject4 = (ToolService)SysData.getBean("w_toolService");
  ...
  public ModelAndView settleTransfer(HttpServletRequest paramHttpServletRequest, HttpServletResponse paramHttpServletResponse)
    throws Exception
  {
    ...
    if (localSettleMatch.getIsChangeOwner() != 1)
    {
      ...
      localObject2 = localLogService.getLogList((QueryConditions)localObject1, null, null);
      localObject3 = Double.valueOf(0.0D);
      localObject4 = ((List)localObject2).iterator();
      Object localObject6;
      while (((Iterator)localObject4).hasNext())
      {
        localObject5 = (LogValue)((Iterator)localObject4).next();
        localObject6 = ((LogValue)localObject5).getContent();
        localObject7 = ((String)localObject6).split("：");
        if (localObject7[1] != null)
        {
          localObject8 = localObject7[1].substring(0, localObject7[1].length() - 1);
          if (localObject8 != "") {
            localObject3 = Double.valueOf(Arith.add(Double.parseDouble((String)localObject8), ((Double)localObject3).doubleValue()));
          }
        }
      }
      localObject4 = Double.valueOf(Double.parseDouble(paramHttpServletRequest.getParameter("quality")));
      if (Arith.add(((Double)localObject3).doubleValue(), ((Double)localObject4).doubleValue()) < localDouble.doubleValue())
      {
        localObject5 = new LogValue();
        ...
        ((LogValue)localObject5).setContent("单号" + str2 + "进行货权转移，本次数量为：" + localObject4 + "。");
        ((LogValue)localObject5).setMatchId(str2);
        localLogService.addLog((LogValue)localObject5);
        str3 = "记录数量成功！";
      }
      else if (Arith.add(((Double)localObject3).doubleValue(), ((Double)localObject4).doubleValue()) == localDouble.doubleValue())
      {
        localObject5 = new LogValue();
        ((LogValue)localObject5).setOperator(AclCtrl.getLogonID(paramHttpServletRequest));
        ((LogValue)localObject5).setOperatime(new Date());
        ((LogValue)localObject5).setType(0);
        ((LogValue)localObject5).setContent("单号" + str2 + "进行货权转移，已完成货权转移。本次数量为：" + localObject4 + "。");
        ((LogValue)localObject5).setMatchId(str2);
        localObject6 = new SettleObject();
    ...
    localSettleMatch = localSettleMatchService.getSettleMatchById(str2);
    Object localObject3 = new ModelAndView(Condition.SETTLEPATH + "warehouseSettle/transforSettle");
    ...
    {
      localObject7 = ((LogValue)((List)localObject5).get(i)).getContent();
      localObject8 = ((String)localObject7).split(str2);
  ...
  public ModelAndView settleMatchReturn(HttpServletRequest paramHttpServletRequest, HttpServletResponse paramHttpServletResponse)
    throws Exception
  {
    return new ModelAndView("redirect:" + Condition.PATH + "servlet/settleMatchController." + Condition.POSTFIX + "?funcflg=settleMatchList&_moduleId[%3D]=" + paramHttpServletRequest.getParameter("moduleId"));
  }
  
  public ModelAndView autoSettleMatch(HttpServletRequest paramHttpServletRequest, HttpServletResponse paramHttpServletResponse)
    throws Exception
  {
    ...
    {
      str3 = ((LogValue)localList1.get(i)).getContent();
      localObject1 = str3.split(str2);
  ...
  public ModelAndView transforSettle(HttpServletRequest paramHttpServletRequest, HttpServletResponse paramHttpServletResponse)
    throws Exception
  {
    String str1 = paramHttpServletRequest.getParameter("matchId");
    SettleMatchService localSettleMatchService = (SettleMatchService)SysData.getBean("w_settleMatchService");
    ...
    {
      localObject2 = (LogValue)((Iterator)localObject1).next();
    ...
    Object localObject2 = new ModelAndView(Condition.SETTLEPATH + "warehouseSettle/transforSettle");
