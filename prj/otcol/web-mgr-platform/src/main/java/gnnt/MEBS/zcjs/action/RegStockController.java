  ...
  extends BaseController
{
  ...
  public ModelAndView getValidRegStockNoStockList(HttpServletRequest paramHttpServletRequest, HttpServletResponse paramHttpServletResponse, String paramString)
    throws Exception
  {
  ...
  public ModelAndView addSaleForward(HttpServletRequest paramHttpServletRequest, HttpServletResponse paramHttpServletResponse)
    throws Exception
  {
    ...
    throws Exception
  {
    ...
    else
    {
      ...
      if ((localList1 != null) && (localList1.size() > 0))
      {
        ...
        while (((Iterator)localObject1).hasNext())
        {
          localObject2 = (CommodityProperty)((Iterator)localObject1).next();
  ...
  public ModelAndView addSaleStock(HttpServletRequest paramHttpServletRequest, HttpServletResponse paramHttpServletResponse)
    throws Exception
  {
    ...
    if ((localList != null) && (localList.size() > 0))
    {
      ...
      {
        localObject = (Map)localList.get(i);
        str3 = str3 + "<property key=\"" + ((Map)localObject).get("key") + "\">" + "<id>" + ((Map)localObject).get("propertyId") + "</id>" + "<name><![CDATA[" + ((Map)localObject).get("PROPERTYNAME") + "]]></name>" + "<value><![CDATA[" + paramHttpServletRequest.getParameter(new StringBuilder().append("cp_").append(((Map)localObject).get("key")).toString()) + "]]></value></property>";
      }
      str3 = str3 + "</root>";
    }
    ...
    if ((localObject != null) && (((List)localObject).size() > 0))
    {
      ...
      while (localIterator.hasNext())
      {
        ...
        str4 = str4 + "<quality id=\"" + localMap.get("qualityId") + "\"" + ">" + "<name><![CDATA[" + localMap.get("qualityname") + "]]></name>" + "<value><![CDATA[" + paramHttpServletRequest.getParameter(new StringBuilder().append("qu_").append(localMap.get("qualityId")).toString()) + "]]></value></quality>";
      }
      str4 = str4 + "</root>";
    }
  ...
  public ModelAndView getValidRegStockList(HttpServletRequest paramHttpServletRequest, HttpServletResponse paramHttpServletResponse, String paramString)
    throws Exception
  {
    this.logger.debug("entering 'list' method...");
    QueryConditions localQueryConditions = QueryHelper.getQueryConditionsFromRequest(paramHttpServletRequest);
  ...
  public ModelAndView deleteRegStock(HttpServletRequest paramHttpServletRequest, HttpServletResponse paramHttpServletResponse)
    throws Exception
  {
    String[] arrayOfString = paramHttpServletRequest.getParameterValues("delCheck");
    String str1 = "";
  ...
  public ModelAndView getRegStockId(HttpServletRequest paramHttpServletRequest, HttpServletResponse paramHttpServletResponse)
    throws Exception
  {
    ...
    throws Exception
  {
    ...
    if (null == localWarehouseRegStock)
    {
      ...
      localModelAndView = new ModelAndView(Condition.PATH + "validRegStock/validRegStockAdd");
      return localModelAndView;
    }
  ...
  public ModelAndView AddRegStock(HttpServletRequest paramHttpServletRequest, HttpServletResponse paramHttpServletResponse)
    throws Exception
  {
