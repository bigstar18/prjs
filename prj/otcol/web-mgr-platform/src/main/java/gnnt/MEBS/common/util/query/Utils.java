...
public class Utils
{
  ...
  {
    if (paramBoolean) {
      return paramString2 + paramString1.replaceAll(paramString2, new StringBuilder().append(paramString2).append(paramString2).toString()) + paramString2;
    }
  ...
  public static Object convert(Object paramObject, String paramString)
  ...
  {
    System.out.print(convertCurrencyToChinese("10001.006"));
  }
}
