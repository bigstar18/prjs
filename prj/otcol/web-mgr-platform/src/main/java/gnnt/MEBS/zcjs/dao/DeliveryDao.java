  ...
  extends DaoHelperImpl
{
  ...
  public void insert(Delivery paramDelivery)
  {
    ...
    Object[] arrayOfObject = { Long.valueOf(paramDelivery.getDeliveryId()), Long.valueOf(paramDelivery.getTradeNo()), Long.valueOf(paramDelivery.getBreedId()), Double.valueOf(paramDelivery.getQuantity()), Double.valueOf(paramDelivery.getPrice()), paramDelivery.getFirmId_s(), Double.valueOf(paramDelivery.getSellMargin()), paramDelivery.getFirmId_b(), Double.valueOf(paramDelivery.getBuyMargin()), Integer.valueOf(paramDelivery.getType()), paramDelivery.getRegStockId(), Integer.valueOf(paramDelivery.getStatus()) };
  ...
  public void update(Delivery paramDelivery)
  {
    ...
    Object[] arrayOfObject = { Long.valueOf(paramDelivery.getTradeNo()), Long.valueOf(paramDelivery.getBreedId()), Double.valueOf(paramDelivery.getQuantity()), Double.valueOf(paramDelivery.getPrice()), paramDelivery.getFirmId_s(), Double.valueOf(paramDelivery.getSellMargin()), paramDelivery.getFirmId_b(), Double.valueOf(paramDelivery.getBuyMargin()), Integer.valueOf(paramDelivery.getType()), paramDelivery.getRegStockId(), Integer.valueOf(paramDelivery.getStatus()), Long.valueOf(paramDelivery.getDeliveryId()) };
