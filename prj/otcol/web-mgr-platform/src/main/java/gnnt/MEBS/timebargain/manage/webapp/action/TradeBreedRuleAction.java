...
public class TradeBreedRuleAction extends BaseAction {
	public ActionForward editGroup(ActionMapping paramActionMapping, ActionForm paramActionForm, HttpServletRequest paramHttpServletRequest,
		...
		try {
			...
			if (!str1.trim().equals("create")) {
				localTradeBreedRuleGC = localTradeBreedRuleManager.getGM_TradeBreedRuleById(new Integer(localTradeBreedRuleGCForm.getGroupID()),
						localTradeBreedRuleGCForm.getBreedID());
				if ((localTradeBreedRuleGC.getMarginAssure_B().toString().equals(localTradeBreedRuleGC.getMarginAssure_S().toString()))
						&& (localTradeBreedRuleGC.getMarginRate_B().toString().equals(localTradeBreedRuleGC.getMarginRate_S().toString()))) {
					str2 = "1";
				}
				if ((localTradeBreedRuleGC.getMarginItem1().toString().equals(localTradeBreedRuleGC.getMarginItem1_S().toString()))
						&& (localTradeBreedRuleGC.getMarginItemAssure1().toString()
								.equals(localTradeBreedRuleGC.getMarginItemAssure1_S().toString()))) {
					str3 = "1";
				}
				if ((localTradeBreedRuleGC.getMarginItem2().toString().equals(localTradeBreedRuleGC.getMarginItem2_S().toString()))
						&& (localTradeBreedRuleGC.getMarginItemAssure2().toString()
								.equals(localTradeBreedRuleGC.getMarginItemAssure2_S().toString()))) {
					str4 = "1";
				}
				if ((localTradeBreedRuleGC.getMarginItem3().toString().equals(localTradeBreedRuleGC.getMarginItem3_S().toString()))
						&& (localTradeBreedRuleGC.getMarginItemAssure3().toString()
								.equals(localTradeBreedRuleGC.getMarginItemAssure3_S().toString()))) {
					str5 = "1";
				}
				if ((localTradeBreedRuleGC.getMarginItem4().toString().equals(localTradeBreedRuleGC.getMarginItem4_S().toString()))
						&& (localTradeBreedRuleGC.getMarginItemAssure4().toString()
								.equals(localTradeBreedRuleGC.getMarginItemAssure4_S().toString()))) {
					str6 = "1";
				}
			} else {
	...
	public ActionForward saveGroup(ActionMapping paramActionMapping, ActionForm paramActionForm, HttpServletRequest paramHttpServletRequest,
		...
		try {
			if (str1.trim().equals("create")) {
				...
				if (("1".equals(str2)) && (localTradeBreedRuleGCForm.getMarginItem1() != null)
						&& (!"".equals(localTradeBreedRuleGCForm.getMarginItem1())) && (localTradeBreedRuleGCForm.getMarginItemAssure1() != null)
						&& (!"".equals(localTradeBreedRuleGCForm.getMarginItemAssure1()))) {
				...
				if (("1".equals(str3)) && (localTradeBreedRuleGCForm.getMarginItem2() != null)
						&& (!"".equals(localTradeBreedRuleGCForm.getMarginItem2())) && (localTradeBreedRuleGCForm.getMarginItemAssure2() != null)
						&& (!"".equals(localTradeBreedRuleGCForm.getMarginItemAssure2()))) {
				...
				if (("1".equals(str4)) && (localTradeBreedRuleGCForm.getMarginItem3() != null)
						&& (!"".equals(localTradeBreedRuleGCForm.getMarginItem3())) && (localTradeBreedRuleGCForm.getMarginItemAssure3() != null)
						&& (!"".equals(localTradeBreedRuleGCForm.getMarginItemAssure3()))) {
				...
				if (("1".equals(str5)) && (localTradeBreedRuleGCForm.getMarginItem4() != null)
						&& (!"".equals(localTradeBreedRuleGCForm.getMarginItem4())) && (localTradeBreedRuleGCForm.getMarginItemAssure4() != null)
						&& (!"".equals(localTradeBreedRuleGCForm.getMarginItemAssure4()))) {
				...
				addSysLog(paramHttpServletRequest,
						"增加客户组交易规则[" + localTradeBreedRuleGC.getBreedID() + "," + localTradeBreedRuleGC.getGroupID() + "]");
				...
				addSysLog(paramHttpServletRequest,
						"修改客户组交易规则[" + localTradeBreedRuleGC.getBreedID() + "," + localTradeBreedRuleGC.getGroupID() + "]");
				paramHttpServletRequest.setAttribute("prompt", "操作成功！");
			}
		} catch (Exception localException) {
	...
	public ActionForward searchFirmBreedMargin(ActionMapping paramActionMapping, ActionForm paramActionForm,
	...
	public ActionForward editFirmBreedMargin(ActionMapping paramActionMapping, ActionForm paramActionForm, HttpServletRequest paramHttpServletRequest,
			HttpServletResponse paramHttpServletResponse) throws Exception {
		if (this.log.isDebugEnabled()) {
		...
		try {
			...
			String str9 = "2";
			if (!str1.trim().equals("create")) {
				localTradeBreedRuleGC = localTradeBreedRuleManager.getFirmBreedMarginById(localTradeBreedRuleGCForm.getFirmID(),
						localTradeBreedRuleGCForm.getBreedID());
				if (localTradeBreedRuleGC != null) {
					if ((localTradeBreedRuleGC.getMarginItem1() != null) && (localTradeBreedRuleGC.getMarginItem1_S() != null)
							&& (localTradeBreedRuleGC.getMarginItemAssure1() != null) && (localTradeBreedRuleGC.getMarginItemAssure1_S() != null)
							&& (localTradeBreedRuleGC.getMarginItem1().toString().equals(localTradeBreedRuleGC.getMarginItem1_S().toString()))
							&& (localTradeBreedRuleGC.getMarginItemAssure1().toString()
									.equals(localTradeBreedRuleGC.getMarginItemAssure1_S().toString()))) {
						str2 = "1";
					}
					if ((localTradeBreedRuleGC.getMarginItem2() != null) && (localTradeBreedRuleGC.getMarginItem2_S() != null)
							&& (localTradeBreedRuleGC.getMarginItemAssure2() != null) && (localTradeBreedRuleGC.getMarginItemAssure2_S() != null)
							&& (localTradeBreedRuleGC.getMarginItem2().toString().equals(localTradeBreedRuleGC.getMarginItem2_S().toString()))
							&& (localTradeBreedRuleGC.getMarginItemAssure2().toString()
									.equals(localTradeBreedRuleGC.getMarginItemAssure2_S().toString()))) {
						str3 = "1";
					}
					if ((localTradeBreedRuleGC.getMarginItem3() != null) && (localTradeBreedRuleGC.getMarginItem3_S() != null)
							&& (localTradeBreedRuleGC.getMarginItemAssure3() != null) && (localTradeBreedRuleGC.getMarginItemAssure3_S() != null)
							&& (localTradeBreedRuleGC.getMarginItem3().toString().equals(localTradeBreedRuleGC.getMarginItem3_S().toString()))
							&& (localTradeBreedRuleGC.getMarginItemAssure3().toString()
									.equals(localTradeBreedRuleGC.getMarginItemAssure3_S().toString()))) {
						str4 = "1";
					}
					if ((localTradeBreedRuleGC.getMarginItem4() != null) && (localTradeBreedRuleGC.getMarginItem4_S() != null)
							&& (localTradeBreedRuleGC.getMarginItemAssure4() != null) && (localTradeBreedRuleGC.getMarginItemAssure4_S() != null)
							&& (localTradeBreedRuleGC.getMarginItem4().toString().equals(localTradeBreedRuleGC.getMarginItem4_S().toString()))
							&& (localTradeBreedRuleGC.getMarginItemAssure4().toString()
									.equals(localTradeBreedRuleGC.getMarginItemAssure4_S().toString()))) {
						str5 = "1";
					}
					if ((localTradeBreedRuleGC.getMarginItem5() != null) && (localTradeBreedRuleGC.getMarginItem5_S() != null)
							&& (localTradeBreedRuleGC.getMarginItemAssure5() != null) && (localTradeBreedRuleGC.getMarginItemAssure5_S() != null)
							&& (localTradeBreedRuleGC.getMarginItem5().toString().equals(localTradeBreedRuleGC.getMarginItem5_S().toString()))
							&& (localTradeBreedRuleGC.getMarginItemAssure5().toString()
									.equals(localTradeBreedRuleGC.getMarginItemAssure5_S().toString()))) {
						str6 = "1";
					}
					if ((localTradeBreedRuleGC.getSettleMarginAlgr_B() != null)
							&& ("1".equals(localTradeBreedRuleGC.getSettleMarginAlgr_B().toString()))) {
						str7 = "1";
						localTradeBreedRuleGC.setSettleMarginRate_B(Arith.mul(localTradeBreedRuleGC.getSettleMarginRate_B(), new Double(100.0D)));
					}
					if ((localTradeBreedRuleGC.getSettleMarginAlgr_S() != null)
							&& ("1".equals(localTradeBreedRuleGC.getSettleMarginAlgr_S().toString()))) {
						str8 = "1";
	...
	public ActionForward saveFirmBreedMargin(ActionMapping paramActionMapping, ActionForm paramActionForm, HttpServletRequest paramHttpServletRequest,
			HttpServletResponse paramHttpServletResponse) throws Exception {
		if (this.log.isDebugEnabled()) {
		...
		try {
			if ((localTradeBreedRuleGC.getSettleMarginAlgr_B() != null) && ("1".equals(localTradeBreedRuleGC.getSettleMarginAlgr_B().toString()))) {
				localTradeBreedRuleGC.setSettleMarginRate_B(
						Double.valueOf(localTradeBreedRuleGC.getSettleMarginRate_B().doubleValue() / new Double(100.0D).doubleValue()));
			}
			if ((localTradeBreedRuleGC.getSettleMarginAlgr_S() != null) && ("1".equals(localTradeBreedRuleGC.getSettleMarginAlgr_S().toString()))) {
				localTradeBreedRuleGC.setSettleMarginRate_S(
						Double.valueOf(localTradeBreedRuleGC.getSettleMarginRate_S().doubleValue() / new Double(100.0D).doubleValue()));
			}
			if ((localTradeBreedRuleGC.getPayoutAlgr() != null) && ("1".equals(localTradeBreedRuleGC.getPayoutAlgr().toString()))) {
				localTradeBreedRuleGC
						.setPayoutRate(Double.valueOf(localTradeBreedRuleGC.getPayoutRate().doubleValue() / new Double(100.0D).doubleValue()));
			}
			if ((localTradeBreedRuleGC.getMarginAlgr() != null) && ("1".equals(localTradeBreedRuleGC.getMarginAlgr().toString()))) {
				if (localTradeBreedRuleGC.getMarginItem1() != null) {
					localTradeBreedRuleGC
							.setMarginItem1(Double.valueOf(localTradeBreedRuleGC.getMarginItem1().doubleValue() / new Double(100.0D).doubleValue()));
				}
				if (localTradeBreedRuleGC.getMarginItem2() != null) {
					localTradeBreedRuleGC
							.setMarginItem2(Double.valueOf(localTradeBreedRuleGC.getMarginItem2().doubleValue() / new Double(100.0D).doubleValue()));
				}
				if (localTradeBreedRuleGC.getMarginItem3() != null) {
					localTradeBreedRuleGC
							.setMarginItem3(Double.valueOf(localTradeBreedRuleGC.getMarginItem3().doubleValue() / new Double(100.0D).doubleValue()));
				}
				if (localTradeBreedRuleGC.getMarginItem4() != null) {
					localTradeBreedRuleGC
							.setMarginItem4(Double.valueOf(localTradeBreedRuleGC.getMarginItem4().doubleValue() / new Double(100.0D).doubleValue()));
				}
				if (localTradeBreedRuleGC.getMarginItem5() != null) {
					localTradeBreedRuleGC
							.setMarginItem5(Double.valueOf(localTradeBreedRuleGC.getMarginItem5().doubleValue() / new Double(100.0D).doubleValue()));
				}
				if (localTradeBreedRuleGC.getMarginItem1_S() != null) {
					localTradeBreedRuleGC.setMarginItem1_S(
							Double.valueOf(localTradeBreedRuleGC.getMarginItem1_S().doubleValue() / new Double(100.0D).doubleValue()));
				}
				if (localTradeBreedRuleGC.getMarginItem2_S() != null) {
					localTradeBreedRuleGC.setMarginItem2_S(
							Double.valueOf(localTradeBreedRuleGC.getMarginItem2_S().doubleValue() / new Double(100.0D).doubleValue()));
				}
				if (localTradeBreedRuleGC.getMarginItem3_S() != null) {
					localTradeBreedRuleGC.setMarginItem3_S(
							Double.valueOf(localTradeBreedRuleGC.getMarginItem3_S().doubleValue() / new Double(100.0D).doubleValue()));
				}
				if (localTradeBreedRuleGC.getMarginItem4_S() != null) {
					localTradeBreedRuleGC.setMarginItem4_S(
							Double.valueOf(localTradeBreedRuleGC.getMarginItem4_S().doubleValue() / new Double(100.0D).doubleValue()));
				}
				if (localTradeBreedRuleGC.getMarginItem5_S() != null) {
					localTradeBreedRuleGC.setMarginItem5_S(
							Double.valueOf(localTradeBreedRuleGC.getMarginItem5_S().doubleValue() / new Double(100.0D).doubleValue()));
				}
				if (localTradeBreedRuleGC.getMarginItemAssure1() != null) {
					localTradeBreedRuleGC.setMarginItemAssure1(
							Double.valueOf(localTradeBreedRuleGC.getMarginItemAssure1().doubleValue() / new Double(100.0D).doubleValue()));
				}
				if (localTradeBreedRuleGC.getMarginItemAssure2() != null) {
					localTradeBreedRuleGC.setMarginItemAssure2(
							Double.valueOf(localTradeBreedRuleGC.getMarginItemAssure2().doubleValue() / new Double(100.0D).doubleValue()));
				}
				if (localTradeBreedRuleGC.getMarginItemAssure3() != null) {
					localTradeBreedRuleGC.setMarginItemAssure3(
							Double.valueOf(localTradeBreedRuleGC.getMarginItemAssure3().doubleValue() / new Double(100.0D).doubleValue()));
				}
				if (localTradeBreedRuleGC.getMarginItemAssure4() != null) {
					localTradeBreedRuleGC.setMarginItemAssure4(
							Double.valueOf(localTradeBreedRuleGC.getMarginItemAssure4().doubleValue() / new Double(100.0D).doubleValue()));
				}
				if (localTradeBreedRuleGC.getMarginItemAssure5() != null) {
					localTradeBreedRuleGC.setMarginItemAssure5(
							Double.valueOf(localTradeBreedRuleGC.getMarginItemAssure5().doubleValue() / new Double(100.0D).doubleValue()));
				}
				if (localTradeBreedRuleGC.getMarginItemAssure1_S() != null) {
					localTradeBreedRuleGC.setMarginItemAssure1_S(
							Double.valueOf(localTradeBreedRuleGC.getMarginItemAssure1_S().doubleValue() / new Double(100.0D).doubleValue()));
				}
				if (localTradeBreedRuleGC.getMarginItemAssure2_S() != null) {
					localTradeBreedRuleGC.setMarginItemAssure2_S(
							Double.valueOf(localTradeBreedRuleGC.getMarginItemAssure2_S().doubleValue() / new Double(100.0D).doubleValue()));
				}
				if (localTradeBreedRuleGC.getMarginItemAssure3_S() != null) {
					localTradeBreedRuleGC.setMarginItemAssure3_S(
							Double.valueOf(localTradeBreedRuleGC.getMarginItemAssure3_S().doubleValue() / new Double(100.0D).doubleValue()));
				}
				if (localTradeBreedRuleGC.getMarginItemAssure4_S() != null) {
					localTradeBreedRuleGC.setMarginItemAssure4_S(
							Double.valueOf(localTradeBreedRuleGC.getMarginItemAssure4_S().doubleValue() / new Double(100.0D).doubleValue()));
				}
				if (localTradeBreedRuleGC.getMarginItemAssure5_S() != null) {
					localTradeBreedRuleGC.setMarginItemAssure5_S(
							Double.valueOf(localTradeBreedRuleGC.getMarginItemAssure5_S().doubleValue() / new Double(100.0D).doubleValue()));
				}
			}
			...
			Map localMap;
			if (str1.trim().equals("create")) {
				if (("1".equals(str7)) && (localTradeBreedRuleGCForm.getMarginItem1() != null)
						&& (!"".equals(localTradeBreedRuleGCForm.getMarginItem1())) && (localTradeBreedRuleGCForm.getMarginItemAssure1() != null)
						&& (!"".equals(localTradeBreedRuleGCForm.getMarginItemAssure1()))) {
				...
				if (("1".equals(str6)) && (localTradeBreedRuleGCForm.getMarginItem5() != null)
						&& (!"".equals(localTradeBreedRuleGCForm.getMarginItem5())) && (localTradeBreedRuleGCForm.getMarginItemAssure5() != null)
						&& (!"".equals(localTradeBreedRuleGCForm.getMarginItemAssure5()))) {
				...
				if ((str2 != null) && (str2.equals("true"))) {
					...
					localList = localTradeBreedRuleManager.getFirmCommodityIDFromMarginForAdd(localTradeBreedRuleGC.getFirmID(),
							localTradeBreedRuleGC.getBreedID());
				...
				if ((str2 != null) && (str2.equals("true"))) {
					localTradeRuleGC = new TradeRuleGC();
					BeanUtils.copyProperties(localTradeRuleGC, localTradeBreedRuleGC);
					localList = localTradeBreedRuleManager.getFirmCommodityIDFromMargin(localTradeBreedRuleGC.getFirmID(),
							localTradeBreedRuleGC.getBreedID());
					for (i = 0; i < localList.size(); i++) {
						localMap = (Map) localList.get(i);
						localTradeRuleGC.setCommodityID((String) localMap.get("COMMODITYID"));
	...
	public ActionForward deleteFirmBreedMargin(ActionMapping paramActionMapping, ActionForm paramActionForm,
			HttpServletRequest paramHttpServletRequest, HttpServletResponse paramHttpServletResponse) throws Exception {
		if (this.log.isDebugEnabled()) {
	...
	public ActionForward searchFirmBreedFee(ActionMapping paramActionMapping, ActionForm paramActionForm, HttpServletRequest paramHttpServletRequest,
			HttpServletResponse paramHttpServletResponse) throws Exception {
		if (this.log.isDebugEnabled()) {
	...
	public ActionForward editFirmBreedFee(ActionMapping paramActionMapping, ActionForm paramActionForm, HttpServletRequest paramHttpServletRequest,
			HttpServletResponse paramHttpServletResponse) throws Exception {
		if (this.log.isDebugEnabled()) {
		...
		try {
			getSelectAttribute(paramHttpServletRequest);
			if (!str1.trim().equals("create")) {
				localTradeBreedRuleGC = localTradeBreedRuleManager.getFirmBreedFeeById(localTradeBreedRuleGCForm.getFirmID(),
						localTradeBreedRuleGCForm.getBreedID());
				if (localTradeBreedRuleGC != null) {
					if ((localTradeBreedRuleGC.getFeeAlgr() != null) && ("1".equals(localTradeBreedRuleGC.getFeeAlgr().toString()))) {
						...
						localTradeBreedRuleGC
								.setHistoryCloseFeeRate_B(Arith.mul(localTradeBreedRuleGC.getHistoryCloseFeeRate_B(), new Double(100.0D)));
						localTradeBreedRuleGC
								.setHistoryCloseFeeRate_S(Arith.mul(localTradeBreedRuleGC.getHistoryCloseFeeRate_S(), new Double(100.0D)));
	...
	public ActionForward saveFirmBreedFee(ActionMapping paramActionMapping, ActionForm paramActionForm, HttpServletRequest paramHttpServletRequest,
			HttpServletResponse paramHttpServletResponse) throws Exception {
		if (this.log.isDebugEnabled()) {
		...
		try {
			if ((localTradeBreedRuleGC.getFeeAlgr() != null) && ("1".equals(localTradeBreedRuleGC.getFeeAlgr().toString()))) {
				localTradeBreedRuleGC
						.setFeeRate_B(Double.valueOf(localTradeBreedRuleGC.getFeeRate_B().doubleValue() / new Double(100.0D).doubleValue()));
				localTradeBreedRuleGC
						.setFeeRate_S(Double.valueOf(localTradeBreedRuleGC.getFeeRate_S().doubleValue() / new Double(100.0D).doubleValue()));
				localTradeBreedRuleGC.setHistoryCloseFeeRate_B(
						Double.valueOf(localTradeBreedRuleGC.getHistoryCloseFeeRate_B().doubleValue() / new Double(100.0D).doubleValue()));
				localTradeBreedRuleGC.setHistoryCloseFeeRate_S(
						Double.valueOf(localTradeBreedRuleGC.getHistoryCloseFeeRate_S().doubleValue() / new Double(100.0D).doubleValue()));
				localTradeBreedRuleGC.setTodayCloseFeeRate_B(
						Double.valueOf(localTradeBreedRuleGC.getTodayCloseFeeRate_B().doubleValue() / new Double(100.0D).doubleValue()));
				localTradeBreedRuleGC.setTodayCloseFeeRate_S(
						Double.valueOf(localTradeBreedRuleGC.getTodayCloseFeeRate_S().doubleValue() / new Double(100.0D).doubleValue()));
				localTradeBreedRuleGC.setForceCloseFeeRate_B(
						Double.valueOf(localTradeBreedRuleGC.getForceCloseFeeRate_B().doubleValue() / new Double(100.0D).doubleValue()));
				localTradeBreedRuleGC.setForceCloseFeeRate_S(
						Double.valueOf(localTradeBreedRuleGC.getForceCloseFeeRate_S().doubleValue() / new Double(100.0D).doubleValue()));
			}
			if ((localTradeBreedRuleGC.getSettleFeeAlgr() != null) && ("1".equals(localTradeBreedRuleGC.getSettleFeeAlgr().toString()))) {
				localTradeBreedRuleGC.setSettleFeeRate_B(
						Double.valueOf(localTradeBreedRuleGC.getSettleFeeRate_B().doubleValue() / new Double(100.0D).doubleValue()));
				localTradeBreedRuleGC.setSettleFeeRate_S(
						Double.valueOf(localTradeBreedRuleGC.getSettleFeeRate_S().doubleValue() / new Double(100.0D).doubleValue()));
			}
			TradeRuleGC localTradeRuleGC;
			List localList;
			int i;
			...
			if (str1.trim().equals("create")) {
				if ((str2 != null) && (str2.equals("true"))) {
					localTradeRuleGC = new TradeRuleGC();
					BeanUtils.copyProperties(localTradeRuleGC, localTradeBreedRuleGC);
					localList = localTradeBreedRuleManager.getFirmCommodityIDFromFeeForAdd(localTradeBreedRuleGC.getFirmID(),
							localTradeBreedRuleGC.getBreedID());
					for (i = 0; i < localList.size(); i++) {
						localMap = (Map) localList.get(i);
						localTradeRuleGC.setCommodityID((String) localMap.get("COMMODITYID"));
				...
				if ((str2 != null) && (str2.equals("true"))) {
					localTradeRuleGC = new TradeRuleGC();
					BeanUtils.copyProperties(localTradeRuleGC, localTradeBreedRuleGC);
					localList = localTradeBreedRuleManager.getFirmCommodityIDFromFee(localTradeBreedRuleGC.getFirmID(),
							localTradeBreedRuleGC.getBreedID());
					for (i = 0; i < localList.size(); i++) {
						localMap = (Map) localList.get(i);
						localTradeRuleGC.setCommodityID((String) localMap.get("COMMODITYID"));
	...
	public ActionForward deleteFirmBreedFee(ActionMapping paramActionMapping, ActionForm paramActionForm, HttpServletRequest paramHttpServletRequest,
			HttpServletResponse paramHttpServletResponse) throws Exception {
		if (this.log.isDebugEnabled()) {
	...
	public ActionForward searchFirmBreedMaxHoldQty(ActionMapping paramActionMapping, ActionForm paramActionForm,
			HttpServletRequest paramHttpServletRequest, HttpServletResponse paramHttpServletResponse) throws Exception {
		if (this.log.isDebugEnabled()) {
	...
	public ActionForward editFirmBreedMaxHoldQty(ActionMapping paramActionMapping, ActionForm paramActionForm,
			HttpServletRequest paramHttpServletRequest, HttpServletResponse paramHttpServletResponse) throws Exception {
		if (this.log.isDebugEnabled()) {
		...
		try {
			getSelectAttribute(paramHttpServletRequest);
			if (!str1.trim().equals("create")) {
				localTradeBreedRuleGC = localTradeBreedRuleManager.getFirmBreedMaxHoldQtyById(localTradeBreedRuleGCForm.getFirmID(),
						localTradeBreedRuleGCForm.getBreedID());
	...
	public ActionForward saveFirmBreedMaxHoldQty(ActionMapping paramActionMapping, ActionForm paramActionForm,
			HttpServletRequest paramHttpServletRequest, HttpServletResponse paramHttpServletResponse) throws Exception {
		if (this.log.isDebugEnabled()) {
		...
		try {
			...
			if (str1.trim().equals("create")) {
				if ((str2 != null) && (str2.equals("true"))) {
					localTradeRuleGC = new TradeRuleGC();
					BeanUtils.copyProperties(localTradeRuleGC, localTradeBreedRuleGC);
					localList = localTradeBreedRuleManager.getFirmCommodityIDFromMaxHoldQtyForAdd(localTradeBreedRuleGC.getFirmID(),
							localTradeBreedRuleGC.getBreedID());
					for (i = 0; i < localList.size(); i++) {
						localMap = (Map) localList.get(i);
						localTradeRuleGC.setCommodityID((String) localMap.get("COMMODITYID"));
				...
				if ((str2 != null) && (str2.equals("true"))) {
					localTradeRuleGC = new TradeRuleGC();
					BeanUtils.copyProperties(localTradeRuleGC, localTradeBreedRuleGC);
					localList = localTradeBreedRuleManager.getFirmCommodityIDFromMaxHoldQty(localTradeBreedRuleGC.getFirmID(),
							localTradeBreedRuleGC.getBreedID());
					for (i = 0; i < localList.size(); i++) {
						localMap = (Map) localList.get(i);
						localTradeRuleGC.setCommodityID((String) localMap.get("COMMODITYID"));
	...
	public ActionForward deleteFirmBreedMaxHoldQty(ActionMapping paramActionMapping, ActionForm paramActionForm,
			HttpServletRequest paramHttpServletRequest, HttpServletResponse paramHttpServletResponse) throws Exception {
		if (this.log.isDebugEnabled()) {
	...
	private void getSelectAttribute(HttpServletRequest paramHttpServletRequest) throws Exception {
		...
		paramHttpServletRequest.setAttribute("breedSelect",
				localLookupManager.getSelectLabelValueByTable("T_A_breed", "BreedID", "BreedID", " order by breedname "));
	}
}
