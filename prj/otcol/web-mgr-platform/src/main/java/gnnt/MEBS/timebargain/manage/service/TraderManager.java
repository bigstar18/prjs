...
public abstract interface TraderManager
{
  ...
  public abstract String getCodeNotChoose(Trader paramTrader)
    throws Exception;
  ...
  public abstract String getNotOperateFirm(Consigner paramConsigner)
    throws Exception;
