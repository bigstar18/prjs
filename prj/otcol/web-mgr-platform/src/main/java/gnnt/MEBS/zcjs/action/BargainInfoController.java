...
public class BargainInfoController extends BaseController {
	...
	public ModelAndView getC_DPConList(HttpServletRequest paramHttpServletRequest, HttpServletResponse paramHttpServletResponse) throws Exception {
	...
	public ModelAndView getH_GOConList(HttpServletRequest paramHttpServletRequest, HttpServletResponse paramHttpServletResponse) throws Exception {
	...
	public ModelAndView getH_DisList(HttpServletRequest paramHttpServletRequest, HttpServletResponse paramHttpServletResponse) throws Exception {
	...
	public ModelAndView getH_TradeResult(HttpServletRequest paramHttpServletRequest, HttpServletResponse paramHttpServletResponse) throws Exception {
	...
	public ModelAndView getH_T(HttpServletRequest paramHttpServletRequest, HttpServletResponse paramHttpServletResponse, String paramString)
		...
		localObject1 = "select * from (select " + str2
				+ ",ht.note note,ht.deliveryplace deliveryplace,extractValue(xmlType(ht.quality),'/root/quality[name=" + '"' + "生产日期" + '"'
				+ "]/value') shengchanriqi,extractValue(xmlType(ht.quality),'/root/quality[name=" + '"' + "交货日" + '"'
				+ "]/value') jiaohuori,extractValue(xmlType(ht.quality),'/root/quality[name=" + '"' + "产地（生产厂家）" + '"'
				+ "]/value') chandi,bf.fullname bfullname,bf.address baddress,extractValue(xmlType(bf.extenddata),'/root/keyValue[key=" + '"'
				+ "businessContacter" + '"' + "]/value') bbusinessContacter,extractValue(xmlType(bf.extenddata),'/root/keyValue[key=" + '"'
				+ "legalRepresentative" + '"' + "]/value') blegalRepresentative,extractValue(xmlType(bf.extenddata),'/root/keyValue[key=" + '"'
				+ "LRphoneNo" + '"'
				+ "]/value') bLRphoneNo,sf.fullname sfullname,sf.address saddress,extractValue(xmlType(sf.extenddata),'/root/keyValue[key=" + '"'
				+ "businessContacter" + '"' + "]/value') sbusinessContacter,extractValue(xmlType(sf.extenddata),'/root/keyValue[key=" + '"'
				+ "legalRepresentative" + '"' + "]/value') slegalRepresentative,extractValue(xmlType(sf.extenddata),'/root/keyValue[key=" + '"'
				+ "LRphoneNo" + '"' + "]/value') sLRphoneNo ,TO_CHAR(ht.tradedate,'YYYY" + '"' + "年" + '"' + "MM" + '"' + "月" + '"' + "DD" + '"' + "日"
				+ '"' + "') chengjiaoshijian    " + paramString + " ) ";
	...
	public ModelAndView getHisCommodityParameter(HttpServletRequest paramHttpServletRequest, HttpServletResponse paramHttpServletResponse)
		...
		while (localIterator1.hasNext()) {
			HashMap localObject = new HashMap();
		...
		ModelAndView localObject = new ModelAndView(Condition.PATH + "bargainInfo/commodityParameter");
	...
	public ModelAndView getH_DisParameter(HttpServletRequest paramHttpServletRequest, HttpServletResponse paramHttpServletResponse) throws Exception {
		this.logger.debug("entering 'getCommodityParameter' method...");
	...
	public ModelAndView getDisParameter(HttpServletRequest paramHttpServletRequest, HttpServletResponse paramHttpServletResponse) throws Exception {
		this.logger.debug("entering 'getCommodityParameter' method...");
		long l = Long.parseLong(paramHttpServletRequest.getParameter("DiscussPriceId"));
	...
	public ModelAndView SystemCancleSub(HttpServletRequest paramHttpServletRequest, HttpServletResponse paramHttpServletResponse) throws Exception {
		long l = Long.parseLong(paramHttpServletRequest.getParameter("goodsOrderId"));
		String str1 = "";
		...
		SystemSettingServerRmi localSystemSettingServerRmi = (SystemSettingServerRmi) Naming
				.lookup("rmi://" + str2 + ":" + i + "/SystemSettingServerRmi");
		try {
