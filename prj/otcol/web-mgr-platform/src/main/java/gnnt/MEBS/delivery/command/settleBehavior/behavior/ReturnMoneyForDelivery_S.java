...
public class ReturnMoneyForDelivery_S
  ...
  public void deal(SettleObject paramSettleObject)
  {
    ...
    try
    {
      ...
      while (localIterator.hasNext())
      {
        ...
        localDouble = Double.valueOf(Double.parseDouble(localElement2.element("TRADEPOUNDAGE_S").getText()));
    ...
    this.moneyDoService.updateFirmFunds(localSettleMatch.getFirmID_S(), "308", 0.0D - localDouble.doubleValue(), localSettleMatch.getContractId() + "", null);
  }
