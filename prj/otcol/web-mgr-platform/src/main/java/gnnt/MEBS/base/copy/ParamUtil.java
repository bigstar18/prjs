...
public class ParamUtil
{
  ...
  public static void bindSubObject(Object paramObject, String paramString1, String paramString2)
    throws SecurityException, Exception
  {
    ...
    if ("".equals(paramString2.trim()))
    {
      ...
      {
        localMethod2 = paramObject.getClass().getMethod("set" + str, new Class[] { localClass });
    ...
    else
    {
      Object localObject1;
      Object localObject2;
      if ((localClass == Integer.class) || (localClass == Float.class) || (localClass == Long.class) || (localClass == Double.class) || (localClass == Byte.class) || (localClass == Boolean.class) || (localClass == Character.class) || (localClass == Short.class))
      {
