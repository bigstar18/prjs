  ...
  extends BaseAction
{
  ...
  public ActionForward edit2(ActionMapping paramActionMapping, ActionForm paramActionForm, HttpServletRequest paramHttpServletRequest, HttpServletResponse paramHttpServletResponse)
    throws Exception
  {
    if (this.log.isDebugEnabled()) {
  ...
  public ActionForward edit3(ActionMapping paramActionMapping, ActionForm paramActionForm, HttpServletRequest paramHttpServletRequest, HttpServletResponse paramHttpServletResponse)
    throws Exception
  {
    if (this.log.isDebugEnabled()) {
    ...
    try
    {
      ...
      if (localDate != null)
      {
        localObject1 = localSimpleDateFormat.format(localDate);
      ...
      {
        localObject2 = localSystemStatus.getRecoverTime();
  ...
  public ActionForward editMargin(ActionMapping paramActionMapping, ActionForm paramActionForm, HttpServletRequest paramHttpServletRequest, HttpServletResponse paramHttpServletResponse)
    throws Exception
  {
    if (this.log.isDebugEnabled()) {
  ...
  public ActionForward saveMargin(ActionMapping paramActionMapping, ActionForm paramActionForm, HttpServletRequest paramHttpServletRequest, HttpServletResponse paramHttpServletResponse)
    throws Exception
  {
    if (this.log.isDebugEnabled()) {
  ...
  public ActionForward editOnlineMargin(ActionMapping paramActionMapping, ActionForm paramActionForm, HttpServletRequest paramHttpServletRequest, HttpServletResponse paramHttpServletResponse)
    throws Exception
  {
    if (this.log.isDebugEnabled()) {
    ...
    try
    {
      ...
      if ("1".equals(str6))
      {
        str2 = Arith.mul((localCommodity.getMarginRate_B() == null ? new Double(0.0D) : localCommodity.getMarginRate_B()).doubleValue(), 100.0F) + "";
        str3 = Arith.mul((localCommodity.getMarginRate_S() == null ? new Double(0.0D) : localCommodity.getMarginRate_S()).doubleValue(), 100.0F) + "";
        str4 = Arith.mul((localCommodity.getMarginAssure_B() == null ? new Double(0.0D) : localCommodity.getMarginAssure_B()).doubleValue(), 100.0F) + "";
        str5 = Arith.mul((localCommodity.getMarginAssure_S() == null ? new Double(0.0D) : localCommodity.getMarginAssure_S()).doubleValue(), 100.0F) + "";
      }
      else
      {
  ...
  public ActionForward editSpacMargin(ActionMapping paramActionMapping, ActionForm paramActionForm, HttpServletRequest paramHttpServletRequest, HttpServletResponse paramHttpServletResponse)
    throws Exception
  {
    if (this.log.isDebugEnabled()) {
    ...
    try
    {
      ...
      if ("1".equals(str7))
      {
        str3 = Arith.mul((localTradeRuleGC.getMarginRate_B() == null ? new Double(0.0D) : localTradeRuleGC.getMarginRate_B()).doubleValue(), 100.0F) + "";
        str4 = Arith.mul((localTradeRuleGC.getMarginRate_S() == null ? new Double(0.0D) : localTradeRuleGC.getMarginRate_S()).doubleValue(), 100.0F) + "";
        str5 = Arith.mul((localTradeRuleGC.getMarginAssure_B() == null ? new Double(0.0D) : localTradeRuleGC.getMarginAssure_B()).doubleValue(), 100.0F) + "";
        str6 = Arith.mul((localTradeRuleGC.getMarginAssure_S() == null ? new Double(0.0D) : localTradeRuleGC.getMarginAssure_S()).doubleValue(), 100.0F) + "";
      }
      else
      {
  ...
  public ActionForward saveSpacMargin(ActionMapping paramActionMapping, ActionForm paramActionForm, HttpServletRequest paramHttpServletRequest, HttpServletResponse paramHttpServletResponse)
    throws Exception
  {
    if (this.log.isDebugEnabled()) {
        ...
        else
        {
          ...
          if (str2.equals("07"))
          {
            ...
            catch (Exception localException2)
            {
              ...
              localObject = localException2.getMessage().split(":");
          ...
          else if (str2.equals("08"))
          {
            ...
            {
              localObject = (StatQueryManager)getBean("statQueryManager");
          ...
          else if (!str2.equals("11"))
          {
            ...
            else if ("recoverDelayTrade".equals(str2))
            {
              ...
              catch (Exception localException5)
              {
                ...
                localObject = localException5.getMessage().split(":");
                paramHttpServletRequest.setAttribute("prompt", localObject[(localObject.length - 1)]);
              }
            }
  ...
  public ActionForward operate2(ActionMapping paramActionMapping, ActionForm paramActionForm, HttpServletRequest paramHttpServletRequest, HttpServletResponse paramHttpServletResponse)
    throws Exception
  {
    if (this.log.isDebugEnabled()) {
  ...
  public ActionForward marketStatus_list(ActionMapping paramActionMapping, ActionForm paramActionForm, HttpServletRequest paramHttpServletRequest, HttpServletResponse paramHttpServletResponse)
    throws Exception
  {
    if (this.log.isDebugEnabled()) {
  ...
  public ActionForward customer_list(ActionMapping paramActionMapping, ActionForm paramActionForm, HttpServletRequest paramHttpServletRequest, HttpServletResponse paramHttpServletResponse)
    throws Exception
  {
    if (this.log.isDebugEnabled()) {
  ...
  public ActionForward getNotMarketCodeOrders(ActionMapping paramActionMapping, ActionForm paramActionForm, HttpServletRequest paramHttpServletRequest, HttpServletResponse paramHttpServletResponse)
    throws Exception
  {
    if (this.log.isDebugEnabled()) {
  ...
  public ActionForward updateMarketOrderNo(ActionMapping paramActionMapping, ActionForm paramActionForm, HttpServletRequest paramHttpServletRequest, HttpServletResponse paramHttpServletResponse)
    throws Exception
  {
    if (this.log.isDebugEnabled()) {
    ...
    try
    {
      localOrdersManager.updateMarketOrderNo(Long.valueOf(paramHttpServletRequest.getParameter("A_OrderNo")), Long.valueOf(paramHttpServletRequest.getParameter("M_OrderNo")));
  ...
  public ActionForward receiveMonitor_list(ActionMapping paramActionMapping, ActionForm paramActionForm, HttpServletRequest paramHttpServletRequest, HttpServletResponse paramHttpServletResponse)
    throws Exception
  {
    if (this.log.isDebugEnabled()) {
  ...
  public ActionForward getAgencyStatus(ActionMapping paramActionMapping, ActionForm paramActionForm, HttpServletRequest paramHttpServletRequest, HttpServletResponse paramHttpServletResponse)
    throws Exception
  {
    if (this.log.isDebugEnabled()) {
  ...
  public ActionForward getWithdrawQueue(ActionMapping paramActionMapping, ActionForm paramActionForm, HttpServletRequest paramHttpServletRequest, HttpServletResponse paramHttpServletResponse)
    throws Exception
  {
    if (this.log.isDebugEnabled()) {
  ...
  public ActionForward queryWithdrawReason(ActionMapping paramActionMapping, ActionForm paramActionForm, HttpServletRequest paramHttpServletRequest, HttpServletResponse paramHttpServletResponse)
    throws Exception
  {
    if (this.log.isDebugEnabled()) {
  ...
  public ActionForward procLog_top(ActionMapping paramActionMapping, ActionForm paramActionForm, HttpServletRequest paramHttpServletRequest, HttpServletResponse paramHttpServletResponse)
    throws Exception
  {
    if (this.log.isDebugEnabled()) {
  ...
  public ActionForward procLog_list(ActionMapping paramActionMapping, ActionForm paramActionForm, HttpServletRequest paramHttpServletRequest, HttpServletResponse paramHttpServletResponse)
    throws Exception
  {
    if (this.log.isDebugEnabled()) {
  ...
  public ActionForward procLog_delete(ActionMapping paramActionMapping, ActionForm paramActionForm, HttpServletRequest paramHttpServletRequest, HttpServletResponse paramHttpServletResponse)
    throws Exception
  {
    if (this.log.isDebugEnabled()) {
  ...
  public ActionForward sysLog_top(ActionMapping paramActionMapping, ActionForm paramActionForm, HttpServletRequest paramHttpServletRequest, HttpServletResponse paramHttpServletResponse)
    throws Exception
  {
    if (this.log.isDebugEnabled()) {
  ...
  public ActionForward sysLog_list(ActionMapping paramActionMapping, ActionForm paramActionForm, HttpServletRequest paramHttpServletRequest, HttpServletResponse paramHttpServletResponse)
    throws Exception
  {
    if (this.log.isDebugEnabled()) {
  ...
  public ActionForward sysLog_delete(ActionMapping paramActionMapping, ActionForm paramActionForm, HttpServletRequest paramHttpServletRequest, HttpServletResponse paramHttpServletResponse)
    throws Exception
  {
    if (this.log.isDebugEnabled()) {
  ...
  public ActionForward searchTradeRespond(ActionMapping paramActionMapping, ActionForm paramActionForm, HttpServletRequest paramHttpServletRequest, HttpServletResponse paramHttpServletResponse)
    throws Exception
  {
    if (this.log.isDebugEnabled()) {
  ...
  public ActionForward backupdb_list(ActionMapping paramActionMapping, ActionForm paramActionForm, HttpServletRequest paramHttpServletRequest, HttpServletResponse paramHttpServletResponse)
    throws Exception
  {
    if (this.log.isDebugEnabled()) {
  ...
  public ActionForward backupdbDel(ActionMapping paramActionMapping, ActionForm paramActionForm, HttpServletRequest paramHttpServletRequest, HttpServletResponse paramHttpServletResponse)
    throws Exception
  {
    if (this.log.isDebugEnabled()) {
  ...
  public ActionForward backupdbcopy(ActionMapping paramActionMapping, ActionForm paramActionForm, HttpServletRequest paramHttpServletRequest, HttpServletResponse paramHttpServletResponse)
    throws Exception
  {
    if (this.log.isDebugEnabled()) {
  ...
  public ActionForward traderLog_list(ActionMapping paramActionMapping, ActionForm paramActionForm, HttpServletRequest paramHttpServletRequest, HttpServletResponse paramHttpServletResponse)
    throws Exception
  {
    if (this.log.isDebugEnabled()) {
  ...
  public ActionForward getLastPrice(ActionMapping paramActionMapping, ActionForm paramActionForm, HttpServletRequest paramHttpServletRequest, HttpServletResponse paramHttpServletResponse)
    throws Exception
  {
    if (this.log.isDebugEnabled()) {
  ...
  public ActionForward editLastPrice(ActionMapping paramActionMapping, ActionForm paramActionForm, HttpServletRequest paramHttpServletRequest, HttpServletResponse paramHttpServletResponse)
    throws Exception
  {
    if (this.log.isDebugEnabled()) {
    ...
    throws Exception
  {
    ...
    paramHttpServletRequest.setAttribute("marketSelect", localLookupManager.getSelectLabelValueByTable("T_A_MARKET", "MarketName", "MarketCode", " where Status=1"));
    paramHttpServletRequest.setAttribute("customerSelect", localLookupManager.getSelectLabelValueByTable("T_CUSTOMER", "Name", "CustomerID", " where Status=0"));
