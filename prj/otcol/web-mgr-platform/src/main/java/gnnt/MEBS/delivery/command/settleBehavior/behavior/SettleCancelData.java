...
public class SettleCancelData
  implements Behaviour
{
  private final transient Log logger = LogFactory.getLog(SettleCancelData.class);
  @Autowired
  ...
  public void deal(SettleObject paramSettleObject)
  {
    ...
    this.settleMatchService.cancelSettle(localSettleMatch);
  }
}
