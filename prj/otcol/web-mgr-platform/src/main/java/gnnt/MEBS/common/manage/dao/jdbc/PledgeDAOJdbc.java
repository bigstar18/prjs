...
public class PledgeDAOJdbc extends JdbcDaoSupport implements PledgeDAO {
	...
	public void updatePledge(Apply_T_PledgeMoney paramApply_T_PledgeMoney) {
		String str1 = "select count(*) from T_E_ApplyBill a where (a.status = 1 or a.status = 2) and a.BillID = '"
				+ paramApply_T_PledgeMoney.getBillID() + "'";
		...
		Object[] arrayOfObject = { paramApply_T_PledgeMoney.getBillID(), Double.valueOf(paramApply_T_PledgeMoney.getBillFund()),
				paramApply_T_PledgeMoney.getFirmId(), paramApply_T_PledgeMoney.getCommodityName(), localLong, paramApply_T_PledgeMoney.getApprover(),
				paramApply_T_PledgeMoney.getApprover() };
