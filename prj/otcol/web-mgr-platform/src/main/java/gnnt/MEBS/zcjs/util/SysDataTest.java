  ...
  implements Serializable
{
  ...
  private static final String beanConfig = "/zcjsBeansTest.xml";
  private static ApplicationContext factory;
  private static Properties props = getProps();
  
  public static void init()
  {
    factory = new ClassPathXmlApplicationContext("/zcjsBeansTest.xml");
  }
  ...
  public static Properties getProps()
  {
    ...
    try
    {
      localProperties = (Properties)getBean("z_config");
    }
