  ...
  extends HttpServlet
{
    ...
    throws ServletException, IOException
  {
    ...
    try
    {
      ...
      if ("logon".equals(str3))
      {
        ...
        localObject3 = getXmlParament(str2, "PASSWORD");
        str7 = getXmlParament(str2, "REGISTER_WORD");
        localObject4 = LogonManager.getInstance();
        str8 = "";
        TraderInfo localTraderInfo = ((LogonManager)localObject4).logon(str4, (String)localObject3, str7, paramHttpServletRequest.getRemoteAddr());
        ...
        if (l6 > 0L)
        {
          ...
          localStringBuffer3.append("<LAST_TIME>" + ((localTraderInfo.lastTime == null) || (localTraderInfo.lastTime.length() < 20) ? "" : localTraderInfo.lastTime.substring(0, 19)) + "</LAST_TIME>\n");
      ...
      if ("logoff".equals(str3))
      {
        ...
        ((StringBuffer)localObject3).append("<?xml version=\"1.0\" encoding=\"GB2312\"?>\n<GNNT>\n<REP name=\"logoff\">\n<RESULT>\n<RETCODE>");
      ...
      if ("check_user".equals(str3))
      {
        ...
        str7 = getXmlParament(str2, "MODULE_ID");
        localObject4 = localLogonManager.remoteLogon((String)localObject2, str7, l4, paramHttpServletRequest.getRemoteAddr());
        str8 = "";
        ...
        if (l5 > 0L)
        {
          ...
          paramHttpServletRequest.getSession().setMaxInactiveInterval(60000);
          ((StringBuffer)localObject1).append("<?xml version=\"1.0\" encoding=\"GB2312\"?>\n<GNNT>\n<REP name=\"check_user\">\n<RESULT>\n<RETCODE>");
  ...
  private Document parserStrtoDocument(String paramString)
  ...
  private String getXmlParament(String paramString1, String paramString2)
    throws Exception
  {
