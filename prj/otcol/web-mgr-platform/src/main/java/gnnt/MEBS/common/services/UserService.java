...
public class UserService
{
  ...
  public int modPassword(String paramString1, String paramString2, String paramString3)
  {
    int i = 0;
    if (this.userDao.checkPassword(paramString1, paramString2) > 0)
    {
      User localUser = getUserById(paramString1);
