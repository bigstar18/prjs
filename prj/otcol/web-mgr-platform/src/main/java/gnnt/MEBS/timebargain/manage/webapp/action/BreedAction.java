...
public class BreedAction
  extends BaseAction
{
  public ActionForward breedGet(ActionMapping paramActionMapping, ActionForm paramActionForm, HttpServletRequest paramHttpServletRequest, HttpServletResponse paramHttpServletResponse)
    throws Exception
  {
  ...
  public ActionForward select(ActionMapping paramActionMapping, ActionForm paramActionForm, HttpServletRequest paramHttpServletRequest, HttpServletResponse paramHttpServletResponse)
    throws Exception
  {
    ...
    throws Exception
  {
    ...
    try
    {
      ...
      paramHttpServletRequest.setAttribute("breedSelect", localLookupManager2.getSelectLabelValueByTable("E_Breed", "breedName", "breedId", " where Status=0"));
      ...
      if (!str3.trim().equals("create"))
      {
        ...
        if (localBreed != null)
        {
          if ((localBreed.getMarginItem1() != null) && (localBreed.getMarginItem1_S() != null) && (localBreed.getMarginItemAssure1() != null) && (localBreed.getMarginItemAssure1_S() != null) && (localBreed.getMarginItem1().toString().equals(localBreed.getMarginItem1_S().toString())) && (localBreed.getMarginItemAssure1().toString().equals(localBreed.getMarginItemAssure1_S().toString()))) {
            str4 = "1";
          }
          if ((localBreed.getMarginItem2() != null) && (localBreed.getMarginItem2_S() != null) && (localBreed.getMarginItemAssure2() != null) && (localBreed.getMarginItemAssure2_S() != null) && (localBreed.getMarginItem2().toString().equals(localBreed.getMarginItem2_S().toString())) && (localBreed.getMarginItemAssure2().toString().equals(localBreed.getMarginItemAssure2_S().toString()))) {
            str5 = "1";
          }
          if ((localBreed.getMarginItem3() != null) && (localBreed.getMarginItem3_S() != null) && (localBreed.getMarginItemAssure3() != null) && (localBreed.getMarginItemAssure3_S() != null) && (localBreed.getMarginItem3().toString().equals(localBreed.getMarginItem3_S().toString())) && (localBreed.getMarginItemAssure3().toString().equals(localBreed.getMarginItemAssure3_S().toString()))) {
            str6 = "1";
          }
          if ((localBreed.getMarginItem4() != null) && (localBreed.getMarginItem4_S() != null) && (localBreed.getMarginItemAssure4() != null) && (localBreed.getMarginItemAssure4_S() != null) && (localBreed.getMarginItem4().toString().equals(localBreed.getMarginItem4_S().toString())) && (localBreed.getMarginItemAssure4().toString().equals(localBreed.getMarginItemAssure4_S().toString()))) {
            str7 = "1";
          }
          if ((localBreed.getMarginItem5() != null) && (localBreed.getMarginItem5_S() != null) && (localBreed.getMarginItemAssure5() != null) && (localBreed.getMarginItemAssure5_S() != null) && (localBreed.getMarginItem5().toString().equals(localBreed.getMarginItem5_S().toString())) && (localBreed.getMarginItemAssure5().toString().equals(localBreed.getMarginItemAssure5_S().toString()))) {
            str8 = "1";
          }
          ...
          localBreed.setMaxFeeRate(Arith.mul(localBreed.getMaxFeeRate() == null ? new Double(0.0D) : localBreed.getMaxFeeRate(), new Double(100.0D)));
    ...
    throws Exception
  {
    ...
    try
    {
      ...
      if ((localBreed1.getFeeAlgr() != null) && ("1".equals(localBreed1.getFeeAlgr().toString())))
      {
        ...
        localBreed1.setHistoryCloseFeeRate_B(Double.valueOf(localBreed1.getHistoryCloseFeeRate_B().doubleValue() / new Double(100.0D).doubleValue()));
        localBreed1.setHistoryCloseFeeRate_S(Double.valueOf(localBreed1.getHistoryCloseFeeRate_S().doubleValue() / new Double(100.0D).doubleValue()));
        localBreed1.setTodayCloseFeeRate_B(Double.valueOf(localBreed1.getTodayCloseFeeRate_B().doubleValue() / new Double(100.0D).doubleValue()));
        localBreed1.setTodayCloseFeeRate_S(Double.valueOf(localBreed1.getTodayCloseFeeRate_S().doubleValue() / new Double(100.0D).doubleValue()));
        localBreed1.setForceCloseFeeRate_B(Double.valueOf(localBreed1.getForceCloseFeeRate_B().doubleValue() / new Double(100.0D).doubleValue()));
        localBreed1.setForceCloseFeeRate_S(Double.valueOf(localBreed1.getForceCloseFeeRate_S().doubleValue() / new Double(100.0D).doubleValue()));
      }
      ...
      if ((localBreed1.getSettleMarginAlgr_B() != null) && ("1".equals(localBreed1.getSettleMarginAlgr_B().toString()))) {
        localBreed1.setSettleMarginRate_B(Double.valueOf(localBreed1.getSettleMarginRate_B().doubleValue() / new Double(100.0D).doubleValue()));
      }
      if ((localBreed1.getSettleMarginAlgr_S() != null) && ("1".equals(localBreed1.getSettleMarginAlgr_S().toString()))) {
        localBreed1.setSettleMarginRate_S(Double.valueOf(localBreed1.getSettleMarginRate_S().doubleValue() / new Double(100.0D).doubleValue()));
      }
      ...
      if ((localBreed1.getMarginAlgr() != null) && ("1".equals(localBreed1.getMarginAlgr().toString())))
      {
        ...
        if (localBreed1.getMarginItemAssure1() != null) {
          localBreed1.setMarginItemAssure1(Double.valueOf(localBreed1.getMarginItemAssure1().doubleValue() / new Double(100.0D).doubleValue()));
        }
        if (localBreed1.getMarginItemAssure2() != null) {
          localBreed1.setMarginItemAssure2(Double.valueOf(localBreed1.getMarginItemAssure2().doubleValue() / new Double(100.0D).doubleValue()));
        }
        if (localBreed1.getMarginItemAssure3() != null) {
          localBreed1.setMarginItemAssure3(Double.valueOf(localBreed1.getMarginItemAssure3().doubleValue() / new Double(100.0D).doubleValue()));
        }
        if (localBreed1.getMarginItemAssure4() != null) {
          localBreed1.setMarginItemAssure4(Double.valueOf(localBreed1.getMarginItemAssure4().doubleValue() / new Double(100.0D).doubleValue()));
        }
        if (localBreed1.getMarginItemAssure5() != null) {
          localBreed1.setMarginItemAssure5(Double.valueOf(localBreed1.getMarginItemAssure5().doubleValue() / new Double(100.0D).doubleValue()));
        }
        if (localBreed1.getMarginItemAssure1_S() != null) {
          localBreed1.setMarginItemAssure1_S(Double.valueOf(localBreed1.getMarginItemAssure1_S().doubleValue() / new Double(100.0D).doubleValue()));
        }
        if (localBreed1.getMarginItemAssure2_S() != null) {
          localBreed1.setMarginItemAssure2_S(Double.valueOf(localBreed1.getMarginItemAssure2_S().doubleValue() / new Double(100.0D).doubleValue()));
        }
        if (localBreed1.getMarginItemAssure3_S() != null) {
          localBreed1.setMarginItemAssure3_S(Double.valueOf(localBreed1.getMarginItemAssure3_S().doubleValue() / new Double(100.0D).doubleValue()));
        }
        if (localBreed1.getMarginItemAssure4_S() != null) {
          localBreed1.setMarginItemAssure4_S(Double.valueOf(localBreed1.getMarginItemAssure4_S().doubleValue() / new Double(100.0D).doubleValue()));
        }
        if (localBreed1.getMarginItemAssure5_S() != null) {
          localBreed1.setMarginItemAssure5_S(Double.valueOf(localBreed1.getMarginItemAssure5_S().doubleValue() / new Double(100.0D).doubleValue()));
        }
      }
      ...
      if (str4.trim().equals("create"))
      {
        ...
        if (("1".equals(str1)) && (localBreedForm.getMarginItem1() != null) && (!"".equals(localBreedForm.getMarginItem1())) && (localBreedForm.getMarginItemAssure1() != null) && (!"".equals(localBreedForm.getMarginItemAssure1())))
        {
        ...
        if (("1".equals(localObject1)) && (localBreedForm.getMarginItem2() != null) && (!"".equals(localBreedForm.getMarginItem2())) && (localBreedForm.getMarginItemAssure2() != null) && (!"".equals(localBreedForm.getMarginItemAssure2())))
        {
        ...
        if (("1".equals(localObject2)) && (localBreedForm.getMarginItem3() != null) && (!"".equals(localBreedForm.getMarginItem3())) && (localBreedForm.getMarginItemAssure3() != null) && (!"".equals(localBreedForm.getMarginItemAssure3())))
        {
        ...
        if (("1".equals(str2)) && (localBreedForm.getMarginItem4() != null) && (!"".equals(localBreedForm.getMarginItem4())) && (localBreedForm.getMarginItemAssure4() != null) && (!"".equals(localBreedForm.getMarginItemAssure4())))
        {
        ...
        if (("1".equals(str3)) && (localBreedForm.getMarginItem5() != null) && (!"".equals(localBreedForm.getMarginItem5())) && (localBreedForm.getMarginItemAssure5() != null) && (!"".equals(localBreedForm.getMarginItemAssure5())))
        {
