...
public class VoucherService
{
  ...
  public List voucherCheckDateList()
  {
    ...
    if ((localList1 != null) && (localList1.size() > 0))
    {
      ...
      {
        localObject4 = (String)((Map)localList1.get(j)).get("balanceDate");
    ...
    if ((localList2 != null) && (localList2.size() > 0) && (i != 0))
    {
      ...
      localObject4 = (String)((Map)localList2.get(0)).get("balanceDate");
      localObject2 = localObject4;
    }
    if ((localObject2 == null) || ("".equals(localObject2))) {
      localObject2 = "2001-01-01";
    }
    Object localObject3 = "select balanceDate balanceDate from (select to_char(sysdate,'yyyy-MM-dd') balanceDate from dual union select to_char(t.audittime,'yyyy-MM-dd') balanceDate from f_voucher t where t.status='audited' and t.b_date is null and t.audittime>to_date('" + (String)localObject2 + " 23:59:59','yyyy-MM-dd hh24:mi:ss') and t.summaryno not like '2%' order by balanceDate)";
  ...
  public int createVoucherFast(String paramString1, String paramString2, String paramString3, String paramString4, String paramString5, String paramString6, String paramString7)
  {
    int i = 0;
    double d = 0.0D;
    try
    ...
    if (i == 0) {
      i = this.voucherDao.callStoredProcedure("FN_F_CreateVoucher('" + paramString1 + "','" + paramString2 + "','" + paramString3 + "','" + paramString4 + "'," + d + "," + paramString5 + ",'" + paramString6 + "')");
    }
    return i;
  }
  ...
  public void createChannel(Channel paramChannel)
  {
    ...
    Object[] arrayOfObject = { paramChannel.getCode(), paramChannel.getName(), paramChannel.getSummaryNo(), paramChannel.getDebitCode(), paramChannel.getCreditCode(), paramChannel.getNeedContractNo(), paramChannel.getNote() };
  ...
  public void updateChannel(Channel paramChannel)
  {
    ...
    logger.debug("sql: " + str);
    Object[] arrayOfObject = { paramChannel.getName(), paramChannel.getSummaryNo(), paramChannel.getDebitCode(), paramChannel.getCreditCode(), paramChannel.getNeedContractNo(), paramChannel.getNote(), paramChannel.getCode() };
    for (int i = 0; i < arrayOfObject.length; i++) {
      logger.debug("params[" + i + "]: " + arrayOfObject[i]);
    }
