...
public class SettleMatchDataRestore
  implements Behaviour
{
  private final transient Log logger = LogFactory.getLog(SettleMatchDataRestore.class);
  @Autowired
  ...
  public void deal(SettleObject paramSettleObject)
  {
    ...
    this.settleMatchService.settleMatchRestore(localSettleMatch);
  }
}
