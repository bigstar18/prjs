...
public class TradeMonitorDAOJdbc
  extends BaseDAOJdbc
  implements TradeMonitorDAO
{
  public ObjSet getQuotation(int paramInt1, int paramInt2, String paramString1, String paramString2)
  {
    ...
    i = getJdbcTemplate().queryForInt(str1);
    ...
    return ObjSet.getInstance(getJdbcTemplate().queryForList(str2), i, paramInt1, paramInt2);
  }
  ...
  public ObjSet getFirmHoldSum(int paramInt1, int paramInt2, String paramString1, String paramString2)
  {
    ...
    String str2 = " select (HoldQty+GageQty) HoldQty,FirmID,decode(BS_Flag, 1, '买', 2, '卖') as BS_Flag,to_char(round(EvenPrice,2),'fm999,999,999,999,990.00') EvenPrice,commodityid from t_FirmHoldSum ";
    if ((paramString1 != null) && (!paramString1.trim().equals("")))
    {
      str1 = str1 + paramString1;
      str2 = str2 + paramString1;
