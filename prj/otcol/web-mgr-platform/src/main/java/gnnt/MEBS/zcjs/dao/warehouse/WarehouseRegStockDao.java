...
public class WarehouseRegStockDao extends DaoHelper {
	...
	public void addRegStock(WarehouseRegStock paramWarehouseRegStock) {
		...
		Object[] arrayOfObject = { paramWarehouseRegStock.getRegStockId(), "", Long.valueOf(paramWarehouseRegStock.getBreedId()),
				paramWarehouseRegStock.getFirmId(), paramWarehouseRegStock.getWarehouseId(), paramWarehouseRegStock.getStockId(),
				Double.valueOf(paramWarehouseRegStock.getInitWeight()), Double.valueOf(paramWarehouseRegStock.getWeight()),
				Double.valueOf(paramWarehouseRegStock.getFrozenWeight()), Double.valueOf(paramWarehouseRegStock.getUnitWeight()),
				Integer.valueOf(paramWarehouseRegStock.getType()), paramWarehouseRegStock.getCreateTime(), paramWarehouseRegStock.getModifyTime() };
	...
	private class UpdateRegstockFrozen extends StoredProcedure {
