...
public class DealNotStandardStockToEnterWareAmountBehaviour
  implements Behaviour
{
  private final transient Log logger = LogFactory.getLog(DealNotStandardStockToEnterWareAmountBehaviour.class);
  @Autowired
