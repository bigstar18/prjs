  ...
  extends MultiActionController
{
  ...
  public ModelAndView queryFirmBalance(HttpServletRequest request, HttpServletResponse response)
    throws Exception
  {
  ...
  public ModelAndView firmFundsForward(HttpServletRequest request, HttpServletResponse response)
    throws Exception
  {
  ...
  public ModelAndView queryMarketBalance(HttpServletRequest request, HttpServletResponse response)
    throws Exception
  {
  ...
  public ModelAndView queryContractBalance(HttpServletRequest request, HttpServletResponse response)
    throws Exception
  {
  ...
  public ModelAndView redoBalance(HttpServletRequest request, HttpServletResponse response)
    throws Exception
  {
    this.logger.debug("entering 'redoBalance' method...");
    VoucherService vs = (VoucherService)SysData.getBean("f_voucherService");
    String redoBeginDate = RequestUtils.getRequiredStringParameter(request, "redoBeginDate");
  ...
  public ModelAndView queryClientLedger(HttpServletRequest request, HttpServletResponse response)
    throws Exception
  {
  ...
  public ModelAndView queryFundflow(HttpServletRequest request, HttpServletResponse response)
    throws Exception
  {
  ...
  public ModelAndView queryLedger(HttpServletRequest request, HttpServletResponse response)
    throws Exception
  {
  ...
  public ModelAndView queryAccountLedger(HttpServletRequest request, HttpServletResponse response)
    throws Exception
  {
  ...
  public ModelAndView queryAccountBook(HttpServletRequest request, HttpServletResponse response)
    throws Exception
  {
  ...
  public ModelAndView queryDailyBalance(HttpServletRequest request, HttpServletResponse response)
    throws Exception
  {
  ...
  public ModelAndView reportDailyBalance(HttpServletRequest request, HttpServletResponse response)
    throws Exception
  {
