...
public class EnterWareServiceTest
  extends AbstractTest
{
  public void testNewStatus()
  {
    Map localMap = this.workflow.getLastMsg(3, 1, "enterWare");
  ...
  {
    Map localMap1 = this.workflow.getLastMsg(1, 9, "enterWare");
  ...
  {
    Map localMap1 = this.workflow.getLastMsg(1, 1, "enterWare");
    int i = ((Integer)localMap1.get("result")).intValue();
    assertEquals(1, i);
    List localList = (List)localMap1.get("transHandleList");
  ...
  {
    Map localMap1 = this.workflow.getLastMsg(2, 0, "enterWare");
    int i = ((Integer)localMap1.get("result")).intValue();
    assertEquals(1, i);
    List localList = (List)localMap1.get("transHandleList");
    assertEquals(2, localList.size());
  ...
  {
    List localList = this.workflow.getFinalStatus("enterWare");
  ...
  {
    Map localMap = this.workflow.getLastMsg(1, 9, "enterWare");
