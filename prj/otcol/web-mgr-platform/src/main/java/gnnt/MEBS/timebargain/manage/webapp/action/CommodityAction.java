  ...
  extends BaseAction
{
    ...
    throws Exception
  {
    ...
    try
    {
      ...
      {
        localObject1 = (LabelValue)localList2.get(1);
      ...
      {
        localObject2 = (LabelValue)((List)localObject1).get(1);
      ...
      if (!str2.trim().equals("create"))
      {
        ...
        localObject4 = (MarketManager)getBean("marketManager");
        localObject5 = ((MarketManager)localObject4).getMarketById(localCommodity.getMarketCode());
        ...
        {
          if ((localCommodity.getMarginItem1() != null) && (localCommodity.getMarginItem1_S() != null) && (localCommodity.getMarginItemAssure1() != null) && (localCommodity.getMarginItemAssure1_S() != null) && (localCommodity.getMarginItem1().toString().equals(localCommodity.getMarginItem1_S().toString())) && (localCommodity.getMarginItemAssure1().toString().equals(localCommodity.getMarginItemAssure1_S().toString()))) {
            localObject2 = "1";
          }
          if ((localCommodity.getMarginItem2() != null) && (localCommodity.getMarginItem2_S() != null) && (localCommodity.getMarginItemAssure2() != null) && (localCommodity.getMarginItemAssure2_S() != null) && (localCommodity.getMarginItem2().toString().equals(localCommodity.getMarginItem2_S().toString())) && (localCommodity.getMarginItemAssure2().toString().equals(localCommodity.getMarginItemAssure2_S().toString()))) {
            str5 = "1";
          }
          if ((localCommodity.getMarginItem3() != null) && (localCommodity.getMarginItem3_S() != null) && (localCommodity.getMarginItemAssure3() != null) && (localCommodity.getMarginItemAssure3_S() != null) && (localCommodity.getMarginItem3().toString().equals(localCommodity.getMarginItem3_S().toString())) && (localCommodity.getMarginItemAssure3().toString().equals(localCommodity.getMarginItemAssure3_S().toString()))) {
            str6 = "1";
          }
          if ((localCommodity.getMarginItem4() != null) && (localCommodity.getMarginItem4_S() != null) && (localCommodity.getMarginItemAssure4() != null) && (localCommodity.getMarginItemAssure4_S() != null) && (localCommodity.getMarginItem4().toString().equals(localCommodity.getMarginItem4_S().toString())) && (localCommodity.getMarginItemAssure4().toString().equals(localCommodity.getMarginItemAssure4_S().toString()))) {
            str7 = "1";
          }
          if ((localCommodity.getMarginItem5() != null) && (localCommodity.getMarginItem5_S() != null) && (localCommodity.getMarginItemAssure5() != null) && (localCommodity.getMarginItemAssure5_S() != null) && (localCommodity.getMarginItem5().toString().equals(localCommodity.getMarginItem5_S().toString())) && (localCommodity.getMarginItemAssure5().toString().equals(localCommodity.getMarginItemAssure5_S().toString()))) {
            str8 = "1";
          }
          ...
          localCommodity.setMaxFeeRate(Arith.mul(localCommodity.getMaxFeeRate() == null ? new Double(0.0D) : localCommodity.getMaxFeeRate(), new Double(100.0D)));
        }
      ...
      else
      {
        ...
        localObject4 = ((BreedManager)localObject3).getBreedById(localCommodityForm.getBreedID().toString());
        ...
        if ((((Breed)localObject4).getFirmMaxHoldQtyAlgr() != null) && ("1".equals(((Breed)localObject4).getFirmMaxHoldQtyAlgr().toString())))
        {
          str23 = "1";
        ...
        if ((((Breed)localObject4).getSettleMarginAlgr_B() != null) && ("1".equals(((Breed)localObject4).getSettleMarginAlgr_B().toString())))
        {
          str19 = "1";
        ...
        if ((((Breed)localObject4).getSettleMarginAlgr_S() != null) && ("1".equals(((Breed)localObject4).getSettleMarginAlgr_S().toString())))
        {
          str20 = "1";
        ...
        if ((((Breed)localObject4).getMarginItem1() != null) && (((Breed)localObject4).getMarginItem1_S() != null) && (((Breed)localObject4).getMarginItemAssure1() != null) && (((Breed)localObject4).getMarginItemAssure1_S() != null) && (((Breed)localObject4).getMarginItem1().toString().equals(((Breed)localObject4).getMarginItem1_S().toString())) && (((Breed)localObject4).getMarginItemAssure1().toString().equals(((Breed)localObject4).getMarginItemAssure1_S().toString()))) {
          localObject2 = "1";
        }
        if ((((Breed)localObject4).getMarginItem2() != null) && (((Breed)localObject4).getMarginItem2_S() != null) && (((Breed)localObject4).getMarginItemAssure2() != null) && (((Breed)localObject4).getMarginItemAssure2_S() != null) && (((Breed)localObject4).getMarginItem2().toString().equals(((Breed)localObject4).getMarginItem2_S().toString())) && (((Breed)localObject4).getMarginItemAssure2().toString().equals(((Breed)localObject4).getMarginItemAssure2_S().toString()))) {
          str5 = "1";
        }
        if ((((Breed)localObject4).getMarginItem3() != null) && (((Breed)localObject4).getMarginItem3_S() != null) && (((Breed)localObject4).getMarginItemAssure3() != null) && (((Breed)localObject4).getMarginItemAssure3_S() != null) && (((Breed)localObject4).getMarginItem3().toString().equals(((Breed)localObject4).getMarginItem3_S().toString())) && (((Breed)localObject4).getMarginItemAssure3().toString().equals(((Breed)localObject4).getMarginItemAssure3_S().toString()))) {
          str6 = "1";
        }
        if ((((Breed)localObject4).getMarginItem4() != null) && (((Breed)localObject4).getMarginItem4_S() != null) && (((Breed)localObject4).getMarginItemAssure4() != null) && (((Breed)localObject4).getMarginItemAssure4_S() != null) && (((Breed)localObject4).getMarginItem4().toString().equals(((Breed)localObject4).getMarginItem4_S().toString())) && (((Breed)localObject4).getMarginItemAssure4().toString().equals(((Breed)localObject4).getMarginItemAssure4_S().toString()))) {
          str7 = "1";
        }
        if ((((Breed)localObject4).getMarginItem5() != null) && (((Breed)localObject4).getMarginItem5_S() != null) && (((Breed)localObject4).getMarginItemAssure5() != null) && (((Breed)localObject4).getMarginItemAssure5_S() != null) && (((Breed)localObject4).getMarginItem5().toString().equals(((Breed)localObject4).getMarginItem5_S().toString())) && (((Breed)localObject4).getMarginItemAssure5().toString().equals(((Breed)localObject4).getMarginItemAssure5_S().toString()))) {
          str8 = "1";
        }
        if ((localCommodity.getLimitCmdtyQty() != null) && ("-1".equals(localCommodity.getLimitCmdtyQty().toString()))) {
          str9 = "2";
        ...
        localCommodity.setMaxFeeRate(Arith.mul(((Breed)localObject4).getMaxFeeRate() == null ? new Double(0.0D) : ((Breed)localObject4).getMaxFeeRate(), new Double(100.0D)));
    ...
    throws Exception
  {
    ...
    {
      localObject1 = Integer.valueOf(Integer.parseInt(arrayOfString[i]));
      localObject2 = new TradeTime();
    ...
    try
    {
      ...
      if ((localCommodity.getFeeAlgr() != null) && ("1".equals(localCommodity.getFeeAlgr().toString())))
      {
        ...
        localCommodity.setHistoryCloseFeeRate_B(Double.valueOf(localCommodity.getHistoryCloseFeeRate_B().doubleValue() / new Double(100.0D).doubleValue()));
        localCommodity.setHistoryCloseFeeRate_S(Double.valueOf(localCommodity.getHistoryCloseFeeRate_S().doubleValue() / new Double(100.0D).doubleValue()));
        localCommodity.setTodayCloseFeeRate_B(Double.valueOf(localCommodity.getTodayCloseFeeRate_B().doubleValue() / new Double(100.0D).doubleValue()));
        localCommodity.setTodayCloseFeeRate_S(Double.valueOf(localCommodity.getTodayCloseFeeRate_S().doubleValue() / new Double(100.0D).doubleValue()));
        localCommodity.setForceCloseFeeRate_B(Double.valueOf(localCommodity.getForceCloseFeeRate_B().doubleValue() / new Double(100.0D).doubleValue()));
        localCommodity.setForceCloseFeeRate_S(Double.valueOf(localCommodity.getForceCloseFeeRate_S().doubleValue() / new Double(100.0D).doubleValue()));
      }
      if ((localCommodity.getSettleFeeAlgr() != null) && ("1".equals(localCommodity.getSettleFeeAlgr().toString())))
      {
        localCommodity.setSettleFeeRate_B(Double.valueOf(localCommodity.getSettleFeeRate_B().doubleValue() / new Double(100.0D).doubleValue()));
        localCommodity.setSettleFeeRate_S(Double.valueOf(localCommodity.getSettleFeeRate_S().doubleValue() / new Double(100.0D).doubleValue()));
      }
      if ((localCommodity.getSettleMarginAlgr_B() != null) && ("1".equals(localCommodity.getSettleMarginAlgr_B().toString()))) {
        localCommodity.setSettleMarginRate_B(Double.valueOf(localCommodity.getSettleMarginRate_B().doubleValue() / new Double(100.0D).doubleValue()));
      }
      if ((localCommodity.getSettleMarginAlgr_S() != null) && ("1".equals(localCommodity.getSettleMarginAlgr_S().toString()))) {
        localCommodity.setSettleMarginRate_S(Double.valueOf(localCommodity.getSettleMarginRate_S().doubleValue() / new Double(100.0D).doubleValue()));
      }
      if ((localCommodity.getPayoutAlgr() != null) && ("1".equals(localCommodity.getPayoutAlgr().toString()))) {
      ...
      if ((localCommodity.getMarginAlgr() != null) && ("1".equals(localCommodity.getMarginAlgr().toString())))
      {
        ...
        if (localCommodity.getMarginItem1_S() != null) {
          localCommodity.setMarginItem1_S(Double.valueOf(localCommodity.getMarginItem1_S().doubleValue() / new Double(100.0D).doubleValue()));
        }
        if (localCommodity.getMarginItem2_S() != null) {
          localCommodity.setMarginItem2_S(Double.valueOf(localCommodity.getMarginItem2_S().doubleValue() / new Double(100.0D).doubleValue()));
        }
        if (localCommodity.getMarginItem3_S() != null) {
          localCommodity.setMarginItem3_S(Double.valueOf(localCommodity.getMarginItem3_S().doubleValue() / new Double(100.0D).doubleValue()));
        }
        if (localCommodity.getMarginItem4_S() != null) {
          localCommodity.setMarginItem4_S(Double.valueOf(localCommodity.getMarginItem4_S().doubleValue() / new Double(100.0D).doubleValue()));
        }
        if (localCommodity.getMarginItem5_S() != null) {
          localCommodity.setMarginItem5_S(Double.valueOf(localCommodity.getMarginItem5_S().doubleValue() / new Double(100.0D).doubleValue()));
        }
        if (localCommodity.getMarginItemAssure1() != null) {
          localCommodity.setMarginItemAssure1(Double.valueOf(localCommodity.getMarginItemAssure1().doubleValue() / new Double(100.0D).doubleValue()));
        }
        if (localCommodity.getMarginItemAssure2() != null) {
          localCommodity.setMarginItemAssure2(Double.valueOf(localCommodity.getMarginItemAssure2().doubleValue() / new Double(100.0D).doubleValue()));
        }
        if (localCommodity.getMarginItemAssure3() != null) {
          localCommodity.setMarginItemAssure3(Double.valueOf(localCommodity.getMarginItemAssure3().doubleValue() / new Double(100.0D).doubleValue()));
        }
        if (localCommodity.getMarginItemAssure4() != null) {
          localCommodity.setMarginItemAssure4(Double.valueOf(localCommodity.getMarginItemAssure4().doubleValue() / new Double(100.0D).doubleValue()));
        }
        if (localCommodity.getMarginItemAssure5() != null) {
          localCommodity.setMarginItemAssure5(Double.valueOf(localCommodity.getMarginItemAssure5().doubleValue() / new Double(100.0D).doubleValue()));
        }
        if (localCommodity.getMarginItemAssure1_S() != null) {
          localCommodity.setMarginItemAssure1_S(Double.valueOf(localCommodity.getMarginItemAssure1_S().doubleValue() / new Double(100.0D).doubleValue()));
        }
        if (localCommodity.getMarginItemAssure2_S() != null) {
          localCommodity.setMarginItemAssure2_S(Double.valueOf(localCommodity.getMarginItemAssure2_S().doubleValue() / new Double(100.0D).doubleValue()));
        }
        if (localCommodity.getMarginItemAssure3_S() != null) {
          localCommodity.setMarginItemAssure3_S(Double.valueOf(localCommodity.getMarginItemAssure3_S().doubleValue() / new Double(100.0D).doubleValue()));
        }
        if (localCommodity.getMarginItemAssure4_S() != null) {
          localCommodity.setMarginItemAssure4_S(Double.valueOf(localCommodity.getMarginItemAssure4_S().doubleValue() / new Double(100.0D).doubleValue()));
        }
        if (localCommodity.getMarginItemAssure5_S() != null) {
          localCommodity.setMarginItemAssure5_S(Double.valueOf(localCommodity.getMarginItemAssure5_S().doubleValue() / new Double(100.0D).doubleValue()));
        }
      }
      if ((localCommodity.getFirmMaxHoldQtyAlgr() != null) && ("1".equals(localCommodity.getFirmMaxHoldQtyAlgr().toString()))) {
      ...
      if (str2.trim().equals("create"))
      {
        if (("1".equals(str5)) && (localCommodityForm.getMarginItem1() != null) && (!"".equals(localCommodityForm.getMarginItem1())) && (localCommodityForm.getMarginItemAssure1() != null) && (!"".equals(localCommodityForm.getMarginItemAssure1())))
        {
        ...
        if (("1".equals(str3)) && (localCommodityForm.getMarginItem2() != null) && (!"".equals(localCommodityForm.getMarginItem2())) && (localCommodityForm.getMarginItemAssure2() != null) && (!"".equals(localCommodityForm.getMarginItemAssure2())))
        {
        ...
        if (("1".equals(localObject1)) && (localCommodityForm.getMarginItem3() != null) && (!"".equals(localCommodityForm.getMarginItem3())) && (localCommodityForm.getMarginItemAssure3() != null) && (!"".equals(localCommodityForm.getMarginItemAssure3())))
        {
        ...
        if (("1".equals(localObject2)) && (localCommodityForm.getMarginItem4() != null) && (!"".equals(localCommodityForm.getMarginItem4())) && (localCommodityForm.getMarginItemAssure4() != null) && (!"".equals(localCommodityForm.getMarginItemAssure4())))
        {
        ...
        if (("1".equals(str4)) && (localCommodityForm.getMarginItem5() != null) && (!"".equals(localCommodityForm.getMarginItem5())) && (localCommodityForm.getMarginItemAssure5() != null) && (!"".equals(localCommodityForm.getMarginItemAssure5())))
        {
  ...
  public ActionForward marketChg(ActionMapping paramActionMapping, ActionForm paramActionForm, HttpServletRequest paramHttpServletRequest, HttpServletResponse paramHttpServletResponse)
    throws Exception
  {
    if (this.log.isDebugEnabled()) {
    ...
    try
    {
      paramHttpServletRequest.setAttribute("breedSelect", localLookupManager.getSelectLabelValueByTable("Breed", "BreedName", "BreedID", " where MarketCode='" + paramHttpServletRequest.getParameter("MarketCode") + "'", (short)1));
    }
    catch (Exception localException)
    {
  ...
  public ActionForward updateStatus(ActionMapping paramActionMapping, ActionForm paramActionForm, HttpServletRequest paramHttpServletRequest, HttpServletResponse paramHttpServletResponse)
    throws Exception
  {
    if (this.log.isDebugEnabled()) {
  ...
  public ActionForward queryCommodity(ActionMapping paramActionMapping, ActionForm paramActionForm, HttpServletRequest paramHttpServletRequest, HttpServletResponse paramHttpServletResponse)
    throws Exception
  {
    if (this.log.isDebugEnabled()) {
  ...
  private void getBreedSelectAttribute(HttpServletRequest paramHttpServletRequest)
    throws Exception
  {
    LookupManager localLookupManager = (LookupManager)getBean("lookupManager");
    paramHttpServletRequest.setAttribute("breedSelect", localLookupManager.getSelectLabelValueByTable("T_A_BREED", "BreedName", "BreedID", " where  BreedID=" + paramHttpServletRequest.getParameter("breedID"), (short)1));
    paramHttpServletRequest.setAttribute("cmdtySortSelect", localLookupManager.getSelectLabelValueByTable("T_A_CMDTYSORT", "SortName", "SortID", " where SortID in (select SortID from T_A_BREED where BreedID=" + paramHttpServletRequest.getParameter("breedID") + ") order by SortID", (short)1));
  }
}
