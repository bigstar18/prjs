...
public class BargainManagerController
  extends BaseController
{
  ...
  public ModelAndView getHisTradelist(HttpServletRequest paramHttpServletRequest, HttpServletResponse paramHttpServletResponse)
    throws Exception
  {
  ...
  public ModelAndView getDeliveryList(HttpServletRequest paramHttpServletRequest, HttpServletResponse paramHttpServletResponse)
    throws Exception
  {
  ...
  public ModelAndView auditing(HttpServletRequest paramHttpServletRequest, HttpServletResponse paramHttpServletResponse)
    throws Exception
  {
    long l = Long.parseLong(paramHttpServletRequest.getParameter("tradeId"));
    HisTrade localHisTrade = getBeanService().getHisTrade(l);
  ...
  public ModelAndView autoDelivery(HttpServletRequest paramHttpServletRequest, HttpServletResponse paramHttpServletResponse)
    throws Exception
  {
    long l = Long.parseLong(paramHttpServletRequest.getParameter("tradeId"));
    HisTrade localHisTrade = getBeanService().getHisTrade(l);
  ...
  public ModelAndView auditingFaitch(HttpServletRequest paramHttpServletRequest, HttpServletResponse paramHttpServletResponse)
    throws Exception
  {
    String str = "";
  ...
  public ModelAndView deleteMatch(HttpServletRequest paramHttpServletRequest, HttpServletResponse paramHttpServletResponse)
    throws Exception
  {
  ...
  public ModelAndView send(HttpServletRequest paramHttpServletRequest, HttpServletResponse paramHttpServletResponse)
    throws Exception
  {
    String str1 = AclCtrl.getLogonID(paramHttpServletRequest);
    long l = Long.parseLong(paramHttpServletRequest.getParameter("tradeNo"));
  ...
  public ModelAndView selectFit(HttpServletRequest paramHttpServletRequest, HttpServletResponse paramHttpServletResponse)
    throws Exception
  {
  ...
  public ModelAndView match(HttpServletRequest paramHttpServletRequest, HttpServletResponse paramHttpServletResponse)
    throws Exception
  {
  ...
  public ModelAndView matchForward(HttpServletRequest paramHttpServletRequest, HttpServletResponse paramHttpServletResponse)
    throws Exception
  {
    long l = Long.parseLong(paramHttpServletRequest.getParameter("tradeId"));
    HisTrade localHisTrade = getBeanService().getHisTrade(l);
  ...
  public ModelAndView dealMatch(HttpServletRequest paramHttpServletRequest, HttpServletResponse paramHttpServletResponse)
    throws Exception
  {
    String str1 = "";
