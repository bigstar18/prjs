...
public class KernelEngineBID
  extends KernelEngine
{
    ...
    throws SQLException
  {
    ...
    System.out.println("======保证金系数是 " + localCommodityVO.b_security + "  交易数量是 " + localCommodityVO.totalAmount + "  保证金费用折扣是 " + localTradeUserVO.feecut + "  手续费系数是 " + localCommodityVO.b_fee + " 手续费折扣是 " + localTradeUserVO.feecutfee);
    if (i1 == 0)
    {
    ...
    else if (i1 == 1)
    {
      ...
      d1 = Arith.format(Arith.mul(Arith.mul(Arith.mul(d3, localCommodityVO.b_security), d6), localCommodityVO.tradeUnit) * localCommodityVO.totalAmount, 2);
    }
    if (j == 1) {
      if (i3 == 0)
      {
      ...
      else if (i3 == 1)
      {
        ...
        d2 = Arith.format(Arith.mul(Arith.mul(Arith.mul(d3, localCommodityVO.b_fee), d5), localCommodityVO.tradeUnit) * localCommodityVO.totalAmount, 2);
      }
    }
    ...
    throws SQLException
  {
    ...
    {
      double d2 = 0.0D;
      MoneyVO[] arrayOfMoneyVO = this.TRADEDAO.getMoneyList("where (operation=404 or operation=407) and firmid='" + str + "' and note='" + paramLong + "'", paramConnection);
      ...
      d2 = 0.0D;
      arrayOfMoneyVO = this.TRADEDAO.getMoneyList("where (operation=403 or operation=413) and firmid='" + str + "' and note='" + paramLong + "'", paramConnection);
      if (arrayOfMoneyVO != null) {
    ...
    throws SQLException
  {
    ...
    else if (j == 1)
    {
      ...
      if (localCommodityVO.tradeMode == 2)
      {
        ...
        if (localCommodityVO.userID.equals(paramString2))
        {
          d1 = Arith.format(Arith.mul(Arith.mul(Arith.mul(paramDouble, localCommodityVO.b_security), d2), localCommodityVO.tradeUnit) * paramLong, 2);
          System.out.println("取买方" + paramString2 + "保证金 =" + d1 + "  保证金系数是 " + localCommodityVO.b_security);
          System.out.println();
        }
        else
        {
          d1 = Arith.format(Arith.mul(Arith.mul(Arith.mul(paramDouble, localCommodityVO.s_security), d2), localCommodityVO.tradeUnit) * paramLong, 2);
          System.out.println("取卖方" + paramString2 + "保证金 =" + d1 + "  保证金系数是 " + localCommodityVO.s_security);
          System.out.println();
        }
      }
  ...
  public CommodityVO[] getCurCommodityList()
  {
    ...
    for (i = 0; i < arrayOfCommodityVO.length; i++) {
    ...
    if (i == 1) {
      ...
      else if (k == 1)
      {
        ...
        if (localCommodityVO.tradeMode == 2)
        {
          ...
          if (localCommodityVO.userID.equals(paramString2))
          {
            d1 = Arith.format(Arith.mul(Arith.mul(Arith.mul(paramDouble, localCommodityVO.b_fee), d2), localCommodityVO.tradeUnit) * paramLong, 2);
            System.out.println();
            System.out.println("买方 " + paramString2 + " 手续费为 " + d1 + "手续费系数为 " + localCommodityVO.b_fee);
          }
          else
          {
            d1 = Arith.format(Arith.mul(Arith.mul(Arith.mul(paramDouble, localCommodityVO.s_fee), d2), localCommodityVO.tradeUnit) * paramLong, 2);
            System.out.println();
            System.out.println("卖方 " + paramString2 + " 手续费为 " + d1 + "手续费系数为 " + localCommodityVO.s_fee);
          }
        }
    ...
    try
    {
      ...
      if (arrayOfCommodityVO != null) {
        for (int i = 0; i < arrayOfCommodityVO.length; i++)
        {
          ...
          if ((localCommodityVO == null) || ((localCommodityVO.bargainFlag == 0) && (((this.TRADESTATUS.getCurStatus() == 2) && (localCommodityVO.lastPrice <= 0.0D)) || (this.TRADESTATUS.getCurStatus() != 2))))
          {
            ...
            {
              FlowControlVO[] arrayOfFlowControlVO = this.TRADEDAO.getFlowControlList("where unitType=1 and tradePartition=" + this.PARTITIONID + " and unitID=" + getNextSection(), localConnection);
              if (arrayOfFlowControlVO != null) {
                addQuotation(localCommodityVO.code, (int)arrayOfFlowControlVO[0].durativeTime, new Timestamp(System.currentTimeMillis()), 0.0D, localCommodityVO.section, -1L, this.PARTITIONID, " ", 0L);
              } else {
                addQuotation(localCommodityVO.code, this.TRADESTATUS.getCountdownTime(), new Timestamp(System.currentTimeMillis()), 0.0D, localCommodityVO.section, -1L, this.PARTITIONID, " ", 0L);
              }
            }
          }
        }
  ...
  protected void resumeTradeStatus()
    throws SQLException
  {
    ...
    if (i == 2)
    {
      ...
      if (arrayOfCommodityVO != null) {
        for (n = 0; n < arrayOfCommodityVO.length; n++) {
          if ((arrayOfCommodityVO[n].section == j) && (arrayOfCommodityVO[n].lastTime != null) && (arrayOfCommodityVO[n].lastTime.getTime() > l)) {
            l = arrayOfCommodityVO[n].lastTime.getTime();
          }
        }
      }
      if ((localTimestamp2.getTime() > localTimestamp1.getTime() - k * 1000) && (l + m * 1000 > this.TRADESTATUS.getPartLastEndTime().getTime())) {
    ...
    for (;;)
    {
      try
      {
        try
        {
          ...
          if (((k != 4) && (k != 5) && (k != 6) && (this.COMMODITYTABLE != null) && (this.COMMODITYTABLE.size() > 0) && (k != 1)) || ((k == 1) && (n > 0)))
          {
            Object localObject1;
            if ((k != 8) && (k != 2))
            {
              localObject1 = this.TRADEDAO.getFlowControlList("where unitType=2 and tradePartition=" + this.PARTITIONID + " and unitID=" + (n - 1), localConnection);
              int i5;
              Object localObject3;
              ...
              localObject1 = this.TRADEDAO.getFlowControlList("where unitType=1 and tradePartition=" + this.PARTITIONID + " and unitID=" + n, localConnection);
              if (localObject1 != null)
              {
                i5 = 0;
                if (i5 < localObject1.length)
            ...
            else
            {
              ...
              if ((l6 >= l1) && (((k == 2) && (l6 <= l7)) || (l6 <= l2)))
              {
                if (k != 2)
                {
                  ...
                  localObject1 = this.COMMODITYTABLE.elements();
                  if (((Enumeration)localObject1).hasMoreElements())
                  {
                    ...
                    synchronized (localObject2)
                    {
                      if ((((CommodityVO)localObject2).section == n) && (((CommodityVO)localObject2).bargainFlag == 0)) {
                        addQuotation(((CommodityVO)localObject2).code, i3, new Timestamp(l6), 0.0D, n, -1L, this.PARTITIONID, " ", ((CommodityVO)localObject2).amount, localConnection);
                      }
                    }
                    continue;
                  }
                ...
                else
                {
                  ...
                  if (j == 0)
                  {
                    localObject1 = this.TRADEDAO.getTradeQuotationList("where countdownTime>0", localConnection);
                  ...
                  if ((l6 >= l8 - i2 * 1000) && (j == 0))
                  {
                    ...
                    if (((Enumeration)localObject1).hasMoreElements())
                    {
                      ...
                      synchronized (localObject2)
                      {
                        ...
                        {
                          this.TRADEDAO.delTradeQuotation("where tradePartition=" + this.PARTITIONID + " and code='" + ((CommodityVO)localObject2).code + "'", localConnection);
                          String str = " ";
                          if ((((CommodityVO)localObject2).lastUserID != null) && (!((CommodityVO)localObject2).lastUserID.equals(""))) {
                          ...
                          addQuotation(((CommodityVO)localObject2).code, i3, localTimestamp, ((CommodityVO)localObject2).lastPrice, m, ((CommodityVO)localObject2).lastSubmitID, this.PARTITIONID, str, ((CommodityVO)localObject2).amount, localConnection);
                        }
                      }
                      j = 1;
                      continue;
                  ...
                  if (localObject2 != null)
                  {
                    ...
                    if (i8 < ((List)localObject2).size())
                    {
                      ...
                      if (localCommodityVO1.tradeMode == 2)
                      {
                        ...
                        System.out.println("==========招标");
                        System.out.println();
                        ((BargainVO)localObject6).s_bail = getBail(((BargainVO)localObject6).code, ((BargainVO)localObject6).price, ((BargainVO)localObject6).amount, ((BargainVO)localObject6).userID, localConnection);
                        ((BargainVO)localObject6).b_bail = getBail(((BargainVO)localObject6).code, ((BargainVO)localObject6).price, ((BargainVO)localObject6).amount, localCommodityVO1.userID, localConnection);
                        d1 = getBail(((BargainVO)localObject6).code, ((BargainVO)localObject6).price, l9, ((BargainVO)localObject6).userID, localConnection);
                        d2 = getBail(((BargainVO)localObject6).code, ((BargainVO)localObject6).price, l9, localCommodityVO1.userID, localConnection);
                      }
                      if (localCommodityVO1.tradeMode == 2)
                      {
                        ((BargainVO)localObject6).s_poundage = getFee(((BargainVO)localObject6).code, ((BargainVO)localObject6).price, ((BargainVO)localObject6).amount, ((BargainVO)localObject6).userID, localConnection);
                        ((BargainVO)localObject6).b_poundage = getFee(((BargainVO)localObject6).code, ((BargainVO)localObject6).price, ((BargainVO)localObject6).amount, localCommodityVO1.userID, localConnection);
                        d3 = getFee(((BargainVO)localObject6).code, ((BargainVO)localObject6).price, l9, ((BargainVO)localObject6).userID, localConnection);
                        d4 = getFee(((BargainVO)localObject6).code, ((BargainVO)localObject6).price, l9, localCommodityVO1.userID, localConnection);
                      }
                      ...
                      TradeUserVO localTradeUserVO = this.TRADEDAO.getTradeUserForUpdate(((BargainVO)localObject6).userID, localConnection);
                      double d5 = 0.0D;
                      if (localCommodityVO1.tradeMode == 2)
                      {
                        ...
                        {
                          localTradeUserVO.totalSecurity += ((BargainVO)localObject6).b_bail + ((BargainVO)localObject6).b_poundage;
                          localTradeUserVO.tradeCount += 1;
                          localCallableStatement = localConnection.prepareCall("{ ?=call FN_F_UpdateFrozenFunds(?,?,?) }");
                          localCallableStatement.setString(2, localTradeUserVO.userCode);
                          localCallableStatement.setDouble(3, -1.0D * (((BargainVO)localObject6).b_bail + ((BargainVO)localObject6).b_poundage));
                          localCallableStatement.setString(4, "4");
                          localCallableStatement.registerOutParameter(1, 8);
                          localCallableStatement.executeUpdate();
                          ...
                          addDailyMoney(d5, localTradeUserVO.paymentForGoods, l10, ((BargainVO)localObject6).userID, ((BargainVO)localObject6).b_bail, 404, "", localConnection);
                          localCallableStatement = localConnection.prepareCall("{ ?=call FN_F_UpdateFunds(?,?,?,?) }");
                          localCallableStatement.setString(2, localTradeUserVO.userCode);
                          ...
                          localCallableStatement.executeUpdate();
                          d5 = localCallableStatement.getDouble(1);
                          addDailyMoney(d5, localTradeUserVO.paymentForGoods, l10, ((BargainVO)localObject6).userID, ((BargainVO)localObject6).b_poundage, 403, "", localConnection);
                          System.out.println();
                          System.out.println("<<<<<<<<<<<<<<<<<<<  生成买方方流水" + ((BargainVO)localObject6).userID + " 保证金为 " + ((BargainVO)localObject6).b_bail + "  手续费为 " + ((BargainVO)localObject6).b_poundage + ">>>>>>>>>>");
                          System.out.println();
                          localCommodityVO2 = this.TRADEDAO.getCommodity(((BargainVO)localObject6).commodityID, localConnection);
                          ...
                          localCallableStatement.executeUpdate();
                          d5 = localCallableStatement.getDouble(1);
                          addDailyMoney(d5, localTradeUserVO.paymentForGoods, l10, localCommodityVO2.userID, ((BargainVO)localObject6).s_bail, 404, "", localConnection);
                          localCallableStatement = localConnection.prepareCall("{ ?=call FN_F_UpdateFunds(?,?,?,?) }");
                          localCallableStatement.setString(2, localTradeUserVO.userCode);
                          localCallableStatement.setInt(3, 403);
                          ...
                          localCallableStatement.executeUpdate();
                          d5 = localCallableStatement.getDouble(1);
                          addDailyMoney(d5, localTradeUserVO.paymentForGoods, l10, localCommodityVO2.userID, ((BargainVO)localObject6).s_poundage, 403, "", localConnection);
                          System.out.println();
                          System.out.println("<<<<<<<<<<<<<<<<<<<  生成卖方方流水" + localCommodityVO2.userID + " 保证金为 " + ((BargainVO)localObject6).s_bail + "  手续费为 " + ((BargainVO)localObject6).s_poundage + ">>>>>>>>>>");
                          System.out.println();
                        ...
                        {
                          localTradeUserVO.totalSecurity += ((BargainVO)localObject6).s_bail + ((BargainVO)localObject6).s_poundage;
                          localTradeUserVO.tradeCount += 1;
                          localCallableStatement = localConnection.prepareCall("{ ?=call FN_F_UpdateFrozenFunds(?,?,?) }");
                          localCallableStatement.setString(2, localTradeUserVO.userCode);
                          ...
                          localCallableStatement.executeUpdate();
                          d5 = localCallableStatement.getDouble(1);
                          addDailyMoney(d5, localTradeUserVO.paymentForGoods, l10, ((BargainVO)localObject6).userID, ((BargainVO)localObject6).s_bail, 404, "", localConnection);
                          localCallableStatement = localConnection.prepareCall("{ ?=call FN_F_UpdateFunds(?,?,?,?) }");
                          localCallableStatement.setString(2, localTradeUserVO.userCode);
                          localCallableStatement.setInt(3, 403);
                          localCallableStatement.setDouble(4, ((BargainVO)localObject6).s_poundage);
                          ...
                          localCallableStatement.executeUpdate();
                          d5 = localCallableStatement.getDouble(1);
                          addDailyMoney(d5, localTradeUserVO.paymentForGoods, l10, ((BargainVO)localObject6).userID, ((BargainVO)localObject6).s_poundage, 403, "", localConnection);
                          localCommodityVO2 = this.TRADEDAO.getCommodity(((BargainVO)localObject6).commodityID, localConnection);
                          delCommodityCharge(((BargainVO)localObject6).commodityID, localConnection);
                          localTradeUserVO = this.TRADEDAO.getTradeUserForUpdate(localCommodityVO2.userID, localConnection);
                          localTradeUserVO.tradeCount += 1;
                          ...
                          localCallableStatement.executeUpdate();
                          d5 = localCallableStatement.getDouble(1);
                          addDailyMoney(d5, localTradeUserVO.paymentForGoods, l10, localCommodityVO2.userID, ((BargainVO)localObject6).b_bail, 404, "", localConnection);
                          localCallableStatement = localConnection.prepareCall("{ ?=call FN_F_UpdateFunds(?,?,?,?) }");
                          localCallableStatement.setString(2, localTradeUserVO.userCode);
                          localCallableStatement.setInt(3, 403);
                          localCallableStatement.setDouble(4, ((BargainVO)localObject6).b_poundage);
                          ...
                          localCallableStatement.executeUpdate();
                          d5 = localCallableStatement.getDouble(1);
                          addDailyMoney(d5, localTradeUserVO.paymentForGoods, l10, localCommodityVO2.userID, ((BargainVO)localObject6).b_poundage, 403, "", localConnection);
                          this.TRADEDAO.dealCommodity(((BargainVO)localObject6).commodityID, localConnection);
                          localCurSubmitVO = this.TRADEDAO.getCurSubmit(((BargainVO)localObject6).submitID);
                          localCurSubmitVO.tradeFlag = 1;
                        }
    ...
    throws SQLException
  {
    ...
    String str1 = localCalendar.get(1) + "-" + localCalendar.get(2) + "-" + localCalendar.get(5) + "  " + localCalendar.get(11) + " : " + localCalendar.get(12);
    int i = 2;
    int j = this.TRADESTATUS.getCurStatus();
  ...
  public int getFirmSubmitCount(String paramString1, String paramString2)
    throws SQLException
  {
    Connection localConnection = null;
    PreparedStatement localPreparedStatement = null;
  ...
  public Map judgeCommodity(long paramLong1, String paramString, double paramDouble, long paramLong2)
  {
    ...
    try
    {
      String str2 = "select result from (select distinct(trunc((price+1000/amount),10)) result from v_curSubmit where code='" + paramString + "' and tradePARTITIONID=" + this.PARTITIONID + " and tradeFlag=2) a order by result asc";
      ...
      while (l1 > 0L)
      {
        ...
        str2 = "select count(*) count from (select userID,price,amount from v_curSubmit where code='" + paramString + "' and trunc((price+1000/amount),10)=" + str3 + " and tradePARTITIONID=" + this.PARTITIONID + " and tradeFlag=2)";
        localPreparedStatement = localConnection.prepareStatement(str2);
        localResultSet = localPreparedStatement.executeQuery();
        ...
        if (j == 1)
        {
          str2 = "select * from (select id,userID,price,amount from v_curSubmit where code='" + paramString + "' and trunc((price+1000/amount),10)=" + str3 + " and tradePARTITIONID=" + this.PARTITIONID + " and tradeFlag=2 )";
          localPreparedStatement = localConnection.prepareStatement(str2);
          localResultSet = localPreparedStatement.executeQuery();
          if (localResultSet.next())
          {
        ...
        else if (j > 1)
        {
          ...
          {
            str2 = "select * from (select id,userID,price,amount,submitTime from v_curSubmit where code='" + paramString + "' and trunc((price+1000/amount),10)=" + str3 + " and tradePARTITIONID=" + this.PARTITIONID + " and tradeFlag=2) order by submitTime";
            localPreparedStatement = localConnection.prepareStatement(str2);
            localResultSet = localPreparedStatement.executeQuery();
            l2 = 0L;
  ...
  public int abandonBargain(long paramLong, String paramString)
    throws Exception
  {
    Connection localConnection = null;
    ...
    try
    {
      localConnection = this.TRADEDAO.getConnection();
      localConnection.setAutoCommit(false);
      String str1 = "select price,amount,userID from v_cursubmit where code='" + paramString + "' and tradeFlag=2 and  tradePARTITIONID=" + this.PARTITIONID;
  ...
  public Map getCommodity(long paramLong, String paramString)
    throws Exception
  {
    Connection localConnection = null;
    PreparedStatement localPreparedStatement = null;
  ...
  public void finishContract(Connection paramConnection, long paramLong, int paramInt, double paramDouble1, double paramDouble2, double paramDouble3)
    throws SQLException, Exception
  {
    PreparedStatement localPreparedStatement = null;
    ResultSet localResultSet = null;
    ...
    try
    {
      ...
      str1 = "select h.price,h.userid,h.commodityID,h.amount,h.lastBail,h.poundage,c.str7,d.security,d.fee,h.bail,h.status,c.num1,d.category,h.lastBail,d.financescale,d.LKuser from v_hisBargain h,v_commExt c,v_commodity d where h.commodityID=c.commid and h.commodityid=d.id and h.contractID=" + paramLong;
      ...
      {
        double d19 = 0.0D;
        str1 = "select sum(money) from v_hisMoney where ContractNo=" + paramLong + " and Operation=417 and FirmID='" + str3 + "' and Market2=" + i;
        localPreparedStatement = paramConnection.prepareStatement(str1);
        localResultSet = localPreparedStatement.executeQuery();
        if (localResultSet.next()) {
      ...
      double d20 = 0.0D;
      double d21 = 0.0D;
      str1 = "select operation,sum(Money) from v_hisMoney where (operation=419 or operation=421) and contractno=" + paramLong + " and Market2=" + i + " group by operation";
      localPreparedStatement = paramConnection.prepareStatement(str1);
      localResultSet = localPreparedStatement.executeQuery();
      while (localResultSet.next()) {
      ...
      if (paramInt == 0)
      {
        ...
        if (m == 0)
        {
          ...
          {
            d29 = 0.0D;
            str1 = "select sum(Money) from v_hisMoney where operation=417 and contractno=" + paramLong + " and firmid='" + str3 + "' and  Market2=" + i + " group by operation";
            localPreparedStatement = paramConnection.prepareStatement(str1);
            localResultSet = localPreparedStatement.executeQuery();
            while (localResultSet.next()) {
      ...
      localPreparedStatement.close();
      localPreparedStatement = null;
      str1 = "update v_tradeusermarket set balance=balance+" + d14 + ",paymentForUser=paymentForUser+" + d15 + " where usercode='" + str2 + "' and marketid=" + i;
      localPreparedStatement = paramConnection.prepareStatement(str1);
      localPreparedStatement.executeUpdate();
      localPreparedStatement.close();
      localPreparedStatement = null;
  ...
  public double getCommodityBail(String paramString, double paramDouble1, long paramLong, double paramDouble2)
    throws Exception
  {
    try
    {
      ...
      if ((i == 0) || (i == 1)) {
        if (k == 0)
        {
          ...
          d1 = Arith.format(Arith.mul(Arith.mul(Arith.mul(paramDouble1, localCommodityVO.s_security), d3), localCommodityVO.tradeUnit) * paramLong, 2);
        }
      }
      double d4 = d1;
      return d4;
  ...
  public double getCommodityFee(String paramString, double paramDouble1, long paramLong, double paramDouble2)
    throws Exception
  {
    try
    {
      ...
      if (i == 1) {
        if (k == 0)
        {
          ...
          d1 += Arith.format(Arith.mul(Arith.mul(Arith.mul(paramDouble1, localCommodityVO.s_fee), d3), localCommodityVO.tradeUnit) * paramLong, 2);
        }
      }
      double d4 = d1;
      return d4;
  ...
  public FundInfoValue getFundInfo(String paramString)
  {
    ...
    {
      localConnection = this.TRADEDAO.getConnection();
      str = "select t3.balance,t1.feecut,t3.FROZENFUNDS,t1.overdraft,t1.totalSecurity,t2.name,t1.paymentForGoods,t1.deductedRatingBail,t1.curTradeAmount from v_tradeUser t1,f_firm t2,f_firmfunds t3 where t1.userCode=t2.firmid and t1.usercode=t3.firmid and t1.usercode='" + paramString + "'";
      localPreparedStatement = localConnection.prepareStatement(str);
      localResultSet = localPreparedStatement.executeQuery();
      while (localResultSet.next())
      {
    ...
    throws Exception
  {
    ...
    {
      double d1 = 0.0D;
      d1 = getCommodityBail(paramString, paramDouble1, paramLong, paramDouble2) + getCommodityFee(paramString, paramDouble1, paramLong, paramDouble3);
      double d2 = d1;
      return d2;
    }
    catch (Exception localException)
  ...
  public ObjSet getCurCommodityList(int paramInt1, int paramInt2)
    throws SQLException
  {
    TradeStatusValue localTradeStatusValue = getTradeStatus();
    TradeCommodityList1 localTradeCommodityList1 = new TradeCommodityList1();
  ...
  public void reLoadCommodity(Connection paramConnection)
    throws SQLException
  {
    PreparedStatement localPreparedStatement = null;
    ResultSet localResultSet = null;
  ...
  public void reLoadFundInfo(Connection paramConnection)
    throws SQLException
  {
    PreparedStatement localPreparedStatement = null;
    ResultSet localResultSet = null;
  ...
  private void modSysStatusDB(Timestamp paramTimestamp1, int paramInt1, Timestamp paramTimestamp2, int paramInt2)
    throws SQLException
  {
  ...
  private void addQuotation(String paramString1, int paramInt1, Timestamp paramTimestamp, double paramDouble, int paramInt2, long paramLong1, int paramInt3, String paramString2, long paramLong2)
    throws SQLException
  {
  ...
  private boolean checkCommodityFinished()
  {
    ...
    while (localEnumeration.hasMoreElements())
    {
      ...
      {
        if ((this.TRADESTATUS.getCurStatus() == 2) && (localCommodityVO.section == this.TRADESTATUS.getLastPartID()) && (getNewCountdown(localCommodityVO.code) != 0)) {
          return false;
        }
      }
    }
  ...
  private void setContractContent(BargainVO paramBargainVO, Connection paramConnection)
  {
    try
    {
      ...
      str1 = str1.replaceAll("t_money", Tool.fmtDouble2(Arith.mul(paramBargainVO.price, localCommodityVO.tradeUnit) * paramBargainVO.amount) + "");
      str1 = str1.replaceAll("t_bmoney", Tool.fmtCapitalization(Arith.mul(paramBargainVO.price, localCommodityVO.tradeUnit) * paramBargainVO.amount));
  ...
  private void addQuotation(String paramString1, int paramInt1, Timestamp paramTimestamp, double paramDouble, int paramInt2, long paramLong1, int paramInt3, String paramString2, long paramLong2, Connection paramConnection)
    throws SQLException
  {
    TradeQuotationVO localTradeQuotationVO = new TradeQuotationVO();
    localTradeQuotationVO.code = paramString1;
  ...
  public void removeCommodityFromMem(String paramString)
    throws Exception
  {
    TradeCommodityList1 localTradeCommodityList1 = new TradeCommodityList1();
  ...
  public int withdrawContract(long paramLong)
    throws SQLException, Exception
  {
    Connection localConnection = null;
    PreparedStatement localPreparedStatement1 = null;
    ...
    try
    {
      ...
      String str2 = null;
      double d = 0.0D;
      String str3 = "select submitID,commodityID,userID,s_bail+s_poundage,code from v_bargain t1,v_commext t2 where t1.commodityid=t2.commid and t1.contractID=" + paramLong;
      ...
      str3 = "update v_tradeUser set balance=balance+" + d + ",tradeCount=tradeCount-1,totalSecurity=totalSecurity-" + d + " where userCode='" + str1 + "'";
      localPreparedStatement1 = localConnection.prepareStatement(str3);
      j = localPreparedStatement1.executeUpdate();
      localPreparedStatement1.close();
      localPreparedStatement1 = null;
      ...
      while (localResultSet.next()) {
        ...
        {
          str3 = "update v_tradeUsermarket set balance=balance+" + localResultSet.getDouble("money") + " where marketid=" + localResultSet.getInt("market2") + " and userCode='" + str1 + "'";
