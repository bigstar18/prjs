...
public class SettleprivilegeDAOJdbc
  extends BaseDAOJdbc
  implements SettleprivilegeDao
{
  ...
  public void insertSettleprivilege(Settleprivilege paramSettleprivilege)
  {
    ...
    Object[] arrayOfObject = { Long.valueOf(getId() + 1L), Integer.valueOf(1), paramSettleprivilege.getTypeId(), Integer.valueOf(2), paramSettleprivilege.getKindId(), Integer.valueOf(paramSettleprivilege.getPrivilegecode_b()), Integer.valueOf(paramSettleprivilege.getPrivilegecode_s()) };
  ...
  public void updateSettleprivilege(Settleprivilege paramSettleprivilege)
  {
    ...
    Object[] arrayOfObject = { paramSettleprivilege.getTypeId(), paramSettleprivilege.getKindId(), Integer.valueOf(paramSettleprivilege.getPrivilegecode_b()), Integer.valueOf(paramSettleprivilege.getPrivilegecode_s()), Long.valueOf(paramSettleprivilege.getId()) };
    getJdbcTemplate().update(str, arrayOfObject);
  }
