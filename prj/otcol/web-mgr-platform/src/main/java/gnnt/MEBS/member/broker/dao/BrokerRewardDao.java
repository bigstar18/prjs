  ...
  extends DaoHelperImpl
{
  ...
  public void updateBrokerReward(BrokerReward paramBrokerReward)
  {
    ...
    Object[] arrayOfObject = { Double.valueOf(paramBrokerReward.getAmount()), Double.valueOf(paramBrokerReward.getPaidAmount()), paramBrokerReward.getPayDate(), paramBrokerReward.getBrokerId(), paramBrokerReward.getOccurDate(), paramBrokerReward.getModuleId() };
  ...
  private class UpdateFundsProcedure
