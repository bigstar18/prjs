...
public class SettleMatchDao extends DaoHelperImpl {
	...
	public void updateSettleMatch(SettleMatch paramSettleMatch) {
		...
		Object[] arrayOfObject = { paramSettleMatch.getModuleId(), Long.valueOf(paramSettleMatch.getBreedId()),
				Double.valueOf(paramSettleMatch.getWeight()), Double.valueOf(paramSettleMatch.getHL_Amount()),
				Integer.valueOf(paramSettleMatch.getStatus()), Integer.valueOf(paramSettleMatch.getResult()), paramSettleMatch.getFirmID_B(),
				Double.valueOf(paramSettleMatch.getBuyPrice()), Double.valueOf(paramSettleMatch.getBuyPayout_Ref()),
				Double.valueOf(paramSettleMatch.getBuyPayout()), Double.valueOf(paramSettleMatch.getBuyMargin()),
				Double.valueOf(paramSettleMatch.getSettlePL_B()), Double.valueOf(paramSettleMatch.getPenalty_B()), paramSettleMatch.getFirmID_S(),
				Double.valueOf(paramSettleMatch.getSellPrice()), Double.valueOf(paramSettleMatch.getSellIncome_Ref()),
				Double.valueOf(paramSettleMatch.getSellIncome()), Double.valueOf(paramSettleMatch.getSellMargin()),
				Double.valueOf(paramSettleMatch.getSettlePL_S()), Double.valueOf(paramSettleMatch.getPenalty_S()), paramSettleMatch.getRegStockId(),
				Integer.valueOf(paramSettleMatch.getRecvInvoice()), paramSettleMatch.getCreateTime(), paramSettleMatch.getModifyTime(),
				paramSettleMatch.getCommodityId(), Long.valueOf(paramSettleMatch.getContractId()), paramSettleMatch.getXml(),
				Integer.valueOf(paramSettleMatch.getIsChangeOwner()), paramSettleMatch.getMatchId() };
	...
	public void updateFundflowId(String paramString, long paramLong) {
		String str = "update S_SettleMatch t set initXml=updateXML(xmlType(t.initXml),'/root/LASTFUNDFLOWID/text()','" + paramLong
				+ "') where matchID=?";
	...
	public void releaseRegStock(String paramString1, String paramString2) throws SQLException {
	...
	public double getContractFactor(String paramString) throws SQLException {
		PreparedStatement localPreparedStatement = null;
		ResultSet localResultSet = null;
		Connection localConnection = null;
		double d = 0.0D;
	...
	private class CreateSettleMatchProcedure extends StoredProcedure {
