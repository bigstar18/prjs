...
public class FrozenRegStockAmountBehaviour
  implements Behaviour
{
  private final transient Log logger = LogFactory.getLog(FrozenRegStockAmountBehaviour.class);
  @Autowired
  ...
  public void deal(WorkFlowClone paramWorkFlowClone)
  {
    ...
    this.regStockService.frozenAmount(localRegStock, d);
