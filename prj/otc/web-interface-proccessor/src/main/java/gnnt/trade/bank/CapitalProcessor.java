...
public class CapitalProcessor
{
  ...
  private long handleOUtMoney(Connection conn, String bankID, String trader, double money, String firmID, String contact, String account, String funID, int type)
    throws SQLException
  {
