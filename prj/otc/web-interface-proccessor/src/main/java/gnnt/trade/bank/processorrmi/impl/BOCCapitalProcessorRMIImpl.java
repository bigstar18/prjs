...
import gnnt.trade.bank.processorrmi.BOCCapitalProcessorRMI;
...
public class BOCCapitalProcessorRMIImpl
  extends UnicastRemoteObject
  implements BOCCapitalProcessorRMI
{
  private static final long serialVersionUID = 1L;
  BOCCapitalProcessor cp = new BOCCapitalProcessor();
  
  public BOCCapitalProcessorRMIImpl()
