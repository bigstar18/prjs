...
import gnnt.trade.bank.processorrmi.CIBCapitalProcessorRMI;
...
public class CIBCapitalProcessorRMIImpl
  extends UnicastRemoteObject
  implements CIBCapitalProcessorRMI
{
  private static final long serialVersionUID = 1L;
  CIBCapitalProcessor cp = new CIBCapitalProcessor();
  
  public CIBCapitalProcessorRMIImpl()
  ...
  public ReturnValue saveZFPH(ZFPHValue zfph)
    throws RemoteException
  {
    this.cp.log("-----------------------------------------saveZFPH  保存总分平衡结果文件");
    ReturnValue result = this.cp.saveZFPH(zfph);
    this.cp.log("=========================================saveZFPH  保存总分平衡结果文件");
    return result;
  }
  ...
  public ReturnValue saveFFHD(FFHDValue ffhd)
    throws RemoteException
  {
    this.cp.log("-----------------------------------------saveFFHD  保存分分核对结果文件");
    ReturnValue result = this.cp.saveFFHD(ffhd);
    this.cp.log("=========================================saveFFHD  保存分分核对结果文件");
    return result;
  }
