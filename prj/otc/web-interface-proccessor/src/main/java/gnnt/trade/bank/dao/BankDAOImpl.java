  ...
  extends BankDAO
{
    ...
    throws SQLException
  {
    ...
    try
    {
      sql = "update f_b_firmidandaccount set ISOPEN=1,STATUS=0,ACCOUNT=?,ACCOUNT1=?,ACCOUNTNAME=?,ACCOUNTNAME1=?,CARDTYPE=?,OPENTIME=sysdate,CARD=?,bankID=? ,isCrossLine=?,OpenBankCode=? where ID=?";
