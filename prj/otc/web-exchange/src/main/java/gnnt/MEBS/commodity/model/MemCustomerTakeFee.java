...
public class MemCustomerTakeFee
  extends SpecialSet
{
  ...
  @ClassStatus(status={@gnnt.MEBS.base.model.inner.StatusDiscription(key="1", value="单边建仓"), @gnnt.MEBS.base.model.inner.StatusDiscription(key="2", value="单边转让"), @gnnt.MEBS.base.model.inner.StatusDiscription(key="3", value="双边建平")})
  ...
  public MemCustomerTakeFee(String commodityId, String firmId, String commodityName, String memberName, Integer feeAlgr, BigDecimal feeRate, Integer feeMode, BigDecimal mkt_FeeRate)
  {
    this.commodityId = commodityId;
