...
public class OperateLogQueryInterceptor
  extends AbstractInterceptor
{
  private final transient Log logger = LogFactory.getLog(OperateLogQueryInterceptor.class);
  private String type;
  @Autowired
    ...
    throws Exception
  {
    ...
    request.setAttribute(ActionConstant.GNNT_ + "primary.operatorType[in]", "('E','M','S')");
