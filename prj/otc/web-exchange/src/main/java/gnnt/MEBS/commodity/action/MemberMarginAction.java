...
@Component("memberMarginAction")
@Scope("request")
public class MemberMarginAction
  extends BaseAction
{
  private final transient Log logger = LogFactory.getLog(MemberMarginAction.class);
  @Autowired
  ...
  {
    return this.memberMarginService;
  }
