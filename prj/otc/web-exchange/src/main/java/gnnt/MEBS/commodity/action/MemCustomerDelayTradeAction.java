...
@Component("memCustomerDelayTradeAction")
@Scope("request")
public class MemCustomerDelayTradeAction
  extends BaseAction
{
  private final transient Log logger = LogFactory.getLog(MemCustomerDelayTradeAction.class);
  @Autowired
  ...
  {
    return this.memCustomerDelayTradeService;
  }
  ...
  public String add()
  {
    ...
    else
    {
      ...
      MemCustomerDelayTrade delayTrade = (MemCustomerDelayTrade)this.obj;
      boolean flag = true;
  ...
  public String delete()
  {
    ...
    if ((ids != null) && (ids.length > 0)) {
      for (String id : ids)
      {
        ...
        MemCustomerDelayTrade delayTrade = new MemCustomerDelayTrade();
        delayTrade.setF_FirmId(primarys[0]);
        delayTrade.setCommodityId(primarys[1]);
        delayTrade = (MemCustomerDelayTrade)getService().get(delayTrade);
        if (delayTrade != null) {
