  ...
  extends BaseDao
{
  ...
  {
    String hql = "select new HoldQty(primary.commodityId,commodity.name,primary.firmId,customer.name,primary.oneMaxOrderQty,primary.oneMinOrderQty,primary.maxCleanQty,primary.maxHoldQty) from HoldQty as primary,Commodity as commodity,Customer as customer where primary.commodityId=commodity.id and primary.firmId=customer.customerNo";
