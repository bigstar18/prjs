...
@Component
@Scope("request")
public class SpecialMemberDelayFeeAction
  extends BaseAction
{
  private final transient Log logger = LogFactory.getLog(SpecialMemberDelayFeeAction.class);
  @Autowired
  ...
  public String list()
  {
    ...
    List<TCDelayFeeVO> list = this.specialMemberDelayFeeService.getList(qc, 
      pageInfo);
    ...
    int total = this.specialMemberDelayFeeService.dictionaryTotal();
  ...
  public String viewById()
  {
    ...
    tcDelayFeeVo = this.specialMemberDelayFeeService.get(tcDelayFeeVo);
    int total = this.specialMemberDelayFeeService.dictionaryTotal();
  ...
  public String update()
  {
    ...
    try
    {
      ...
      this.obj = tcDelayFeeVo;
      int resultValue = this.specialMemberDelayFeeService.update(tcDelayFeeVo);
  ...
  public String delete()
  {
    ...
    if ((ids != null) && (ids.length > 0)) {
      for (String id : ids)
      {
        ...
        resultValue = this.specialMemberDelayFeeService.delete(delayFee);
      }
    } else {
      resultValue = -2;
    }
  ...
  public String updateForAudit()
  {
    ...
    this.obj = tcDelayFeeVo;
    int resultValue = this.specialMemberDelayFeeService.audit(tcDelayFeeVo);
    addResultMsg(this.request, resultValue);
    return getReturnValue();
  }
