...
import gnnt.MEBS.commodity.service.CustomerDelayTradeService;
...
@Component("customerDelayTradeAction")
@Scope("request")
public class CustomerDelayTradeAction
  extends BaseAction
{
  private final transient Log logger = LogFactory.getLog(CustomerDelayTradeAction.class);
  @Autowired
  @Qualifier("customerDelayTradeService")
  private CustomerDelayTradeService customerDelayTradeService;
  @Autowired
  ...
  {
    return this.customerDelayTradeService;
  }
  ...
  public String updateRMI()
  {
    try
    {
      ...
      this.customerDelayTradeService.updateSlipPointPro("C");
