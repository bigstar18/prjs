...
@Repository("marginDao")
public class MarginDao
  extends BaseDao
{
  private final transient Log logger = LogFactory.getLog(MarginDao.class);
  ...
  {
    String hql = "select new Margin(primary.commodityId,commodity.name,primary.firmId,primary.marginAlgr,primary.tradeMargin) from Margin as primary,Commodity as commodity where primary.commodityId=commodity.id";
