	...
	<body>
		<div id="tabs">
			<ul>
				...
				<li><a href="customerhold.action?AUsessionId=${LOGINIDS}">客户持仓单监控</a></li>
				<%/* <li><a href="customerclose.action?AUsessionId=${LOGINIDS}">客户平仓单监控</a></li> */%>
				<li><a href="customerclosesimple.action?AUsessionId=${LOGINIDS}">客户平仓单监控</a></li>
				<li><a href="customerlimit.action?AUsessionId=${LOGINIDS}">客户指价单监控</a></li>
				<%/* <li><a href="customerfund.action?AUsessionId=${LOGINIDS}">客户资金监控</a></li> */%>
				<li><a href="customerfundsimple.action?AUsessionId=${LOGINIDS}">风险率监控</a></li>
				...
				<li><a href="membertoucun.action?AUsessionId=${LOGINIDS}">会员头寸监控</a></li>
				<li><a href="memberfund.action?AUsessionId=${LOGINIDS}">会员资金监控</a></li>
