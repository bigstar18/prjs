										...
										<table border="0" class="table2_td_widthmax" cellspacing="0" cellpadding="0">
											...
											<tr class="report_w12h">
												...
												<td align="left" width="240">  
												 商品：<select id="commodityId" name="${GNNT_}primary.commodityId[=][String]"
														class="input_textmin">
														<option value="">
															请选择
														</option>
...
<script type="text/javascript">
	function select1(){
		...
		frm.action="${basePath}/report/specialMemberTradeStats/tradeStatsReport.action";
