						...
						<tr height="14%">
							<td>
								<div class="report_bor01">
									<form
										action="${basePath}/report/settlementBankFund/settlementBankFundReportQuary.action"
										...
										<table border="0" width="100%" cellpadding="0" class="table2_td_width">
											...
											<tr>
												<td align="left" class="table3_td_1tjcx">
													&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;签约银行：
													<select name="${GNNT_}primary.bankcode[like]" style="width: 100px">
														<option value="">
															全部
														</option>
														<option value="102">
...
function select1() {
	...
	frm.action = "${basePath}/report/settlementBankFund/settlementBankFundReport.action";
