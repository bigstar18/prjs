										...
										<table width="820" border="0" cellspacing="0" class="table2_td_widthmax" cellpadding="0">
											<tr class="report_w12h">
											   <td class="table3_td_1" align="left">&nbsp;&nbsp;会员编号： 
												...
												<td class="table3_td_1" align="left">会员类别： 
													<select name="${GNNT_}membertype[=][String]" style="width:100">
												 		<option value="">全部</option>
												 		<option value="经纪会员">经纪会员</option>
												 		<option value="综合会员">综合会员</option>
												 	</select>
...
function select1() {
	...
	frm.action="${basePath}/report/memberFundioThreshold/memberFundioThresholdReport.action";
