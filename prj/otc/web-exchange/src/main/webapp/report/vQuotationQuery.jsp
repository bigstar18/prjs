					...
					<table width="98%" border="0" align="center" cellpadding="0"
						...
						<tr>
							<td>
								<div class="div_tj">
									<form
										action="${basePath}/report/vQuotationReport/vQuotationQuery.action"
...
function select1() {
	...
	frm.action = "${basePath}/report/vQuotationReport/vQuotationQuery.action"
