								...
								<tr>
									<td>
										<ec:table items="list"
											...
											var="memberFunds"
											action="${basePath}/report/memberFunds/memberFundsReportQuery.action"
											title="" minHeight="345" listWidth="270%"
											...
											<ec:row recordKey="${customer.customerNo}">
												...
												<ec:column property="memberNo[like]" title="综合会员编号" width="3%"
													style="text-align:left; " value="${memberFunds.memberNo}"
													ellipsis="true" />
												<ec:column property="memberName[like]" title="综合会员名称"
													width="5%" style="text-align:left; "
													value="${memberFunds.memberName}" ellipsis="true" />
												...
												<ec:column property="closeplsum[=][double]" title="平仓净盈亏" width="3%"
													style="text-align:right; ">
												...
												<ec:column property="holdplsum[=][double]" title="持仓净盈亏" width="3%"
													style="text-align:right; ">
													<fmt:formatNumber value="${memberFunds.holdplsum}"
														pattern="#,##0.00" />
												</ec:column>
												<ec:column property="mktfee[=][double]" title="交易所存留手续费" width="4%"
													style="text-align:right; ">
												...
												<ec:column property="customerfee[=][double]" title="收客户手续费" width="3%"
													style="text-align:right; ">
												...
												<ec:column property="total_endcapital[=][double]" title="客户期末权益" width="5%"
													style="text-align:right; ">
												...
												<ec:column property="total_livemargin[=][double]" title="客户可用保证金" width="5%"
													style="text-align:right; ">
