									...
									<form
										...
										<table border="0" cellspacing="0" width="800" cellpadding="0">
											<tr class="report_w12h">
											   <td class="table3_td_1tjcx" align="left">&nbsp;&nbsp;会员编号： <input type="text" name="${GNNT_}memberno[=][String]" id="memberNo"
											...
											<tr>
												...
												<td align="left">
													...
													显示无持仓客户
													<input type="hidden"
														name="${GNNT_}primary.qtysum[>][int]" value="0"
...
function select1() {
	...
	frm.action="${basePath}/report/customerHoldSummary/customerHoldSummaryReport.action";
