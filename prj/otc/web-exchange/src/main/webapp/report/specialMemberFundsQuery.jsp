								...
								<tr>
									<td>
										<ec:table items="list"
											...
											action="${basePath}/report/specialMemberFunds/fundsReportQuery.action"
											title="" minHeight="345" listWidth="105%"
											...
											<ec:row ondblclick="">
												...
												<ec:column property="clearDate[=][date]" title="结算日期"
													width="8%" style="text-align:left; " ellipsis="true">
												...
												<ec:column property="s_memberNo[like]" title="特别会员编号"
													...
													value="${specialMemberFunds.s_memberNo}" ellipsis="true" />
												<ec:column property="s_memberName[like]" title="特别会员名称"
													width="10%" style="text-align:left; "
													value="${specialMemberFunds.s_memberName}" ellipsis="true" />
												...
												<ec:column property="fundio[=][double]" title="出入金" width="11%"
													style="text-align:right; ">
													<fmt:formatNumber value="${specialMemberFunds.fundio}"
														pattern="#,##0.00" />
												</ec:column>
												<ec:column property="delayfee[=][double]" title="收延期费" width="7%"
													style="text-align:right; ">
												...
												<ec:column property="endcapital[=][double]" title="期末权益"
													width="11%" style="text-align:right; " format="#,##0.00">
													<fmt:formatNumber value="${specialMemberFunds.endcapital}"
														pattern="#,##0.00" />
												</ec:column>
												<ec:column property="risk_log[=][String]" title="风险率"
													width="6%" style="text-align:right; " filterable="false"
													value="${specialMemberFunds.risk_log}" sortable="false"/>
											</ec:row>
