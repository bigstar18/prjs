										...
										<ec:table items="list"
											...
											<ec:row ondblclick="">
												...
												<ec:column property="s_memberNo[like]" title="特别会员编号"
													width="11%" style="text-align:left; "
													value="${specialMemberHold.s_memberNo}" ellipsis="true" />
												<ec:column property="s_memberName[like]" title="特别会员名称"
													width="16%" style="text-align:left; "
													value="${specialMemberHold.s_memberName}" ellipsis="true" />
												<ec:column property="buyqty[=][int]" title="买持仓量" width="11%"
													style="text-align:right; " format="#,##0">
													<fmt:formatNumber value="${specialMemberHold.buyqty}"
														pattern="#,##0" />
												</ec:column>
												<ec:column property="sellqty[=][int]" title="卖持仓量" width="11%"
													style="text-align:right; ">
													<fmt:formatNumber value="${specialMemberHold.sellqty}"
														pattern="#,##0" />
												</ec:column>
												<ec:column property="netqty[=][int]" title="净持仓量" width="11%"
													style="text-align:right; ">
													<fmt:formatNumber value="${specialMemberHold.netqty}"
														pattern="#,##0" />
												</ec:column>
												<ec:column property="delayfee[=][double]" title="收延期费" width="11%"
													style="text-align:right; " >
