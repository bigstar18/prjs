...
<html xmlns:MEBS>
						...
						<tr>
							<td>
								<div class="report_bor01">
									<form 
									    action="${basePath}/report/broker/brokerReportQuery.action"
  ...
  <tr>
    ...
    <td width="38%" align="left" class="report_w12h"><input type="checkbox" name="tableList" value="closePositionReport"  />
																			平仓单</td>
    <td width="47%" align="left" class="report_w12h"><input type="checkbox" name="tableList" value="capitalFlowingReport"  />
																			资金流水</td>
    <td width="5%">&nbsp;</td>
  </tr>
  <tr>
    <td>&nbsp;</td>
    <td align="left" class="report_w12h"><input type="checkbox" name="tableList" value="demurrageReport"  />
																			延期费</td>
    <td align="left" class="report_w12h"><input type="checkbox" id="isData" name="${GNNT_}primary.isData[=][String]" value="" onclick="change()"/>
																			显示无单账户</td>
    <td>&nbsp;</td>
  </tr>
  <tr>
        ...
        <td align="right" valign="bottom" class="report_showborbot"><img src="../images/report_bg05br.gif" width="11" height="8" /></td>
						...
						<tr>
							<td class="report_bor02">
								<iframe name="report" src="${basePath }/report/primaryReport.jsp"
...
function select1(){
	...
	frm.action="${basePath}/report/broker/brokerReport.action";
