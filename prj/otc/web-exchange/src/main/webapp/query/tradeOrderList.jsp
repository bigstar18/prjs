			...
			<table class="table1_style" border="0" cellspacing="0"
				...
				<tr>
					<td>
						<div class="div_tj">
							<form name="frm"
								action="${basePath }/query/queryTradeOrder/list.action?sortName=operateTime&sortOrder=true"
								method="post">
										...
										<ec:table items="resultList"
											...
											<ec:row style="text-align:center;" rowId="${globalLog.id}">
												<ec:column width="5%" property="_0" title="序号"
													...
													filterable="false" />
												<ec:column property="operator[like]" title="操作人" width="13%"
													style="text-align:left; " value="${globalLog.operator}"
													ellipsis="true" />
												<ec:column property="operateIp[like]" title="操作人Ip" width="13%"
