			...
			<table class="table1_style" border="0" cellspacing="0"
				...
				<tr>
					<td>
						<div class="div_tj">
							<form name="frm"
								action="${basePath}/query/querySpecialMemberBankInternalTransSearch/list.action?sortName=primary.transId&sortOrder=true"
								method="post">
												...
												<table class="table3_style" border="0" cellspacing="0"
													...
													<tr>
														<td class="table3_td_1" align="left">
															交易账号:&nbsp;
															<label>
																<input type="text" class="input_textmin" id="firmId"
									...
									<td>
										<ec:table items="resultList"
											...
											<ec:row ondblclick="">
												...
												<ec:column property="firm.firmName[like]" title="账号名称"
													width="10%" style="text-align:left; "
