			...
			<table class="table1_style" border="0" cellspacing="0"
				...
				<tr>
					<td>
						<div class="div_tj">
							<form name="frm"
								action="${basePath}/query/queryCustomerBankInternalTransSearch/list.action?sortName=primary.transId&sortOrder=true"
								method="post">
														...
														<td class="table3_td_1" align="left">
															...
															<label>
																<input type="text" class="input_textmin" id="firmId"
																	...
																	value="${oldParams['firm.firmId[=][String]'] }" />
															</label>
														</td>
														<td class="table3_td_1" align="left">
															账户名称:&nbsp;
