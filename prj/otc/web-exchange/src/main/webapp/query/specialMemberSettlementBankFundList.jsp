			...
			<table class="table1_style" border="0" cellspacing="0"
				...
				<tr>
					<td>
						<div class="div_tj">
							<form name="frm"
								action="${basePath}/query/querySpecialMemberSettlementBankFundSearch/list.action?sortName=primary.b_date&sortOrder=true"
								method="post">
												...
												<table class="table3_style" border="0" cellspacing="0"
													...
													<tr>
														...
														<td class="table3_td_1mid" align="left">
															特别会员名称:
															<label>
																<input type="hidden" name="${ORIGINAL_}smemberIdsTwo"
																	id="memberIds" value="${original_smemberIdsTwo}"
																	class="input_text">
																<!-- <input type="text" name="${GNNT_}firm.firmName[like]"
																	id="firmName" value="${oldParams['firm.firmName[like]'] }" onclick="clickText()"
																	readonly=true size="8" class="input_textmin" /> -->
																<input type="text" id="smemberNames"
								...
								<tr>
									<td>
										<ec:table items="resultList"
											...
											action="${basePath}/query/querySpecialMemberSettlementBankFundSearch/list.action"
											...
											<ec:row ondblclick="">
												...
												<ec:column property="firm.firmId[like]" title="特别会员编号"
													width="4%" style="text-align:left; "
													value="${settlementBankFund.firmId}" ellipsis="true" />
												<ec:column property="firm.firmName[like]" title="特别会员名称"
...
<SCRIPT type="text/javascript">
		...
		function clickText() {
			...
			if (result != null && result != '') {
				...
				frm.smemberNames.value = result1[1];
			}
		}
		</SCRIPT>