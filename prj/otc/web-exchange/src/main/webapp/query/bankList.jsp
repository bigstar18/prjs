												...
												<table class="table3_style" border="0" cellspacing="0"
													...
													<tr>
														...
														<td class="table3_td_1" align="left">
															操作人:&nbsp;
															<label>
																<input type="text" name="${GNNT_}primary.operator[=][String]"
																	id="operateType"
																	value="${oldParams['primary.operator[=][String]'] }"
																	class="input_textmin" />
															</label>
														</td>
														<td align="left" class="table3_td_1">
															...
															<select id="moudleId"
																...
																<c:forEach items="${bankLogList}" var="logCataLog">
										...
										<ec:table items="resultList"
											...
											<ec:row style="text-align:center;" rowId="${globalLog.id}">
												<ec:column width="4%" property="_0" title="序号"
													...
													filterable="false" />
												<ec:column property="operator[like]" title="操作人" width="9%"
