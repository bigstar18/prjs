										...
										<ec:table items="resultList"
											...
											<ec:row ondblclick="">
												...
												<ec:column property="memberNo[like]" title="综合会员编号" width="4%"
													...
													<ec:column property="memberName[like]" title="综合会员名称" width="6%"
													style="text-align:left; "
													value="${memberHoldSearch.memberName}" ellipsis="true"/>
