								...
								<tr>
									<td>
										<ec:table items="resultList"
											...
											action="${basePath}/query/querySpecialMemberOrderSearch/list.action?sortName=primary.tradeNo&sortOrder=true"
											title="" minHeight="325" listWidth="190%"
											...
											<ec:row ondblclick="">
												...
												<ec:column property="s_memberNo[like]" title="特别会员编号"
													width="4%" style="text-align:left; "
													value="${speicalMemberTransaction.s_memberNo}"
													ellipsis="true" />
												<ec:column property="s_name[like]" title="特别会员名称" width="5%"
													style="text-align:left; "
													value="${speicalMemberTransaction.s_name}" ellipsis="true" />
												...
												<ec:column property="traderId[like]" title="操作人"
													value="${speicalMemberTransaction.traderId}" width="5%"
