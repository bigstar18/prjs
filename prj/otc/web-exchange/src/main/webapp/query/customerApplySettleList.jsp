										...
										<ec:table items="resultList"
											...
											<ec:row ondblclick="">
												...
												<ec:column property="bs_flag[=][int]" title="买卖标志"
													...
													<c:set var="typeKey">
														<c:out value="${customerSettle.bs_flag}"></c:out>
													</c:set>
		  											${firstMap[typeKey]}
												</ec:column>
												<ec:column property="updateTime[=][date]" title="更新时间"
													width="7%" style="text-align:left; "
													value="${datefn:formatdate(customerSettle.updateTime)}"
													ellipsis="true" />
											</ec:row>
										</ec:table>
									</td>
