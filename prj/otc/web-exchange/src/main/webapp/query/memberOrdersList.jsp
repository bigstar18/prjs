											...
											<ec:row ondblclick="">
												...
												<c:if test="${queryType=='H'}">
													<ec:column property="clearDate[=][date]" title="结算日期"
														...
														<fmt:formatDate value="${memberOrder.clearDate}"
															pattern="yyyy-MM-dd" />
													</ec:column>
												</c:if>
												<ec:column property="memberNo[like]" title="综合会员编号" width="4%"
													style="text-align:left; " value="${memberOrder.memberNo}"
													ellipsis="true" />
												<ec:column property="memberName[like]" title="综合会员名称"
													width="6%" style="text-align:left; "
													value="${memberOrder.memberName}" ellipsis="true" />
												...
												<ec:column property="holdno[=][int]" title="持仓单号" width="4%"
													style="text-align:left; " value="${memberOrder.holdno}"
													ellipsis="true" />
												...
												<ec:column property="tradefunds[=][double]" title="成交金额"
													...
													<fmt:formatNumber value="${memberOrder.tradefunds}"
														pattern="#,##0.00" />
												</ec:column>
												...
												<ec:column property="actualpl[=][double]" title="实际盈亏"
													width="6%" style="text-align:right; ">
													<fmt:formatNumber value="${memberOrder.actualpl}"
														pattern="#,##0.00" />
												</ec:column>
												<ec:column property="traderId[like]" title="操作人" width="5%"
													style="text-align:left; " value="${memberOrder.traderId}"
													ellipsis="true" />
												<ec:column property="s_Name[like]" title="特别会员名称" width="5%"
													style="text-align:left; " value="${memberOrder.s_Name}"
													ellipsis="true" />
