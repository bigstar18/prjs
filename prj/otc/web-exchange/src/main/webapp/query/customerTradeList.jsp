									...
									<td>
										<ec:table items="resultList"
											...
											<ec:row ondblclick="">
												...
												<ec:column property="de_buildNo[like]" title="平仓单号"
												...
												<ec:column property="customerId[like]" title="交易账号" width="5%"
													style="text-align:left; " value="${customerTrade.customerId}"  ellipsis="true"/>
												...
												<ec:column property="buildNo[like]" title="委托单号" width="5%"
													style="text-align:left; " value="${customerTrade.buildNo}" ellipsis="true"/>
												<ec:column property="build_flag[=][int]" title="建仓方向" width="5%"
												...
												<ec:column property="buildDate[=][date]" title="建仓时间"
													...
													value="${datefn:formatdate(customerTrade.buildDate)}" ellipsis="true"/>
												...
												<ec:column property="de_buildDate[=][date]" title="平仓时间"
													width="8%" style="text-align:left; "
													value="${datefn:formatdate(customerTrade.de_buildDate)}" ellipsis="true"/>
												...
												<ec:column property="de_builderId[like]" title="平仓者"
													width="5%" style="text-align:left; " value="${customerTrade.de_builderId}" ellipsis="true">
													 
														
												</ec:column>
												<ec:column property="builderId[like]" title="建仓者"
													width="5%" style="text-align:left;" value="${customerTrade.builderId}" ellipsis="true">
