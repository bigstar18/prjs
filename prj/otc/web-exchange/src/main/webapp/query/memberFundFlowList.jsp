												...
												<table class="table3_style" border="0" cellspacing="0"
													...
													<tr>
														...
														<td class="table3_td_1" align="left">
															流水号:&nbsp;
															<label>
																<input type="text" name="${GNNT_}fundFlowId[=][int]"
																	id="memberName"
																	value="${oldParams['fundFlowId[=][int]'] }"
																	class="input_textmin" />
															</label>
														</td>
													</tr>
										...
										<ec:table items="resultList"
											...
											<ec:row ondblclick="">
												...
												<ec:column property="memberNo[like]" title="综合会员编号"
													...
													value="${memberFundFlow.memberNo}" ellipsis="true" />
												<ec:column property="memberName[like]" title="综合会员名称"
													width="6%" style="text-align:left; "
													value="${memberFundFlow.memberName}" ellipsis="true" />
