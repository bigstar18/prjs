			...
			<table class="table1_style" border="0" cellspacing="0"
				...
				<tr>
					<td>
						<div class="div_tj">
							<form name="frm"
								action="${basePath}/commodity/memberDelayFee/list.action"
								method="post">
														...
														<td class="table3_td_1" align="left">
															...
															<label>
																<input type="text" class="input_text"
																	id="memberName" name="${GNNT_}memberInfo.name[like]"
									...
									<td>
										<ec:table items="resultList"
											...
											<ec:row recordKey="tcDelayFee.memberNo">
												...
												<ec:column property="commodity.name[like]" title="商品名称" width="10%" filterable="false" style="text-align:left;"  ellipsis="true"> <a href="#" class="blank_a" onclick="return update('${tcDelayFee.memberNo}','${tcDelayFee.commodityId}');"><font color="#880000">${tcDelayFee.commodityName }</font> </a> </ec:column>
												...
												<c:forEach var="ta" begin="1" end="${total}" step="1">
													...
													<ec:column property="stepNO${ta}[=]"  title="${note}的延期费率"
														...
														sortable="false" >
														${tcDelayFee[step]}<c:if test="${commodityFeeAlgrKey==1}">%</c:if>
													</ec:column>
...
function update(memberNo, commodityId) {
	var url = "${basePath}/commodity/memberDelayFee/forwardUpdate.action?obj.firmId="
...
function addDelayFee(){
	var url = "${basePath}/commodity/memberDelayFee/forwardAdd.action";
	ecsideDialog(url, "", 600, 446);
}
function deleteDelayFee(){
	var url="${basePath}/commodity/memberDelayFee/delete.action";
