...
<html>
	...
	<body>
			...
			<table class="table1_style" border="0" cellspacing="0"
				...
				<tr>
					<td>
						<div class="div_tj">
							<form name="frm"
								action="${basePath}/commodity/customerMargin/list.action?sortName=primary.commodityId"
								method="post">
						...
						<div class="div_gn">
							<button class="anniu_btn" onclick="addCustomerMargin()"
								id="update">
								添加
							</button>
							<button class="anniu_btn" onclick="deleteCustomerMargin()"
								id="delete">
								删除
							</button>
						</div>
									...
									<td>
										<ec:table items="resultList"
											...
											<ec:row recordKey="${margin.firmId}">
												...
												<ec:column property="customerinfo.firmId[like]" title="交易账号"
		...
		function update(firmId,commodityId){
			var url="${basePath}/commodity/customerMargin/forwardUpdate.action?obj.commodityId="+commodityId+"&obj.firmId="+firmId;
			
			ecsideDialog(url,window,630,430);
		}
		function submitMargin(){
			frm.submit();
		}
		function addCustomerMargin(){
			var url="${basePath}/commodity/customerMargin/forwardAdd.action";
			ecsideDialog(url,window,630,335);
		}
		function deleteCustomerMargin(){
			var url="${basePath}/commodity/customerMargin/delete.action";
