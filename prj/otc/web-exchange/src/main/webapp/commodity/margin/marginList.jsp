...
<html>
	...
	<body>
			...
			<table class="table1_style" border="0" cellspacing="0" cellpadding="0">
				<tr>
					<td>
						<div class="div_tj">
						<form name="frm"
								action="${basePath}/commodity/margin/list.action?sortName=primary.commodityId"
								method="post">
											...
											<table class="table3_style" border="0" cellspacing="0"
												...
												<tr>
													...
													<td class="table3_td_anniu" align="left">
															<button  class="btn_sec" onclick="submitMargin()">查询</button>&nbsp;&nbsp;
									...
									<td>
										<ec:table items="resultList"
											...
											<ec:row recordKey="${margin.firmId}">
												...
												<ec:column property="primary.firmId[like]" title="类型" width="14%"
													style="text-align:left;" editTemplate="ecs_t_firmDis">
											  		${firmDisMap[margin.firmId]}
											  	</ec:column>
												...
												<ec:column property="primary.tradeMargin[=][bigdecimal]" title="即市占用/冻结"
													...
													filterable="false" value="${margin.tradeMargin_log}" />
												 <%-- 
												<ec:column property="primary.settleMargin[like]" title="结算维持"
													width="14%" style="text-align:right;"
		...
		function update(firmId,commodityId){
			var url="${basePath}/commodity/margin/forwardUpdate.action?obj.commodityId="+commodityId+"&obj.firmId="+firmId;
