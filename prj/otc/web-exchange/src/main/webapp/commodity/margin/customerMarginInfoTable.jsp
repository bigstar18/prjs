...
%>
<div class="div_cxtj"><img src="<%=skinPath%>/cssimg/13.gif" />&nbsp;客户保证金</div>
<table border="0" cellspacing="0" cellpadding="4" width="100%"
	...
	<tr height="40">
		...
		<td width="30%">
			...
			<select id="commodityId" name="obj.commodityId" class="select_widmid" style="width: 140" onblur="myblur('commodityId')"  onfocus="myfocus('commodityId')"
		...
		<td>
			...
			<input id="firmId" name="obj.firmId" class="input_textmid"  onblur="myblur('firmId')"  onfocus="myfocus('firmId')"
				onchange="setCommodityName();">
		</td>
	...
	<tr height="40">
					...
					<input type="text" class="input_textmid"  id="marginAlgr_v" value="比例" readonly="readonly">
					</td>
				</tr>
				<tr height="40">
					<td align="right" width="20%">
					...
					<td>
						<input type="text" class="input_textmid" id="tradeMargin" style="text-align:right"
...
function commodityId(userID){
	...
	if(firmId){
		checkAction.existCustomerMargin(commodityId, firmId, function(isExist){
			if(isExist){
				alert('信息已存在，请重新添加');
...
function setCommodityName() {
	...
	//document.getElementById('firmName').value = m_FirmId.value;
}
</script>
<script type="text/javascript">
<!--
