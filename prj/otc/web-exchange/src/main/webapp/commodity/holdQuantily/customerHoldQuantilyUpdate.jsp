...
<html>
	...
	<body leftmargin="0" topmargin="0" class="st_body">
		<form name="frm" action="${basePath}/commodity/customerHoldQuantily/update.action" method="post" targetType="hidden">
			<div>
			<%@ include file="/commodity/holdQuantily/customerHoldQuantilyUpdateTable.jsp"%>
			</div>
			<div class="tab_pad">
...
function updateHoldQuantily(){
		...
		if((isNaN(frm.maxCleanQty.value))){
			alert("最大净持仓量必须位数字");
