			...
			<table class="table1_style" border="0" cellspacing="0"
				...
				<tr>
					<td>
						<div class="div_tj">
							<form name="frm"
								action="${basePath}/commodity/customerTakeFee/list.action?sortName=commodity.id"
								method="post">
						...
						<div class="div_gn">
							<button class="anniu_btn" onclick="addCustomerTakeFeePoint()" id="update">
								添加
							</button>
								...
								<tr>
									<td>
										<ec:table items="resultList"
											...
											action="${basePath}/commodity/customerTakeFee/list.action"
											...
											<ec:row recordKey="${customerTakeFee.commodityId}">
												...
												<ec:column property="memberInfo.name[Like]" title="客户名称"
...
function deleteCustomerTakeFeePoint() {
	var url = "${basePath}/commodity/customerTakeFee/delete.action";
	deleteEcside(ec.ids, url);
}
function forwardUpdate(commodityId, firmId) {
	var url = "${basePath}/commodity/customerTakeFee/forwardUpdate.action?obj.commodityId="
			+ commodityId + "&obj.m_FirmId=" + firmId;
	ecsideDialog(url, "", 580, 520);
}
function addCustomerTakeFeePoint() {
	var urlFee = "${basePath}/commodity/customerTakeFee/forwardAdd.action";
