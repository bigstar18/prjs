...
<div class="div_cxtjmax">
	<img src="<%=skinPath%>/cssimg/13.gif" />&nbsp;会员管辖客户收取手续费
</div>
<table border="0" cellspacing="0" cellpadding="4" width="100%"
	...
	<tr height="40">
		...
		<td>
			<select id="feeAlgr" name="obj.feeAlgr_v" class="select_widmid"  onchange="feeAlgrChange(this.value);" class="select_widmid">
				<c:forEach items="${feeAlgrMap}" var="maps">
					<option value="${maps.key}" <c:if test="${maps.key==obj.feeAlgr_v}">selected=selected</c:if> >${maps.value }</option>
				</c:forEach>
			</select>
		</td>
	</tr>
