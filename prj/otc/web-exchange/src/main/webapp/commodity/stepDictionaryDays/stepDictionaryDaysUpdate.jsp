...
<html>
	...
	<body class="st_body">
		<form name="frm" action="${basePath}/commodity/stepDictionary/update.action"
		  ...
		  <div>
			...
			<div class="st_title"><img src="<%=skinPath%>/cssimg/st_ico1.gif" align="absmiddle" />&nbsp;&nbsp;详细信息</div>
				...
				<table border="0" cellspacing="0" cellpadding="4" width="100%"
					...
					<!-- <tr height="35">
						<td align="right" width="38%">阶梯编号: 
						</td>
						<td>
							<input class="input_text" type="text" id="id" name="id" value="延期天数阶梯" readonly="readonly" style="background-color: #bebebe">
						</td>
					</tr> -->
					<tr height="35">
					<div class="div_cxtjd"><img src="<%=skinPath%>/cssimg/13.gif" />&nbsp;延期天数阶梯</div>
						<td align="right">阶梯阶号: 
						</td>
						<td>
					...
					<tr height="35">
						...
						<td>
							<input class="input_text" type="text" id="stepValue" style="text-align:right"
							onblur="myblur('stepValue')"  onfocus="myfocus('stepValue')" 
							 name="obj.stepValue" value="${obj.stepValue}" >
						</td>
