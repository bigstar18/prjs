...
<html>
	...
	<body class="st_body">
		<br />
		<form name="frm" action="${basePath}/commodity/stepDictionary/add.action"
			method="post" targetType="hidden">
			<fieldset width="50%" height="60%">
				<div class="st_title"><img src="<%=skinPath%>/cssimg/st_ico1.gif" align="absmiddle" />&nbsp;&nbsp;会员延期费阶梯添加</div>
				<input type="hidden" name="obj.ladderCode" value="DelayDays">
				<table border="0" cellspacing="0" cellpadding="4" width="90%"
					...
					<tr height="35">
						...
						<td>
							<input class="input_text_pwdmin" type="text" id="id" name="obj.id" value="延期天数阶梯" readonly="readonly">
						</td>
					</tr>
					<tr height="35">
						<td align="right">阶梯阶号: 
					...
					<tr height="35">
						...
						<td>
							<input class="from" type="text" id="stepValue" name="obj.stepValue" value="" style="text-align:right" >
						</td>
					</tr>
				</table>
			</fieldset>
