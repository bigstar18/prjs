...
<html>
	...
	<body>
			...
			<table class="table1_style" border="0" cellspacing="0"
				...
				<tr>
					<td>
						<div class="div_tj">
							<form name="frm"
								action="${basePath}/commodity/specialMemberQuotePoint/list.action?sortName=primary.commodityId"
								method="post">
									...
									<td>
										<ec:table items="resultList"
											...
											<ec:row recordKey="${quotePoint.m_firmId}">
												...
												<ec:column property="specialMember.name[like]" title="特别会员编号"
		...
		function update(firmId,commodityId){
			var url="${basePath}/commodity/specialMemberQuotePoint/forwardUpdate.action?obj.commodityId="+commodityId+"&obj.m_firmId="+firmId;
		...
		function addMemberQuotePoint(){
			var url="${basePath}/commodity/specialMemberQuotePoint/forwardAdd.action";
			ecsideDialog(url,"",580,375);
		}
		function deleteMemberQuotePoint(){
	  		var url="${basePath}/commodity/specialMemberQuotePoint/delete.action";
