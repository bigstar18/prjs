...
<div class="div_cxtjmid">
	<img src="<%=skinPath%>/cssimg/13.gif" />&nbsp;&nbsp;会员报价点差
</div>
<table border="0" cellspacing="0" cellpadding="4" width="100%"
	...
	<tr height="40">
		...
		<td>
			...
			<select id="memberNo" name="obj.m_firmId" class="select_widmid"
				onblur="myblur('memberNo')" onfocus="myfocus('memberNo')" onchange="setCommodityName();">
				<option value="">
					请选择
				</option>
	...
	<tr height="40">
		...
		<td>
			<select id="operate" name="obj.operate">
...
function commodityId(userID) {
	...
	if(firmId){
		checkAction.existMemberQuotePoint(commodityId, firmId, function(isExist){
			if(isExist){
				alert('信息已存在，请重新添加');
