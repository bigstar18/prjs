...
<div class="div_cxtjmid">
	<img src="<%=skinPath%>/cssimg/13.gif" />&nbsp;默认延迟成交
</div>
<table border="0" cellspacing="0" cellpadding="4" width="100%"
					...
					<tr height="40">
						...
						<input class="input_text_pwdmin" type="text" id="memberName"
							name="obj.memberName" value="${firmDisMap[obj.f_FirmId]}" readonly="readonly">
						</td>
					...
					<tr>
						...
						<select id="isslipPoint" name="obj.isslipPoint" class="select_widmid">
							<c:forEach items="${isslipPointMap}" var="maps">
								<option value="${maps.key}"<c:if test="${maps.key==obj.isslipPoint}">selected=selected</c:if> >${maps.value }
								</option>
							</c:forEach>
						</select>
						</td>
