...
<html>
	...
	<body>
			...
			<table class="table1_style" border="0" cellspacing="0"
				...
				<tr>
					<td>
						<div class="div_tj">
							<form name="frm"
								action="${basePath}/commodity/customerDelayTrade/list.action?sortName=primary.commodityId"
								method="post">
														...
														<td class="table3_td_1" align="left">
															...
															<label>
																<input type="text" id="memberInfoName"
																	class="input_text" name="${GNNT_}customer.name[like]"
																	value="${oldParams['customer.name[like]'] }" />
															</label>
														</td>
									...
									<td>
										<ec:table items="resultList"
											...
											<ec:row recordKey="${commodityDelayTrade.f_FirmId}">
												...
												<ec:column property="customer.name[Like]" title="客户名称"
		...
		function update(f_FirmId,commodityId){
			var url = "${basePath}/commodity/customerDelayTrade/forwardUpdate.action?obj.commodityId="+commodityId+"&obj.f_FirmId="+f_FirmId;
		...
		function addDelayTradePoint() {
			var urlFee = "${basePath}/commodity/customerDelayTrade/forwardAdd.action";
			ecsideDialogDelayTrade(urlFee, "", 580, 415);
		}
		function updateRMI() {
			frm.action = "${basePath}/commodity/customerDelayTrade/updateRMI.action";
		...
		function deleteDelayTrade(){
			...
			var url = "${basePath}/commodity/customerDelayTrade/delete.action";
