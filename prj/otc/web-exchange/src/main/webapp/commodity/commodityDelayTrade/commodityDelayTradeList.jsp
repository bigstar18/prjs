...
<html>
	...
	<body>
			...
			<table class="table1_style" border="0" cellspacing="0"
				...
				<tr>
					<td>
						<div class="div_tj">
							<form name="frm"
								action="${basePath}/commodity/commodityDelayTrade/list.action?sortName=primary.commodityId"
								method="post">
									...
									<td>
										<ec:table items="resultList"
											...
											<ec:row recordKey="${commodityDelayTrade.f_FirmId}">
												...
												<ec:column property="commodity.name[Like]" title="商品名称" width="18%" style="text-align:left;" ellipsis="true" > <a href="#" class="blank_a" onclick="return update('${commodityDelayTrade.f_FirmId}','${commodityDelayTrade.commodityId}');"><font color="#880000">${commodityDelayTrade.commodityName}</font> </a> </ec:column>
												<ec:column property="primary.f_FirmId[like]" title="交易商类型"
													width="18%" style="text-align:left;">
		  											${firmDisMap[commodityDelayTrade.f_FirmId]}
		  										</ec:column>
												<ec:column property="primary.delayTradeType[=][int]"
													title="延迟成交类型" width="19%" style="text-align:left;">
												...
												<ec:column property="primary.delayTradeTime[=][int]"
													title="延迟成交时间（毫秒）" width="19%" style="text-align:right; "
													value="${commodityDelayTrade.delayTradeTime}" filterable="false"/>
												<ec:column property="primary.isslipPoint[like]"
													title="是否滑点" width="19%" style="text-align:right; "  filterable="false">
		...
		function update(f_FirmId,commodityId){
			var url = "${basePath}/commodity/commodityDelayTrade/forwardUpdate.action?obj.commodityId="+commodityId+"&obj.f_FirmId="+f_FirmId;
		...
		function deleteDelayTrade(){
			...
			var url = "${basePath}/commodity/commodityDelayTrade/delete.action";
		...
		function addDelayTradePoint() {
			var urlFee = "${basePath}/commodity/commodityDelayTrade/forwardAdd.action";
