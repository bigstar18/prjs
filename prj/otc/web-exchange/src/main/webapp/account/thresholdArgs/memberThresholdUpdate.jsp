...
<%
	...
	String warnTh = "当前权益/期初权益*100%";
	String frozenTh = "当前权益/期初权益*100%";
	String m_CU_BalanceSum = "";
					...
					<tr>
						<td>
							...
							<table border="0" cellspacing="0" cellpadding="4" width="100%"
								...
								<tr height="35">
									<td align="right">
										<font color="gray">客户总权益:&nbsp;</font>
									</td>
									<td>
										<input class="input_text" type="text" id="m_CU_BalanceSum" style="text-align:right"
											name="obj.m_CU_BalanceSum" value="<fmt:formatNumber value="${obj.m_CU_BalanceSum}"   pattern="###,##0.00"/>" readonly="readonly">
											<span>（元）</span>
									</td>
									<td align="left" height="40">
										<div id="m_CU_BalanceSum_vTip"><%=m_CU_BalanceSum%></div>
									</td>
								</tr>
								<tr height="35">
									<td align="right">
