									...
									<td>
										<ec:table items="resultList"
											...
											<ec:row recordKey="memberThreshold.memberNo">
												...
												<ec:column property="primary.memberNo[like]" title="会员编号" style="text-align:left;" width="14%" ellipsis="true" > <a href="#" class="blank_a" onclick="return update('${memberThreshold.memberNo}');"><font color="#880000">${memberThreshold.memberNo}</font> </a> </ec:column>
												...
												<ec:column property="primary.minRiskFund[=][bigdecimal]" title="会员出金阈值"
													style="text-align:right;" width="14%">  
													<fmt:formatNumber value="${memberThreshold.minRiskFund}"   pattern="###,##0.00"/>
												</ec:column>
												<ec:column property="primary.m_CU_BalanceSum[=][bigdecimal]" title="客户总权益"
													style="text-align:right;" width="14%">
												<fmt:formatNumber 	value="${memberThreshold.m_CU_BalanceSum}"  pattern="###,##0.00"/>
												</ec:column>                          
												<ec:column property="primary.warnTh[=][bigdecimal]" title="会员预警风险率"
													style="text-align:right;" width="14%"
													value="${memberThreshold.warnTh_log}" />
												<ec:column property="primary.frozenTh[=][bigdecimal]" title="会员冻结风险率"
													style="text-align:right;" width="14%"
													value="${memberThreshold.frozenTh_v}%" />
												<ec:column property="primary.m_SelfTradeRate[=][bigdecimal]" title="会员非客户头寸交易比例"
