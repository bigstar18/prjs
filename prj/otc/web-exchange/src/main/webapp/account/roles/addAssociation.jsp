				...
				<td>
					...
					<form name="frm"
						...
						<table id="tb" border="0" cellspacing="0" cellpadding="0"
							width="100%" height="300" style="table-layout:fixed">
							<tHead>
								<tr height="25" align=center>
									<td width="3%" class="panel_tHead_LB">
										&nbsp;
									</td>
									<td width="7%" class="panel_tHead_MB" align=center>
									...
									<td width="48%" class="panel_tHead_MB" align=center>
										用户描述
									</td>
									<td width="2%" class="panel_tHead_RB">
										&nbsp;
									</td>
								</tr>
							</tHead>
