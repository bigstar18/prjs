...
<html>
	...
	<body class="st_body">
		<form name="frm" action="${basePath}/account/specialMemberFreezeStatus/update.action"
			method="post" targetType="hidden">
			<div class="div_scromin1">
			<table border="0" width="90%" align="center">
				<tr>
					<td>
					<div class="st_title"><img src="<%=skinPath%>/cssimg/st_ico1.gif" align="absmiddle" />&nbsp;&nbsp;特别会员冻结</div>
				<table border="0" cellspacing="0" cellpadding="4" width="100%"
					...
					<tr height="35">
						...
						<td><input type="hidden" name="obj.specialMemberStatus.status" value="F" >
