			...
			<table class="table1_style" border="0" cellspacing="0" cellpadding="0">
				<tr>
					<td>
						<div class="div_tj">
						<form name="frm"
								action="${basePath}/account/specialMemberFreezeStatus/list.action"
								method="post">
									...
									<td>
										<ec:table items="resultList"
											...
											<ec:row recordKey="${specialMember.id}">
												...
												<ec:column property="id[Like]" title="特别会员编号"  width="12%"
...
function update(id) {
	var url = "${basePath}/account/specialMemberFreezeStatus/forwardUpdate.action?obj.id="
			+ id;
