			...
			<table class="table1_style" border="0" cellspacing="0" cellpadding="0">
				<tr>
					<td>
						<div class="div_tj">
						<form name="frm"
								action="${basePath}/account/specialMemberUFreezeStatus/list.action"
								method="post">
									...
									<td>
										<ec:table items="resultList"
											...
											<ec:row recordKey="${specialMember.id}">
												...
												<ec:column property="id[Like]" title="特别会员编号" width="14%"
													style="text-align:left; ">
													<a href="#" class="blank_a"
														onclick="return update('${specialMember.id}');"><font
														color="#880000">${specialMember.id}</font>
													</a>
												</ec:column>
												...
												<ec:column property="useFunds[=][bigdecimal]" width="20%"
...
function update(id) {
	var url = "${basePath}/account/specialMemberUFreezeStatus/forwardUpdate.action?obj.id="
			+ id;
