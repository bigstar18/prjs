									...
									<td>
										<ec:table items="resultList"
											...
											<ec:row recordKey="${user.userId}">
												...
												<ec:column property="userId[=]" width="13%" title="用户代码"
												...
												<ec:column property="_1" width="14%" title="关联角色"
												...
												<ec:column property="_2" width="14%" title="密码修改"
													style="text-align:center;" filterable="false" sortable="false">
...
<SCRIPT LANGUAGE="JavaScript">
	...
	function modPwd(userId){
	  ...
	  if(checkie()){
			...
			result = ecsideDialog(url, null, 580, 340);
	  	}else{
		  	var url = "<%=basePath%>/user/forwardUpdatePassword.action?obj.userId="+userId+"&d="+Date();
			result = ecsideDialog(url, null, 580, 290);
	  	}
	  if(result)
		{		
			queryInfo();
