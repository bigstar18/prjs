				...
				<td align="center">
					<form name="frm"
						...
						<table id="tb" border="0" cellspacing="0" cellpadding="0"
							width="98%" style="word-break:break-all;table-layout:fixed;border-right: 1px solid #d9d9d9;border-top: 1px solid #d9d9d9;border-bottom: 1px solid #d9d9d9;">
