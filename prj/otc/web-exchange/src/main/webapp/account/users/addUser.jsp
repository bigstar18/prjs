					...
					<table border="0" cellspacing="0" cellpadding="0" width="90%"
						...
						<tr height="35">
							...
							<td align="left" width="45%">
								<input id="userId" style="width: 160px;" name="obj.userId"
									onblur="myblur('userId')" onfocus="myfocus('userId')"
						...
						<tr height="35">
							...
							<td align="left" width="45%">
								<input id="name" style="width: 160px;" name="obj.name"
									type="text" class="text" onblur="myblur('name')"
						...
						<tr height="35">
							...
							<td align="left">
								<textarea id="description" name="obj.description" cols="20"
									rows="5" class="normal" onblur="myblur('description')"
									onfocus="myfocus('description')"></textarea>
							</td>
							<td>
								<div id="description_vTip" class="onShow"></div>
							</td>
						</tr>
						<tr>
