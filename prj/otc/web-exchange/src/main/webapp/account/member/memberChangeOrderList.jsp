										...
										<ec:table items="resultList"
											...
											<ec:row recordKey="${memberInfo.id}">
												...
												<ec:column property="_" title="转单分配"
													style="text-align:center" width="25%" filterable="false" sortable="false">
