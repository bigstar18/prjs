...
<form name="frm" id="frm" method="post" targetType="hidden">
		 <div class="div_scromin">
			<table border="0" width="100%" align="center">
				...
				<tr>
					<td>
						<div class="st_title"><img src="<%=skinPath%>/cssimg/st_ico1.gif" width="43" height="40" align="absmiddle" />&nbsp;&nbsp;添加会员用户</div>
		<table border="0" cellspacing="0" cellpadding="0" width="80%" align="center" class="st_bor">
			  <tr height="35">
            	<td align="right"> 用户代码 ：</td>
                <td align="left">
                	<input id="userId" name="obj.userId" onkeyup="value=value.replace(/[\W]/g,'')" onbeforepaste="clipboardData.setData('text',clipboardData.getData('text').replace(/[^\d]/g,''))" type="text" class="text" style="width: 180px;"><b><font color=red>&nbsp;*</font></b>
                </td>
        </tr>
        <tr height="35">
            	<td align="right"> 姓名 ：</td>
                <td align="left">
                	<input id="name" name="obj.name" type="text" class="input_text_mid">
                </td>
			  </tr>
        <tr height="35">
                <td align="right"> 密码 ：</td>
                <td align="left">
                	<input id="password" name="obj.password" type="password" class="text" style="width: 180px;"><b><font color=red>&nbsp;*</font></b>
                </td>
        </tr>
        <tr height="35">       
                <td align="right"> 确认密码 ：</td>
                <td align="left">
                	<input id="password1" name="password1" type="password" class="text" style="width: 180px;"><b><font color=red>&nbsp;*</font></b>
                </td>
              </tr>
		 ...
		 <table border="0" cellspacing="0" cellpadding="0" align="center" width="100%">
			  <tr height="35">
				<td align="center">
					<button  class="btn_sec" onClick="addChk()" id="add">修改</button>
				</td>
				<td align="center">
...
//	if(frm.enableKey[0].checked && frm.keyCode.value == '')
	...
	//防止重复提交
	if(sign){
		frm.action="<%=basePath %>/account/memberUser/add.action";
		frm.submit();
		}
