			...
			<table class="table1_style" border="0" cellspacing="0" cellpadding="0">
				<tr>
					<td>
						<div class="div_tj">
						<form name="frm"
								action="${basePath}/account/memberActiveStatus/list.action?sortName=primary.id"
								method="post">
									...
									<td>
										<ec:table items="resultList"
											...
											<ec:row recordKey="${memberInfo.id}">
												...
												<ec:column property="name[like]" title="会员名称" width="26%"
												...
												<ec:column property="-1" width="15%" filterable="false" ellipsis="true" interceptor="gnnt.MEBS.account.action.interceptor.MemberTipInterceptor"
...
function update(id) {
	var url = "${basePath}/account/memberActiveStatus/forwardUpdateActive.action?obj.id="
			+ id;
