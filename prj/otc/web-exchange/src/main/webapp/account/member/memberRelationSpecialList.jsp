		...
		<form action="" name="frm" method="post" targetType="hidden">
			<fieldset>
				...
				<table border="0" cellspacing="0" cellpadding="0" width="100%">
					<tr>
						<td colspan="2" align="center" style="font-size: 14; color: red">
							选择关联的特别会员
						</td>
					</tr>
					<tr>
				...
				<table cellspacing="0" cellpadding="0" border="0" width="100%">
					<tr>
						<td width="50%" align="center">
							<button value="ContactSpecialMember"
...
function contactSpecialMember(id) {
	...
	frm.action = "${basePath}/account/memberRelation/update.action?memberId="
			+ id;
	frm.submit();
}
</script>
