...
<body style="overflow-y:hidden" onload="setCheckReadOnly();">
<form name="frm" method="post">
  <div class="st_title"><img src="<%=skinPath%>/cssimg/st_ico1.gif" align="absmiddle" />&nbsp;&nbsp;用户权限</div>
		<div class="div_scromax" style="overflow-x:hidden;position:absolute;top:50;z-index:1;">
...
function frmChk()
{
	...
	if(sign)
	{
		frm.action="<%=basePath %>/right/commonRightSaveUserRights.action"
		frm.submit();
	}
}
function setCheckReadOnly() {
