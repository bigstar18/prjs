...
<html>
	...
	<div class="st_title">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<img src="<%=skinPath%>/cssimg/st_ico1.gif" align="absmiddle" />&nbsp;&nbsp;选择会员</div>			
			...
			<table border="0" width="90%" align="center">
				<tr>
					<td>
				<table border="0" cellspacing="0" cellpadding="0" width="90%" align="left" class="st_bor" valign="top">
