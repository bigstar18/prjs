...
<html>
	...
	<body style="overflow-y:hidden">
		<form name="frm"
			action="${basePath}/account/customerFreezeStatus/update.action"
			method="post" targetType="hidden">
			<div class="div_scromin1">
			<table border="0" width="80%" align="center">
				<tr>
					<td>
					<div class="st_title"><img src="<%=skinPath%>/cssimg/st_ico1.gif" width="30" height="28" align="absmiddle" />&nbsp;&nbsp;客户冻结</div>
				<table border="0" cellspacing="0" cellpadding="4" width="100%"
					...
					<tr height="35">
						...
						<td>
							<input type="hidden" id="status" name="obj.customerStatus.status" value="F">
	...
	<tr>
		<td align="center">
			<button  class="btn_sec" onClick="updateCustomerStatus()" id="update">冻结</button>
		</td>
		<td align="center">
