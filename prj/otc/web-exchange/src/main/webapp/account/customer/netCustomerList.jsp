										...
										<ec:table items="resultList"
											...
											<ec:row recordKey="${customer.customerNo}">
												...
												<ec:column property="primary.customerNo[like]" width="3%"
													...
													<a href="#" onclick="toinformation('${customer.customerNo}')">查看</a>
													</ec:column>
												<ec:column property="primary.customerNo[like]" width="3%"
													title="交易商须知" style="text-align:center; " sortable="false">
													<a href="#" onclick="tojsp('xuzhi')">查看</a>
													</ec:column>
												<ec:column property="primary.customerNo[like]" width="3%"
													title="风险告知书" style="text-align:center; " sortable="false">
													<a href="#" onclick="tojsp('fengxian')">查看</a>
													</ec:column>
											</ec:row>
										</ec:table>
									</td>
