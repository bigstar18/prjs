...
<script type="text/javascript"
	src="<%=publicPath%>/ecsideTool.js"></script>
<html>
<body>
...
this.filters.alpha.opacity=80"></a></div>
    <div class="anniu_01"><a href="#" onclick="changePwd('${CURRENUSERID}');"><img src="<%=skinPath%>/cssimg/02.gif" width="91" height="25" border="0" style="-moz-opacity:0.5; filter:alpha(opacity=80);cursor:hand;background-attachment: fixed;" onmouseover="this.style.MozOpacity=1;
this.filters.alpha.opacity=100" onmouseout="this.style.MozOpacity=0.5;
this.filters.alpha.opacity=80"></a></div>
   </div>
...
<script language="javascript">
	...
	function changePwd(id)
	{
		...
		var value=dialog(url, window, 420, 350);
		//if(value==1111)
	...
	function shinStyle(id){
		var url = "<%=basePath %>/user/commonUserModStyle.action?obj.userId="+id+"&d="+Date();
		ecsideDialog(url, null, 400, 250);
		if(result)
		{		
