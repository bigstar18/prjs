	...
	<form id="frm" action="" method="post">
		...
		<div id="main_body">
  		...
  		<tHead>
  			<tr align=center>
				...
				<td width="8%" class="panel_tHead_MB" align="center">时间</td>
		...
		<tBody>
			...
			<tr height="22" align=center>
				...
				<td class="underLine_last" align="left" colspan="4">出入金差值：<%=Tool.fmtMoney(cm11.money-cm12.money)%>(元)</td>
				<td class="panel_tBody_RB">&nbsp;</td>
			</tr>
			<tr height="22" align=center>
				<td class="panel_tBody_LB">&nbsp;</td>
				...
				<td class="underLine_last" align="left" colspan="4">出入金差值：<%=Tool.fmtMoney(cm21.money-cm22.money)%>(元)</td>
				<td class="panel_tBody_RB">&nbsp;</td>
			</tr>
			<tr height="22" align=center>
				<td class="panel_tBody_LB">&nbsp;</td>
				...
				<td class="underLine_last" align="left" colspan="4">出入金差值：<%=Tool.fmtMoney(cm31.money-cm32.money)%>(元)</td>
				<td class="panel_tBody_RB">&nbsp;</td>
			</tr>
			<%}%>
	  	</tBody>
