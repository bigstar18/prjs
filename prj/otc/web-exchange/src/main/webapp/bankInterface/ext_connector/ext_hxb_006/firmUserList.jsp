...
if(firmType != null && firmType.length()>0){
	filter1 += " and mf.firmType='"+firmType+"' ";
}
if(belevemember != null && belevemember.trim().length()>0){
	if("M".equalsIgnoreCase(firmType) || "S".equalsIgnoreCase(firmType)){
		filter1 += " and fbf.firmID='"+belevemember.trim()+"' ";
	}else{
		filter1 += " and mc.memberno='"+belevemember.trim()+"' ";
	}
}
											...
											<table class="table3_style" border="0" cellspacing="0"
												...
												<tr>
													...
													<td width="210" align="left" >
													 ...
													 <td width="210" align="left">
														&nbsp;&nbsp;
														<input type="hidden" maxlength="15" class="input_text"  name="firmID" value="<%=firmID %>"/>
													</td>
												</tr>
												<tr>
													<td align="left">
													...
													<td align="left" width="600">
														&nbsp;预签约状态：&nbsp;
														<select name="checkSignHX" style="width:68px">
															<option value="">全部</option>
			...
			for(int i=0;i<dicList1.size();i++) {
				...
				<tr align="center"  onclick="selectTr();" height="22" >
					...
					<td class="underLine" align="center"><%
						if("C".equals(firmer.firmType)){
							out.print("客户");
						}else if("M".equals(firmer.firmType)){
							out.print("会员");
						}else if("S".equals(firmer.firmType)){
							out.print("特别会员");
						}
					%>&nbsp;</td>
					<td class="underLine" align="center"><%=replaceNull(firmer.belevemember)%>&nbsp;</td>
...
function doQuery(){
	...
	if(!isStr(firmID.value.trim(),false,null)){
		alert("交易账号非法");
		firmID.focus();
	}else if(!isStr(belevemember.value.trim(),false,null)){
		alert("所属会员编号非法");
		belevemember.focus();
