...
<html>
			...
			<table class="table1_style" border="0" cellspacing="0" cellpadding="0">
				<tr>
					<td>
						<div class="div_tj">
						<form name="frm"
								action="${basePath}/tradeManage/announcementList/noticeList.action"
								method="post">
	...
	function showAnnouncement(id) {
		var url = "${basePath}/tradeManage/announcementList/showAnnouncement.action?obj.id="+id;
		ecsideDialog(url,null,610,560);
	}
	
	function showSendPeople(id) {
		var url = "${basePath}/tradeManage/announcementList/showSendPeople.action?obj.id="+id;
		ecsideDialog(url,null,610,560);
	}
