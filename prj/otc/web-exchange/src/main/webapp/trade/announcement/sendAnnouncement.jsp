													...
													<tr>
														...
														<td align="left">
															<input type="text" name="notice.author" id="author"
																class="nput_textmax" value="${user.id}" size="50" style="width: 800;" 
																readonly="readonly" />
														</td>
													</tr>
													<tr>
														...
														<td align="left">
															<c:if test="${notice.authorOrganization != null}">
																<input type="text" name="notice.authorOrganization" id="authorOrganization"
																	class="input_textmax" value="${notice.authorOrganization}" size="50" style="width: 800;" 
																	onkeydown="checkAuthorOrganization()" onkeyup="checkAuthorOrganization()"/>
															</c:if>
															<c:if test="${notice.authorOrganization == null}">
																<input type="text" name="notice.authorOrganization" id="authorOrganization"
																	class="input_textmax" value="测试交易所" size="50" style="width: 800;" 
																	onkeydown="checkAuthorOrganization()" onkeyup="checkAuthorOrganization()"/>
															</c:if>
															<span style="width:150px;"><div><strong class="check_input">*(最多输入32个字)&nbsp;</strong></div></span>
														</td>
													</tr>
													<tr>
														<td align="left">
...
function checkAuthorOrganization() {
	var max = 32;
	var cur = document.getElementById('authorOrganization').value.length;
	if (cur > max){
	   document.getElementById('authorOrganization').value = document.getElementById('authorOrganization').value.substring(0, max);
	} 
}
