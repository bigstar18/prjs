...
function sub() {
	...
	if (checks) {
		...
		parWin.document.getElementById('trader').value = returnNames;
		if(showNames.length > 0){
			parWin.document.getElementById('traderManagerShow').value = showNames.substring(0, showNames.length - 1);
		} else {
			parWin.document.getElementById('traderManagerShow').value = "";
		}
	}
	...
	if (memberInfoIds) {
		if(memberInfoIds.length){
			...
			parWin.document.getElementById('traderInfoIds').value = memberInfoString;
		} else {
			if (memberInfoIds.checked) {
				parWin.document.getElementById('traderInfoIds').value = memberInfoIds.value;
			}
		}
	}
	...
	if (organizationIds) {
		if(organizationIds.length){
			...
			parWin.document.getElementById('trader_ognIds').value = organizationString;
		} else {
			if (organizationIds.checked) {
				parWin.document.getElementById('trader_ognIds').value = "'" + organizationIds.value + "'";
			}
		}
	}
	window.close();
...
if(parWin.document.getElementById('traderInfoIds')){
	var memberInfoIds = parWin.document.getElementById('traderInfoIds').value;
...
if(parWin.document.getElementById('trader_ognIds')){
	var organizationIds = parWin.document.getElementById('trader_ognIds').value;
