	...
	<body style="overflow-y:hidden">
		<form name="myForm" action=""
			...
			<table border="0" width="90%" align="center">
				...
				<input type="hidden" name="applyId" value="${tcDelayFeeMap.applyId}">
				<%@ include file="/commodity/tcDelayFee/memberDelayFeeInfoUpdateTable.jsp"%>
...
<script language="javascript">
	function audit(aa){
		myForm.action="${basePath}/audit/${COMMODITY_}memberDelayFeeAudit/audits.action";
