			...
			<table class="table1_style" border="0" cellspacing="0"
				...
				<tr>
					<td>
						...
						<div class="div_tj">
							<form name="myForm"
								action="${basePath}/audit/articleParitiesAgioAudit/auditList.action"
								method="post">
								...
								<tr>
									<td>
										<ec:table items="list"
											...
											action="${basePath}/audit/articleParitiesAgioAudit/auditList.action"
											title="" minHeight="450" listWidth="100%" height="450px"
											...
											<ec:row ondblclick="doubleClick(${obj.id})">
												...
												<ec:column property="commodityId[like]" title="商品代码" width="20%"
													style="text-align:left;" value="${obj.commodityId}" />
...
function doubleClick(id) {
	var url = "${basePath}/audit/articleParitiesAgioAudit/auditDetails.action?applyId="
			+ id;
	ecsideDialog(url, window, 580, 435);
}
