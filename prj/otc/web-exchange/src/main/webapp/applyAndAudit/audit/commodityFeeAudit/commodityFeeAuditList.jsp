			...
			<table class="table1_style" border="0" cellspacing="0"
				...
				<tr>
					<td>
						...
						<div class="div_tj">
							<form name="myForm"
								action="${basePath}/audit/commodityFeeAudit/auditList.action"
								method="post">
											...
											<div class="div2_top">
												<table class="table3_style" border="0" cellspacing="0"
													...
													<tr>
														...
														<td class="table3_td2">
															<label>
															 <input type="text" id="${GNNT_}commodityName[like]" name="${GNNT_}commodityName[like]" value="${oldParams['commodityName[like]'] }"/>
															</label>
														</td>
														<td class="table3_td" align="right">
															&nbsp;
...
function doubleClick(id) {
	var url = "${basePath}/audit/commodityFeeAudit/auditDetails.action?applyId="
			+ id;
