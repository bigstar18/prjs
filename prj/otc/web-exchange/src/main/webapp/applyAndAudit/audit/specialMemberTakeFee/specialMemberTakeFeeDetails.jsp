	...
	<body style="overflow-y:hidden" class="st_body" >
		<form name="frm" action="" method="post" targetType="hidden">
			...
			<table border="0" width="90%" align="center">
				<tr>
				<td>
				<div class="st_title"><img src="<%=skinPath%>/cssimg/st_ico1.gif" align="absmiddle" />&nbsp;申请具体信息</div>
...
<script type="text/javascript">
	function audit(aa){
		frm.action="${basePath}/apply/${COMMODITY_}specialMemberTakeFeeAudit/audits.action";
