			...
			<table class="table1_style" border="0" cellspacing="0"
				...
				<tr>
					<td>
						...
						<div class="div_tj">
							<form name="myForm"
								action="${basePath}/audit/priceProtectAudit/auditList.action"
								method="post">
									...
									<td>
										<ec:table items="list"
											...
											<ec:row ondblclick="doubleClick(${obj.id})">
												<ec:column property="id[=][long]" title="id" width="20%"
													style="text-align:left; " value="${obj.id}" />
												<ec:column property="commodityName[like]" title="申请流水号"
...
function doubleClick(id) {
	var url = "${basePath}/audit/priceProtectAudit/auditDetails.action?applyId="
			+ id;
