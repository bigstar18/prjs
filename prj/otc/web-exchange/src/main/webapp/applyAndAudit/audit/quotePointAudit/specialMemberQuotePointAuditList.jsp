			...
			<table class="table1_style" border="0" cellspacing="0"
				...
				<tr>
					<td>
						...
						<div class="div_tj">
							<form name="myForm"
								action="${basePath}/audit/specialMemberQuotePointAudit/auditList.action"
								method="post">
									...
									<td>
										<ec:table items="list"
											...
											<ec:row ondblclick="doubleClick(${obj.id})">
												...
												<ec:column property="m_firmId[like]" title="会员编号" width="20%"
													style="text-align:left;" value="${obj.m_firmId}" />
...
function doubleClick(id) {
	var url = "${basePath}/audit/specialMemberQuotePointAudit/auditDetails.action?applyId=" + id;
	ecsideDialog(url, window, 580, 370);
}
