			...
			<table class="table1_style" border="0" cellspacing="0"
				...
				<tr>
					<td>
						...
						<div class="div_tj">
							<form name="myForm"
								action="${basePath}/audit/memberQuotePointAudit/auditList.action"
								method="post">
									...
									<td>
										<ec:table items="list"
											...
											<ec:row ondblclick="doubleClick(${obj.id})">
												...
												<ec:column property="name[like]" title="会员编号" width="20%"
...
function doubleClick(id) {
	var url = "${basePath}/audit/memberQuotePointAudit/auditDetails.action?applyId=" + id;
