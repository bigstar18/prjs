	...
	<body style="overflow-y:hidden">
		<form name="myForm" action=""
			...
			<table border="0" width="90%" align="center">
				...
				<td>
				<div class="st_title">
				<img src="<%=skinPath%>/cssimg/st_ico1.gif" width="43" height="40" align="absmiddle" />&nbsp;详细信息</div>
...
<script language="javascript">
	function audit(aa){
		myForm.action="${basePath}/audit/${COMMODITY_}memberTradeAuthAudit/audits.action";
