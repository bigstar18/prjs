			...
			<table class="table1_style" border="0" cellspacing="0"
				...
				<tr>
					<td>
						...
						<div class="div_tj">
							<form name="myForm"
								action="${basePath}/audit/memCustomerTakeFeeAudit/auditList.action"
								method="post">
								...
								<tr>
									<td>
										<ec:table items="list"
											...
											action="${basePath}/audit/memberTakeFeeAudit/auditList.action"
...
function doubleClick(id) {
	var url = "${basePath}/audit/memCustomerTakeFeeAudit/auditDetails.action?applyId="
			+ id;
