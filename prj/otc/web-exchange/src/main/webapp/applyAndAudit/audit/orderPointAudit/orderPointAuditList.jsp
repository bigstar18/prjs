			...
			<table class="table1_style" border="0" cellspacing="0"
				...
				<tr>
					<td>
						...
						<div class="div_tj">
							<form name="myForm"
								action="${basePath}/audit/orderPointAudit/auditList.action"
								method="post">
...
function doubleClick(id) {
	var url = "${basePath}/audit/orderPointAudit/auditDetails.action?applyId="
			+ id;
	ecsideDialog(url, window, 580, 465);
}
