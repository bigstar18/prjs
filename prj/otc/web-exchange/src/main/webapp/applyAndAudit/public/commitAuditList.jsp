				...
				<tr>
					<td>
						<ec:table items="list"
							...
							action="${basePath}/audit/commitAudit/commitAuditList.action"
							...
							<ec:row>
								...
								<ec:column property="statusDiscribe[like]" title="描述" 
								 ellipsis="true" width="20%" style="text-align:left;" value="${obj.statusDiscribe}" />
								<ec:column property="primary.modTime[=][timestemp]" title="申请时间"
...
function doubleClick(id,type) {
	var url = "${basePath}/audit/commitAudit/"+type+"Audit/auditDetails.action?applyId="
			+ id+"&apply=1";
