				...
				<tr>
					<td>
						<ec:table items="list"
							...
							action="${basePath}/audit/baseSelfPassAudit/baseAuditList.action"
							...
							<ec:row>
								...
								<ec:column property="auditProposer[like]" title="审核人"
									width="20%" style="text-align:left;"
									value="${obj.auditProposer}" />
								<ec:column property="auditModtime[=][timestemp]" title="审核时间"
									width="20%" style="text-align:left;"
									value="${datefn:formatdate(obj.auditModtime)}" />
							</ec:row>
						</ec:table>
					</td>
				</tr>
