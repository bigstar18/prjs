  ...
  <body  >
    <form name="frm_openAccount" id="frm_openAccount" method="post" action="<%=basePath%>/weixinAddZs.fir?funcflg=saveFrim">
        <div class="frame">
            ...
            <div class="title">交易商入市协议书</div>
            <div class="con">
                <div class="back_frame" >
                	<table width="100%">
                		<tr>
                			<td>甲方：${memberInfo.Name}</td>
                			<td>乙方：${auditInfo.name }</td>
                		</tr>

                		<tr>
                			<td>电话：${memberInfo.PHONE}</td>
                			<td>电话:${auditInfo.phone }</td>
                		</tr>
                		
                		<tr>
                			<td>地址：${memberInfo.ADDRESS}</td>
                			<td>地址：${auditInfo.address }</td>
                		</tr>
                	</table>
                	<textarea rows="30%" cols="95%" style="overflow: auto;width: 100%;" readonly="readonly" disabled="disabled">
${agreementMap.AGREEMENT2 }
</textarea>
                 </div>
                <div class="system">
