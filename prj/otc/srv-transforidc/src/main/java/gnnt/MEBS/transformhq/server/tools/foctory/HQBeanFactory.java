package gnnt.MEBS.transformhq.server.tools.foctory;
  ...
  implements Serializable
{
  ...
  private static final String beanConfig = "TransFormHQ.xml";
  private static BeanFactory factory;
  private static Properties props = getProps();
  
  public static void init()
  {
    ClassPathResource res = new ClassPathResource("TransFormHQ.xml");
    log.debug("初始化context:TransFormHQ.xml");
