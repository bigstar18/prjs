				...
				<td>
					<ec:table items="noticeList"
						...
						<ec:row recordKey="${notice.id}">
							...
							<ec:column property="title[like]" title="主题" width="20%" style="text-align:center;" tipTitle='${notice.titleHtml}'> <a href="#" class="blank_a" onclick="showAnnouncement(${notice.id});"><font style="color: #880000">${notice.titleHtml}</font></a></ec:column>
