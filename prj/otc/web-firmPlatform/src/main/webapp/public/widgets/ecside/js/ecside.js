...
/**
 * 以下代码实现了保留翻页后的Ecside checkbox 状态
 * @param {Object} dx
 * @memberOf {TypeName} 
 * @return {TypeName} 
 */
...
ECSideUtil.gotoPage=function(pageno,formid){   
	var allcheckarray =ECSideUtil.getPageCheckValue("chkBoxUser")  ;//获得所有的check值   
	var ecsideObj=ECSideUtil.getGridObj(formid);   
	ecsideObj.showWaitingBar();   
    try{
        ECSideUtil.NearPagesBar.doHideMe();   
	...
	ECSideUtil.initPageCheckValue("chkBoxUser",allcheckarray);//初始化本页   
}; 