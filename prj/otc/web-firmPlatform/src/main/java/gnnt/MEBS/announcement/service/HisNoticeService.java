  ...
  extends BaseService<HisNotice>
{
  ...
  public List<HisNotice> getCustomerOKNoticeList(QueryConditions qc, PageInfo pageInfo, String userId)
  {
    return this.hisNoticeDao.getCustomerOKNoticeList(qc, pageInfo, userId);
  }
