...
<html>
	...
	<body>
			...
			<table class="table1_style" border="0" cellspacing="0" cellpadding="0">
				<tr>
					<td>
						<div class="div_tj">
						<form name="frm"
								action="${basePath}/commodity/memberTradeAuth/list.action?sortName=primary.commodityId"
								method="post">
						...
						<div class="div_gn">
							<button class="anniu_btn" onclick="addMemberTrade()" id="update">
								添加
							</button>
						</div>
								...
								<tr>
									<td>
										<ec:table items="resultList"
											...
											var="tradeAuth"
											action="${basePath}/commodity/memberTradeAuth/list.action?sortName=primary.commodityId" title=""
											...
											<ec:row recordKey="${tradeAuth.firmId}">
												...
												<ec:column property="memberInfo.name[=][int]" title="会员名称"
		...
		function update(firmId,commodityId){
			var url="${basePath}/commodity/memberTradeAuth/forwardUpdate.action?obj.commodityId="+commodityId+"&obj.firmId="+firmId;
			ecsideDialog(url,"",580,590);
		}
		function submitMember(){
			frm.submit();
		}
		function addMemberTrade() {
			var urlFee = "${basePath}/commodity/memberTradeAuth/forwardAdd.action";
