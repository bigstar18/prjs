...
<html>
	...
	<body leftmargin="0" topmargin="0">
		<form name="frm" action="${basePath}/commodity/tradeAuthForTrader/update.action" method="post" targetType="hidden">
			<div>
			<table border="0" width="90%" align="center" >
				<tr>
					<td>
						   <div class="st_title"><img src="<%=skinPath%>/cssimg/st_ico1.gif" align="absmiddle" />&nbsp;&nbsp;交易权限设置</div>
							<%@ include file="/commodity/tradeAuth/traderTradeAuthInfoTable.jsp"%>
