								...
								<tr>
									<td>
										<ec:table items="resultList"
											...
											minHeight="460" listWidth="120%" height="460"
											...
											<ec:row recordKey="${takeFee.commodityId}"
												ondblclick="return forwardUpdate('${takeFee.commodityId}','${takeFee.m_FirmId }');">
												<ec:column property="commodity.id[like]" title="商品代码"
													width="14%" style="text-align:center; "
													value="${takeFee.commodityId}" />
												<ec:column property="commodity.name[like]" title="商品名称"
													width="14%" style="text-align:center;overflow:hidden;text-overflow:ellipsis"
													value="${takeFee.commodityName}" tipTitle="${takeFee.commodityName}"/>
												...
												<ec:column property="feeMode[=]" title="收取方式" width="14%"
													style="text-align:center;" editTemplate="ecs_takeFeeType">
