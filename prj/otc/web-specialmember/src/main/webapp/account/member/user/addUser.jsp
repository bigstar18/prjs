...
<form name="frm" id="frm" method="post" targetType="hidden">
        ...
        <tr height="35">
                ...
                <td align="left">
                	<input id="password" name="obj.password" type="password" class="input_text_mid"><b><font color=red>&nbsp;*</font></b>
                </td>
        </tr>
        <tr height="35">       
                <td align="right"> 确认密码 ：</td>
                <td align="left">
                	<input id="password1" name="password1" type="password" class="input_text_mid"><b><font color=red>&nbsp;*</font></b>
                </td>
              </tr>
