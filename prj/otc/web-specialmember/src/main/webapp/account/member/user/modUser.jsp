				...
				<tr>
               	...
               	<input type="hidden" class="from" name="obj.skin" value="${obj.skin}">
					...
					<tr height="35">
						...
						<td>
							<input class="input_text" name="obj.name" id="name" type="text" class="text" value="${obj.name}" >
						</td>
					</tr>
					<input class="input_text" type="hidden" name="enableKey" id="enableKey" value="N">
		  <!-- 
