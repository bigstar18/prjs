...
<form name="frm" method="post">
		<div class="div_scromax" style="overflow-x:hidden;position:absolute;top:10;z-index:1;">
			<table border="0" width="90%" align="center">
				<tr height="100"></tr>
				<tr>
					<td>
						<div class="st_title"><img src="<%=skinPath%>/cssimg/st_ico1.gif" width="43" height="40" align="absmiddle" />&nbsp;&nbsp;特别会员管理员权限</div>
