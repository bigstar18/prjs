			...
			<table class="table1_style" border="0" cellspacing="0" cellpadding="0">
				<tr>
					<td>
						...
						<div class="div_tj">
						<form name="frm"
								action="${basePath}/account/customerCloseStatus/list.action?sortName=customer.name"
								method="post">
										...
										<ec:table items="resultList"
											...
											<ec:row recordKey="${customer.customerNo}"
												...
												<ec:column property="address[like]" width="20%" title="地址"
													style="text-align:center;overflow:hidden;text-overflow:ellipsis" value="${customer.address}" tipTitle=""/>
