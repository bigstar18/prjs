...
<body>
     <form name="frm" id="frm" method="post" targetType="hidden">
		...
		<table border="0" cellspacing="0" cellpadding="0" width="95%" align="center" class="st_bor">
		  <tr height="35">
           	<td align="right" class="td_size">用户代码 ：</td>
         ...
         <tr height="35">
			...
			<td align="left" class="td_size">
				<input class="input_text" name="obj.name" id="name" type="text" class="text" 
				onblur="checkName('name');"	onfocus="myfocus('name')"	value="${obj.name}">
