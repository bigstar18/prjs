			...
			<table class="table1_style" border="0" cellspacing="0"
				...
				<tr>
					<td>
						<div class="div_tj">
							<form name="frm"
								action="${basePath}/query/queryMemberThSearch/list.action?sortName=primary.name"
								method="post">
										...
										<ec:table items="resultList"
											...
											<ec:row>
												...
												<ec:column property="memberNo[like]" title="会员编号"
													...
													value="${memberTh.memberNo}" ellipsis="true" />
												<ec:column property="name[like]" title="会员名称" width="12%"
													style="text-align:left; " value="${memberTh.name}"
													ellipsis="true" />
												<ec:column property="memberMarginTh[=][double]"
													title="会员资金预警阈值" width="12%" style="text-align:right; ">
												...
												<ec:column property="memberFreezeTh[=][double]"
													title="会员冻结阈值比例" width="14%" style="text-align:right; ">
													<fmt:formatNumber value="${memberTh.memberFreezeTh*100}"
														pattern="0.00" />%
												</ec:column>
												<ec:column property="memberNetHoldTh[=][double]"
													title="会员出金阈值比例" width="10%" style="text-align:right; ">
													<fmt:formatNumber value="${memberTh.memberNetHoldTh*100}"
														pattern="0.00" />%
												</ec:column>
												<ec:column property="traderate[=][double]" title="会员非客户头寸交易比例"
													width="10%" style="text-align:right; ">
													<fmt:formatNumber value="${memberTh.traderate*100}"
														pattern="0.00" />%
												</ec:column>
											</ec:row>
										</ec:table>
