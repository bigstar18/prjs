...
frm.commodityId.value = '${oldParams["primary.commodityName[like]"] }';
													...
													<tr>
														...
														<td class="table3_td_1" align="left">
															...
															<label>
																<span class="right_03zi"> <select
																		name="${GNNT_}de_build_flag[=][int]" size="1"
																		id="flag" style="width: 100">
																		<option value="">
																			请选择
																		</option>
																		<option value="1">
														...
														<script type="text/javascript">
															frm.flag.value = '${oldParams["de_build_flag[=][int]"] }';
														</script>
													</tr>
												</table>
											</div>
								...
								<tr>
									<td>
										<ec:table items="resultList"
											...
											title="" minHeight="345" listWidth="185%"
											...
											<ec:row>
												...
												<ec:column property="atClearDate[=][date]" title="结算日期"
													...
													value="${datefn:formatdate(memberTrade.atClearDate)}" ellipsis="true"/>
												</c:if>
												...
												<ec:column property="commodityName[like]" title="商品名称"
													width="6%" style="text-align:left; "
													value="${memberTrade.commodityName}" />
												<ec:column property="holdQty[=][int]" title="数量" width="4%"
													style="text-align:right; " value="${memberTrade.holdQty}" />
												...
												<ec:column property="buildDate[=][date]" title="建仓时间"
													...
													value="${datefn:formatdate(memberTrade.buildDate)}" />
												<ec:column property="de_build_flag[=][int]" title="平仓方向 "
													width="4%" style="text-align:left; "
													editTemplate="esc_de_bsFlag">
													<c:set var="typeKey">
														<c:out value="${memberTrade.de_build_flag}"></c:out>
													</c:set>
		  											${bsFlagMap[typeKey]}
		  											</ec:column>
												...
												<ec:column property="de_buildDate[=][date]" title="平仓时间"
													width="4%" style="text-align:left; "
													value="${datefn:formatdate(memberTrade.de_buildDate)}" />
												...
												<ec:column property="closetraderid[like]" title="平仓者"
													width="5%" style="text-align:right; " value="${memberTrade.closetraderid}"  ellipsis="true">
													 
														
												</ec:column>
												<ec:column property="opentraderid[like]" title="建仓者"
													width="5%" style="text-align:right;" value="${memberTrade.opentraderid}" ellipsis="true">
