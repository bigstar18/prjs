...
<td valign="middle"  columnName="age[=]"  sortable="true"  resizeColWidth="true"  editTemplate="ecs_t_input"  width="100"  class="tableHeader  tableResizeableHeader editableColumn"  onmouseover="ECSideUtil.lightHeader(this,'ec');"  onmouseout="ECSideUtil.unlightHeader(this,'ec');"  oncontextmenu="ECSideUtil.showColmunMenu(event,this,'ec');"  onmouseup="ECSideUtil.doSort(event,'age[=]','asc','ec');"  title="排序 机构" ><span onmousedown="ECSideUtil.StartResize(event,this,'ec');" onmouseup="ECSideUtil.EndResize(event);" class="columnSeparator columnResizeableSeparator" >&#160;</span><div class="headerTitle" >机构</div></td>
<td valign="middle"  columnName="address[like]"  sortable="true"  resizeColWidth="true"  editTemplate="ecs_t_input"  width="100"  class="tableHeader  tableResizeableHeader editableColumn"  onmouseover="ECSideUtil.lightHeader(this,'ec');"  onmouseout="ECSideUtil.unlightHeader(this,'ec');"  oncontextmenu="ECSideUtil.showColmunMenu(event,this,'ec');"  onmouseup="ECSideUtil.doSort(event,'address[like]','asc','ec');"  title="排序 版本号" ><span onmousedown="ECSideUtil.StartResize(event,this,'ec');" onmouseup="ECSideUtil.EndResize(event);" class="columnSeparator columnResizeableSeparator" >&#160;</span><div class="headerTitle" >版本号</div></td>
<td valign="middle"  columnName="address[like]"  sortable="true"  resizeColWidth="true"  editTemplate="ecs_t_input"  width="100"  class="tableHeader  tableResizeableHeader editableColumn"  onmouseover="ECSideUtil.lightHeader(this,'ec');"  onmouseout="ECSideUtil.unlightHeader(this,'ec');"  oncontextmenu="ECSideUtil.showColmunMenu(event,this,'ec');"  onmouseup="ECSideUtil.doSort(event,'address[like]','asc','ec');"  title="排序 ip地址" ><span onmousedown="ECSideUtil.StartResize(event,this,'ec');" onmouseup="ECSideUtil.EndResize(event);" class="columnSeparator columnResizeableSeparator" >&#160;</span><div class="headerTitle" >ip地址</div></td>
<td valign="middle"  columnName="address[like]"  sortable="true"  resizeColWidth="true"  editTemplate="ecs_t_input"  width="100"  class="tableHeader  tableResizeableHeader editableColumn"  onmouseover="ECSideUtil.lightHeader(this,'ec');"  onmouseout="ECSideUtil.unlightHeader(this,'ec');"  oncontextmenu="ECSideUtil.showColmunMenu(event,this,'ec');"  onmouseup="ECSideUtil.doSort(event,'address[like]','asc','ec');"  title="排序 端口" ><span onmousedown="ECSideUtil.StartResize(event,this,'ec');" onmouseup="ECSideUtil.EndResize(event);" class="columnSeparator columnResizeableSeparator" >&#160;</span><div class="headerTitle" >端口</div></td>
</tr>
	</thead>
</table></div>
...
<td style="text-align:center;"  width="44"  cellValue="003001"  ondblclick="ECSideUtil.editCell(this,'ec')"   ><input type="checkbox"  name="checkboxId"  value="003001"  class="checkbox" /></td>
<td style="text-align:center;"  width="100"  cellValue="lxc_kh"  ondblclick="ECSideUtil.editCell(this,'ec')"   >lxc_kh</td>
<td style="text-align:center;"  width="100"  cellValue="gnnt"  ondblclick="ECSideUtil.editCell(this,'ec')"   >gnnt</td>
<td style="text-align:center;"  width="100"  cellValue="4.0.44"  ondblclick="ECSideUtil.editCell(this,'ec')"   >4.0.44</td>
<td style="text-align:center;"  width="100"  cellValue="172.16.1.64"  ondblclick="ECSideUtil.editCell(this,'ec')"   >172.16.1.64</td>
<td style="text-align:center;"  width="100"  cellValue="8888" ondblclick="ECSideUtil.editCell(this,'ec')"   >8888</td>
</tr>
