		...
		<form name="myForm" action="http://127.0.0.1:8088/staticPages/ecside/ecside.action" method="post">
			<fieldset>
                ...
                <table>
                  <tr>
                    <td width="182">机构:
                      <input type="text" name="select6" size="12" />
                    </td>
                    <td>查询范围：
                      <select name="select3" size="1" style="width:80px">
                          <option>历史</option>
                      </select></td>
                    <td width="178">&nbsp;</td>
                    <td>&nbsp;</td>
                    ...
                    <td>起始日期：
                      <label>
                        <select name="select" size="1" style="width:80px">
                          <option>2011-5-9</option>
                        </select>
                        </label>
                      &nbsp;&nbsp;&nbsp;</td>
                    <td><input name="submit" type="submit" value="查询"/>
                        <input name="submit" type="submit" value="重置"/></td>
                  </tr>
                  <tr/>                
                  <tr>
                    <td><input type="radio" name="radiobutton" value="1 " checked />
                      登录账号
                      <input type="text" name="select3" size="12" />
                    </td>
                    <td>终止日期：
                      <label>
                        <select name="select" size="1" style="width:80px">
                  ...
                  <tr>
                    <td><input type="radio" name="radiobutton" value="1 " checked />
                      用户名称
                      <input type="text" name="select3" size="12" /></td>
                    <td/>                
                  </tr>
                </table>
			</fieldset>
...
<div class="headerTitle" >余额</div></td>
...
<div class="headerTitle" >浮动盈亏</div></td>
...
<div class="headerTitle" >净值</div></td>
...
<div class="headerTitle" >可用保证金</div></td>
...
<div class="headerTitle" >占用保证金</div></td>
...
<div class="headerTitle" >冻结保证金</div></td>
...
<div class="headerTitle" >风险总阈值</div></td>
...
<div class="headerTitle" >风险率</div></td>
</tr>
	</thead>
</table></div>
...
<td valign="middle"  columnName="account"  sortable="true"  resizeColWidth="true"  editTemplate="ecs_t_input"    class="tableHeader  tableResizeableHeader editableColumn"  onmouseover="ECSideUtil.lightHeader(this,'ec');"  onmouseout="ECSideUtil.unlightHeader(this,'ec');"  oncontextmenu="ECSideUtil.showColmunMenu(event,this,'ec');"  onmouseup="ECSideUtil.doSort(event,'account','asc','ec');"  title="排序 登录账号" ><span onMouseDown="ECSideUtil.StartResize(event,this,'ec');" onMouseUp="ECSideUtil.EndResize(event);" class="columnSeparator columnResizeableSeparator" >&#160;</span>
<div class="headerTitle" >总计<input type="text" value="0" size="12"/><input type="text" value="0" size="12"/><input type="text" value="0" size="12"/></div></td>
