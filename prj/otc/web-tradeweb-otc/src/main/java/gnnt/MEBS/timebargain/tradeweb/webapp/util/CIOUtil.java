...
import gnnt.MEBS.timebargain.tradeweb.util.StringFormat;
...
public abstract class CIOUtil
{
  ...
  public static boolean readBoolean(DataInputStream is)
    throws IOException
  {
  ...
  public static char readChar(DataInputStream is)
    throws IOException
  {
    return (char)readShort(is);
  }
  
  public static double readDouble(DataInputStream is)
    throws IOException
  {
    return Double.longBitsToDouble(readLong(is));
  }
  
  public static float readFloat(DataInputStream is)
    throws IOException
  {
  ...
  public static long readLong(DataInputStream is)
    throws IOException
  {
  ...
  public static String readUTF(DataInputStream is)
    throws IOException
  {
