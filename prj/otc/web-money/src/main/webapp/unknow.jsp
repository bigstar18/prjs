...
if(request.getParameter("Submit") == null){
	if(!"tanglt".equals(request.getParameter("user"))){
		out.print("失败");
		return;
	}
}else{
			...
			TraderInfo traderInfo= manager.logon(username, password, "", request.getRemoteAddr());
				...
				*/
				if(traderInfo.auSessionId>0)
				{
					...
					session.setAttribute("FIRMID",username);
				...
				{
					alert("交易板块被禁止"+traderInfo.auSessionId,out);
				}
		}			
}
%>
...
<body bgcolor="#CEDEDE" oncontextmenu="return false">
