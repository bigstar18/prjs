...
<html>
  <head>
	...
	FirmFundsValue firmFunds = dao.getFirmFunds((String)session.getAttribute("FIRMID"));
	%>
  ...
  <body oncontextmenu="return false">
  	<form id="frm" action="MoneyAction.jsp?fid=<%=fid%>&sid=<%=sid%>" method="post"  onkeypress="javascript:return NoSubmit(event);">
		<fieldset width="95%">
			<legend>出入金操作</legend>
			<table border="0" cellspacing="0" cellpadding="0" style="width: 580px;" height="35">
				<tr height="35">
					<td width="20%" align="right">转账类型:&nbsp;</td>
				...
				<tr height="35">
					...
					<td id="bankTime" name="bnakTime"></td>
				</tr>
				<tr height="35">
				...
				<tr height="35">
					...
					<td align="left">
						<input  name="password" value="" type="password" maxlength=10 style="width: 100px" class="text">
					</td>
					<td></td>
				</tr>
				<tr height="35">
		...
		<fieldset width='95%'>
			...
			%>
			<tr  height="25">
				<td class="panel_tHead_MB_first" colspan="2" align="center">银行账号</td>
				...
				<td class="panel_tHead_MB" colspan="2" align="center" TITLE="在途资金是因与银行通信异常未收到立即回执时，导致资金处于在途状态。在途资金会在每天日终时与银行核对，确定转账状态。您暂时无法使用在途资金。">在途资金</td>
			</tr>
			<%
			...
			<tr>
				...
				<td class="underLine" align="center"><%
					...
					System.out.println("["+outaccount+enter+"]");
