...
public abstract interface CGBCapitalProcessorRMI
  extends CapitalProcessorRMI
{
  ...
  public abstract double getfirmQY(String paramString1, String paramString2)
    throws RemoteException;
  
  public abstract void sendCGBQS(Date paramDate)
    throws RemoteException;
}
