...
import gnnt.trade.bank.ABCZLCapitalProcessor;
import gnnt.trade.bank.processorrmi.ABCZLCapitalProcessorRMI;
...
public class ABCZLCapitalProcessorRMIImpl
  extends UnicastRemoteObject
  implements ABCZLCapitalProcessorRMI
{
  private static final long serialVersionUID = 2L;
  ABCZLCapitalProcessor cp = new ABCZLCapitalProcessor();
  
  public ABCZLCapitalProcessorRMIImpl()
