    ...
    try
    {
      ...
      if (flag.booleanValue())
      {
        ...
        else
        {
          ...
          TransferMoneyVO rmo = new TransferMoneyVO(bankId, null, 
            transferInfo.money, pay, receive, 0L);
          ...
          try
          {
            ...
            conn = DAO.getConnection();
            conn.setAutoCommit(false);
            DAO.modTransfer(actionId, rv.funID, transferInfo.status, 
              curTime, conn);
