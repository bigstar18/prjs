...
public class DataProcess
{
  ...
  protected int openAccount(String firmID, String bankID, Connection conn)
    throws SQLException
  {
    int result = -1;
  ...
  protected int ifFirmDelAccount(String firmID, String bankID, Connection conn)
    throws SQLException
  {
    int result = -1;
    CallableStatement proc = null;
  ...
  protected ReturnValue changeFirmIsOpen(String firmID, int flag, String bankID, Connection conn)
    throws SQLException
  {
  ...
  protected double getRealFunds(String bankID, String firmID, int type, Connection conn)
    throws SQLException
  {
  ...
  protected double updateFrozenFunds(String firmID, double money, Connection conn)
    throws SQLException
  {
    double result = 0.0D;
    CallableStatement proc = null;
  ...
  protected double updateFundsFull(String bankID, String firmID, String contractno, double money, int type, Connection conn)
    throws SQLException
  {
    log("修改交易账号资金bankID[" + bankID + "] firmID[" + firmID + "]contractno[" + contractno + "]money[" + money + "]type[" + type + "]");
    double result = 0.0D;
    if (type == 0) {
  ...
  private double inMoneyFunds(String bankID, String firmID, String contractno, double money, Connection conn)
    throws SQLException
  {
    log("调用交易系统入金存储过程 bankID[" + bankID + "]firmID[" + firmID + "]contractno[" + contractno + "]money[" + money + "]");
    double result = 0.0D;
    String sql = "";
    if ("true".equalsIgnoreCase(Tool.getConfig("actionInto"))) {
  ...
  private double outMoneyFunds(String bankID, String firmID, String contractno, double money, Connection conn)
    throws SQLException
  {
    log("调用交易系统出金存储过程bankID[" + bankID + "]firmID[" + firmID + "]contractno[" + contractno + "]money[" + money + "]");
    double result = 0.0D;
    String sql = "";
    if ("true".equalsIgnoreCase(Tool.getConfig("actionInto"))) {
  ...
  {
    Logger plog = Logger.getLogger("DataProcesslog");
    plog.debug(content);
  }
}
