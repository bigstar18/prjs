...
import gnnt.trade.bank.processorrmi.CCBCapitalProcessorRMI;
...
public class CCBCapitalProcessorRMIImpl
  extends UnicastRemoteObject
  implements CCBCapitalProcessorRMI
{
  private static final long serialVersionUID = 2L;
  CCBCapitalProcessor cp = new CCBCapitalProcessor();
  
  public CCBCapitalProcessorRMIImpl()
  ...
  public FirmValue getFirmValue(FirmValue value)
    throws RemoteException
  {
    this.cp.log("-----------------------------------------getFirmValue  查询会员信息表会员信息");
    FirmValue result = this.cp.getFirmValue(value);
    this.cp.log("=========================================getFirmValue  查询会员信息表会员信息");
    return result;
  }
  ...
  public int modfirmuser(FirmValue value, String bankid)
    throws RemoteException
  {
    this.cp.log("-----------------------------------------modfirmuser  修改会员信息表会员信息，并同步到会员信息和银行绑定表");
    int result = this.cp.modfirmuser(value, bankid);
    this.cp.log("=========================================modfirmuser  修改会员信息表会员信息，并同步到会员信息和银行绑定表");
    return result;
  }
  ...
  public ReturnValue modCapitalInfoStatus(long id, String funID, int status, Timestamp bankTime)
    throws RemoteException
  {
    this.cp.log("-----------------------------------------modCapitalInfoStatus  修改银行流水号信息");
    ReturnValue result = this.cp.modCapitalInfoStatus(id, funID, status, bankTime);
    this.cp.log("=========================================modCapitalInfoStatus  修改银行流水号信息");
    return result;
  }
  ...
  public Map<String, CapitalValue> getCapitalValue(Vector<String> contacts, String bankID)
    throws RemoteException
  {
    this.cp.log("-----------------------------------------getCapitalValue  查询流水信息");
    Map<String, CapitalValue> result = this.cp.getCapitalValue(contacts, bankID);
    this.cp.log("=========================================getCapitalValue  查询流水信息");
    return result;
  }
  ...
  public String getfirmid(String contact)
    throws RemoteException
  {
    this.cp.log("-----------------------------------------getfirmid  变更账户方法 变更 交易账号代码与银行账号对应关系 的签约状态");
    String result = this.cp.getfirmid(contact);
    this.cp.log("=========================================getfirmid  变更账户方法 变更 交易账号代码与银行账号对应关系 的签约状态");
    return result;
  }
  ...
  public Vector<CorrespondValue> getCorrespondList(String filter)
    throws RemoteException
  {
    this.cp.log("-----------------------------------------getCorrespondList  查询交易商信息表会员信息");
    Vector<CorrespondValue> result = this.cp.getCorrespondList(filter);
    this.cp.log("=========================================getCorrespondList  查询交易商信息表会员信息");
    return result;
  }
  ...
  public ReturnValue checkSigning(FirmValue value)
    throws RemoteException
  {
    this.cp.log("-----------------------------------------checkSigning  预签约信息校验");
    ReturnValue result = this.cp.checkSigning(value);
    this.cp.log("-----------------------------------------checkSigning  预签约信息校验");
    return result;
  }
  ...
  public int updateFirmInfo(String firmid, String bankid, String key, String value)
    throws RemoteException
  {
    this.cp.log("-----------------------------------------updateFirmInfo  同步数据到扩展表");
    int result = this.cp.updateFirmInfo(firmid, bankid, key, value);
    this.cp.log("-----------------------------------------updateFirmInfo  同步数据到扩展表");
    return result;
  }
  
  public void send(Date tradeDate)
    throws RemoteException
  {
    new CCBExDataImpl().send(tradeDate);
  }
  
  public void sendTZData(Date tradeDate, List<String> list1)
    throws RemoteException
  {
    new CCBExDataImpl().sendTZData(tradeDate, list1);
  }
  ...
  public ReturnValue saveCCBQSResult(Vector<CCBQSResult> qsResult)
    throws RemoteException
  {
    this.cp.log("-----------------------------------------saveCCBQSResult  保存银行清算结果信息");
    ReturnValue result = this.cp.saveCCBQSResult(qsResult);
    this.cp.log("-----------------------------------------saveCCBQSResult  保存银行清算结果信息");
    return result;
  }
  
  public long modBankQS(ReturnValue rv, Date date)
    throws RemoteException
  {
    this.cp.log("-----------------------------------------modBankQS  修改清算结果状态");
    long result = this.cp.modBankQS(rv, date);
    this.cp.log("-----------------------------------------modBankQS  修改清算结果状态");
    return result;
  }
  ...
  public ReturnValue sendOldQS(Date date)
    throws RemoteException
  {
    this.cp.log("----------------------------------------sendOldQS   发送指定日期的清算");
    ReturnValue result = new CCBExDataImpl().send(date);
    this.cp.log("========================================sendOldQS   发送指定日期的清算");
    return result;
  }
  ...
  public Map<String, Double> getFirmBalanceMap(String bankid, String date)
    throws RemoteException
  {
    return this.cp.getFirmBalanceMap(bankid, date);
  }
}
