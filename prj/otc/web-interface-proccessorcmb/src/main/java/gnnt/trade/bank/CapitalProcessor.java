...
public class CapitalProcessor
{
  ...
  public TransferInfoValue getPayInfo(String bankID, String firmID, int type, Connection conn)
    throws SQLException
  {
  ...
  public TransferInfoValue getReceiveInfo(String bankID, String firmID, int type, Connection conn)
    throws SQLException
  {
  ...
  public ReturnValue checkArgs(Connection conn, double money, String firmID, String bankID)
    throws SQLException
  {
  ...
  public long bankFrozenFuns(String firmID, String contact, String bankID, String account, double money, Connection conn)
    throws SQLException
  {
  ...
  protected long handleOUtMoney(Connection conn, String bankID, String trader, double money, String firmID, String contact, String account, String funID, int type)
    throws SQLException
  {
  ...
  public long rgstAccount(CorrespondValue correspondValue)
  {
    ...
    try
    {
      ...
      else if (DAO.getCorrespondList(" and bankID='" + correspondValue.bankID + "' and firmID='" + correspondValue.firmID + "' and (account='" + correspondValue.account + "' or account='" + defaultAccount + "') and isopen=1", conn).size() > 0)
      {
        result = -40004L;
      ...
      else if (DAO.getCorrespondList(" and bankID='" + correspondValue.bankID + "' and firmID='" + correspondValue.firmID + "' and account='" + correspondValue.account + "'", conn).size() <= 0)
      {
        log("添加交易账号");
  ...
  {
    log("银行账号注销 delAccount correspondValue:" + (correspondValue == null ? "为 null" : new StringBuilder("\n").append(correspondValue.toString()).append("\n").toString()));
    long result = -1L;
    ...
    try
    {
      ...
      try
      {
        ...
        if (result < 0L)
        {
          ...
          DAO.closeStatement(null, null, conn);return l1;
        }
        Vector<CorrespondValue> vcv = DAO.getCorrespondList(" and isOpen=1 and contact='" + correspondValue.contact + "' and bankID<>'" + correspondValue.bankID + "'", conn);
  ...
  {
    log("银行账号注销 delAccountMaket correspondValue:" + (correspondValue == null ? "为 null" : new StringBuilder("\n").append(correspondValue.toString()).append("\n").toString()));
    ...
    try
    {
      ...
      try
      {
        ...
        else
        {
          ...
          Vector<CorrespondValue> vcv = DAO.getCorrespondList(" and isOpen=1 and trim(contact)='" + cv2.contact + "' and bankID<>'" + cv2.bankID + "'", conn);
          if ((vcv == null) || (vcv.size() <= 0)) {
  ...
  private ReturnValue firmFrozen(String firmID, int type, int launcher, String contact)
    throws SQLException, ClassNotFoundException
  {
        ...
        try
        {
          if ((v == null) || (v.size() <= 0))
          {
            if (money <= 0.0D)
            {
              ...
              DAO.closeStatement(null, null, conn);return l2;
            }
  ...
  public ReturnValue outMoney(String bankID, double money, String contact, String bankAccount, String funID, String operator, int express, int type)
  {
    ...
    try
    {
      ...
      if ((Tool.getConfig("AutoAudit") != null) && 
        (Tool.getConfig("AutoAudit").equalsIgnoreCase("True")))
      {
  ...
  public ReturnValue chargeAgainst(ChargeAgainstValue cav)
  {
    ...
    else
    {
      try
      {
        ...
        filter = " and bankID='" + cav.bankID + "' and ((createtime>=trunc(sysdate) and createtime<trunc(sysdate)+1) or (bankTime>=trunc(sysdate) and bankTime<trunc(sysdate)+1)) and status not in (" + 1 + "," + 9 + ") and (type=" + 0 + " or type=" + 1 + ") ";
        if (cav.actionID > 0L)
        {
  ...
  public FirmBalanceValue getMarketBalance(String firmID, String contact, String bankID)
  {
    ...
    try
    {
      ...
      if ((firmID == null) || (firmID.trim().length() <= 0))
      {
        ...
        FirmBalanceValue localFirmBalanceValue1 = new FirmBalanceValue();return localFirmBalanceValue1;
      }
  ...
  public ReturnValue refuseCapitalInfo(long actionID)
  {
    ...
    try
    {
      ...
      {
        conn.setAutoCommit(false);
        Vector<CapitalValue> value = DAO.getCapitalInfoList(" and (type=0 or type=1) and status<>1 and status<>9 and ACTIONID=" + actionID + " for update ", conn);
    ...
    if ((vector != null) && (vector.size() > 0)) {
      for (CapitalValue cv : vector) {
        if (cv != null)
        {
          ...
          {
            result.result = -1L; ReturnValue 
              tmp74_73 = result;tmp74_73.remark = (tmp74_73.remark + "[" + cv.funID + "]");
          }
        }
      }
    }
      ...
      if (capital != null)
      {
        ...
        if (funFlag)
        {
          ...
          if (number != 0L)
          {
            ...
            ReturnValue localReturnValue3 = result;return localReturnValue3;
          }
          if (result.result == 0L) {
            try
            {
              if ((capital.note != null) && (capital.note.startsWith("市场端出金")))
              {
                ...
                if (bankadapter == null)
                {
                  ...
                  conn.setAutoCommit(true);return localReturnValue2;
                }
                try
                {
                  conn.setAutoCommit(false);
            ...
            else
            {
              try
              {
                ...
                if ((ll == null) || (ll.size() <= 0))
                {
                  ...
                  DAO.closeStatement(null, null, conn);return bankadapter;
                }
                DAO.modCapitalInfoStatus(capital.iD, capital.funID, 2, curTime, conn);
                conn.commit();
              }
        ...
        try
        {
          ...
          for (int i = 0; i < qsResult.size(); i++)
          {
            ...
            if (qs != null)
            {
              ...
              {
                flag = false;
                DAO.delCCBQSResult(qs.bankID, qs.qsDate, 
                  conn);
              }
  ...
  public double getDayTransMoney(String bankID, String contact, int type, Timestamp time, Connection conn)
    throws SQLException
  {
    System.out.println("{{{{{{{{{{{{{{{{{{{{{{{{{{{{{{{{{{{{{{{{{{{{{{");
  ...
  private int getDayTransCount(String bankID, String contact, int type, Timestamp time, Connection conn)
    throws SQLException
  {
    System.out.println("{{{{{{{{{{{{{{{{{{{{{{{{{{{{{{{{{{{{{{{{{{{{{");
    ...
    System.out.println("}}}}}}}}}}}}}}}}}}}}}时间：" + Tool.fmtTime(new java.util.Date()) + "}}}}}}}}}}}}}}}}}}}}}}}}");
    Vector<CapitalValue> capitalList = DAO.getCapitalInfoList("and (status!=1 and status !=-1) and to_char(createtime,'yyyy-mm-dd')='" + Tool.convertTS(time) + "'" + 
      " and bankID='" + bankID + "' and contact='" + contact + "' and type=" + type, conn);
