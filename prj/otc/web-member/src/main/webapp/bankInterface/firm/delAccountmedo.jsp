...
<%
	...
	Vector<CorrespondValue> cps = dao.getCorrespondList(" and firmid='"+firmID+"' and bankID='"+oldbankID+"'");
	...
	if("do".equals(request.getParameter("submitFlag"))){
		long bak = -1;
		String str=CONTACTTITLE+"管理-解约模拟银行账号["+firmID+"]";
		String strs = "";
		if(corr == null){
			strs = "未查寻到账号信息";
		}else{
  ...
  <body style="overflow-y: hidden">
	...
	<div style="overflow:auto;height:150;">
	 <table border="0" width="95%" align="center">
		<tr>
		  <td>
			<div class="st_title"><img src="<%=skinPath%>/cssimg/st_ico1.gif" align="absmiddle" />&nbsp;(模拟银行)交易所发起解约</div>
			<table border="0" cellspacing="0" cellpadding="0" width="100%" height="35" class="st_bor">
				<tr height="35" style="display: none;">
					<td align="right" width="25%"><%=FIRMTITLE%>：&nbsp;</td>
		...
		<input type="hidden" name="bankID" id="bankID" value="01">
		<input type="hidden" name="01" id="01" value="模拟银行">
	</form>
  </body>
</html>
