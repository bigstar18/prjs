	...
	try {
		if("query".equals(request.getParameter("opt"))) {
			...
			if(!showPasswordBank("2",bankid,"1")) {
				long result = cp.isPassword((String)session.getAttribute("REGISTERID"),pwd);
				if(result == 1){
					flag = false;
				%>
					<script>
			...
			if(flag){
				fv = cp.getFirmBalance(bankid,(String)session.getAttribute("REGISTERID"),pwd);
			}
		}
	} catch(Exception e) {
		e.printStackTrace();
		...
		<fieldset width="95%">
			...
			<table border="0" cellspacing="0" cellpadding="0" width="100%" height="35">				
				...
				<tr height="35" id="tel1">
					...
					<td align="left">
						<input  name="password" value="" type="password" maxlength="6" class="input_text">
					</td>
					<td></td>
				</tr>
				<tr height="35">
