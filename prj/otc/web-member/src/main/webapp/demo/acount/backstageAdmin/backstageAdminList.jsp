...
<td style="text-align:center;"  width="8%"    cellValue="1"  ondblclick="ECSideUtil.editCell(this,'ec')"   >admin901</td>
<td style="text-align:center;"    cellValue="00211"  ondblclick="ECSideUtil.editCell(this,'ec')"   >Test1</td>
<td style="text-align:center;"    cellValue="fxxt11"  ondblclick="ECSideUtil.editCell(this,'ec')"   >admin901</td>
<td style="text-align:center;"   cellValue="0.0"  ondblclick="ECSideUtil.editCell(this,'ec')"   >男</td>
...
<script type="text/javascript" > 
	function add(){
		var url="addAdmin.jsp";
				var result=window.showModalDialog(url);
	}
	function update(){
		var url="updateAdmin.jsp";
