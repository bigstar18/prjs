			...
			<fieldset>
				...
				<table>
					<tr>
					  ...
					  <td width="178">特别会员<select name="select3" size="1" style="width:80px" disabled="disabled">
					      <option>不限</option>
                        </select> </td>
				  </tr>
					<tr>
					  ...
					  <td>操作类型<select name="select3" size="1" style="width:80px" disabled="disabled">
					      <option>不限</option>
                        </select> </td>
				  </tr>
					<tr>
...
<div class="headerTitle" >单号</div></td>
...
<div class="headerTitle" >操作类型</div></td>
...
<div class="headerTitle" >商品名称</div></td>
...
<div class="headerTitle" >买卖</div></td>
...
<div class="headerTitle" >建仓价</div></td>
...
<div class="headerTitle" >持仓价</div></td>
...
<div class="headerTitle" >中间价</div></td>
...
<td valign="middle"  columnName="risk"  sortable="true"  resizeColWidth="true"  editTemplate="ecs_t_input"    class="tableHeader  tableResizeableHeader editableColumn"  onmouseover="ECSideUtil.lightHeader(this,'ec');"  onmouseout="ECSideUtil.unlightHeader(this,'ec');"  oncontextmenu="ECSideUtil.showColmunMenu(event,this,'ec');"  onmouseup="ECSideUtil.doSort(event,'risk','asc','ec');"  title="排序 风险总阈值" ><span onMouseDown="ECSideUtil.StartResize(event,this,'ec');" onMouseUp="ECSideUtil.EndResize(event);" class="columnSeparator columnResizeableSeparator" >&#160;</span>
<div class="headerTitle" >接单特别会员</div></td>
</tr>
	</thead>
</table></div>
...
<td valign="middle"  columnName="risk"  sortable="true"  resizeColWidth="true"  editTemplate="ecs_t_input"    class="tableHeader  tableResizeableHeader editableColumn"  onmouseover="ECSideUtil.lightHeader(this,'ec');"  onmouseout="ECSideUtil.unlightHeader(this,'ec');"  oncontextmenu="ECSideUtil.showColmunMenu(event,this,'ec');"  onmouseup="ECSideUtil.doSort(event,'risk','asc','ec');"  title="排序 风险总阈值" ><span onMouseDown="ECSideUtil.StartResize(event,this,'ec');" onMouseUp="ECSideUtil.EndResize(event);" class="columnSeparator columnResizeableSeparator" >&#160;</span>
<div class="headerTitle" >总价:<input type="text" value="0" size="12"><input type="text" value="0" size="12"><input type="text" value="0" size="12"></div></td>
