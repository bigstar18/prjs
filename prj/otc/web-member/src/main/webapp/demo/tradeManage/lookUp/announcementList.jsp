			...
			<fieldset>
				...
				<table width="759">
					<tr>
					  ...
					  <td>&nbsp;&nbsp;发布者：
				      <input type="text" name="Input" value=""/></td>
					  <td>&nbsp;</td>
				  </tr>
					<tr>
					  <td width="317"> 开始日期：
					    <label>
					    <input name="textfield" type="text" value="日历">
				      </label></td>
					  <td width="273">  结束日期： 
				        <input type="text" value="日历"/>&nbsp;&nbsp;&nbsp;</td>
						<td width="153"><input type="submit" value="查询"/>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type="reset" value="重置"/></td>
					</tr>
			</table>
			</fieldset>
		</form>
...
<div class="headerTitle" >发布日期</div></td>
...
<div class="headerTitle" >有效日期</div></td>
...
<div class="headerTitle" >公布内容</div></td>
...
<div class="headerTitle" >主题</div></td>
...
<div class="headerTitle" >发布者</div></td>
...
<td width="2%"  ondblclick="ECSideUtil.editCell(this,'ec')"   cellValue="1"   ><input type="checkbox"  width="2%"  name="checkboxId"  value="1"  class="checkbox" /></td>
<td style="text-align:center;"  width="17%"    cellValue="1"  ondblclick="ECSideUtil.editCell(this,'ec')"   >001</td>
<td width="22%" style="text-align:center;"  ondblclick="ECSideUtil.editCell(this,'ec')"    cellValue="00211"   >2011-4-10 11：24：24 </td>
<td width="27%" style="text-align:center;"  ondblclick="ECSideUtil.editCell(this,'ec')"    cellValue="fxxt11"   >2011-11-10 11：24：24</td>
<td width="10%" style="text-align:center;"  ondblclick="ECSideUtil.editCell(this,'ec')"   cellValue="0.0"   >公告</td>
<td width="7%" style="text-align:center;"  ondblclick="ECSideUtil.editCell(this,'ec')"    cellValue="0.0"   >公告</td>
<td width="7%" style="text-align:center;"  ondblclick="ECSideUtil.editCell(this,'ec')"    cellValue="0.0"   >-</td>
<td width="8%" style="text-align:center;"  ondblclick="ECSideUtil.editCell(this,'ec')"    cellValue="0.0"   >-</td>
</tr>		
	</tbody>
