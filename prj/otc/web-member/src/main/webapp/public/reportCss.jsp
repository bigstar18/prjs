...
%>
<link rel="stylesheet" href="<%=basePath %>report/report_css.css" type="text/css" />
<link rel="stylesheet" href="<%=basePath %>common/skinstyle/default/common/commoncss/common1.css" type="text/css" />
<link rel="stylesheet" href="<%=basePath %>public/widgets/ecside/css/ecside_style.css" type="text/css" />
