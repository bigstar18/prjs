									...
									<td>
										<ec:table items="resultList"
											...
											<ec:row recordKey="${quotePoint.m_firmId}">
												...
												<ec:column property="commodity.name[Like]" title="商品名称" width="20%" style="text-align:left;" ellipsis="true"><a href="#" class="blank_a"	onclick="return update('${quotePoint.m_firmId}','${quotePoint.commodityId}');"><font color="#880000">${quotePoint.commodityName }</font></a> </ec:column>
												<ec:column property="primary.m_firmId[like]" title="类型"
												...
												<ec:column property="primary.quotePointAlgr[=][int]"
													title="报价点差算法" width="19%" style="text-align:left;"
