...
<html>
	<head>
		...
		<%request.setAttribute("applyType","commodity_memberQuotePoint"); %>
	</head>
	<body leftmargin="0" topmargin="0" class="st_body">
		<form name="frm"
			action="${basePath}/commodity/memberQuotePoint/update.action"
				...
				<table border="0" width="90%" align="center">
					<tr>
						<td>
							...
							<%@ include file="/commodity/quotePoint/memberQPUpdateTable.jsp"%>
						</td>
						<td align="right">
						</td>
						<td>
