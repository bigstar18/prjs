			...
			<table class="table1_style" border="0" cellspacing="0" cellpadding="0">
				<tr>
					<td>
						<div class="div_tj">
						<form name="frm"
								action="${basePath}/commodity/stepFundsDictionary/list.action"
								method="post">
									...
									<td>
										<ec:table items="resultList"
											...
											<ec:row recordKey="stepDictionary.ladderCode">
												...
												<ec:column property="primary.stepNo[=][int]" title="阶梯阶号"
												...
												<ec:column property="primary.stepValue[=][bigdecimal]" title="阶梯值"
...
function update(id1,id2) {
	var url = "${basePath}/commodity/stepFundsDictionary/forwardUpdate.action?obj.ladderCode="+id1+"&obj.stepNo="+id2;
	ecsideDialog(url,"",580,245);
}
function select1() {
	frm.submit();
}
function addStepDictionary(){
	var url="${basePath}/commodity/stepFundsDictionary/forwardAdd.action";
	ecsideDialog(url);
}
function deleteByCheckBox(){
	 		var url="${basePath}/commodity/stepFundsDictionary/delete.action"
