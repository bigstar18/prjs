...
<html>
	...
	<body>
			...
			<table class="table1_style" border="0" cellspacing="0" cellpadding="0">
				<tr>
					<td>
						<div class="div_tj">
						<form name="frm"
								action="${basePath}/commodity/tradeAuthForSMember/list.action?sortName=primary.commodityId"
								method="post">
						...
						<div class="div_gn">
							<button class="anniu_btn" onclick="addSpecialMemberTrade()" id="update">
								添加
							</button>
						</div>
								...
								<tr>
									<td>
										<ec:table items="resultList"
											...
											var="tradeAuth"
											action="${basePath}/commodity/tradeAuthForSMember/list.action?sortName=primary.commodityId" title=""
											minHeight="345" listWidth="150%"
											...
											<ec:row recordKey="${tradeAuth.firmId}">
												...
												<ec:column property="specialMember.name[=][int]" title="特别会员名称"
													width="7%" style="text-align:left;" ellipsis="true"
													editTemplate="ecs_cancel1" value="${tradeAuth.firmName}" />
		...
		function update(firmId,commodityId){
			var url="${basePath}/commodity/tradeAuthForSMember/forwardUpdate.action?obj.commodityId="+commodityId+"&obj.firmId="+firmId;
			ecsideDialog(url,"",580,575);
		}
		function submitMember(){
			frm.submit();
		}
		function addSpecialMemberTrade() {
			var urlFee = "${basePath}/commodity/tradeAuthForSMember/forwardAdd.action";
			ecsideDialog(urlFee, "", 580, 590);
		}
		</SCRIPT>
	</body>
</html>