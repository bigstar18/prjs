		...
		<td>
			...
			<table border="0" cellspacing="0" cellpadding="4" width="100%"
				...
				<tr height="20">
					...
					<td>
						<input type="text" id="commodityName" class="input_textmid1"
				...
				<tr height="40">
					...
					<td>
						<input type="text" class="input_textmid1"
							name="obj.firmName" value="${obj.firmName}"
							readonly="readonly">
						<input type="hidden" name="obj.firmId" id="firmId" value="${obj.firmId}">
					</td>
...
<script type="text/javascript">
<!--
function setReadOnly(sIndex){
	var obj = document.getElementById('firmId');
