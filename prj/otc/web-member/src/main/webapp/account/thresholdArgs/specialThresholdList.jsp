											...
											<table class="table3_style" border="0" cellspacing="0"
												...
												<tr>
													<td class="table3_td_1mid" align="left">
														特别会员编号:&nbsp;
														<label>
															<input type="text" class="input_text" id="firmId" name="${GNNT_}primary.firmId[=][String]"
										...
										<ec:table items="resultList"
											...
											<ec:row recordKey="specialThreshold.firmId">
												...
												<ec:column property="primary.firmId[like]" title="特别会员编号"
													style="text-align:left; " width="19%" ellipsis="true">
													<a href="#" class="blank_a"
														onclick="return update('${specialThreshold.firmId}');"><font
														color="#880000">${specialThreshold.firmId}</font>
													</a>
												</ec:column>
												...
												<ec:column property="primary.minRiskFund[like]" title="特别会员出金阈值"
													style="text-align:right;" width="17%">
													<fmt:formatNumber value="${specialThreshold.minRiskFund}"  pattern="###,##0.00"/>
													</ec:column>
												<ec:column property="primary.warnTh[like]" title="特别会员预警风险率"
													style="text-align:right;" width="19%"
													value="${specialThreshold.warnTh_v}%" />
												<ec:column property="primary.frozenTh[like]" title="特别会员冻结风险率"
													style="text-align:right;" width="19%"
