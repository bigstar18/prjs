			...
			<table class="table1_style" border="0" cellspacing="0"
				...
				<tr>
					<td>
						...
						<div class="div_gn">
							<button class="anniu_btn" onclick="addRole()" id="add">
								添加
							</button>
							&nbsp;&nbsp;
							<button class="anniu_btn" onclick="deleteRole()" id="delete">
								删除
							</button>
						</div>
