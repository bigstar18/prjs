				...
				<table class="table1_style" border="0" cellspacing="0"
					...
					<tr>
						<td><input type="hidden" name="roleId" value="${role.id }">
							&nbsp;<img src="<%=skinPath%>/cssimg/xr.gif" align="absmiddle" />&nbsp;<span style="color:#920808;font-weight:bold;font-size:13px;">${role.name }[${role.id }]所辖管理员列表</span>
							<!-- <div class="div_tj">
														...
														<td>
															<table border="0" cellspacing="0" cellpadding="0"
																...
																<tr>
																	...
																	<td class="table3_td2">
																		<input name="_userId[like]" type="text"
											...
											<ec:table items="userSet"
												...
												<ec:row recordKey="${user.userId }">
													<ec:column cell="checkbox" headerCell="checkbox"
														alias="ids" value="${user.userId}" width="2%"
														viewsAllowed="html" style="text-align:center; " />
