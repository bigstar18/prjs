	...
	<body class="st_body">
		...
		<form name="frm" action="${basePath}/account/memberActiveStatus/updateActiveStatus.action"
			...
			<fieldset width="50%" height="60%">
				<div class="st_title"><img src="<%=skinPath%>/cssimg/st_ico1.gif" width="43" height="40" align="absmiddle" />&nbsp;&nbsp;会员激活</div>
			...
			<table border="0" cellspacing="0" cellpadding="4" width="100%" align="center">
						<tr>
							<td  align="center">
								<div class="st_anbor"><a href="#" onclick="updateMemberStatus()" class="st_an">激活</a></div>
							</td>
							<td align="center">
