										...
										<table align="center">
											<tr>
												...
												<td width="10%" align="center">
													<button class="btn_min" id="btnSelectSingle"
														onclick="selectSingle('selectFrom','selectTo')">
														>
													</button>
													<br>
													<button class="btn_min" id="btnSelectAll"
														onclick="selectAll('selectFrom','selectTo')">
														>>
													</button>
													<br>
													<button class="btn_min" id="btnDeselectSingle"
														onclick="selectSingle('selectTo','selectFrom')">
														<
													</button>
													<br>
													<button class="btn_min" id="btnUnselectAll"
