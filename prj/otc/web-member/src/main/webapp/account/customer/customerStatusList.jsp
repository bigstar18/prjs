									...
									<td>
										<ec:table items="resultList"
											...
											<ec:row recordKey="${customer.customerNo}">
												...
												<ec:column property="primary.name[Like]" width="20%" title="客户名称"
												...
												<ec:column property="primary.useFunds[=][bigdecimal]"
													width="8%" title="可用资金" style="text-align:right;">
													<fmt:formatNumber value="${customer.useFunds}" pattern="#,##0.00"/>
												</ec:column>
												<ec:column property="primary.address[like]" width="20%" title="地址"
													style="text-align:left;" value="${customer.address}" />
												<ec:column property="customerStatus.status[=]" width="20%"
