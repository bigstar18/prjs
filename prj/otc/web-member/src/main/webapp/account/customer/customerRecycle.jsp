										...
										<ec:table items="resultList"
											...
											<ec:row recordKey="${customer.id}"
												...
												<ec:column cell="checkbox" headerCell="checkbox" alias="ids"
													style="text-align:center;" value="${customer.id}" width="2%" viewsAllowed="html" />
												<ec:column property="id[like]" width="7%" title="交易账号"
													style="text-align:left; " value="${customer.id}" />
												<ec:column property="name[Like]" width="7%" title="客户名称"
													style="text-align:left;" value="${customer.name}" />
												...
												<ec:column property="papersName[like]" width="7%" title="证件号码"
													style="text-align:left;" value="${customer.papersName}" />
												<ec:column property="address[like]" width="7%" title="通讯地址"
													style="text-align:left;" value="${customer.address}" />
