									...
									<td>
										<ec:table items="resultList"
											...
											<ec:row recordKey="${customer.customerNo}">
												...
												<ec:column property="primary.name[Like]" width="7%" title="客户名称"
												...
												<ec:column property="primary.papersType[=][int]" width="4%"
												...
												<ec:column property="primary.papersName[like]" width="8%" title="证件号码"
													style="text-align:left;" value="${customer.papersName}"  tipTitle="${customer.papersName}"/>
												<ec:column property="primary.address[like]" width="8%" title="地址"
													style="text-align:left;overflow:hidden;text-overflow:ellipsis" value="${customer.address}" tipTitle="${customer.address}"/>
												<ec:column property="primary.phone[like]" width="6%" title="电话"
													style="text-align:left;" value="${customer.phone}"  tipTitle="${customer.phone}"/>
												<ec:column property="primary.fax[like]" width="6%" title="传真"
													style="text-align:left;" value="${customer.fax}"  tipTitle="${customer.fax}"/>
												<ec:column property="primary.postCode[like]" width="4%" title="邮编"
													style="text-align:left;" value="${customer.postCode}"  tipTitle="${customer.postCode}"/>
												<ec:column property="primary.email[like]" width="8%" title="电子邮箱"
													style="text-align:left;" value="${customer.email}"  tipTitle="${customer.email}"/>
											</ec:row>
										</ec:table>
									</td>
								</tr>
