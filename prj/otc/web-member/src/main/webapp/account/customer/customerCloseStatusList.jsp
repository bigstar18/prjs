...
<html>
	...
	<body>
			...
			<table class="table1_style" border="0" cellspacing="0" cellpadding="0">
				<tr>
					<td>
						<div class="div_tj">
						<form name="frm"
								action="${basePath}/account/customerCloseStatus/list.action?sortName=primary.name"
								method="post">
								...
								<tr>
									<td>
										<ec:table items="resultList"
											...
											action="${basePath}/account/customerCloseStatus/list.action"
											...
											<ec:row recordKey="${customer.customerNo}">
												...
												<ec:column property="primary.name[Like]" width="10%" title="客户名称"
		...
		function update(id){
			var url = "${basePath}/account/customerCloseStatus/forwardUpdate.action?obj.customerNo="+id;
