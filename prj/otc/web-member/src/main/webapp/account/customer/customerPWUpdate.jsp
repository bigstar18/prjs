...
<body>
<form name="frm" id="frm" method ="post" action="<%=basePath%>/account/customer/updatePasswordPhone.action" targetType="hidden">
		<div class="div_scromin">
			<table border="0" width="80%" align="center">
				<tr>
					<td>
					<input type="hidden" name="obj.memberNo" value="${obj.memberNo}" />
			<div class="st_title"><img src="<%=skinPath%>/cssimg/st_ico1.gif" width="30" height="28" align="absmiddle" />&nbsp;&nbsp;修改电话密码</div>	
			<table border="0" cellspacing="0" cellpadding="0" width="100%" class="st_bor">
		<tr height="35">
        	<td align="right" class="td_size" width="35%"> 交易账号 :</td>
            <td align="left">
            	<input name="obj.customerNo" type="text" class="input_text_pwd" value="${obj.customerNo }" readonly="readonly">
            </td>
        </tr>
        <tr height="35">
