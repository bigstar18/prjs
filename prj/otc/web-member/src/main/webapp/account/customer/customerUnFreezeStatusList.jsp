...
<html>
	...
	<body>
			...
			<table class="table1_style" border="0" cellspacing="0" cellpadding="0">
				<tr>
					<td>
						<div class="div_tj">
						<form name="frm"
								action="${basePath}/account/customerUnFreezeStatus/list.action?sortName=primary.name"
								method="post">
									...
									<td>
										<ec:table items="resultList"
											...
											<ec:row recordKey="${test.id}">
												...
												<ec:column property="primary.name[Like]" width="12%" title="客户名称"
													style="text-align:left;overflow:hidden;text-overflow:ellipsis" value="${customer.name}" tipTitle="${customer.name}"/>
												<%-- <ec:column property="memberInfo.name[like]" width="16%"
		...
		function update(id){
			var url = "${basePath}/account/customerUnFreezeStatus/forwardUpdate.action?obj.customerNo="+id;
