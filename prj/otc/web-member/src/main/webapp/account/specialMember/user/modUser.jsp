     ...
     <form name="frm" id="frm" method="post" targetType="hidden">
		...
		<table border="0" cellspacing="0" cellpadding="0" width="80%" align="center">
         ...
         <tr height="35">
			...
			<td align="left">
				<input name="obj.name" id="name" type="text" class="input_text_mid" value="${obj.name}">
			</td>
		  </tr>
	 ...
	 <table border="0" cellspacing="0" cellpadding="0" width="100%">
		  <tr height="35">
			...
			<td width="30%"><div align="left">
				<div class="st_anbor"><a href="#" id="updateButton" onclick="frmChk()" class="st_an">保存</a></div>
			</div></td>
