			...
			<table class="table1_style" border="0" cellspacing="0"
				...
				<tr>
					<td>
						<div class="div_tj">
							<form name="frm"
								action="${basePath}/query/queryMemberFundOutInSearch/list.action"
								method="post">
								...
								<tr>
									<td>
										<ec:table items="resultList"
											...
											var="customerFund"
											action="${basePath}/query/queryMemberFundOutInSearch/list.action"
											title="" minHeight="345" listWidth="165%"
											...
											<ec:row ondblclick="">
												<ec:column width="3%" property="_0" title="序号"
													...
													filterable="false" />
												<ec:column property="primary.firmId[like]" title="综合会员编号"
													width="4%" style="text-align:left; "
													value="${customerFund.firmId}" ellipsis="true" />
												<ec:column property="primary.firmName[like]" title="综合会员名称"
												...
												<ec:column property="primary.v_balance[=][double]"
													title="交易账号当前可用保证金" width="7%" style="text-align:right; ">
