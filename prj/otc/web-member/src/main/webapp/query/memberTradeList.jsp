...
frm.commodityId.value = '${oldParams["primary.commodityName[like]"] }';
														...
														<script type="text/javascript">
frm.specialId.value = '${oldParams["s_memberNo[like]"] }';
</script>
													</tr>
													<tr>
														<td class="table3_td_1" align="left">
