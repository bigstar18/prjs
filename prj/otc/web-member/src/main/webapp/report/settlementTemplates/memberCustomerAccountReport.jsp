	...
	<table width="150%" border="0" align="center" cellpadding="0"
		...
		<table width="100%" border="0" align="center" cellpadding="0"
			...
			<tr class="report_w14">
				...
				<td width="14%" class="report_td_bt" rowspan="2">
					结算日期
				</td>
				<td width="14%" class="report_td_bt" colspan="2">
					开户
				</td>
				<td width="14%" class="report_td_bt" colspan="2">
					销户
				...
				<td width="11%" class="report_td_bt" rowspan="2">
					签约银行
				</td>
				<td width="14%" class="report_td_bt" colspan="2">
					签约
					...
					<td colspan="5" height="100%">
						<table width="100%" height="100%" border="0" align="center" cellpadding="0"
							...
							<s:iterator value="memberCustomerAllList(#qc)" status="sta">
								<tr>
									<td width="27%" align="left" class="report_td_th" >
										<s:property value="bankname" />
										&nbsp;
									</td>
									<td align="right" class="report_td_th"  width="17%" >
