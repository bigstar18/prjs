...
<table width="60%" border="0" align="center" cellpadding="0" cellspacing="0" bordercolor="#000000" style='border-collapse: collapse;' height="26">
	...
	<table width="140%" border="1" align="left" cellpadding="0" cellspacing="0" bordercolor="#000000" style='table-layout:fixed;border-collapse: collapse;' bgcolor="#ffbfc9" height="26">
  <tr class="report_w14">
  	 <td width="4%" rowspan="2">序号</td>
    <td width="6%" rowspan="2">结算日期</td>
     <td width="6%" rowspan="2">会员编号</td>
     <td width="6%" rowspan="2">会员名称</td>
    <td width="5%" rowspan="2">机构</td>
    <td width="5%" rowspan="2">客户代表</td>
    <td width="6%" rowspan="2">交易账号</td>
    <td width="5%" rowspan="2">客户名称</td>
    <td width="5%" rowspan="2">商品</td>
    <td width="3%" rowspan="2">成交量</td>
    <td width="6%" rowspan="2">成交金额</td>
    <td width="20%" colspan="3">交易盈亏</td>
    <td width="23%" colspan="3">手续费</td>
    <td width="10%" rowspan="2">延期费</td>
  </tr>
  <tr>
   <td>平仓盈亏</td>
    <td>持仓盈亏</td>
      ...
      <s:set var="customerfee" value="0"></s:set>
			<s:iterator value="dataList()" var="dataMap">
				<tr>
					...
					<td>
						<s:property value="#dataMap.brokername" />
					</td>
					<td>
