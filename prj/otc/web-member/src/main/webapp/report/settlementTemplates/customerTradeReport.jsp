		...
		<table width="100%" border="1" align="center" cellpadding="0"
			...
			<s:iterator value="dataList()" var="dataMap">
				<tr class="report_w14_neirong">
					...
					<td align="right">
						<s:set var="a" value="format(#dataMap.customertradefeesum)" />
						<fmt:formatNumber value="${a }" pattern="#,##0.00"/>
					...
					<td align="right">
						<s:set var="a" value="format(#dataMap.customerplsum)" />
						<fmt:formatNumber value="${a }" pattern="#,##0.00"/>
			...
			<tr class="report_w14">
				...
				<td align="right">
					<s:set var="a" value="format(#customertradefeesum)" />
					<fmt:formatNumber value="${a }" pattern="#,##0.00"/>
				</td>
				<td align="right">
				...
				<td align="right">
					<s:set var="a" value="format(#customerplsum)" />
					<fmt:formatNumber value="${a }" pattern="#,##0.00"/>
				</td>
				<td align="right">
					&nbsp;
