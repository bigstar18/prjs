...
<html xmlns:MEBS>
  ...
  <tr>
    ...
    <input type="checkbox" name="tableList" value="closePositionReport"  />平仓明细</td>
    <td width="45%" align="left" class="report_w12h">
    <input type="checkbox" name="tableList" value="tradeDetailReport" />成交明细</td>
  ...
  <tr>
    ...
    <input type="checkbox" name="tableList" value="holdPositionReport" />持仓明细</td>
    <td align="left" class="report_w12h">
    <input type="checkbox" name="tableList" value="capitalFlowingReport"  />资金流水</td>
  ...
  <tr>
    <td>&nbsp;</td>
    <td align="left" class="report_w12h">
     <input type="checkbox" name="tableList" value="capitalAccountReport" checked="checked"/>资金状况</td>
    <td align="left" class="report_w12h">
   &nbsp;
    <td>&nbsp;</td>
  </tr>
