...
<html>
	...
	<body leftmargin="0" topmargin="0" onload="sele()" style="overflow-y:hidden">
			<div class="st_title">&nbsp;&nbsp;&nbsp;&nbsp;<img src="<%=skinPath%>/cssimg/st_ico1.gif" align="absmiddle" />&nbsp;&nbsp;选择会员查询</div>
			<div class="div_scro" style="overflow-x:hidden;position:absolute;top:50;z-index:1;">
