									...
									<table id="tb" border="0" cellspacing="0" cellpadding="0"
										...
										<tr>
											<td>
												<ec:table items="list"
													...
													<ec:row ondblclick="">
														...
														<ec:column property="memberfee[=][double]"
															title="综合会员存留手续费" width="6%" style="text-align:right; ">
															<fmt:formatNumber value="${customerFund.memberfee}"
																pattern="#,##0.00" />
														</ec:column>
														<ec:column property="customerfee[=][double]"
															title="收客户手续费" width="5%" style="text-align:right;">
												...
												<ec:column property="memberdelayfee[=][double]" title="会员存留延期费" width="5%"
													style="text-align:right;">
