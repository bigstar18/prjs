										...
										<ec:table items="list"
											...
											<ec:row ondblclick="">
												...
												<ec:column property="customerbuyqty[=][int]" title="客户买持仓"
													width="4%" style="text-align:right; " format="#,##0">
												...
												<ec:column property="membernetqty[=][double]" title="综合会员净持仓"
													width="5%" style="text-align:right; " format="#,##0">
