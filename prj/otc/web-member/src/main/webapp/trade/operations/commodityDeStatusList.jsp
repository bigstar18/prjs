...
<html>
	...
	<body>
			...
			<table class="table1_style" border="0" cellspacing="0" cellpadding="0">
				<tr>
					<td>
						<div class="div_tj">
						<form name="frm"
								action="${basePath}/tradeManage/deOperator/deList.action?sortName=id"
								method="post">
													...
													<td class="table3_td_1" align="left">
														...
														<label>
															<input type="text" class="input_text"
																name="${GNNT_}id[like]" id="commodityId"
								...
								<tr>
									<td>
										<ec:table items="resultList"
											...
											var="commodity"
											action="${basePath}/tradeManage/deOperator/deList.action"
											...
											<ec:column width="6%" property="_0" title="序号" value="${GLOBALROWCOUNT}" sortable="false" filterable="false" />
												<ec:column property="id[like]" title="商品代码" width="30%"
													style="text-align:left; " value="${commodity.id}" />
		...
		function update(id){
			var url="${basePath}/tradeManage/deOperator/deForwardUpdate.action?obj.id="+id;
			var result=ecsideDialog(url,window,600,300);
			if(result>0)
			{
	 			  ec.submit();	
			}
