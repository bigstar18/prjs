...
function sub() {
	...
	parWin.document.getElementById('parentNo').value = checkValue;
	parWin.document.getElementById('parentOrgName').innerHTML = returnName;
	if(isMemberNo&&(ORGANIZATIONID==null||ORGANIZATIONID=='')){
		parWin.document.getElementById('parentNo').value = "";
		parWin.document.getElementById('parentOrgName').innerHTML ="会员直属居间";
	}else if(isMemberNo&&ORGANIZATIONID!=null&&ORGANIZATIONID!=''){
		parWin.document.getElementById('parentNo').value = "";
	}
	window.close();
}
