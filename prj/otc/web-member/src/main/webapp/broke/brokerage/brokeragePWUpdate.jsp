...
<body>
<form name="frm" id="frm" method ="post" action="<%=basePath%>/broke/brokerage/updatePassword.action" targetType="hidden">
		...
		<tr height="35">
        	<td align="right" class="td_size" width="35%"> 居间代码 ：</td>
            <td align="left">
            	<input name="obj.brokerageNo" type="text" class="input_text_pwd" value="${obj.brokerageNo }" readonly="readonly">
            </td>
        </tr>
        <tr height="35">
        	<td align="right" class="td_size"> 居间名称 ：</td>
            <td align="left">
