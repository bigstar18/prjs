...
<form name="frm" id="frm" method ="post" action="<%=basePath%>/broke/organization/updatePassword.action" targetType="hidden">
		<div class="div_scromin">
			<table border="0" width="90%" align="center" >
				<tr>
				 <td>
				 <div class="st_title"><img src="<%=skinPath%>/cssimg/st_ico1.gif" align="absmiddle" />&nbsp;&nbsp;修改机构密码</div>
			<table border="0" cellspacing="0" cellpadding="0" width="100%" class="st_bor">
		<tr height="35">
        	<td align="right" class="td_size" width="35%"> 机构代码 ：</td>
            <td align="left">
        ...
        <tr height="35">
        	<td align="right" class="td_size"> 机构名称 ：</td>
            <td align="left">
