  ...
  extends BaseService<HisNotice>
{
  ...
  public List<HisNotice> getOrganizationOKNoticeList(QueryConditions qc, PageInfo pageInfo, String userId)
  {
    return this.hisNoticeDao.getOrganizationOKNoticeList(qc, pageInfo, userId);
  }
  
  public List<HisNotice> getMemberOKNoticeList(QueryConditions qc, PageInfo pageInfo, String userId)
  {
    return this.hisNoticeDao.getMemberOKNoticeList(qc, pageInfo, userId);
  }
