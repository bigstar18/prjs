  ...
  implements Serializable
{
  ...
  {
    String treeString = "<li><input type=\"checkbox\" name=\"checks\" id=\"memberInfo\" value=\"" + this.organizationNO + "\"> " + " <img src=\"../../tree1/organization.gif\"  align=\"absmiddle\"/><label id=\"" + this.organizationNO + "_memberInfo\" value=\"" + this.organizationNO + "\" >" + 
      this.name + "</label>";
