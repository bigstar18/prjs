...
<div id="main_body">
	<table class="table1_style" border="0" cellspacing="0" cellpadding="0">
		<tr>
			<td>
				<div class="div_cx">
					<form id="frm" name="frm" action="${basePath}/timebargain/apply/commodityFeeAppList.action?sortColumns=order+by+id+desc" method="post">
				...
				<br />
			    <div class="div_gn">
					<rightButton:rightButton name="提交申请" onclick="addForward();" className="anniu_btn" action="/timebargain/apply/addCommodityFeeAppforward.action" id="add"></rightButton:rightButton>
				</div>
				<div class="div_list">
						...
						<tr>
							<td>
								<ec:table items="pageInfo.result" var="commodityFee"
									action="${basePath}/timebargain/apply/commodityFeeAppList.action?sortColumns=order+by+id+desc"											
									autoIncludeParameters="${empty param.autoInc}"
									xlsFileName="导出列表.xls" csvFileName="导出列表.csv"
									showPrint="true" listWidth="100%"
									minHeight="345"  style="table-layout:fixed;">
									<ec:row>
									    <ec:column property="COMMODITYID" title="商品代码" width="20%" style="text-align:center;" value="${commodityFee.dataMap['commodityID']}" filterable="false" sortable="false"/>
									    <ec:column property="FEEALGR" title="交易手续费算法" editTemplate="ecs_t_feeAlgr" width="10%" style="text-align:center;" value="${FEEALGR[commodityFee.dataMap['feeAlgr']]}" filterable="false" sortable="false"/>
									    <ec:column property="SETTLEFEEALGR" title="交收手续费算法" editTemplate="ecs_t_settleFeeAlgr" width="10%" style="text-align:center;" value="${FEEALGR[commodityFee.dataMap['settleFeeAlgr']]}" filterable="false" sortable="false"/>
										<ec:column property="LOWESTSETTLEFEE" title="最低交收手续费金额" width="15%"  style="text-align:center;" value="${commodityFee.dataMap['lowestSettleFee']}" filterable="false" sortable="false"/>
										...
										<ec:column property="applyTime" title="申请时间" width="15%" style="text-align:center;">
											<fmt:formatDate pattern="yyyy-MM-dd" value="${commodityFee.applyTime}"/>
										</ec:column>
									</ec:row>
								</ec:table>
							</td>
