      ...
      <table class="table1_style" border="0" cellspacing="0" cellpadding="0">
		<tr>
		  <td>
		    ...
		    <div class="div_gn">
			  <rightButton:rightButton name="添加" onclick="forwardAdd();" className="anniu_btn" action="/timebargain/firmSet/breedSpecial/addSettleFeeFoward.action" id="add"></rightButton:rightButton>
			  &nbsp;&nbsp;
			  <rightButton:rightButton name="删除" onclick="deleteSettleFee();" className="anniu_btn" action="/timebargain/firmSet/breedSpecial/deleteSettleFee.action" id="delete"></rightButton:rightButton>
			</div>     
				    ...
				    <ec:table items="pageInfo.result" var="breedSettleFee"
					  ...
					  <ec:row>
					    ...
					    <ec:column property="_1" title="修改" width="10%" style="text-align:center;" sortable="false" filterable="false">
                          <%-- <a href="#" onclick="viewById('<c:out value="${breedSettleFee.firmID}"/>','<c:out value="${breedSettleFee.breedID}"/>')"><img title="进入修改信息" src="<c:url value="${skinPath}/image/app/timebargain/fly.gif"/>"/></a> --%>
                          <rightHyperlink:rightHyperlink text="<img title='进入修改信息' src='${skinPath}/image/app/timebargain/fly.gif'/>" href="#" onclick="viewById('${breedSettleFee.firmID}','${breedSettleFee.breedID}')" action="/timebargain/firmSet/breedSpecial/viewSettleFee.action"/>
                        </ec:column>
