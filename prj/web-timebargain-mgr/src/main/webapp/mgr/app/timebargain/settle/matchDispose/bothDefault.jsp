    ...
    <script type="text/javascript">
	  ...
	  function event(v){
		  ...
		  switch(v)
			{	
		  	case 1:
			  	url = "${basePath}/timebargain/settle/matchDispose/viewMatch.action?flag=41&entity.matchID=${entity.matchID}";
				break;
			case 2:
				url = "${basePath}/timebargain/settle/matchDispose/viewMatch.action?flag=42&entity.matchID=${entity.matchID}";
				break;
			case 3:
				url = "${basePath}/timebargain/settle/matchDispose/viewMatch.action?flag=43&entity.matchID=${entity.matchID}";
				break;
			case 4:
				url = "${basePath}/timebargain/settle/matchDispose/viewMatch.action?flag=44&entity.matchID=${entity.matchID}";
				break;
			case 20:
	...
	<div>
	  <table border="0" cellspacing="0" cellpadding="4" width="100%" align="center">
	    ...
	    <c:if test="${entity.status <= 1 }">
		  ...
		  <td>
			<button class="btn_sec1" onClick="event(2)">收卖方违约金</button>
		  </td>
