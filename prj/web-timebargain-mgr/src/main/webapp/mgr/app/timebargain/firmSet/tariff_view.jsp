	  ...
	  <table class="table1_style" border="0" cellspacing="0" cellpadding="0">
		<tr>
			<td>
				...
				<div class="div_gn">
					<rightButton:rightButton name="返回" onclick="back();" className="anniu_btn" action="/timebargain/firmSet/firmTariff/firmTariffList.action" id="back"></rightButton:rightButton>
				</div>
				<div class="div_list">
					<table id="tb" border="0" cellspacing="0" cellpadding="0" width="100%">
						<tr>
							<td>
								<ec:table items="pageInfo.result" var="commodityTariff"
									action="${basePath}/timebargain/firmSet/firmTariff/viewTariff.action"											
									autoIncludeParameters="${empty param.autoInc}"
									xlsFileName="commodityTariff.xls" csvFileName="commodityTariff.csv"
									...
									<ec:row>
							            ...
							            <ec:column property="modifyTime" title="修改时间" width="160" style="text-align:center;">
							              <fmt:formatDate value="${commodityTariff.modifyTime }" pattern="yyyy-MM-dd HH:mm:SS" />
							            </ec:column>
