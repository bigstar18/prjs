...
function query(exportTo)
{
	...
	if(cateGoryId == ""){
     ...
     if(exportTo=="excel"){		
		var url="${mgrPath}/app/timebargain/printReport/tradeMonthReportExcel.jsp?startFirmID="+zStart +"&endFirmID="+ zEnd +"&startClearDate="+zDate+"&endClearDate="+zEndDate + "&orderBy=" + orderBy+ "&title=成交量统计表&brokerId=" +brokerId+ "&cateGoryId="+cateGoryId;
		document.location.href = url;
	 }else{
		//获取配置权限的 URL		
		var url="${mgrPath}/app/timebargain/printReport/tradeMonthReport.jsp?startFirmID="+zStart +"&endFirmID="+ zEnd +"&startClearDate="+zDate+"&endClearDate="+zEndDate+ "&orderBy=" + orderBy+ "&title=成交量统计表&brokerId=" +brokerId+ "&cateGoryId="+cateGoryId;
