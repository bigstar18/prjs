...
<html>
  ...
  <script type="text/javascript">
    ...
    function query()
    {
      ...
      {
    	parent.ListFrame.location.href = "${basePath}/timebargain/firmSet/commoditySpecial/listTradeMargin.action?sortColumns=order+by+modifyTime+desc";
      }
      else if(oper.value == "settleMargin")
      {
    	parent.ListFrame.location.href = "${basePath}/timebargain/firmSet/commoditySpecial/listSettleMargin.action?sortColumns=order+by+modifyTime+desc";
      }
      else if(oper.value == "qty")
      {
    	parent.ListFrame.location.href = "${basePath}/timebargain/firmSet/commoditySpecial/listMaxHoldQty.action?sortColumns=order+by+modifyTime+desc";
      } 
      else if(oper.value == "tradeFee")
      {
    	parent.ListFrame.location.href = "${basePath}/timebargain/firmSet/commoditySpecial/listTradeFee.action?sortColumns=order+by+modifyTime+desc";
      } 
      else if(oper.value == "settleFee")
      {
    	parent.ListFrame.location.href = "${basePath}/timebargain/firmSet/commoditySpecial/listSettleFee.action?sortColumns=order+by+modifyTime+desc";
      } 
  }
      ...
      <tr>
        ...
        <td width="120" background="<c:url value="${skinPath }/image/app/timebargain/bgimage.gif"/>">
           <%--  <a href="#" id="tradeMargin" class="common" onclick="tradeMargin_onclick()">特殊交易保证金</a>--%>
            <rightHyperlink:rightHyperlink href="#" id="tradeMargin" text="特殊交易保证金" className="common" onclick="tradeMargin_onclick()" action="/timebargain/firmSet/commoditySpecial/listTradeMargin.action" />
        </td>
         <td width="17" background="<c:url value="${skinPath }/image/app/timebargain/bgimage.gif"/>"><div align="left"><img src="<c:url value="${skinPath }/image/app/timebargain/line.gif"/>" width="3" height="31"></div></td>   
        <td width="120" background="<c:url value="${skinPath }/image/app/timebargain/bgimage.gif"/>">
           <%-- <a href="#" id="settleMargin" class="common" onclick="settleMargin_onclick()">特殊交收保证金</a>--%> 
            <rightHyperlink:rightHyperlink href="#" id="settleMargin" text="特殊交收保证金" className="common" onclick="settleMargin_onclick()" action="/timebargain/firmSet/commoditySpecial/listSettleMargin.action" />
        </td>
        <td width="17" background="<c:url value="${skinPath }/image/app/timebargain/bgimage.gif"/>"><div align="left"><img src="<c:url value="${skinPath }/image/app/timebargain/line.gif"/>" width="3" height="31"></div></td>
        <td width="120" background="<c:url value="${skinPath }/image/app/timebargain/bgimage.gif"/>" class="common" >
            ...
            <rightHyperlink:rightHyperlink href="#" id="qty" text="特殊订货量" className="common" onclick="qty_onclick()" action="/timebargain/firmSet/commoditySpecial/listMaxHoldQty.action" />
        </td>
        ...
        <td width="120" background="<c:url value="${skinPath }/image/app/timebargain/bgimage.gif"/>" class="common" >
              ...
              <rightHyperlink:rightHyperlink href="#" id="tradeFee" text="特殊交易手续费" className="common" onclick="tradeFee_onclick()" action="/timebargain/firmSet/commoditySpecial/listTradeFee.action" />
        </td>
        <td width="13" background="<c:url value="${skinPath }/image/app/timebargain/bgimage.gif"/>" class="common" ><img src="<c:url value="${skinPath }/image/app/timebargain/line.gif"/>" width="3" height="31"></td>
        <td width="120" background="<c:url value="${skinPath }/image/app/timebargain/bgimage.gif"/>" class="common" >
             <%--  <a href="#" id="settleFee" class="common" onclick="settleFee_onclick()">特殊交收手续费</a>--%>
              <rightHyperlink:rightHyperlink href="#" id="settleFee" text="特殊交收手续费" className="common" onclick="settleFee_onclick()" action="/timebargain/firmSet/commoditySpecial/listSettleFee.action" />
        </td>
        <td width="13" background="<c:url value="${skinPath }/image/app/timebargain/bgimage.gif"/>" class="common" ><img src="<c:url value="${skinPath }/image/app/timebargain/line.gif"/>" width="3" height="31"></td>
