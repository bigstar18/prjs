    ...
    <script type="text/javascript">
	   ...
	   //设置数据源地址
		function winload() 
		{
			...
			setRequestUrl("${basePath}/timebargain/tradeMonitor/monitorUnTradeInfoS.action");
			//setRequestUrl("<c:url value='/timebargain/tradeMonitor/tradeMonitor.do?funcflg=listUnTradeInfoS'/>");
		}
