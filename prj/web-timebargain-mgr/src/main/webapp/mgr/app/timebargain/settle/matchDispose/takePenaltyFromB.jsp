...
<html>
  ...
  <body>
  <form id="frm" enctype="multipart/form-data" method="post" targetType="hidden" action="${basePath}/timebargain/settle/matchDispose/takePenaltyFromB.action?entity.matchID=${entity.matchID}" >
    <div class="div_cx">
	  <table border="0" width="100%" align="center">
	    <tr>
		  <td>
		    <div class="warning">
			  <div class="content">
			          温馨提示 :交收配对【${entity.matchID}】收买方违约金信息
			  </div>
			</div>
		  </td>
		</tr>
	    ...
	    <tr align="center">   
		  <td>
						...
						<rightButton:rightButton name="保存" onclick="" className="btn_sec"
							action="/timebargain/settle/matchDispose/takePenaltyFromB.action" id="update" ></rightButton:rightButton>
		  </td>
	    </tr>
	  </table>
    </div>
