		...
		<div id="main_body">
			<table class="table1_style" border="0" cellspacing="0" cellpadding="0">
				<tr>
					<td>
					    <div class="div_cx">
							<form name="frm" action="${basePath}/timebargain/bill/alreadyPairTotal.action" method="post">
											...
											<tr>
												...
												<td valign="top">
													<table valign="top" border="0"  width="100%" cellpadding="0" cellspacing="0" class="common" align="left">
														...
														<tr height="20"><td bgcolor="FF9950" align="center">交易商代码</td><td bgcolor="FF9950" align="center">已配对数量</td></tr>
														<c:forEach items = "${buyeralreadyPairTotalList }" var = "buyeralreadyTotalMap">
															<tr height="20" align="center">
																<td>
																	${buyeralreadyTotalMap['FIRMID'] }
																</td>
																<td>
																	${buyeralreadyTotalMap['ALREADYPAIRTOTAL'] }
																</td>
															</tr>
														</c:forEach>	
													</table>
												...
												<td valign="top">
													<table valign="top" border="0"  width="100%" cellpadding="0" cellspacing="0" class="common" align="right">
														...
														<tr height="20"><td bgcolor="FF9950" align="center">交易商代码</td><td bgcolor="FF9950" align="center">已配对数量</td></tr>
														<c:forEach items = "${selleralreadyPairTotalList }" var = "selleralreadyTotalMap">
															<tr height="20" align="center">
																<td>
																	${selleralreadyTotalMap['FIRMID'] }
																</td>
																<td>
																	${selleralreadyTotalMap['ALREADYPAIRTOTAL'] }
																</td>
															</tr>
														</c:forEach>
													</table>
