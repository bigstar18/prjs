...
<html>
	...
	<body>
		<form id="frm" enctype="multipart/form-data" action="${basePath}/timebargain/deduct/addDeductPosition.action" method="post" targetType="hidden">
			<div class="div_cx">
										...
										<div class="div_tj">
											<table border="0" cellspacing="0" cellpadding="4"
												...
												<tr height="40">
													...
													<td align="left" width="30%">
														<input id="profitLvl1" name="entity.profitLvl1" value="${entity.profitLvl1 }" style="width: 120px"
												...
												<tr height="40">
													...
													<td align="left" width="30%">
														<input id="profitLvl2" name="entity.profitLvl2" value="${entity.profitLvl2 }" style="width: 120px"
												...
												<tr height="40">
													...
													<td align="left" width="30%">
														<input id="profitLvl3" name="entity.profitLvl3" value="${entity.profitLvl3 }" style="width: 120px"
												...
												<tr height="40">
													...
													<td align="left" width="30%">
														<input id="profitLvl4" name="entity.profitLvl4"  style="width: 120px"
													...
													<td align="left" width="30%">
														<input type="radio" name="entity.selfCounteract" value="0" checked="checked" style="border:0px;">否
														<input type="radio" name="entity.selfCounteract" value="1" style="border:0px;">所有会员双向订货对冲
														<div id="selfCounteract" style="display: none"><input type="radio" name="entity.selfCounteract" value="2" style="border:0px;">超净订货申报对冲</div>
													</td>
												</tr>
												<tr height="40">
													<td align="right" width="20%">
													...
													<td align="left" width="30%">
														<input id="profitLvl5" name="entity.profitLvl5" value="${entity.profitLvl5 }" style="width: 120px"
													...
													<td align="left" width="30%">
														<input id="lossRate" name="entity.lossRate" value="${entity.lossRate }" style="width: 120px"
				...
				<tr>
					<td align="center">
						<rightButton:rightButton name="保存" onclick="" className="btn_sec"
							action="/timebargain/deduct/addDeductPosition.action" id="add" ></rightButton:rightButton>
					&nbsp;&nbsp;&nbsp;
