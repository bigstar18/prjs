	...
	<table class="table1_style" border="0" cellspacing="0" cellpadding="0">
		<tr>
			<td>
				...
				<br />
			    <div class="div_gn">
					<rightButton:rightButton name="提交申请" onclick="addForward();" className="anniu_btn" action="/timebargain/apply/addPledgeAppforward.action" id="add"></rightButton:rightButton>
				</div>
				<div class="div_list">
							...
							<td>
								<ec:table items="pageInfo.result" var="pledge"
									...
									<ec:row>
								        ...
								        <ec:column property="FIRMID" title="交易商代码" ellipsis="true" width="170" style="text-align:center;">
								        </ec:column>
