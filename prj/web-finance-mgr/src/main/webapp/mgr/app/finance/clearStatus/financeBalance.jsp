	...
	<head>
		...
		<!-- 
			...
			function getStatus(){
				...
				var url = "${basePath}/ajaxcheckVoucherModel/voucherModel/getStatusJson.action?d=" + new Date().getTime();
				$.ajaxSettings.async = false;
				$.getJSON(url,null,function call(result){
					document.getElementById("balanceStatus").innerHTML = result;
				});
		...
		<table class="table1_style" border="0" cellspacing="0" cellpadding="0">
			<tr>
				<td valign="middle">
					...
					<rightButton:rightButton name="手工结算" onclick="addF();" className="anniu_btn" action="/finance/clearStatus/financeBalance.action" id="add"></rightButton:rightButton>
