												...
												<c:forEach items="${entity.voucherEntries}" var="entry">
											  		<tr>
											  			...
											  			<td align="right" class="underLine">
											  				<input id="accountCode" name="voucherEntries[${i }].accountCode" value="${entry.accountCode }"  readonly="readonly" type="text" class="text" style="width: 200px;" reqfv="required;科目代码" onchange="changeAccountCode(this.value);" onkeydown="if(event.keyCode==13)event.keyCode=9">
											  			</td>
											  			<td align="right" class="underLine">
											  				<input id="accountName" name="accountName" type="text" class="readonly" style="width: 200px;" readonly="readonly" reqfv="required;科目名称" onkeydown="if(event.keyCode==13)event.keyCode=9">
											  			</td>
											  			<td align="right" class="underLine">
											  				<input id="debitAmount" name="voucherEntries[${i }].debitAmount" value="${entry.debitAmount }" readonly="readonly" type="text" class="text" style="width: 120px;" reqfv="req_num;1;0;借方金额" value="0" onchange="computeSum();" onkeydown="if(event.keyCode==13)event.keyCode=9">
											  			</td>
											  			<td align="right" class="underLine">
											  				<input id="creditAmount" name="voucherEntries[${i }].creditAmount" value="${entry.creditAmount }" readonly="readonly" type="text" class="text" style="width: 120px;" reqfv="req_num;1;0;贷方金额" value="0" onchange="computeSum();" onkeydown="if(event.keyCode==13)event.keyCode=9">
											  			</td>
											  		</tr>
											  	<c:set var="i" value="1" />
											  	</c:forEach>
			...
			<table border="0" cellspacing="0" cellpadding="4" width="100%" align="center">
				<tr>
					<td align="right">
					    ...
					    <rightButton:rightButton name="审核通过" onclick="auditVoucher('true');" className="anniu_btn" action="/finance/voucher/auditVoucher1.action" id="update1"></rightButton:rightButton>
					    &nbsp;&nbsp;
					    <rightButton:rightButton name="审核不通过" onclick="auditVoucher('false');" className="anniu_btn" action="/finance/voucher/auditVoucher1.action" id="update2"></rightButton:rightButton>
						&nbsp;&nbsp;
