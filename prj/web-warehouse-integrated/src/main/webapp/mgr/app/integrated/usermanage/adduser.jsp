...
jQuery(document).ready(function() {
		...
		jQuery("#frm").validationEngine( {
			...
			ajaxFormValidationURL : "../ajaxcheck/warehouse/checkUserForm.action",
					...
					<td>
						...
						<table border="0" cellspacing="0" cellpadding="0" width="100%"
							...
							<tr height="35">
								...
								<td align="left" width="45%">
									<input id="userId" style="width: 160px;" name="entity.userId"
										type="text"
										class="validate[required,custom[onlyLetterNumber],maxSize[<fmt:message key='userID' bundle='${PropsFieldLength}'/>],ajax[checkUserByUserId]] input_text" />
								</td>
								<td align="left">
									<div class="onfocus">
										不能为空！
							...
							<tr style="display: none;">
								...
								<td>
									<input type="text" id="warehouseID" name="entity.warehouseID"
										size="16" class="input_text" />
								</td>
							</tr>
							<tr height="35">
								<td align="right" class="td_size" width="20%">
							...
							<tr height="35">
								...
								<td align="left">
									<textarea id="description" name="entity.description" cols="20"
										rows="5"
										class="validate[maxSize[<fmt:message key='userDescription' bundle='${PropsFieldLength}'/>]]"></textarea>
								</td>
								<td>
									&nbsp;
								</td>
...
<script type="text/javascript" src="${basePath}/mgr/public/js/keycode.js">
</script>
