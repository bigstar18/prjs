...
<html>
	<head>
		...
		<link rel="stylesheet" href="${skinPath}/css/app/integrated_warehouse/role.css" type="text/css"/>
			...
			jQuery(document).ready(function() {
				...
				$(".btn").click(function(){
					$(".more").toggle("fast");
				  	count++;
					if(count %2 ==0){
					$(".btn").html('<img src="<%=skinPath%>/image/app/integrated_warehouse/role/btn_1.gif" width="26" height="18" />');
					}else{
					$(".btn").html('<img src="<%=skinPath%>/image/app/integrated_warehouse/role/btn_2.gif" width="26" height="18" />');
					}
				});
				...
				<div class="word">
				 ...
				 <div class="btn">
					 <c:if test="${fn:length(tradeModuleMap) >4}">
					 	<img src="<%=skinPath%>/image/app/integrated_warehouse/role/btn_1.gif" width="26" height="18" />
					 </c:if>
				 </div>
			<div class="more">
