								...
								<tr>
									<td>
										<ec:table items="pageInfo.result" var="user"
											...
											xlsFileName="wareUser.xls" csvFileName="wareUser.csv"
											...
											<ec:row recordKey="${user.userId}">
												...
												<ec:column property="userId" width="11%" title="管理员代码"
													...
													<rightHyperlink:rightHyperlink href="#" className="blank_a" action="/user/updateForward.action" id="detail" text="<font color='#880000'>${user.userId}</font>" onclick="return forwardUpdate('${user.userId}');"/>
												</ec:column>
