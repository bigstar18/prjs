...
<html>
	...
	jQuery("#frm").validationEngine( {
		...
		ajaxFormValidationURL : "../../ajaxcheck/warehouse/checkStockFirmIdForm.action",
	...
	function getPropertyByBreedID(select){
		...
		if(value){
			var url = "${basePath}/mgr/app/warehouse/checkneedless/getPropertyValueByBreedID.action?breedId="+value+"&"+Math.random();//访问路径
			var frame = document.getElementById("hiddenframe");
			frame.src=url;
			if (!/*@cc_on!@*/0) {//非IE浏览器
				frame.onload = function(){
					var w = frame.contentWindow.document;
					if(w.getElementById("modulebase")){
										...
										<div
											...
											<table border="0" cellspacing="0" cellpadding="4"
												...
												<tr height="20">
													...
													<td width="28%">
														${warehouseID}
														<input type="hidden" id="warehouseID" name="entity.warehouseID" value="${warehouseID}">
													</td>
													<td width="*">
														&nbsp;
													</td>
