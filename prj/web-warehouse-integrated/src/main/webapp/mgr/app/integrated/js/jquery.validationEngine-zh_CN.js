    ...
    $.validationEngineLanguage = {
        newLang: function(){
            $.validationEngineLanguage.allRules = {
	            ...
	            "checkFirmByFirmId": {
                    "url": "../../ajaxcheck/warehouse/checkFirmByFirmId.action",
                ...
                "checkFirmByBankAccount": {
                    "url": "../../ajaxcheck/warehouse/checkFirmByBankAccount.action",
                ...
                "checkFirmByEmail": {
                    "url": "../../ajaxcheck/warehouse/checkFirmByEmail.action",
                ...
                "checkUserByUserId": {
                  	"url": "../ajaxcheck/warehouse/checkUserByUserId.action",
                    // error
                ...
                "checkRoleByName": {
                    "url": "../ajaxcheck/warehouse/checkRoleByName.action",
                ...
                "checkMessageByUserId": {
                    "url": "../../ajaxcheck/warehouse/checkMessageByUserId.action",
                ...
                "mouseCheckFirmByFirmId": {
                    "url": "../../ajaxcheck/warehouse/mouseCheckFirmByFirmId.action",
                    // error
                    "alertText": "* 此交易商不存在",
                    // if you provide an "alertTextOk", it will show as a green prompt when the field validates
                ...
                "checkStockByFirmId": {
                    "url": "../../ajaxcheck/warehouse/checkStockByFirmId.action",
                    "extraDataDynamic": ['#oldFirmId'],
                    // error
                    "alertText": "* 此交易商不存在或已注销",
                    // if you provide an "alertTextOk", it will show as a green prompt when the field validates
                    "alertTextOk": "此交易商可以使用",
                    // speaks by itself
                    "alertTextLoad": "* 正在确认交易商是否有存在，请稍等。"
                ...
                "checkKey": {
                    "url": "../../ajaxcheck/warehouse/checkKey.action",
