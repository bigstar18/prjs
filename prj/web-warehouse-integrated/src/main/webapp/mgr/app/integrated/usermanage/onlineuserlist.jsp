											...
											<table class="table3_style" border="0" cellspacing="0"
												...
												<tr>
													<td class="table3_td_1" align="left">
														管理员代码:&nbsp;
														<label>
															<input name="${GNNT_}TraderId[=][String]" id="TraderId" type="text"
																class="input_text" 
																value="<c:out value="${oldParams['TraderId[=][String]']}"/>"  maxLength="<fmt:message key='userID_q' bundle='${PropsFieldLength}'/>">
														</label>
													</td>
