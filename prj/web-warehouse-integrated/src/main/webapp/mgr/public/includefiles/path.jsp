...
<%
	...
	//web url：http://127.0.0.1:8080/integrated_mgr
	String basePath = request.getScheme() + "://" + request.getServerName() + ":" + request.getServerPort() + path;
	//mgr 路径：http://127.0.0.1:8080/integrated_mgr/mgr
	String mgrPath=basePath+"/mgr";
	//public 路径：http://127.0.0.1:8080/integrated_mgr/mgr/public
	String publicPath = mgrPath + "/public";
	//公共加载页面路径：http://127.0.0.1:8080/integrated_mgr/mgr/public/includefiles
	String includePath = publicPath + "/includefiles";
	//当前样式路径：http://127.0.0.1:8080/integrated_mgr/mgr/skinstyle/default
	String skinPath = mgrPath + "/skinstyle/" + skinName;
	//ecside 样式路径：http://127.0.0.1:8080/integrated_mgr/mgr/skinstyle/default/ecside
	String escideskinPath =skinPath+ "/ecside";
	//框架路径：http://127.0.0.1:8080/integrated_mgr/mgr/frame
	String framePath = basePath + "/mgr/frame";
	//按钮图片路径：http://127.0.0.1:8080/integrated_mgr/mgr/skinstyle/default/image/frame/menu/
