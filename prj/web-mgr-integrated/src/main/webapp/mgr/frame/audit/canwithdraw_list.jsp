				...
				<tr>
					<td>
						<ec:table items="pageInfo.result" var="apply"
							action="${basePath}/audit/baseAudit/canWithdrawList.action"
							...
							<ec:row>
								...
								<ec:column property="applyType" title="审核类型" width="22%"
									...
									<rightHyperlink:rightHyperlink href="#" className="blank_a" action="/audit/baseAudit/canWithdrawDetails.action" id="detail" text="<font color='#880000'>${auditOperateMap[applyTypeKey].name}</font>" onclick="doubleClick('${apply.id}');"/>
								</ec:column>
