			...
			<table class="table1_style" border="0" cellspacing="0"
				...
				<tr>
					<td>
						<div class="div_cx">
							<form name="frm"
								action="${basePath}/logquery/queryOperateLogSearch/mgrList.action?sortColumns=order+by+operateTime+desc&isQueryDB=true"
								method="post">
														...
														<td class="table3_td_1" align="left">
															...
															<label>
																<input type="text" class="input_text" id="operator"
																	...
																	value="${oldParams['primary.operator[allLike]'] }"   maxLength="<fmt:message key='userID_q' bundle='${PropsFieldLength}'/>"/>
															</label>
														</td>
									...
									<td>
										<ec:table items="pageInfo.result" var="operateLog" 
											...
											<ec:row>
												...
												<ec:column property="operator" title="管理员代码" width="8%" style="text-align:left;"/>
												<ec:column property="operateIp" title="登录IP" width="12%" style="text-align:left;"/>
												<ec:column property="operateTime" title="登录时间" width="20%" style="text-align:center;" sortable="true" filterable="false" >
