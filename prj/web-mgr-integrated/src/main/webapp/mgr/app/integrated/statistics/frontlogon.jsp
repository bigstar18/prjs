...
<html>
			...
			<table class="table1_style" border="0" cellspacing="0"
				...
				<tr height="10%">
					<td>
						<div class="div_cx">
							<form name="frm"
								action="${basePath}/statisticsQuery/frontlogon/frontLogonForwardQuery.action"
	...
	function select1() {
        ...
        if((reg.test(sDate)||sDate =="")&&(reg.test(eDate)||eDate =="")){        
			...
			frm.action="${basePath}/frameset?__report=mgr/app/integrated/statistics/frontlogon.rptdesign&__clean=true&__showtitle=false&__title=&__fittopage=true&__isHostPage=true&__navigationbar=false&__format=HTML&frameWidth="+frameWidth+"&frameHeight="+frameHeight;
