			...
			<div>
				<table border="0" cellspacing="0" cellpadding="4" width="100%"
					...
					<tr>
						...
						<td width="30%">
							<input type="text" id="code"
								class="validate[required,custom[onlyNumberSp],maxSize[2],ajax[checkCertificateTypeByCode]] input_text"
					...
					<tr>
						...
						<td  width="30%">
							<input type="text" id="sortNo"  ${readonly} class="validate[required,custom[onlyNumberSp],maxSize[2],ajax[checkCertificateTypeBySortNo]] input_text" name="entity.sortNo" value="${entity.sortNo}"/>
						</td>
						<script>
						if(${readonly!=null}){
