...
<html>
	...
	jQuery(document).ready(function() {
		...
		ajaxFormValidationURL : "../../ajaxcheck/checkAddCertificateTypeForm.action",
	...
	<iframe id="hiddenframe" name="hiddenframe" width=0 height=0 style="display:none" src="" application="yes"></iframe>
		<form id="frm" method="post"
			action="${basePath}/mfirmAttribute/mainTenance/updateCertificateType.action" target="hiddenframe">
			...
			<div>
				<table border="0" cellspacing="0" cellpadding="4" width="100%"
					...
					<tr>
						...
						<td  width="30%">
							<input type="text" id="sortNo"   class="validate[required,custom[onlyNumberSp],maxSize[2],ajax[checkCertificateTypeBySortNo]] input_text" name="entity.sortNo" value="${entity.sortNo}"/>
						</td>
						<td colspan="2">
							<div class="onfocus">
								不能为空！
					...
					<tr>
						<td align="right">
							<rightButton:rightButton name="修改" onclick="" className="btn_sec"
								action="/mfirmAttribute/mainTenance/updateCertificateType.action" id="update"></rightButton:rightButton>
