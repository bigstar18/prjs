...
function none(id) {
	...
	<head>
		...
		<form id="frm" method="post"
			action="${basePath}/mfirmAttribute/mainTenance/addZone.action" targetType="hidden">
			<div class="div_cx"  style="overflow-y:auto;height:250px;" >
				...
				<tr>
					...
					<tr>
						<td>
							<%@include file="zonecommontable.jsp"%>
						</td>
					</tr>
				</table>
			</div>
					...
					<tr>
						<td align="right">
							<rightButton:rightButton name="添加" onclick="" className="btn_sec"
								action="/mfirmAttribute/mainTenance/addZone.action" id="add"></rightButton:rightButton>
							&nbsp;&nbsp;
