			...
			<div>
				<table border="0" cellspacing="0" cellpadding="4" width="100%"
					...
					<tr>
						...
						<td width="30%">
							<input type="text" id="code"
								${readonly}
								class="validate[required,custom[onlyLetterNumber],maxSize[<fmt:message key='code_q' bundle='${PropsFieldLength}' />],ajax[checkIndustryByCode]] input_text"
					...
					<tr>
						...
						<td  width="30%">
							<input type="text" id="sortNo"  ${readonly} class="validate[required,custom[onlyNumberSp],maxSize[2],ajax[checkIndustryBySortNo]] input_text" name="entity.sortNo" value="${entity.sortNo}"/>
						</td>
						<script>
						if(${readonly!=null}){
