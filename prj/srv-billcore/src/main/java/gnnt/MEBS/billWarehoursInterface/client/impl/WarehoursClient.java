...
public class WarehoursClient {
	protected final transient Log logger = LogFactory.getLog(WarehoursClient.class);
	...
	public WarehoursClient(String serverAddr, int serverPort) {
	...
	public WarehoursClient(InetAddress localHost, int port) {
	...
	public ResponseVO communicate(RequestVO requestVO) {
		...
		if (connectServer()) {
			try {
				...
				switch (requestVO.getProtocolName()) {
				case register:
					responseVO = new RegisterResponseVO();
	...
	public static void main(String[] args) throws Exception {
		WarehoursClient client = new WarehoursClient();
		client.communicate(new RegisterRequestVO());
	}
}
