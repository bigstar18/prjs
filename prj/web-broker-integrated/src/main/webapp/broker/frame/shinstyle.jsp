...
<%@include file="/broker/public/includefiles/taglib.jsp"%>
<%@include file="/broker/public/includefiles/path.jsp"%>
<%@include file="/broker/public/includefiles/jsinclude.jsp"%>
<%@include file="/broker/public/includefiles/cssinclude.jsp"%>
<%@include file="/broker/public/jsp/session.jsp"%>
<%
