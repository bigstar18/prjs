...
<html>
	...
	jQuery(document).ready(function() {
		...
		jQuery("#frm").validationEngine( {
			...
			ajaxFormValidationURL : "../../ajaxcheck/ajaxFirmApply/checkFirmApplyUpdateForm.action",
	...
	<head>
		...
		<form id="frm" method="post"
			action="${basePath}/broker/firmManager/updateFirmApply.action" targetType="hidden">
			<div class="div_cx"  style="overflow:auto;height:480px;" >
				<table border="0" width="90%" align="center">
				<input type="hidden" name="entity.applyId" value="${entity.applyId }"></input>
				<tr>
					<td>
						<div class="warning">
							<div class="content">
										...
										<div>
											<table border="0" cellspacing="0" cellpadding="4" width="100%"
												...
												<tr>
													...
													<td  width="30%">
														<input type="text" id="userId" class="validate[required,funcCall[checkUserId],maxSize[16] input_text" name="entity.userId" value="${entity.userId}"/>
													</td>
												</tr>
												<tr>
													<td align="right">
													...
													<td>
														<select id="type" class="input_text" name="entity.brFirmApply.brokerAgeId"  data-prompt-position="topLeft:0">
															...
															<c:forEach items="${list}" var="brokerAge">
																...
																<c:if test="${entity.brFirmApply.brokerAgeId==brokerAge['BROKERAGEID']}">selected="selected"</c:if>>
																	${brokerAge['NAME']}</option>
															</c:forEach>
														</select>
													</td>
													<td align="right">
												...
												<td width="30%">
													<select id="certificateType" name="entity.certificateType" class="validate[required] input_text">
														...
														<c:forEach items="${certificateTypeMap}" var="map">
															<option value="${map.key}" title='${map.value}'<c:if test="${entity.certificateType==map.key }">selected="selected"</c:if>>
															${map.value}</option>
														</c:forEach>
													</select>
												</td>
										...
										<div>
											<table border="0" cellspacing="0" cellpadding="4" width="100%"
												...
												<tr>
													...
													<td width="30%">
														<input type="password" id="password" class="validate[required,minSize[6]] input_text" name="entity.password" value="${entity.password }" data-prompt-position="topRight:25,30"/>
													</td>
													<td colspan="2" width="*">
														<div class="onfocus">
															不能为空！
												...
												<tr>
													...
													<td  >
														<input type="password" id="password1" class="validate[required,equals[password]] input_text" name="password1" value="${entity.password }" data-prompt-position="topRight:25,25"/>
													</td>
													<td colspan="2">
														<div class="onfocus">
															不能为空！
					...
					<tr>
						<td align="right">
							<rightButton:rightButton name="修改" onclick="" className="btn_sec"
								action="/broker/firmManager/updateFirmApply.action" id="update"></rightButton:rightButton>
							&nbsp;&nbsp;
