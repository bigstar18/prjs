...
<html>
	...
	<head>
		...
		<form id="frm" method="post"
			action="${basePath}/broker/brokerage/addBrokerage.action" targetType="hidden">
										...
										<div>
											<table border="0" cellspacing="0" cellpadding="4" width="100%"
												...
												<tr>
													...
													<td  width="30%">
														<input type="text" id="brokerageId" name="entity.brokerAgeId"
															class="validate[required,maxSize[32]] input_text" value=""
													...
													<td>
														<input type="text" id="name"
															class="validate[required,maxSize[20]] input_text"
												...
												<tr>
													...
													<td>
														<select id="type" class="input_text" id="pBrokerageId2" name="pBrokerageId2" onchange="changeBrokerage(this)" >
														...
														<input type="hidden" id="pbrokerAgeId" name="entity.pbrokerAgeId" value=""/>
													</td>													
												</tr>
												<tr>
													<td align="right">
					...
					<tr>
						<td align="right">
							<rightButton:rightButton name="添加" onclick="" className="btn_sec"
								action="/broker/brokerage/addBrokerage.action" id="update"></rightButton:rightButton>
							&nbsp;&nbsp;
