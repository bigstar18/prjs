...
public class NjuptAuthentication implements IAuthentication {
	...
	public boolean authenticate(String usercode, String username,
		...
		// 南邮实名认证地址
		String schoolurl = "http://jwxt.njupt.edu.cn/";
		...
		try {
			...
			// 获取__VIEWSTATE的值
			String viewState = HttpUtil.fetchNecessaryParam(
					EntityUtils.toString(response.getEntity()), "__VIEWSTATE");
			// 填充需要提交的表单
