			...
			<table class="table1_style" border="0" cellspacing="0"
				...
				<tr>
					<td>
						<div class="div_cx">
							<form name="frm"
								action="${basePath}/warehouse/log/${logType }List.action?sortColumns=order+by+id&isQueryDB=true"
								method="post">
									...
									<td>
										<ec:table items="pageInfo.result" var="operateLog" 
											...
											<ec:row>
												...
												<ec:column property="operator" title="操作人" width="5%" ellipsis="true" style="text-align:left;"/>
												<ec:column property="operateIp" title="操作人Ip" width="8%" ellipsis="true" style="text-align:left;"/>
												...
												<ec:column property="logCatalog.tradeModule.cnName" title="操作模块" width="10%" >
													${operateLog.logCatalog.tradeModule.cnName}
												</ec:column>
												 <ec:column property="wareHouseID" title="仓库编号" width="10%" >
												</ec:column>
												...
												<ec:column property="logCatalog.catalogName" title="操作类型" width="10%" style="text-align:center;" ellipsis="true" >
													${operateLog.logCatalog.catalogName }
												</ec:column>
