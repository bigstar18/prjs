        ...
        newLang: function(){
            $.validationEngineLanguage.allRules = {
                ...
                "phone": {
                    ...
                    "alertText": "* 请输入有效的11位手机号码"
                },
                "phoneOrTel": {
                    "regex":/^(1[3|4|5|8|7][0-9]\d{8})|([0-9]{3,4}\-[0-9]{7,8})$/,
                    "alertText": "* 请输入有效的11位手机号码或固定电话。固话格式:“区号-号码”"
                },
                "onlyLetterNumber": {
                    "regex": /^[0-9a-zA-Z]+$/,
                    "alertText": "* 只接受英文字母大小写或数字"
                ...
                "onlyLetterNumberCN_":{
                	...
                	"alertText":"* 只接受中文，英文，数字，减号和下划线"
                },
                "onlyCapitalLetterNumber":{
                	"regex":/^[A-Z0-9]{0,}$/,
                	"alertText":"* 只接受大写英文字母和数字"
                },
                "onlyLetterNumberCN":{
                	"regex":/^[\u4E00-\u9FA5a-zA-Z0-9]{0,}$/,
                	"alertText":"* 只接受中文，英文和数字"
                },
                "onlyLetterCN":{
                	"regex":/^[a-zA-Z\u4e00-\u9fa5]+$/,
                	"alertText":"* 只接受中文和英文"
                ...
                "checkWarehouseBywarehouseId": {
                    ...
                    "alertTextOk": "此仓库编号可以使用",
                    // speaks by itself
                    "alertTextLoad": "* 正在确认仓库编号是否有存在，请稍等。"
                },
                 "checkStockByFirmId": {
                 ...
                 "checkWuserByUserId": {
                    ...
                    // speaks by itself
                    "alertTextLoad": "* 正在确认用户代码是否有存在，请稍等。"
                },
                "checkKey": {
