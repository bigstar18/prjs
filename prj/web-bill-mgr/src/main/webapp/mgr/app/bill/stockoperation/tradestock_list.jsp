												...
												<table class="table3_style" border="0" cellspacing="0" 
													...
													<tr >
														...
														<td class="table3_td_1" align="right">
															...
															<label>
																<input type="text" class="input_text" style="width: 100px;"
																maxLength="<fmt:message key='tradeNo_q' bundle='${PropsFieldLength}'/>" 
																	name="${GNNT_}primary.tradeNo[=][String]"
																	value="${oldParams['primary.tradeNo[=][String]'] }" />
															</label>
														</td>														
									...
									<ec:table items="pageInfo.result" var="stockOperation"
											...
											<ec:row>
												<ec:column width="5%" property="_0" title="序号" style="text-align:center;"
													...
													filterable="false" />
												<ec:column property="stock.stockId" width="6%" title="Stock.stockId"
												...
												<ec:column property="stock.quantity" width="10%" title="Stock.quantity"
													style="text-align:right; " ellipsis="true">
													<fmt:formatNumber value="${stockOperation.stock.quantity}" pattern="#,##0.00"/>(${stockOperation.stock.unit})</ec:column>
												<ec:column property="stock.ownerFirm" width="10%" title="Stock.ownerFirm"
													style="text-align:left; " ellipsis="true">
												</ec:column>
												<ec:column property="moduleId" width="10%" title="模块名" style="text-align:left; ">
												...
												<ec:column property="tradeNo" width="10%" title="合同号" style="text-align:left; "></ec:column>
												<ec:column property="stock.lastTime" width="12%" title="Stock.lastTime"
													style="text-align:center; ">
													<fmt:formatDate value="${stockOperation.stock.lastTime}" pattern="yyyy-MM-dd HH:mm:ss"/>
												</ec:column>
												<ec:column property="stock.createTime" width="12%" title="Stock.createTime"
													style="text-align:center; ">
...
<SCRIPT type="text/javascript">
	...
	function details(stockid){
		...
		var result =showDialogRes(url, '', 700, 450);
	}
</SCRIPT>
	</body>
</html>