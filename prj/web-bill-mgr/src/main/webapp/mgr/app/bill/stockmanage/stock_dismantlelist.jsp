														...
														<td class="table3_td_1" align="right">
															...
															<label>
																...
																maxLength="<fmt:message key='warehouseId_q' bundle='${PropsFieldLength}'/>"
																	name="${GNNT_}primary.stock.warehouseId[allLike]"
																	value="${oldParams['primary.stock.warehouseId[allLike]']}" />
															</label>
														</td>
														<td class="table3_td_1" align="right">
								...
								<tr>
									...
									<ec:table items="pageInfo.result" var="dismantle"
											...
											<ec:row>
												...
												<ec:column property="dismantleId" width="9%" title="拆仓单编号"
													style="text-align:left; ">
												...
												<ec:column property="stock.ownerFirm" width="9%" title="所属交易商"
												...
												<ec:column property="status" width="6%" title="Stock.stockStatus"
													style="text-align:center; ">
