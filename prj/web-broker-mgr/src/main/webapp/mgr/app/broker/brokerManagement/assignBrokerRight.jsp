...
<html>
	<head>
		...
		//---------------------------------------------------------华丽分割线 -------------------------------------------	
			...
			function addModule($newList){
				...
				url += "&t="+Math.random();
				//获取下面定义好的iframe ,并且给iframe的src赋予路径访问后台。
	...
	<body style="overflow-y:hidden">
		...
		<form name="frm" method="post" targetType="hidden">
			...
			&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
				<rightButton:rightButton name="修改" onclick="frmChk();" className="btn_sec" action="/broker/brokerManagement/updateBrokerRight.action" id="update"></rightButton:rightButton>
				&nbsp;&nbsp;
