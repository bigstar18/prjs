	...
	<head>
		...
		<!-- 
			...
			function customerDetails(customerId){
				var url = "${basePath}/demo/customerplay/customerdetails.action?entity.customerId="+customerId;
		...
		<div id="main_body">
			<table class="table1_style" border="0" cellspacing="0" cellpadding="0">
				<tr>
					<td>
						<div class="div_cx">
							<form name="frm" action="${basePath}/demo/customerplay/customerlist.action?sortColumns=order+by+customerId+desc" method="post">
						...
						<div class="div_gn">
							<rightButton:rightButton name="添加" onclick="addCustomerForward();" className="anniu_btn" action="/demo/customerplay/addcustomerforward.action" id="add"></rightButton:rightButton>
							&nbsp;&nbsp;
							<rightButton:rightButton name="删除" onclick="delateCustomerList();" className="anniu_btn" action="/demo/customerplay/delatecustomerlist.action" id="delate"></rightButton:rightButton>
						</div>
						<div class="div_list">
								...
								<tr>
									<td>
										<ec:table items="pageInfo.result" var="customer"
											action="${basePath}/demo/customerplay/customerlist.action?sortColumns=order+by+customerId+desc"											
											...
											<ec:row>
												...
												<ec:column property="prop" title="修改信息" width="10%" style="text-align:center;">
													<rightButton:rightButton name="修改" onclick="updateCustomerForward('${customer.customerId}');" className="anniu_btn" action="/demo/customerplay/updatecustomerforward.action" id="update${customer.customerId}"></rightButton:rightButton>
												</ec:column>
											</ec:row>
										</ec:table>
									</td>
